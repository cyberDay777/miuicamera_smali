...
.method public final a(Z)V
    ...
    iget-object v4, v1, Le9/c;->e5:Ljava/lang/Boolean;

    if-nez v4, :cond_0

    sget-object v4, Lp9/c0;->V0:Lp9/b0;

    invoke-static {v4, v1}, Landroidx/appcompat/widget/a;->b(Lp9/b0;Le9/c;)Ljava/lang/Boolean;

    move-result-object v4

    iput-object v4, v1, Le9/c;->e5:Ljava/lang/Boolean;

    :cond_0
    iget-object v1, v1, Le9/c;->e5:Ljava/lang/Boolean;
...
.method public final b(Z)V
    ...
    iget-object v2, p0, Le6/a;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {p0, p1}, Le6/a;->f(Z)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, Le6/a;->i(Z)V
    ...
    :cond_2
    invoke-virtual {v2}, Lcom/android/camera/module/m;->getMutexModePicker()Lcom/android/camera/v3;
    ...
    invoke-virtual {v4}, Lcom/android/camera/v3;->b()Z
    ...
    :cond_5
    invoke-virtual {v4, v6}, Lcom/android/camera/v3;->d(I)V
    ...
    :try_start_3
    invoke-virtual {v4}, Lcom/android/camera/v3;->c()V
    ...
    :try_start_4
    invoke-virtual {v2}, Lcom/android/camera/module/m;->getUserEventMgr()Lz5/j;
    ...
    invoke-interface {v1, v2}, Lz5/j;->updatePreferenceInWorkThread([I)V
...
.method public final c()Z
    ...
    iget-boolean v2, v2, Lx0/p;->d:Z

    if-eqz v2, :cond_6

    sget-object p0, Ltb/a$b;->a:Ltb/a;

    iget-object v2, p0, Ltb/a;->g:L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;

    invoke-virtual {v2}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->m2()Z
    ...
    iget-boolean p0, p0, Lx0/p;->e:Z

    return p0

    :cond_8
    iget-boolean p0, p0, Le6/a;->d:Z
...
.method public final d(I)Z
    ...
    iget-object p0, p0, Le6/a;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v1}, Le9/d;->G1(Le9/c;)Z
...
.method public final e(Z)V
    ...
    iget-object v4, v1, Le9/c;->R2:Ljava/lang/Boolean;

    if-nez v4, :cond_0

    sget-object v4, Lp9/c0;->I0:Lp9/b0;

    invoke-static {v4, v1}, Landroidx/appcompat/widget/a;->b(Lp9/b0;Le9/c;)Ljava/lang/Boolean;

    move-result-object v4

    iput-object v4, v1, Le9/c;->R2:Ljava/lang/Boolean;

    :cond_0
    iget-object v1, v1, Le9/c;->R2:Ljava/lang/Boolean;
...
.method public final f(Z)Z
    ...
    iget-object v3, v3, Lx0/l1;->f:Lx0/p;
    ...
    invoke-virtual {v3, v4}, Lx0/p;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v3, v4}, Lx0/p;->o(Ljava/lang/String;)Z
    ...
    invoke-static {v4}, Lx0/p;->h(Ljava/lang/String;)I
    ...
    invoke-virtual {p1}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->h5()I
    ...
    invoke-static {p1}, Le9/d;->z1(Le9/c;)Z
...
.method public final g(Ljava/lang/String;)V
    ...
    invoke-interface {v0}, Lcom/android/camera/module/h0;->getMutexModePicker()Lcom/android/camera/v3;

    move-result-object v0

    invoke-virtual {v0, v1}, Lcom/android/camera/v3;->d(I)V
    ...
    iget-object v0, p0, Le6/a;->j:Ljava/lang/String;
    ...
    iput-object p1, p0, Le6/a;->j:Ljava/lang/String;
...
.method public final h()V
    ...
    :cond_0
    iget-object v1, p0, Le6/a;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v0, v4}, Lx0/p;->getComponentValue(I)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v2}, Lcom/android/camera/module/Camera2Module;->getZoomManager()Lc9/h;

    move-result-object v5

    invoke-virtual {v5}, Lc9/h;->B()F

    move-result v5

    invoke-interface {v3}, Lz5/k;->T()Z

    invoke-virtual {v2}, Lcom/android/camera/module/m;->getAppStateMgr()Lz5/b;

    move-result-object v6

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v6, Lc9/a;->a:Landroid/util/Range;
    ...
    iget-boolean v5, p0, Le6/a;->c:Z

    if-nez v5, :cond_2

    iget-boolean v5, p0, Le6/a;->b:Z
    ...
    invoke-virtual {v5}, Lcom/android/camera/v3;->a()Z
    ...
    invoke-virtual {p0, v7}, Le6/a;->b(Z)V

    invoke-virtual {p0, v7}, Le6/a;->i(Z)V

    :cond_3
    invoke-virtual {v0, v4}, Lx0/p;->o(Ljava/lang/String;)Z
    ...
    invoke-static {v13}, Le9/d;->z1(Le9/c;)Z
    ...
    invoke-virtual {v13}, Le9/a;->q()Le9/z;
    ...
    iget-object v13, v13, Lx0/l1;->f:Lx0/p;

    invoke-virtual {v13, v14}, Lx0/p;->getComponentValue(I)Ljava/lang/String;
    ...
    iget-object v14, v14, Lx0/l1;->e:Lx0/m;

    invoke-virtual {v14, v1}, Lx0/m;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, v5, v14}, Le9/a;->O(ILjava/lang/Integer;)Z
    ...
    iput-boolean v10, p0, Le6/a;->f:Z

    invoke-virtual {p0, v11}, Le6/a;->g(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v8}, Le6/a;->g(Ljava/lang/String;)V

    goto :goto_3

    :cond_b
    invoke-virtual {p0, v4}, Le6/a;->g(Ljava/lang/String;)V

    goto :goto_3

    :cond_c
    :goto_2
    invoke-virtual {p0, v12}, Le6/a;->g(Ljava/lang/String;)V
    ...
    iget-object v5, v2, Lcom/android/camera/module/Camera2Module;->mAiSceneMgr:Lb6/b;

    iget-boolean v5, v5, Lb6/b;->c:Z
    ...
    invoke-virtual {v5}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->h5()I
    ...
    iget-boolean v5, v1, Le9/z;->K0:Z

    if-eqz v5, :cond_11

    iput-boolean v7, v1, Le9/z;->K0:Z
    ...
    invoke-direct {v5, v0, v10}, Le9/g;-><init>(Le9/y;I)V

    invoke-virtual {v1, v5}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    :cond_12
    iput-boolean v7, p0, Le6/a;->d:Z
    ...
    :cond_14
    iget-object v1, v2, Lcom/android/camera/module/Camera2Module;->mAiSceneMgr:Lb6/b;

    iget-boolean v2, v1, Lb6/b;->c:Z

    if-eqz v2, :cond_16

    iget-boolean v2, v1, Lb6/b;->d:Z
    ...
    invoke-direct {v5, v1}, Lb6/a;-><init>(Lb6/b;)V
    ...
    iget-boolean v1, v0, Le9/z;->K0:Z

    if-eq v1, v10, :cond_19

    iput-boolean v10, v0, Le9/z;->K0:Z
    ...
    invoke-direct {v1, p0, v10}, Le9/g;-><init>(Le9/y;I)V
    ...
    iget v2, v1, Le9/z;->L0:I

    if-eq v2, v0, :cond_1b

    iput v0, v1, Le9/z;->L0:I
    ...
    invoke-direct {v1, p0, v9}, Le9/i;-><init>(Le9/y;I)V
    ...
    iget v2, v1, Le9/z;->k2:I

    if-eq v2, v0, :cond_1d

    iput v0, v1, Le9/z;->k2:I
    ...
    invoke-direct {v1, p0, v10}, Le9/h;-><init>(Le9/y;I)V
...
.method public final i(Z)V
    ...
    invoke-virtual {v1, v2}, Lx0/p;->getComponentValue(I)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Lx0/p;->o(Ljava/lang/String;)Z
    ...
    invoke-static {v2, p1, v5}, Landroidx/activity/e;->g(Ljava/lang/String;ZLjava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-boolean v5, p0, Le6/a;->h:Z
    ...
    iget-object v1, p0, Le6/a;->g:Le6/b;
    ...
    iget-boolean v2, v1, Le6/b;->a:Z

    if-eqz v2, :cond_2

    iget-wide v9, v1, Le6/b;->b:J
    ...
    :cond_4
    iput-boolean p1, p0, Le6/a;->h:Z

    iput-boolean v3, p0, Le6/a;->i:Z
    ...
    invoke-direct {p1, v0}, Lcom/android/camera/e;-><init>(I)V
