...
.method public constructor <init>(Lk/j;Ls/b;Lr/j;)V
    ...
    iput-object v0, p0, Lm/o;->a:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lm/o;->b:Landroid/graphics/Path;

    iput-object p1, p0, Lm/o;->c:Lk/j;

    iput-object p2, p0, Lm/o;->d:Ls/b;

    iget-object p1, p3, Lr/j;->a:Ljava/lang/String;

    iput-object p1, p0, Lm/o;->e:Ljava/lang/String;

    iget-boolean p1, p3, Lr/j;->e:Z

    iput-boolean p1, p0, Lm/o;->f:Z
...
.method public final c(Ljava/util/ListIterator;)V
    ...
    iget-object v2, p0, Lm/o;->c:Lk/j;

    iget-object v3, p0, Lm/o;->d:Ls/b;

    const-string v4, "Repeater"

    iget-boolean v5, p0, Lm/o;->f:Z

    const/4 v7, 0x0

    move-object v1, p1

    invoke-direct/range {v1 .. v7}, Lm/c;-><init>(Lk/j;Ls/b;Ljava/lang/String;ZLjava/util/ArrayList;Lq/l;)V

    iput-object p1, p0, Lm/o;->j:Lm/c;
...
.method public final e(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
    ...
    iget-object v6, p0, Lm/o;->a:Landroid/graphics/Matrix;
    ...
    iget-object v7, p0, Lm/o;->j:Lm/c;

    float-to-int v8, v9

    invoke-virtual {v7, p1, v6, v8}, Lm/c;->e(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
...
.method public final g(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, p2}, Lm/c;->g(Ljava/util/List;Ljava/util/List;)V
...
.method public final getName()Ljava/lang/String;
    ...
    iget-object p0, p0, Lm/o;->e:Ljava/lang/String;
...
.method public final getPath()Landroid/graphics/Path;
    ...
    invoke-virtual {v0}, Lm/c;->getPath()Landroid/graphics/Path;

    move-result-object v0

    iget-object v1, p0, Lm/o;->b:Landroid/graphics/Path;

    invoke-virtual {v1}, Landroid/graphics/Path;->reset()V

    iget-object v2, p0, Lm/o;->g:Ln/c;
    ...
    iget-object v4, p0, Lm/o;->a:Landroid/graphics/Matrix;

    int-to-float v5, v2

    add-float/2addr v5, v3

    iget-object v6, p0, Lm/o;->i:Ln/o;
