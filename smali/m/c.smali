...
.method public constructor <init>(Lk/j;Ls/b;Ljava/lang/String;ZLjava/util/ArrayList;Lq/l;)V
    ...
    iput-object v0, p0, Lm/c;->b:Landroid/graphics/RectF;
    ...
    iput-object v0, p0, Lm/c;->c:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Lm/c;->d:Landroid/graphics/Path;
    ...
    iput-object v0, p0, Lm/c;->e:Landroid/graphics/RectF;

    .line 18
    iput-object p3, p0, Lm/c;->f:Ljava/lang/String;

    .line 19
    iput-object p1, p0, Lm/c;->i:Lk/j;

    .line 20
    iput-boolean p4, p0, Lm/c;->g:Z

    .line 21
    iput-object p5, p0, Lm/c;->h:Ljava/util/List;
    ...
    invoke-interface {p2, p3}, Lm/i;->c(Ljava/util/ListIterator;)V
...
.method public constructor <init>(Lk/j;Ls/b;Lr/m;)V
    ...
    invoke-interface {v2, p1, p2}, Lr/b;->a(Lk/j;Ls/b;)Lm/b;
    ...
    .line 11
    invoke-direct/range {v0 .. v6}, Lm/c;-><init>(Lk/j;Ls/b;Ljava/lang/String;ZLjava/util/ArrayList;Lq/l;)V
...
.method public final b(Landroid/graphics/RectF;Landroid/graphics/Matrix;Z)V
    ...
    iget-object v0, p0, Lm/c;->c:Landroid/graphics/Matrix;

    invoke-virtual {v0, p2}, Landroid/graphics/Matrix;->set(Landroid/graphics/Matrix;)V

    iget-object p2, p0, Lm/c;->k:Ln/o;
    ...
    :cond_0
    iget-object p2, p0, Lm/c;->e:Landroid/graphics/RectF;

    const/4 v1, 0x0

    invoke-virtual {p2, v1, v1, v1, v1}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p0, p0, Lm/c;->h:Ljava/util/List;
    ...
    instance-of v3, v2, Lm/d;

    if-eqz v3, :cond_1

    check-cast v2, Lm/d;

    invoke-interface {v2, p2, v0, p3}, Lm/d;->b(Landroid/graphics/RectF;Landroid/graphics/Matrix;Z)V
...
.method public final c()Ljava/util/List;
    ...
    iget-object v0, p0, Lm/c;->j:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lm/c;->j:Ljava/util/ArrayList;

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lm/c;->h:Ljava/util/List;
    ...
    instance-of v2, v1, Lm/l;

    if-eqz v2, :cond_0

    iget-object v2, p0, Lm/c;->j:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p0, p0, Lm/c;->j:Ljava/util/ArrayList;
...
.method public final e(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
    ...
    iget-object v4, p0, Lm/c;->h:Ljava/util/List;
    ...
    iget-object p2, p0, Lm/c;->b:Landroid/graphics/RectF;

    const/4 v5, 0x0

    invoke-virtual {p2, v5, v5, v5, v5}, Landroid/graphics/RectF;->set(FFFF)V

    invoke-virtual {p0, p2, v0, v1}, Lm/c;->b(Landroid/graphics/RectF;Landroid/graphics/Matrix;Z)V

    iget-object p0, p0, Lm/c;->a:Ll/a;
    ...
    instance-of v1, p2, Lm/d;

    if-eqz v1, :cond_8

    check-cast p2, Lm/d;

    invoke-interface {p2, p1, v0, p3}, Lm/d;->e(Landroid/graphics/Canvas;Landroid/graphics/Matrix;I)V
...
.method public final g(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-interface {v0, p2, v1}, Lm/b;->g(Ljava/util/List;Ljava/util/List;)V
...
.method public final getName()Ljava/lang/String;
    ...
    iget-object p0, p0, Lm/c;->f:Ljava/lang/String;
...
.method public final getPath()Landroid/graphics/Path;
    ...
    :cond_0
    iget-object v1, p0, Lm/c;->d:Landroid/graphics/Path;

    invoke-virtual {v1}, Landroid/graphics/Path;->reset()V

    iget-boolean v2, p0, Lm/c;->g:Z
    ...
    instance-of v4, v3, Lm/l;

    if-eqz v4, :cond_2

    check-cast v3, Lm/l;

    invoke-interface {v3}, Lm/l;->getPath()Landroid/graphics/Path;
