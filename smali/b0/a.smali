...
# direct methods
.method public constructor <init>(Landroid/graphics/Rect;Lcom/android/camera/y5;)V
    .locals 2
...
.method public final b(Landroid/view/MotionEvent;Landroid/view/View;)V
    ...
    iget-object p2, p0, La1/f;->f:Le0/q;

    if-eqz p2, :cond_3

    iget v0, p2, Le0/q;->b:I

    const/4 v1, -0x1

    iput-object p1, p2, Le0/q;->i:[I

    goto :goto_1

    :cond_3
    iget-object p2, p0, La1/f;->g:Le0/q;
    ...
    :cond_4
    :goto_1
    iget-object p1, p0, La1/f;->f:Le0/q;

    if-eqz p1, :cond_5

    iput-boolean v2, p1, Le0/q;->l:Z
