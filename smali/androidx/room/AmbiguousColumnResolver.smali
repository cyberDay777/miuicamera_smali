...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILql/l;)V
    .locals 2
    ...
    invoke-static {p2}, Lfl/n;->B(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object p0

    invoke-interface {p4, p0}, Lql/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, p2, v1, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILql/l;)V
    ...
    invoke-static {p2}, Lkotlin/jvm/internal/f;->e(Ljava/util/List;)I
...
.method public static synthetic dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILql/l;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILql/l;)V

    return-void
.end method

.method private final rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lql/q;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2, v3, v4}, Lql/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    invoke-static {v2, v7}, Lfl/l;->q(Ljava/util/Collection;[Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-static {v2}, La/e;->k(Lgl/f;)Lgl/f;

    new-instance v4, Lgl/a;

    invoke-direct {v4}, Lgl/a;-><init>()V
    ...
    invoke-virtual {v2, v9}, Lgl/f;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4, v11}, Lgl/a;->add(Ljava/lang/Object;)Z
    ...
    :cond_6
    invoke-static {v4}, Lkotlin/jvm/internal/f;->c(Lgl/a;)Lgl/a;
    ...
    invoke-direct {v10, v4, v8, v11}, Landroidx/room/AmbiguousColumnResolver;->rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lql/q;)V
    ...
    invoke-direct {v13}, Lgl/a;-><init>()V

    invoke-virtual {v4}, Lgl/a;->iterator()Ljava/util/Iterator;
    ...
    check-cast v15, Lgl/a$a;

    invoke-virtual {v15}, Lgl/a$a;->hasNext()Z

    move-result v16

    if-eqz v16, :cond_9

    invoke-virtual {v15}, Lgl/a$a;->next()Ljava/lang/Object;
    ...
    invoke-virtual {v13, v5}, Lgl/a;->add(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-static {v13}, Lkotlin/jvm/internal/f;->c(Lgl/a;)Lgl/a;

    invoke-virtual {v13}, Lgl/a;->isEmpty()Z
    ...
    invoke-static {v0, v11, v1}, Landroidx/appcompat/widget/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v11 .. v17}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILql/l;ILjava/lang/Object;)V
    ...
    invoke-static/range {v6 .. v12}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILql/l;ILjava/lang/Object;)V
