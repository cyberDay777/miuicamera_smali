...
.method public static final dropFtsSyncTriggers(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    invoke-virtual {v0, v2}, Lgl/a;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v2}, La/e;->n(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    invoke-static {v0}, Lkotlin/jvm/internal/f;->c(Lgl/a;)Lgl/a;

    invoke-virtual {v0}, Lgl/a;->iterator()Ljava/util/Iterator;
    ...
    check-cast v1, Lgl/a$a;

    invoke-virtual {v1}, Lgl/a$a;->hasNext()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-virtual {v1}, Lgl/a$a;->next()Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v3}, Lxl/i;->U(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v1, p0}, La/e;->n(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final processForeignKeyCheckFailure(Landroid/database/Cursor;)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v1, v4, v2}, La/d;->g(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static final readVersion(Ljava/io/File;)I
    ...
    invoke-static {p0, v1}, La/e;->n(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {p0, v0}, La/e;->n(Ljava/io/Closeable;Ljava/lang/Throwable;)V
