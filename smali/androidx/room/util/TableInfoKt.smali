...
.method private static final readColumns(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Map;
    ...
    sget-object v0, Lfl/q;->a:Lfl/q;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-static {v2, v4}, La/e;->n(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v9, v10, v11}, Lgl/b;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    goto :goto_0

    :cond_2
    invoke-virtual {v9}, Lgl/b;->b()V

    iput-boolean v11, v9, Lgl/b;->l:Z
    :try_end_1
    ...
    invoke-static {v2, v1}, La/e;->n(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readForeignKeyFieldMappings(Landroid/database/Cursor;)Ljava/util/List;
    ...
    invoke-virtual {v4, v5}, Lgl/a;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {v4}, Lfl/n;->B(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-virtual {v4, p0}, Lgl/a;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    :cond_2
    invoke-static {p0}, Lfl/h;->J([Ljava/lang/Object;)Ljava/util/List;
...
.method private static final readForeignKeys(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v5, v6}, Lgl/f;->add(Ljava/lang/Object;)Z

    goto/16 :goto_0

    :cond_5
    invoke-static {v5}, La/e;->k(Lgl/f;)Lgl/f;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static final readIndex(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;Z)Landroidx/room/util/TableInfo$Index;
    ...
    invoke-static {v0}, Lfl/n;->B(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {p0, v4}, La/e;->n(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readIndices(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    :cond_0
    new-instance v4, Lgl/f;

    invoke-direct {v4}, Lgl/f;-><init>()V
    ...
    invoke-static {p1, v5}, La/e;->n(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    return-object v5

    :cond_3
    :try_start_1
    invoke-virtual {v4, v6}, Lgl/f;->add(Ljava/lang/Object;)Z

    goto :goto_0

    :cond_4
    invoke-static {v4}, La/e;->k(Lgl/f;)Lgl/f;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
