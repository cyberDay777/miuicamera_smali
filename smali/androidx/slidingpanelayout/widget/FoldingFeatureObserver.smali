...
.method public final registerLayoutStateChangeCallback(Landroid/app/Activity;)V
    ...
    iget-object v0, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lyl/a1;
    ...
    :cond_0
    invoke-interface {v0, v1}, Lyl/a1;->a(Ljava/util/concurrent/CancellationException;)V

    :goto_0
    iget-object v0, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->executor:Ljava/util/concurrent/Executor;

    instance-of v2, v0, Lyl/k0;

    if-eqz v2, :cond_1

    move-object v2, v0

    check-cast v2, Lyl/k0;

    :cond_1
    new-instance v2, Lyl/u0;

    invoke-direct {v2, v0}, Lyl/u0;-><init>(Ljava/util/concurrent/Executor;)V

    sget-object v0, Lyl/a1$b;->a:Lyl/a1$b;

    invoke-interface {v2, v0}, Lil/f;->get(Lil/f$c;)Lil/f$b;
    ...
    :cond_2
    new-instance v0, Lyl/d1;

    invoke-direct {v0, v1}, Lyl/d1;-><init>(Lyl/a1;)V

    invoke-interface {v2, v0}, Lil/f;->plus(Lil/f;)Lil/f;
    ...
    invoke-direct {v0, p0, p1, v1}, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver$registerLayoutStateChangeCallback$1;-><init>(Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;Landroid/app/Activity;Lil/d;)V
    ...
    :goto_3
    invoke-static {v2, p1, v3}, Lyl/w;->a(Lil/f;Lil/f;Z)Lil/f;
    ...
    sget-object v7, Lil/e$a;->a:Lil/e$a;

    invoke-interface {p1, v7}, Lil/f;->get(Lil/f$c;)Lil/f$b;

    move-result-object v7

    if-nez v7, :cond_5

    invoke-interface {p1, v2}, Lil/f;->plus(Lil/f;)Lil/f;
    ...
    new-instance v1, Lyl/h1;

    invoke-direct {v1, p1, v0}, Lyl/h1;-><init>(Lil/f;Lql/p;)V

    goto :goto_4

    :cond_7
    new-instance v1, Lyl/p1;

    invoke-direct {v1, p1, v3}, Lyl/p1;-><init>(Lil/f;Z)V

    :goto_4
    invoke-virtual {v1, v4, v1, v0}, Lyl/a;->U(ILyl/a;Lql/p;)V

    iput-object v1, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lyl/a1;
...
.method public final unregisterLayoutStateChangeCallback()V
    ...
    iget-object p0, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lyl/a1;
    ...
    invoke-interface {p0, v0}, Lyl/a1;->a(Ljava/util/concurrent/CancellationException;)V
