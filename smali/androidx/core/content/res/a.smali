...
.method public final run()V
    ...
    :pswitch_0
    iget-object v1, v0, Landroidx/core/content/res/a;->b:Ljava/lang/Object;

    check-cast v1, Lik/f$a;

    iget-object v0, v0, Landroidx/core/content/res/a;->c:Ljava/lang/Object;
    ...
    iget-object v4, v1, Lik/f$a;->a:Lik/f;

    iget-object v4, v4, Lik/f;->u:Ljava/lang/Object;

    monitor-enter v4

    :try_start_0
    iget-object v5, v1, Lik/f$a;->a:Lik/f;

    iput-boolean v3, v5, Lik/f;->Q:Z
    :try_end_0
    ...
    iget-object v0, v1, Lik/f$a;->a:Lik/f;

    iget-object v0, v0, Lik/f;->s:[F

    invoke-virtual {v1, v0}, Lik/f$a;->a([F)V

    iget-object v0, v1, Lik/f$a;->a:Lik/f;

    iget-object v0, v0, Lik/f;->N:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    invoke-virtual {v0}, Lik/f;->f()V

    :cond_0
    iget-object v0, v1, Lik/f$a;->a:Lik/f;

    iget-object v5, v0, Lik/f;->w:Lik/a;
    ...
    iget-object v0, v5, Lh8/a;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {v0}, Lcom/android/camera/z4$a;->prepareGL()V

    goto :goto_0

    :cond_1
    invoke-virtual {v0}, Lik/f;->k()V
    ...
    iget-object v4, v0, Lik/f;->v:Lik/i;
    ...
    iget-boolean v5, v5, Lik/f;->P:Z

    if-nez v5, :cond_6

    iget-object v5, v1, Lik/f$a;->a:Lik/f;

    iget-object v5, v5, Lik/f;->N:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget-object v0, v4, Lh8/l;->a:Lh8/i;
    ...
    iput-boolean v2, v0, Lik/f;->P:Z

    :cond_6
    sget-boolean v0, Lik/f;->b0:Z

    if-eqz v0, :cond_8

    sget-object v0, Lqj/d$a;->a:Lqj/d;

    iget-object v1, v0, Lqj/d;->b:Lqj/c;
    ...
    invoke-direct {v1, v2}, Lqj/c;-><init>(Ljava/lang/String;)V

    iput-object v1, v0, Lqj/d;->b:Lqj/c;
    ...
    iget-object v5, v1, Lsh/d;->j0:[B

    invoke-virtual {v0}, Lcom/android/gallery3d/ui/b;->getId()I

    move-result v0

    iget v6, v1, Lsh/d;->e:I

    iget v7, v1, Lsh/d;->f:I

    invoke-virtual {v4, v5, v0, v6, v7}, Lsh/e;->a([BIII)I

    iget-object v0, v1, Lsh/d;->a:Lrg/i;

    iget-boolean v0, v0, Lrg/i;->a:Z

    if-eqz v0, :cond_12

    iget-object v0, v1, Lsh/d;->m0:Ljava/util/concurrent/atomic/AtomicInteger;

    iget v4, v1, Lsh/d;->e:I

    iget-object v5, v1, Lsh/d;->Q:Lsh/e;

    iget-object v5, v5, Lsh/e;->a:Lih/g0;
    ...
    iget-object v6, v1, Lsh/d;->Q:Lsh/e;

    iget-object v6, v6, Lsh/e;->a:Lih/g0;

    iget-object v6, v6, Lih/c;->h:Lcom/faceunity/wrapper/faceunity$AvatarInfo;
    ...
    iget-object v7, v1, Lsh/d;->Q:Lsh/e;
    ...
    iget-object v9, v1, Lsh/d;->Q:Lsh/e;

    iget-object v9, v9, Lsh/e;->a:Lih/g0;

    iget-object v9, v9, Lih/c;->j:[F
    ...
    iget-object v1, v1, Lsh/d;->m0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-boolean v3, v2, Ly0/e;->v:Z

    iget-object v2, v1, Lcf/o;->c:Lcf/a;

    if-eqz v2, :cond_13

    iput-boolean v3, v2, Lcf/a;->f:Z

    :cond_13
    iget-object v2, v1, Lcf/o;->f:Lcf/i;

    iget-object v3, v2, Lcf/i;->a:Lcf/d;
    ...
    invoke-direct {v4, v2}, Lcf/h;-><init>(Lcf/i;)V

    invoke-direct {v3, v4, v0}, Lcf/d;-><init>(Lcf/h;Ljava/lang/String;)V

    iput-object v3, v2, Lcf/i;->a:Lcf/d;
    ...
    :goto_7
    iget-object v1, v1, Lcf/o;->b:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-interface {v2, v0}, Lcf/j;->onFriendReady(Ljava/lang/String;)V
    ...
    iget-object v1, v1, Lne/e;->a:Loe/f;

    invoke-interface {v1, v0}, Loe/f;->d(Landroid/hardware/camera2/CameraDevice;)V
    ...
    invoke-static {v1, v0}, Lcom/android/camera2/compat/theme/custom/mm/top/MainTopBar;->M1(Lcom/android/camera2/compat/theme/custom/mm/top/MainTopBar;Landroid/view/View;)V
    ...
    iput-object v0, v1, Lg6/s;->r:Lcom/xiaomi/inceptionmediaprocess/OpenGlRender;
    ...
    invoke-static {v1, v0}, Lcom/android/camera/module/Camera2Module;->i4(Lcom/android/camera/module/Camera2Module;Le9/a;)V
    ...
    invoke-direct {v7, v4, v5, v3, v1}, Lno/b;-><init>(Landroid/view/View;Landroid/view/ViewPropertyAnimator;Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Lmiuix/recyclerview/card/CardDefaultItemAnimator;)V
