...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Li6/r;->f:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Li6/r;->g:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Li6/r;->h:Landroid/graphics/Matrix;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Li6/r;->m:Ljava/util/HashMap;
...
.method public final d(Lcom/android/camera/module/h0;)V
    ...
    iget-object v2, v0, Li6/r;->e:Lh6/d;
    ...
    invoke-static {v7, v5}, La/d;->c(Ljava/lang/String;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    iget-object v7, v0, Li6/r;->g:Landroid/graphics/Matrix;

    invoke-virtual {v7}, Landroid/graphics/Matrix;->reset()V

    iget-object v9, v0, Li6/r;->h:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v11}, Lcom/android/camera/ActivityBase;->h9()Lcom/android/camera/x2;

    move-result-object v11

    iget v15, v11, Lcom/android/camera/z4;->V:I

    iget v14, v11, Lcom/android/camera/z4;->U:I

    iget-object v11, v0, Li6/r;->i:Landroid/graphics/Rect;

    iget v12, v0, Li6/r;->j:F
    ...
    iget-object v11, v0, Li6/r;->f:Landroid/graphics/RectF;
    ...
    iget-object v5, v0, Li6/r;->m:Ljava/util/HashMap;
    ...
    new-instance v9, Li6/q;

    invoke-direct {v9, v3, v6}, Li6/q;-><init>(Ljava/util/ArrayList;I)V
    ...
    invoke-virtual {v1, v4, v6}, Lcom/android/camera/module/m;->setTrackRect(Landroid/graphics/Rect;I)V

    invoke-virtual {v1, v3}, Lcom/android/camera/module/m;->setAiAudioZoomLvManually(F)V
    ...
    invoke-static {v4, v1, v5, v3}, La1/c0;->d(Ljava/lang/String;ZLjava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3, v6}, Lle/a;->g(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v4, v5, v6}, Lle/a;->g(Ljava/lang/String;Z)Z
    ...
    check-cast v9, Ld7/d3;

    const-string v10, "cinematic_intell_dolly_not_detect_desc"

    const/4 v11, 0x0

    const v12, 0x7f140318

    const-wide/16 v13, -0x1

    invoke-interface/range {v9 .. v14}, Ld7/d3;->alertRecommendDescTip(Ljava/lang/String;IIJ)V
    ...
    invoke-interface {v1, v2}, Ld7/d3;->hideRecommendDescTip(Ljava/lang/String;)V

    :goto_5
    iget-boolean v1, v0, Li6/r;->l:Z

    if-eqz v1, :cond_9

    iput-boolean v6, v0, Li6/r;->l:Z
    ...
    invoke-virtual {v0, v3, v8}, Lle/a;->m(Ljava/lang/String;Z)Lle/a;
...
.method public final h(Lcom/android/camera/module/h0;Le9/c;)Z
    ...
    iput-object p2, p0, Li6/r;->i:Landroid/graphics/Rect;
    ...
    iget p1, p1, Lcom/android/camera/z4;->U:I

    iput p1, p0, Li6/r;->k:I
...
.method public final k(Landroid/hardware/camera2/CaptureResult;Lcom/android/camera/module/h0;)V
    ...
    iget-object p2, p0, Li6/r;->i:Landroid/graphics/Rect;
...
.method public final r()V
    ...
    sget-object v0, Ly7/n;->h:Lp9/b0;

    invoke-virtual {p0, v0}, Lh6/i;->n(Lp9/b0;)Lh6/d;

    move-result-object v0

    iput-object v0, p0, Li6/r;->e:Lh6/d;
