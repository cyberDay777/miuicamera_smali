...
.field public h:Lr9/l$a;

.field public i:Lr9/l$a;
...
.method public constructor <init>(Lcom/android/camera/module/Camera2Module;)V
    ...
    iput-object v0, p0, Lb6/v;->a:Ljava/lang/ref/WeakReference;
...
.method public final a(Z)V
    ...
    iget-object p0, p0, Lb6/v;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v6, v4}, Le9/y;->L(I)V
    ...
    invoke-virtual {v2}, Lr9/n;->g()Z

    move-result v7

    if-eqz v7, :cond_7

    invoke-static {v4, v4}, Lz5/n;->f(ZZ)V

    iget-boolean p1, v2, Lr9/n;->q:Z
    ...
    iget-object p0, v0, Lcom/android/camera/ActivityBase;->b0:Lcom/android/camera/ui/v0;
    ...
    invoke-interface {p0, v6, p1}, Lcom/android/camera/ui/v0;->N0(Lkk/c;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v2}, Lr9/n;->e()Z

    move-result v7

    if-nez v7, :cond_9

    iget-boolean v7, v2, Lr9/n;->k:Z
    ...
    invoke-static {v7}, Le9/d;->M0(Le9/c;)Z
    ...
    invoke-static {v7}, Le9/d;->L0(Le9/c;)Z
    ...
    invoke-static {v7}, Le9/d;->N2(Le9/c;)Z
    ...
    invoke-interface {p0, v6, v7}, Lcom/android/camera/ui/v0;->N0(Lkk/c;[Ljava/lang/Object;)V
    ...
    invoke-direct {v8, p1, v9}, Ls4/m;-><init>(ZI)V
...
.method public final c()Z
    ...
    iget-boolean v2, v2, La1/g1;->r0:Z
    ...
    invoke-virtual {v2}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->b1()Z
    ...
    :cond_5
    iget-object v0, p0, Lb6/v;->c:Lio/reactivex/disposables/Disposable;
    ...
    iput-object v0, p0, Lb6/v;->c:Lio/reactivex/disposables/Disposable;

    :cond_6
    iget-boolean v0, p0, Lb6/v;->m:Z
    ...
    invoke-virtual {p0, v0}, Lb6/v;->a(Z)V
    ...
    invoke-direct {v3, v2, p0, v0}, Lv5/i;-><init>(ILjava/lang/Object;Z)V
...
.method public final g(Landroid/hardware/camera2/CaptureResult;Le9/p2$a;)V
    .locals 13

    const/4 v0, 0x0

    iput-boolean v0, p0, Lb6/v;->p:Z

    iget-object v1, p0, Lb6/v;->a:Ljava/lang/ref/WeakReference;
    ...
    iget-boolean v3, p0, Lb6/v;->b:Z

    if-nez v3, :cond_3a

    iget-object v3, v2, Lcom/android/camera/module/Camera2Module;->mMultiCap:Lb6/r;
    ...
    iget-boolean v7, p0, Lb6/v;->b:Z

    if-nez v7, :cond_13

    iget-boolean v7, p2, Le9/p2$a;->P:Z
    ...
    invoke-virtual {v10, v7, v8}, Le9/a;->O(ILjava/lang/Integer;)Z
    ...
    :cond_7
    :goto_2
    iput-boolean v4, p2, Le9/p2$a;->G:Z
    ...
    iget-boolean v7, p2, Le9/p2$a;->G:Z
    ...
    iget-boolean v4, p2, Le9/p2$a;->G:Z
    ...
    iput-boolean v7, p2, Le9/p2$a;->B:Z
    ...
    iget-boolean v8, p2, Le9/p2$a;->B:Z
    ...
    invoke-static {v4}, Le9/d;->T1(Le9/c;)Z
    ...
    iget v11, v10, Lr9/i$a;->a:I

    const/16 v12, 0xa

    if-ne v11, v12, :cond_b

    iget v7, v10, Lr9/i$a;->b:I
    ...
    :goto_6
    iput v7, p0, Lb6/v;->n:I

    invoke-virtual {p0}, Lb6/v;->e()Z

    move-result v7

    iput-boolean v7, p2, Le9/p2$a;->C:Z

    invoke-virtual {p0}, Lb6/v;->b()I

    move-result v7

    iput v7, p2, Le9/p2$a;->D:I
    ...
    :goto_b
    iput-boolean v7, p2, Le9/p2$a;->E:Z
    ...
    invoke-static {p1, v4}, Lr9/l;->b(Landroid/hardware/camera2/CaptureResult;Z)Lr9/l$a;

    move-result-object v4

    iput-object v4, p0, Lb6/v;->i:Lr9/l$a;
    ...
    iput-object v4, p2, Le9/p2$a;->H:[B
    ...
    iget-object v7, p2, Le9/p2$a;->H:[B
    ...
    iget-boolean v8, p2, Le9/p2$a;->C:Z

    if-eqz v8, :cond_1c

    iget-boolean v8, p2, Le9/p2$a;->G:Z
    ...
    :cond_14
    invoke-virtual {v4}, Lcom/android/camera/module/m;->getCameraManager()Lz5/k;
    ...
    invoke-static {v8}, Le9/d;->T1(Le9/c;)Z
    ...
    iget-object v10, v8, Le9/c;->i2:Ljava/lang/Boolean;

    if-nez v10, :cond_18

    sget-object v10, Lp9/g;->U1:Lp9/f;

    invoke-virtual {v10}, Lp9/f;->c()Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v8, v11}, Le9/c;->k0(Ljava/lang/String;)Z

    move-result v11

    if-eqz v11, :cond_16

    iget-object v11, v8, Le9/c;->d:Landroid/hardware/camera2/CameraCharacteristics;

    invoke-static {v11, v10}, Lp9/e0;->a(Landroid/hardware/camera2/CameraCharacteristics;Lp9/d0;)Ljava/lang/Object;
    ...
    iput-object v10, v8, Le9/c;->i2:Ljava/lang/Boolean;

    :cond_18
    iget-object v8, v8, Le9/c;->i2:Ljava/lang/Boolean;
    ...
    invoke-virtual {v4}, Lcom/android/camera/module/Camera2Module;->getZoomManager()Lc9/h;

    move-result-object v8

    iget v8, v8, Lc9/h;->i:F
    ...
    invoke-virtual {v4}, Lcom/android/camera/module/m;->getModuleState()Lz5/f;

    move-result-object v4

    invoke-interface {v4}, Lz5/f;->O()Z
    ...
    invoke-static {v8, v4}, La1/c0;->c(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iget-object p2, p2, Le9/p2$a;->H:[B

    iput-object p2, p1, Le9/z;->n1:[B

    invoke-virtual {p0}, Lb6/v;->f()V

    return-void

    :cond_1d
    iput v0, p0, Lb6/v;->n:I

    invoke-virtual {p0}, Lb6/v;->e()Z

    move-result v4

    iput-boolean v4, p2, Le9/p2$a;->C:Z

    invoke-virtual {p0}, Lb6/v;->b()I

    move-result v4

    iput v4, p2, Le9/p2$a;->D:I
    ...
    iget-boolean v9, p2, Le9/p2$a;->E:Z
    ...
    :cond_20
    invoke-virtual {v10}, Lcom/android/camera/module/m;->getCameraManager()Lz5/k;
    ...
    invoke-static {v10}, Le9/d;->Q0(Le9/c;)Z
    ...
    :cond_21
    sget-object v10, Lp9/c0;->W0:Lp9/b0;

    invoke-static {p1, v10}, Lp9/e0;->f(Landroid/hardware/camera2/CaptureResult;Lp9/d0;)Ljava/lang/Object;
    ...
    invoke-static {v11, v10}, Landroidx/appcompat/app/b;->d(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/String;
    ...
    iput-boolean v0, p2, Le9/p2$a;->E:Z
    ...
    :goto_19
    iput-boolean v7, v5, La1/g1;->r0:Z
    ...
    iput-boolean v0, v5, La1/g1;->r0:Z

    :goto_1a
    iget-boolean v5, p2, Le9/p2$a;->E:Z
    ...
    invoke-virtual {v2, v7}, Lcom/android/camera/module/m;->updatePreferenceTrampoline([I)V
    ...
    iget-boolean v10, p2, Le9/p2$a;->E:Z
    ...
    iput v7, v6, Le9/z;->m1:I

    iget-boolean p2, p2, Le9/p2$a;->G:Z
    ...
    invoke-virtual {v6}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->T5()Z
    ...
    invoke-static {p2}, Le9/d;->C0(Le9/c;)Z
    ...
    iget-boolean p2, p2, Le9/z;->V0:Z

    if-nez v9, :cond_2e

    iget-boolean v3, p0, Lb6/v;->o:Z
    ...
    iput-object p1, p0, La1/g1;->s0:Lr9/n;
    ...
    invoke-direct {p2, p1, v9, v4, v1}, Lr9/n;-><init>(Landroid/hardware/camera2/CaptureResult;ZILe9/c;)V
    ...
    iget-boolean p2, p1, Lr9/n;->p:Z

    if-nez p2, :cond_30

    invoke-virtual {v2}, Lcom/android/camera/module/Camera2Module;->getSuperNightCbImpl()Lb6/c0;

    move-result-object p2

    invoke-virtual {p2}, Lb6/c0;->b()Z

    move-result p2

    if-eqz p2, :cond_30

    iget-object p2, p1, Lr9/n;->c:Lr9/e;

    if-eqz p2, :cond_30

    iput v0, p1, Lr9/n;->g:I

    iput v0, p2, Lr9/e;->c:I
    ...
    iput-object p1, p2, La1/g1;->s0:Lr9/n;

    if-eqz p1, :cond_32

    iget p2, p1, Lr9/n;->o:I

    if-eqz p2, :cond_31

    invoke-virtual {p1}, Lr9/n;->b()I
    ...
    invoke-static {v1}, Le9/d;->p0(Le9/c;)Z
    ...
    invoke-virtual {p2}, Le9/a;->q()Le9/z;

    move-result-object p2

    invoke-virtual {p2}, Le9/z;->g()Z
