...
.method public constructor <init>(Lb6/f;)V
    ...
    iput-object p1, p0, Lb6/f$a;->b:Lb6/f;
...
# virtual methods
.method public final onFocusStateChanged(Lk6/o;)V
    .locals 8

    iget-object v0, p0, Lb6/f$a;->b:Lb6/f;

    invoke-virtual {v0}, Lz5/d;->k0()Z
    ...
    iget-object v0, v0, Lz5/d;->b:Lcom/android/camera/module/h0;
    ...
    invoke-direct {v1, v6}, Lcom/android/camera/w0;-><init>(I)V
    ...
    iget-object v1, p0, Lb6/f$a;->b:Lb6/f;

    iget-object v1, v1, Lz5/d;->G:Lk6/n;
    ...
    iget-boolean v1, p1, Lk6/o;->g:Z

    if-eqz v1, :cond_4

    iget-object v1, p0, Lb6/f$a;->b:Lb6/f;

    iget-boolean v1, v1, Lb6/f;->O:Z
    ...
    iget v1, p0, Lb6/f$a;->a:I

    add-int/2addr v1, v5

    iput v1, p0, Lb6/f$a;->a:I

    iget-object v1, p0, Lb6/f$a;->b:Lb6/f;

    iget-boolean v5, v1, Lb6/f;->O:Z

    if-eqz v5, :cond_8

    iput-boolean v4, v1, Lb6/f;->O:Z
    ...
    iget-object p0, p0, Lb6/f$a;->b:Lb6/f;
    ...
    iget-boolean v1, v0, Lz5/d;->E:Z

    if-nez v1, :cond_12

    iget-object v0, v0, Lz5/d;->a:Le9/a;

    if-eqz v0, :cond_c

    iget-object v0, p0, Lb6/f$a;->b:Lb6/f;

    iget-object v1, v0, Lz5/d;->G:Lk6/n;
    ...
    iget-object v0, v0, Lz5/d;->G:Lk6/n;
    ...
    invoke-virtual {v0, v5}, Lz5/d;->j(I)V
    ...
    iget-object p1, v0, Lz5/d;->I:Le9/y;

    invoke-virtual {p1, v4}, Le9/y;->E(I)V

    iget-object p1, v0, Lz5/d;->I:Le9/y;

    const/4 v1, 0x0

    invoke-virtual {p1, v1}, Le9/y;->D(F)V

    iput-boolean v5, v0, Lz5/d;->F:Z
    ...
    iget-boolean p1, p0, Lz5/d;->E:Z

    if-eqz p1, :cond_12

    invoke-virtual {p0}, Lz5/d;->s0()V
