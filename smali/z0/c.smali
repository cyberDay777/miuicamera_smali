...
.method public constructor <init>(Lz0/f;)V
    ...
    iput-object p1, p0, Lz0/c;->c:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance p1, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {p1}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object p1, p0, Lz0/c;->d:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance p1, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {p1}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object p1, p0, Lz0/c;->e:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance p1, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {p1}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object p1, p0, Lz0/c;->f:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final c(ILjava/util/ArrayList;)I
    ...
    invoke-static {v0, p2}, Lz0/c;->f(ILjava/util/ArrayList;)I
    ...
    iget-object v2, p0, Lz0/c;->f:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-static {v6, p2}, Lz0/c;->f(ILjava/util/ArrayList;)I
    ...
    invoke-static {v7, v5}, Landroidx/appcompat/app/b;->d(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/String;
...
.method public final d(Ljava/util/ArrayList;Ljava/util/HashMap;)V
    ...
    invoke-virtual {v1, v7, v3}, Lle/a;->i(Ljava/lang/String;I)I
    ...
    invoke-direct {v2, p2, v6}, Landroidx/window/embedding/b;-><init>(Ljava/util/Set;I)V
    ...
    invoke-virtual {p0, v1}, Lz0/f;->T([I)V
...
.method public final g(IZ)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lz0/c;->initItems()Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lz0/c;->e:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {p0}, Lz0/c;->i()Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_2
    invoke-virtual {p0}, Lz0/c;->h()Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final h()Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_0
    iget-object p0, p0, Lz0/c;->c:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final declared-synchronized i()Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_0
    iget-object v0, p0, Lz0/c;->d:Ljava/util/concurrent/CopyOnWriteArrayList;
    :try_end_0
...
.method public final declared-synchronized initItems()Ljava/util/List;
    ...
    invoke-interface {v3}, Lcom/android/camera/module/entry/a;->getModeItem()Ld5/a;
    ...
    iget-object v3, p0, Lz0/c;->e:Ljava/util/concurrent/CopyOnWriteArrayList;

    iget-object v4, v4, Ld5/a;->a:Lcom/android/camera/data/data/b;
    ...
    iget-boolean v5, v4, Ld5/a;->b:Z

    if-eqz v5, :cond_5

    iget-object v5, p0, Lz0/c;->f:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_8
    :goto_4
    invoke-virtual {p0, v0, v1}, Lz0/c;->d(Ljava/util/ArrayList;Ljava/util/HashMap;)V
    ...
    :cond_13
    iget-object v1, p0, Lz0/c;->c:Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-virtual {v1}, Ljava/util/concurrent/CopyOnWriteArrayList;->clear()V

    iget-object v1, p0, Lz0/c;->d:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_19
    invoke-virtual {p0, v1, v0}, Lz0/c;->c(ILjava/util/ArrayList;)I
    ...
    iget-object v2, p0, Lz0/c;->c:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_1b
    :goto_c
    iget-object v2, p0, Lz0/c;->d:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final k(I)Z
    ...
    iget-object v0, p0, Lz0/c;->c:Ljava/util/concurrent/CopyOnWriteArrayList;
