...
.method public constructor <init>(Lx0/l1;)V
    ...
    iput-object p1, p0, Lx0/c0;->b:Ljava/lang/String;

    const/4 p1, -0x1

    iput p1, p0, Lx0/c0;->c:I
...
.method public final c(Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p0, v2}, Lx0/c0;->l(Ljava/lang/String;)V
...
.method public final i()Ljava/lang/String;
    ...
    iget-object v0, p0, Lx0/c0;->e:Le9/c;
...
.method public final j()[Ljava/lang/String;
    ...
    iget-object p0, p0, Lx0/c0;->e:Le9/c;

    invoke-static {p0}, Le9/d;->K(Le9/c;)I
...
.method public final r(Le9/c;II)V
    .locals 12
    ...
    invoke-virtual {p2}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->n0()Ljava/lang/String;
    ...
    :goto_0
    invoke-static {p1}, Le9/d;->d2(Le9/c;)Z
    ...
    :cond_4
    invoke-virtual {p0, v0}, Lx0/c0;->d(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_5
    invoke-virtual {p0, v0}, Lx0/c0;->f(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_6
    invoke-virtual {p0, v0}, Lx0/c0;->c(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_7
    invoke-virtual {p0, v0}, Lx0/c0;->g(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_8
    invoke-virtual {p0, v0}, Lx0/c0;->e(Ljava/util/ArrayList;)V
    ...
    invoke-static {p1}, Le9/d;->K(Le9/c;)I
    ...
    invoke-static {p1}, Le9/d;->J(Le9/c;)Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v9}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v10}, Ltb/a;->c3(Ljava/lang/String;)Landroid/util/Size;

    move-result-object v9

    invoke-static {p1, v9}, Le9/d;->Z2(Le9/c;Landroid/util/Size;)Z
    ...
    invoke-virtual {v11}, La1/g1;->a0()La1/r0;

    move-result-object v11

    invoke-virtual {v11, p2}, La1/r0;->isSwitchOn(I)Z
    ...
    invoke-virtual {p2, v2}, Lk6/e;->D(I)Le9/c;

    move-result-object p2

    invoke-static {p2, v9}, Le9/d;->Z2(Le9/c;Landroid/util/Size;)Z
    ...
    invoke-static {v3, v4}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :goto_2
    iput-boolean p2, p0, Lx0/c0;->f:Z

    :cond_12
    iget-boolean p2, p0, Lx0/c0;->f:Z
    ...
    iget-object v4, p1, Le9/c;->x:Lr9/v;
    ...
    sget-object v4, Lp9/g;->E3:Lp9/f;

    iget-object v5, p1, Le9/c;->d:Landroid/hardware/camera2/CameraCharacteristics;
    ...
    invoke-static {v4}, Lr9/v;->a([I)Ljava/util/ArrayList;
    ...
    :cond_19
    iput-object v3, p1, Le9/c;->x:Lr9/v;
    ...
    invoke-direct {v1}, Lr9/v;-><init>()V

    iput v2, v1, Lr9/v;->a:I

    iput v0, v1, Lr9/v;->b:I

    iput p2, v1, Lr9/v;->c:I

    iput-object v1, p1, Le9/c;->x:Lr9/v;
    ...
    :cond_1c
    :goto_5
    iget-object v3, p1, Le9/c;->x:Lr9/v;
    ...
    invoke-direct {v3}, Lr9/v;-><init>()V

    iput v2, v3, Lr9/v;->a:I

    iput v0, v3, Lr9/v;->b:I

    iput p2, v3, Lr9/v;->c:I

    :cond_1e
    iget p2, v3, Lr9/v;->b:I

    const-string v0, "camera.debug.test.duration"

    invoke-static {v0, p2}, Lsf/f;->d(Ljava/lang/String;I)I

    move-result p2

    iput p2, v3, Lr9/v;->b:I

    const-string p2, "camera.debug.test.duration_save"

    iget v0, v3, Lr9/v;->c:I

    invoke-static {p2, v0}, Lsf/f;->d(Ljava/lang/String;I)I

    move-result p2

    iput p2, v3, Lr9/v;->c:I

    iput-object v3, p0, Lx0/c0;->g:Lr9/v;

    :cond_1f
    if-nez p3, :cond_20

    iput-object p1, p0, Lx0/c0;->e:Le9/c;
...
.method public final u(Le9/c;I)V
    .locals 3
    .annotation build Lcom/android/camera/jacoco/JacocoForceIgnore;
    .end annotation
    ...
    :cond_0
    invoke-virtual {p0, p1, v1, p2}, Lx0/c0;->r(Le9/c;II)V
    ...
    :cond_2
    invoke-virtual {p0}, Lx0/c0;->h()Ljava/lang/String;
