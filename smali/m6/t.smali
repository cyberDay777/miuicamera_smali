...
.field public final i:Lm6/z$a;

.field public j:Lm6/t$b;

.field public k:Ljava/io/File;

.field public final l:Ltf/i;

.field public final m:Lm6/q;


# direct methods
.method public constructor <init>(Lm6/x;Lm6/p;Lm6/z$a;)V
    .locals 2
    ...
    iput-object v0, p0, Lm6/t;->d:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-object v0, p0, Lm6/t;->k:Ljava/io/File;

    new-instance v0, Ltf/i;

    invoke-direct {v0}, Ltf/i;-><init>()V

    iput-object v0, p0, Lm6/t;->l:Ltf/i;

    new-instance v0, Lm6/q;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lm6/q;-><init>(Ljava/lang/Object;I)V

    iput-object v0, p0, Lm6/t;->m:Lm6/q;

    iput-object p1, p0, Lm6/t;->e:Lm6/x;

    iput-object p2, p0, Lm6/t;->f:Lm6/p;

    iput-object p3, p0, Lm6/t;->i:Lm6/z$a;

    return-void
.end method

.method public static e(ILm6/x;)I
    .locals 2

    invoke-static {p0}, Lm6/a0;->j(I)I

    move-result p0

    if-gtz p0, :cond_0

    iget-object p0, p1, Lm6/x;->j:Landroid/media/CamcorderProfile;
...
.method public final a(I)V
    ...
    iget-object v0, p0, Lm6/t;->f:Lm6/p;
    ...
    iget-object p1, p0, Lm6/t;->j:Lm6/t$b;
    ...
    iget-object v0, p1, Lcom/android/camera/module/VideoBase;->mUserRecordSetting:Lm6/x;
    ...
    invoke-static {p1, v2, v2, v0}, Lcom/android/camera/module/VideoModule;->access$300(Lcom/android/camera/module/VideoModule;ZZLt7/a;)Landroid/net/Uri;

    iget-object p1, p1, Lcom/android/camera/module/VideoBase;->mUserRecordSetting:Lm6/x;

    iput-object v3, p1, Lm6/x;->n:Landroid/content/ContentValues;

    :cond_1
    iget-object p0, p0, Lm6/t;->e:Lm6/x;

    iget-object p1, p0, Lm6/x;->m:Landroid/content/ContentValues;

    iput-object p1, p0, Lm6/x;->n:Landroid/content/ContentValues;

    iput-object v3, p0, Lm6/x;->m:Landroid/content/ContentValues;

    goto/16 :goto_1

    :pswitch_1
    iget-boolean p1, p0, Lm6/t;->c:Z
    ...
    iget-object p1, p0, Lm6/t;->e:Lm6/x;

    iget-object p1, p1, Lm6/x;->l:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p1, Lm6/x;->o:Ljava/lang/String;

    invoke-static {v5, v3, v4, v0}, Lm6/a0;->d(IJLjava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p1, Lm6/x;->o:Ljava/lang/String;

    iget-object v3, p0, Lm6/t;->e:Lm6/x;

    iget v4, v3, Lm6/x;->p:I

    iget-object v6, v3, Lm6/x;->o:Ljava/lang/String;

    iget-object v7, v3, Lm6/x;->h:Ljava/lang/String;
    ...
    invoke-static/range {v3 .. v10}, Lm6/a0;->h(Lm6/x;IILjava/lang/String;Ljava/lang/String;ZZZ)Landroid/content/ContentValues;
    ...
    iget-object v1, p0, Lm6/t;->a:Lhf/n;
    ...
    invoke-interface {v1, v3}, Lhf/n;->e(Ljava/io/File;)V
    :try_end_0
    ...
    iput-object p1, p0, Lm6/x;->m:Landroid/content/ContentValues;
...
.method public final b()V
    ...
    iput-object v2, p0, Lm6/t;->h:Landroid/view/Surface;
    ...
    iget-object p0, p0, Lm6/t;->h:Landroid/view/Surface;
...
.method public final c()V
    ...
    iget-object v2, p0, Lm6/t;->d:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v3, p0, Lm6/t;->a:Lhf/n;
    ...
    invoke-direct {v3}, Lhf/p;-><init>()V

    iput-object v3, p0, Lm6/t;->a:Lhf/n;

    sget-object v5, Lr7/u;->g:Ljava/lang/String;

    iget-object v6, v3, Lhf/p;->a:Lhf/k;

    iput-object v5, v6, Lhf/k;->t:Ljava/lang/String;
    ...
    invoke-interface {v3, v1}, Lhf/n;->l(Ljava/lang/Boolean;)V
    ...
    invoke-direct {v1}, Lhf/q;-><init>()V

    iput-object v1, p0, Lm6/t;->a:Lhf/n;
    ...
    iget-object p0, p0, Lm6/t;->a:Lhf/n;
    ...
    invoke-interface {p0}, Lhf/n;->reset()V
...
.method public final f(Lm6/b;ZLcom/android/camera/ActivityBase;)V
    .locals 2
    ...
    invoke-interface {v0}, Lhf/n;->a()Landroid/media/MediaRecorder;

    move-result-object p0

    sget v0, Lcom/android/camera/module/j0;->a:I

    iput v0, p1, Lm6/b;->g:I
    ...
    iput-object v0, p1, Lm6/b;->b:La0/a;

    invoke-virtual {p1, p3, p2}, Lm6/b;->a(Lcom/android/camera/ActivityBase;Z)V

    goto :goto_0

    :cond_0
    invoke-interface {v0}, Lhf/n;->n()V

    iget-object p0, p0, Lm6/t;->a:Lhf/n;

    invoke-interface {p0}, Lhf/n;->i()Landroid/media/AudioParaManger$TuneListener;
    ...
    iput-object p0, p1, Lm6/b;->w:Landroid/media/AudioParaManger$TuneListener;
    ...
    iput-object p0, p1, Lm6/b;->b:La0/a;
...
.method public final g(ZLm6/b;Lcom/android/camera/ActivityBase;I)Lm6/l;
    .locals 20
    ...
    invoke-direct {v15}, Lm6/l;-><init>()V

    iget-object v9, v1, Lm6/t;->d:Ljava/lang/Object;

    monitor-enter v9

    :try_start_0
    invoke-virtual/range {p0 .. p0}, Lm6/t;->n()V

    invoke-virtual/range {p0 .. p0}, Lm6/t;->b()V

    invoke-virtual/range {p0 .. p0}, Lm6/t;->c()V

    const/4 v3, 0x1

    iput-boolean v3, v15, Lm6/l;->b:Z

    iget-object v4, v1, Lm6/t;->h:Landroid/view/Surface;

    iget-object v6, v1, Lm6/t;->a:Lhf/n;

    invoke-interface {v6, v4}, Lhf/n;->d(Landroid/view/Surface;)V

    move-object/from16 v8, p3

    invoke-virtual {v1, v2, v0, v8}, Lm6/t;->f(Lm6/b;ZLcom/android/camera/ActivityBase;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    :try_start_1
    iget v4, v2, Lm6/b;->t:I

    if-ne v4, v3, :cond_0

    iget-boolean v4, v2, Lm6/b;->u:Z
    ...
    :goto_0
    invoke-virtual {v1, v4, v6}, Lm6/t;->k(IZ)Lhf/o;
    ...
    :try_start_2
    iget-object v4, v1, Lm6/t;->a:Lhf/n;

    invoke-interface {v4, v7}, Lhf/n;->k(Lhf/o;)V
    :try_end_2
    ...
    invoke-virtual {v2, v3}, Lm6/b;->d(Z)V
    :try_end_3
    ...
    :goto_1
    :try_start_4
    iget-object v2, v1, Lm6/t;->e:Lm6/x;

    iget-object v2, v2, Lm6/x;->i:Lt7/a;

    iget-object v2, v2, Lt7/a;->f:Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v4, v1, Lm6/t;->e:Lm6/x;

    iget-object v5, v4, Lm6/x;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v5}, Ljava/util/concurrent/atomic/AtomicInteger;->get()I

    move-result v5

    iget-object v6, v1, Lm6/t;->e:Lm6/x;

    iget-object v6, v6, Lm6/x;->o:Ljava/lang/String;

    invoke-static {v5, v2, v3, v6}, Lm6/a0;->d(IJLjava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, v4, Lm6/x;->o:Ljava/lang/String;

    iget-object v6, v1, Lm6/t;->e:Lm6/x;

    iget v3, v6, Lm6/x;->p:I

    iget-object v2, v6, Lm6/x;->l:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v5, v2, Lm6/x;->o:Ljava/lang/String;
    :try_end_4
    ...
    :try_start_5
    iget-object v7, v2, Lm6/x;->h:Ljava/lang/String;
    ...
    :try_start_6
    invoke-static/range {v2 .. v9}, Lm6/a0;->h(Lm6/x;IILjava/lang/String;Ljava/lang/String;ZZZ)Landroid/content/ContentValues;

    move-result-object v2

    move-object/from16 v3, v18

    iput-object v2, v3, Lm6/x;->n:Landroid/content/ContentValues;

    iget-object v2, v1, Lm6/t;->e:Lm6/x;

    iget-object v3, v2, Lm6/x;->i:Lt7/a;

    iget-object v2, v2, Lm6/x;->n:Landroid/content/ContentValues;

    iput-object v2, v3, Lt7/a;->d:Landroid/content/ContentValues;
    ...
    iget-object v3, v1, Lm6/t;->a:Lhf/n;

    invoke-virtual {v2, v3, v0}, Lt7/a;->k(Lhf/n;Z)V

    iget-object v2, v1, Lm6/t;->e:Lm6/x;

    iget-object v3, v2, Lm6/x;->n:Landroid/content/ContentValues;
    ...
    iput-object v0, v2, Lm6/x;->r:Ljava/lang/String;

    goto :goto_3

    :cond_5
    iget-object v0, v1, Lm6/t;->k:Ljava/io/File;
    ...
    iput-object v0, v1, Lm6/t;->k:Ljava/io/File;

    :cond_6
    iget-object v0, v1, Lm6/t;->e:Lm6/x;

    new-instance v2, Ljava/io/File;

    iget-object v3, v1, Lm6/t;->k:Ljava/io/File;

    iget-object v4, v1, Lm6/t;->e:Lm6/x;

    iget-object v4, v4, Lm6/x;->n:Landroid/content/ContentValues;
    ...
    iput-object v2, v0, Lm6/x;->r:Ljava/lang/String;

    :cond_7
    :goto_3
    invoke-virtual/range {p0 .. p0}, Lm6/t;->h()V

    iget-object v0, v1, Lm6/t;->e:Lm6/x;

    iget-object v0, v0, Lm6/x;->i:Lt7/a;

    iget-object v2, v1, Lm6/t;->a:Lhf/n;

    invoke-interface {v2}, Lhf/n;->j()Ljava/lang/String;

    move-result-object v2

    iput-object v2, v0, Lt7/a;->h:Ljava/lang/String;
    :try_end_6
    ...
    invoke-virtual {v2}, Lt7/a;->d()Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Lu7/b;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const/4 v3, 0x0

    iput-object v3, v1, Lm6/t;->h:Landroid/view/Surface;
    ...
    iget-object v5, v1, Lm6/t;->e:Lm6/x;
    ...
    invoke-virtual/range {p0 .. p0}, Lm6/t;->i()V

    :goto_7
    iget-boolean v0, v15, Lm6/l;->b:Z
    ...
    iget-object v1, v1, Lm6/t;->h:Landroid/view/Surface;
    ...
    iput-object v7, v15, Lm6/l;->a:Lhf/o;
    ...
    invoke-static {v13, v14, v1}, Landroidx/concurrent/futures/b;->e(JLjava/lang/StringBuilder;)Ljava/lang/String;
...
.method public final h()V
    ...
    iget-object v2, p0, Lm6/t;->a:Lhf/n;

    invoke-interface {v2}, Lhf/n;->prepare()V

    iget-object v2, p0, Lm6/t;->a:Lhf/n;

    invoke-interface {v2, p0}, Lhf/n;->b(Lhf/n$a;)V

    iget-object v2, p0, Lm6/t;->a:Lhf/n;

    invoke-interface {v2, p0}, Lhf/n;->f(Lhf/n$b;)V

    iget-object v2, p0, Lm6/t;->a:Lhf/n;

    invoke-interface {v2, p0}, Lhf/n;->g(Lhf/n$c;)V
    ...
    invoke-static {v0, v1, p0}, Landroidx/concurrent/futures/b;->e(JLjava/lang/StringBuilder;)Ljava/lang/String;
...
.method public final i()V
    ...
    iput-object v2, p0, Lm6/t;->a:Lhf/n;
...
.method public final k(IZ)Lhf/o;
    .locals 17
    ...
    new-instance v2, Lhf/o$a;

    invoke-direct {v2}, Lhf/o$a;-><init>()V

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iget-object v4, v0, Lm6/t;->e:Lm6/x;

    iget-object v5, v4, Lm6/x;->h:Ljava/lang/String;
    ...
    :goto_1
    iget-object v7, v2, Lhf/o$a;->a:Lhf/o;

    iput-boolean v5, v7, Lhf/o;->a:Z

    move/from16 v9, p2

    iput-boolean v9, v7, Lhf/o;->w:Z

    const/4 v9, 0x2

    iput v9, v7, Lhf/o;->l:I
    ...
    iput v8, v7, Lhf/o;->f:I

    :cond_3
    :goto_2
    iget-object v8, v4, Lm6/x;->j:Landroid/media/CamcorderProfile;

    iget v9, v8, Landroid/media/CamcorderProfile;->fileFormat:I

    iput v9, v7, Lhf/o;->m:I

    iget v8, v8, Landroid/media/CamcorderProfile;->videoCodec:I

    iput v8, v7, Lhf/o;->g:I
    ...
    iget-object v9, v4, Lm6/x;->c:Lfe/c;
    ...
    iget-object v8, v4, Lm6/x;->c:Lfe/c;

    iget v9, v8, Lfe/c;->a:I

    iget v8, v8, Lfe/c;->b:I

    new-instance v13, Landroid/util/Size;

    invoke-direct {v13, v9, v8}, Landroid/util/Size;-><init>(II)V

    iput-object v13, v7, Lhf/o;->k:Landroid/util/Size;
    ...
    invoke-static {v9, v4}, Lm6/t;->e(ILm6/x;)I

    move-result v13

    iput v13, v7, Lhf/o;->j:I

    iget-object v14, v0, Lm6/t;->i:Lm6/z$a;

    iget-object v14, v14, Lm6/z$a;->a:Lm6/z;

    iput v13, v14, Lm6/z;->h:I

    const-string v14, "setupRecorder: videoFrameRate = "

    invoke-static {v14, v13}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v6, v4, Lm6/x;->j:Landroid/media/CamcorderProfile;

    invoke-static {v6, v13}, Lm6/y;->b(Landroid/media/CamcorderProfile;I)I

    move-result v6

    invoke-virtual {v0, v13}, Lm6/t;->d(I)I

    move-result v8

    const/16 v15, 0x100

    invoke-virtual {v2, v15, v8}, Lhf/o$a;->a(II)V

    sget-object v2, Ljava/util/Locale;->ENGLISH:Ljava/util/Locale;

    new-array v11, v11, [Ljava/lang/Object;

    iget-object v15, v4, Lm6/x;->j:Landroid/media/CamcorderProfile;
    ...
    :cond_6
    iget-object v10, v4, Lm6/x;->j:Landroid/media/CamcorderProfile;
    ...
    invoke-static {v10}, Lm6/y;->a(Landroid/media/CamcorderProfile;)I

    move-result v10

    const-string v11, "setupRecorder: H265 bitrate = "

    invoke-static {v11, v10}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {v6}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->T()I
    ...
    invoke-static {v8}, Le9/d;->X(Le9/c;)I
    ...
    invoke-virtual {v2, v6, v11}, Lhf/o$a;->a(II)V
    ...
    invoke-static {v8}, Le9/d;->d3(Le9/c;)Z
    ...
    :cond_a
    invoke-static {v8}, Le9/d;->c3(Le9/c;)Z
    ...
    :cond_b
    invoke-static {v8}, Le9/d;->e3(Le9/c;)Z
    ...
    :cond_c
    invoke-static {v8}, Le9/d;->f3(Le9/c;)Z
    ...
    :cond_d
    invoke-static/range {p1 .. p1}, Lcom/android/camera/z2;->L2(I)Z
    ...
    iget-object v6, v8, Le9/c;->D7:Ljava/lang/Boolean;

    if-nez v6, :cond_10

    sget-object v6, Lp9/g;->B3:Lp9/f;

    invoke-virtual {v6}, Lp9/f;->c()Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v8, v10}, Le9/c;->k0(Ljava/lang/String;)Z

    move-result v10

    if-eqz v10, :cond_f

    iget-object v10, v8, Le9/c;->d:Landroid/hardware/camera2/CameraCharacteristics;

    invoke-static {v10, v6}, Lp9/e0;->a(Landroid/hardware/camera2/CameraCharacteristics;Lp9/d0;)Ljava/lang/Object;
    ...
    iput-object v6, v8, Le9/c;->D7:Ljava/lang/Boolean;
    ...
    invoke-static {}, Lm6/t;->j()Landroid/media/MediaCodecInfo;
    ...
    invoke-virtual {v2, v15, v10}, Lhf/o$a;->a(II)V
    ...
    invoke-static {v2, v6}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :goto_a
    iput v6, v7, Lhf/o;->h:I

    if-eqz v5, :cond_16

    const v2, 0x4e200

    iput v2, v7, Lhf/o;->d:I

    iget-object v2, v4, Lm6/x;->j:Landroid/media/CamcorderProfile;

    iget v5, v2, Landroid/media/CamcorderProfile;->audioChannels:I

    iput v5, v7, Lhf/o;->b:I

    iget v5, v2, Landroid/media/CamcorderProfile;->audioSampleRate:I

    iput v5, v7, Lhf/o;->e:I

    iget v2, v2, Landroid/media/CamcorderProfile;->audioCodec:I

    iput v2, v7, Lhf/o;->c:I

    :cond_16
    iget-boolean v2, v4, Lm6/x;->d:Z
    ...
    invoke-virtual {v6}, La1/g1;->T()La1/l0;

    move-result-object v6

    const/16 v8, 0xa0

    invoke-virtual {v6, v8}, La1/l0;->getDefaultValue(I)Ljava/lang/String;

    move-result-object v6

    const-string v8, "pref_new_video_time_lapse_frame_interval_key"

    invoke-virtual {v2, v8, v6}, Lle/a;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v6}, La1/g1;->R()La1/j0;
    ...
    invoke-virtual {v2, v6, v5}, Lle/a;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Ltb/a;->b5()Z

    move-result v5

    if-nez v5, :cond_1d

    iget v5, v4, Lm6/x;->f:I

    iput v5, v7, Lhf/o;->j:I

    invoke-virtual {v4}, Lm6/x;->d()I
    ...
    iget v6, v4, Lm6/x;->f:I

    const/16 v8, 0x1e0

    if-ne v6, v8, :cond_1b

    iget v6, v4, Lm6/x;->b:I
    ...
    invoke-static {v6, v8}, Lsf/f;->d(Ljava/lang/String;I)I
    ...
    invoke-static {v2, v5}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput v5, v7, Lhf/o;->h:I

    :cond_1d
    iget v2, v4, Lm6/x;->f:I
    ...
    iput-wide v10, v7, Lhf/o;->n:D

    const/16 v2, 0xa2

    if-ne v1, v2, :cond_1f

    invoke-virtual {v4, v9}, Lm6/x;->f(I)Z
    ...
    iget v2, v4, Lm6/x;->a:I

    iput v2, v7, Lhf/o;->p:I
    ...
    iput-object v6, v7, Lhf/o;->o:Landroid/util/Pair;
    ...
    invoke-static {v2, v5}, Lsf/f;->d(Ljava/lang/String;I)I

    move-result v2

    iget-wide v5, v4, Lm6/x;->s:J

    invoke-static {v2, v5, v6}, Lm6/a0;->l(IJ)J
    ...
    invoke-virtual {v11}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->U1()Z
    ...
    :goto_d
    iget-object v0, v4, Lm6/x;->h:Ljava/lang/String;
    ...
    iget-object v2, v4, Lm6/x;->g:Landroid/util/Range;
    ...
    invoke-virtual {v2, v5}, Lq5/a;->e(I)Z
    ...
    invoke-virtual {v2, v0}, Lq5/a;->e(I)Z
    ...
    :cond_2b
    iget v0, v4, Lm6/x;->t:I

    iput v0, v7, Lhf/o;->r:I
    ...
    invoke-virtual {v0, v2}, Lq5/a;->e(I)Z

    move-result v0

    iput-boolean v0, v7, Lhf/o;->t:Z

    iput-object v3, v7, Lhf/o;->s:Ljava/util/List;

    invoke-static/range {p1 .. p1}, Lcom/android/camera/z2;->W0(I)Z

    move-result v0

    iput-boolean v0, v7, Lhf/o;->v:Z

    return-object v7
.end method

.method public final l()Lhf/o;
    .locals 15

    new-instance v0, Lhf/o$a;

    invoke-direct {v0}, Lhf/o$a;-><init>()V

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iget-object v2, p0, Lm6/t;->e:Lm6/x;

    iget-object v3, v2, Lm6/x;->h:Ljava/lang/String;
    ...
    :goto_1
    iget-object v5, v0, Lhf/o$a;->a:Lhf/o;

    iput-boolean v3, v5, Lhf/o;->a:Z

    const/4 v7, 0x2

    iput v7, v5, Lhf/o;->l:I

    iget-object v9, v2, Lm6/x;->j:Landroid/media/CamcorderProfile;

    iget v10, v9, Landroid/media/CamcorderProfile;->fileFormat:I

    iput v10, v5, Lhf/o;->m:I

    iget v9, v9, Landroid/media/CamcorderProfile;->videoCodec:I

    iput v9, v5, Lhf/o;->g:I
    ...
    iget-object v10, v2, Lm6/x;->c:Lfe/c;
    ...
    iget-object v9, v2, Lm6/x;->c:Lfe/c;
    ...
    iput-object v12, v5, Lhf/o;->k:Landroid/util/Size;

    invoke-static {}, Lk6/e;->H()Lk6/e;

    move-result-object v9

    invoke-virtual {v9}, Lk6/e;->F()Le9/c;
    ...
    invoke-static {v10, v2}, Lm6/t;->e(ILm6/x;)I

    move-result v10

    iput v10, v5, Lhf/o;->j:I

    iget-object v12, p0, Lm6/t;->i:Lm6/z$a;

    iget-object v12, v12, Lm6/z$a;->a:Lm6/z;

    iput v10, v12, Lm6/z;->h:I

    const-string v12, "setupRecorder: videoFrameRate = "

    invoke-static {v12, v10}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v4, v2, Lm6/x;->j:Landroid/media/CamcorderProfile;

    invoke-static {v4, v10}, Lm6/y;->b(Landroid/media/CamcorderProfile;I)I

    move-result v4

    invoke-virtual {p0, v10}, Lm6/t;->d(I)I

    move-result v9

    const/16 v12, 0x100

    invoke-virtual {v0, v12, v9}, Lhf/o$a;->a(II)V

    sget-object v0, Ljava/util/Locale;->ENGLISH:Ljava/util/Locale;

    new-array v13, v13, [Ljava/lang/Object;

    iget-object v14, v2, Lm6/x;->j:Landroid/media/CamcorderProfile;
    ...
    :cond_3
    iget-object v12, v2, Lm6/x;->j:Landroid/media/CamcorderProfile;
    ...
    invoke-static {v12}, Lm6/y;->a(Landroid/media/CamcorderProfile;)I

    move-result v12

    const-string v13, "setupRecorder: H265 bitrate = "

    invoke-static {v13, v12}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {v4}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->T()I
    ...
    invoke-static {v9}, Le9/d;->d3(Le9/c;)Z
    ...
    :cond_4
    invoke-virtual {v0, v4, v14}, Lhf/o$a;->a(II)V
    ...
    :cond_5
    invoke-static {v9}, Le9/d;->c3(Le9/c;)Z
    ...
    :cond_6
    invoke-static {v9}, Le9/d;->e3(Le9/c;)Z
    ...
    invoke-virtual {v0, v7, v14}, Lhf/o$a;->a(II)V
    ...
    :cond_7
    invoke-static {v9}, Le9/d;->f3(Le9/c;)Z
    ...
    invoke-virtual {v0, v13, v14}, Lhf/o$a;->a(II)V
    ...
    invoke-static {v0, v4}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget v3, v2, Lm6/x;->f:I

    iput v3, v5, Lhf/o;->j:I

    invoke-virtual {v2}, Lm6/x;->d()I
    ...
    invoke-static {v4, v6}, Lsf/f;->d(Ljava/lang/String;I)I
    ...
    invoke-static {v0, v3}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput v3, v5, Lhf/o;->h:I

    :cond_f
    iget v0, v2, Lm6/x;->f:I

    int-to-double v3, v0

    iput-wide v3, v5, Lhf/o;->n:D
    ...
    iget v0, v2, Lm6/x;->a:I

    iput v0, v5, Lhf/o;->p:I

    const-string v0, "camera.debug.video_max_size"

    invoke-static {v0, v8}, Lsf/f;->d(Ljava/lang/String;I)I

    move-result v0

    iget-wide v3, v2, Lm6/x;->s:J

    invoke-static {v0, v3, v4}, Lm6/a0;->l(IJ)J
    ...
    invoke-virtual {v7}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->U1()Z
    ...
    iput-boolean v0, p0, Lm6/t;->c:Z

    goto :goto_7

    :cond_14
    iput-boolean v8, p0, Lm6/t;->c:Z
    ...
    iget-object v0, v2, Lm6/x;->g:Landroid/util/Range;
    ...
    :cond_15
    iget p0, v2, Lm6/x;->t:I

    iput p0, v5, Lhf/o;->r:I
    ...
    invoke-virtual {p0, v0}, Lq5/a;->e(I)Z

    move-result p0

    iput-boolean p0, v5, Lhf/o;->t:Z

    iput-object v1, v5, Lhf/o;->s:Ljava/util/List;

    return-object v5
.end method

.method public final m(ILm6/x;)Z
    .locals 10
    ...
    invoke-static {p1, p2}, Lm6/t;->e(ILm6/x;)I
    ...
    iget-object v6, p0, Lm6/t;->a:Lhf/n;
    ...
    :cond_1
    invoke-interface {v6}, Lhf/n;->start()V
    ...
    iget-object v6, v6, Lx0/l1;->j:Lx0/a0;

    invoke-virtual {v6}, Lx0/a0;->g()Z
    ...
    iput-wide v6, v0, Lm6/x;->w:J

    const-wide/16 v6, 0x0

    iput-wide v6, v0, Lm6/x;->x:J

    iget-object v0, p0, Lm6/t;->l:Ltf/i;

    invoke-static {}, Lio/reactivex/schedulers/Schedulers;->io()Lio/reactivex/Scheduler;

    move-result-object v6

    iget-object v7, p0, Lm6/t;->m:Lm6/q;

    const-wide/16 v8, 0x32c8

    invoke-virtual {v0, v8, v9, v6, v7}, Ltf/i;->c(JLio/reactivex/Scheduler;Lio/reactivex/functions/Action;)V
    ...
    iget-object v1, p2, Lm6/x;->i:Lt7/a;
    ...
    iget-object p2, p2, Lt7/a;->a:Landroid/net/Uri;
    ...
    iget-object p2, p0, Lm6/t;->f:Lm6/p;

    iput-boolean p1, p2, Lm6/p;->j:Z

    iput-boolean v5, p2, Lm6/p;->h:Z
    :try_end_0
    ...
    iget-object p0, p0, Lm6/t;->g:Ljava/lang/ref/WeakReference;

    invoke-virtual {p0}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lm6/t$a;
...
.method public final n()V
    ...
    iget-object v1, p0, Lm6/t;->b:Ljava/util/concurrent/CountDownLatch;
    ...
    :try_start_0
    iget-object p0, p0, Lm6/t;->b:Ljava/util/concurrent/CountDownLatch;
    ...
    invoke-static {v1, v2, p0}, Landroidx/concurrent/futures/b;->e(JLjava/lang/StringBuilder;)Ljava/lang/String;
