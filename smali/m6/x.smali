...
.field public v:Lcom/android/camera/fragment/beauty/p;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lm6/x;->b:I

    const-string v0, "normal"

    iput-object v0, p0, Lm6/x;->e:Ljava/lang/String;
    ...
    iput-object v0, p0, Lm6/x;->g:Landroid/util/Range;

    iput v1, p0, Lm6/x;->k:I

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Lm6/x;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lm6/x;->q:J
    ...
    iput-object v2, p0, Lm6/x;->u:Ljava/lang/ref/WeakReference;

    iput-wide v0, p0, Lm6/x;->w:J

    iput-wide v0, p0, Lm6/x;->x:J
...
.method public final a()V
    ...
    iget-object v0, p0, Lm6/x;->r:Ljava/lang/String;

    if-eqz v0, :cond_1

    new-instance v0, Ljava/io/File;

    iget-object v1, p0, Lm6/x;->r:Ljava/lang/String;
    ...
    iput-object v2, p0, Lm6/x;->r:Ljava/lang/String;
...
.method public final b()V
    ...
    iget-object p0, p0, Lm6/x;->r:Ljava/lang/String;
...
.method public final c()V
    ...
    iget-object v0, p0, Lm6/x;->i:Lt7/a;
    ...
    :cond_0
    :try_start_0
    invoke-virtual {v0}, Lt7/a;->f()Ljava/lang/String;
...
.method public final d()I
    ...
    iget-object p0, p0, Lm6/x;->j:Landroid/media/CamcorderProfile;
...
.method public final h()Z
    ...
    invoke-direct {v0, v1, v2}, Lfe/c;-><init>(II)V

    iget-object p0, p0, Lm6/x;->c:Lfe/c;

    invoke-virtual {v0, p0}, Lfe/c;->equals(Ljava/lang/Object;)Z
...
.method public final i()Z
    ...
    iget-object v0, p0, Lm6/x;->u:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct {v0, v1, v4}, Lfe/c;-><init>(II)V
...
.method public final k(Le9/c;ILz5/k;)Z
    .locals 4
    ...
    :cond_1
    invoke-static {p1}, Le9/d;->F2(Le9/c;)Z
    ...
    :cond_4
    invoke-static {p1}, Le9/d;->B2(Le9/c;)Z
    ...
    invoke-static {p2, p0}, Lcom/android/camera/z2;->O1(ILcom/android/camera/fragment/beauty/p;)Z
    ...
    invoke-virtual {p0, p2, p1}, La1/u0;->x(IZ)Z
...
.method public final l(IILcom/android/camera/w2;I)V
    ...
    :goto_0
    invoke-virtual/range {p3 .. p3}, Lcom/android/camera/w2;->e()I
    ...
    invoke-virtual {v8, v2, v7, v5}, Lx0/e0;->i(ILjava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-virtual {v8, v9, v5}, Lle/a;->g(Ljava/lang/String;Z)Z
    ...
    :goto_2
    iput-object v8, v0, Lm6/x;->e:Ljava/lang/String;
    ...
    iput-object v8, v0, Lm6/x;->h:Ljava/lang/String;

    goto :goto_3

    :cond_5
    iput-object v11, v0, Lm6/x;->e:Ljava/lang/String;
    ...
    :goto_3
    iput v5, v0, Lm6/x;->k:I

    iput-boolean v5, v0, Lm6/x;->d:Z

    iget-object v8, v0, Lm6/x;->e:Ljava/lang/String;
    ...
    iput v6, v0, Lm6/x;->b:I

    sget-object v6, Lm6/y;->c:Landroid/util/Size;

    invoke-static {}, Lu0/a;->i()Lx0/l1;

    move-result-object v7

    iget-object v7, v7, Lx0/l1;->n:Lx0/b0;

    invoke-virtual {v7, v3}, Lx0/b0;->getComponentValue(I)Ljava/lang/String;
    ...
    sget-object v6, Lm6/y;->b:Landroid/util/Size;

    iput v7, v0, Lm6/x;->b:I

    :cond_8
    if-ne v7, v9, :cond_9

    sget-object v6, Lm6/y;->d:Landroid/util/Size;
    ...
    iget-object v8, v8, Lx0/l1;->j:Lx0/a0;

    invoke-virtual {v8, v3}, Lx0/a0;->getComponentValue(I)Ljava/lang/String;
    ...
    iget-object v8, v0, Lm6/x;->h:Ljava/lang/String;
    ...
    invoke-virtual {v0, v6, v8}, Lm6/x;->m(Landroid/util/Size;I)V
    ...
    :cond_10
    :goto_6
    invoke-virtual {v0, v6, v15}, Lm6/x;->m(Landroid/util/Size;I)V
    ...
    :cond_12
    :goto_7
    iget-object v6, v0, Lm6/x;->e:Ljava/lang/String;
    ...
    invoke-virtual {v6}, Ltb/a;->Nc()Z

    move-result v8

    if-nez v8, :cond_15

    invoke-virtual {v6}, Ltb/a;->cd()Z
    ...
    invoke-virtual {v6, v11, v8}, Lle/a;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v8}, La1/g1;->T()La1/l0;

    move-result-object v8

    const/16 v11, 0xa0

    invoke-virtual {v8, v11}, La1/l0;->getDefaultValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lle/a;->f()Lle/a;

    const-string v8, "pref_video_speed_key"

    invoke-virtual {v6, v8, v10}, Lle/a;->q(Ljava/lang/String;Ljava/lang/String;)Lle/a;

    invoke-virtual {v6}, Lle/a;->b()V

    iput-object v10, v0, Lm6/x;->e:Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p1}, Lm6/x;->f(I)Z
    ...
    invoke-virtual {v6, v1}, Lk6/e;->N(I)Z
    ...
    invoke-virtual {v8, v6}, Lk6/e;->N(I)Z
    ...
    invoke-virtual {v8, v6}, Lk6/e;->D(I)Le9/c;

    move-result-object v8

    invoke-static {v8}, Le9/d;->m3(Le9/c;)Ljava/util/ArrayList;
    ...
    :goto_c
    iput-object v6, v0, Lm6/x;->j:Landroid/media/CamcorderProfile;
    ...
    invoke-static {v6}, Le9/d;->c3(Le9/c;)Z
    ...
    iget-object v6, v0, Lm6/x;->j:Landroid/media/CamcorderProfile;
    ...
    :cond_1e
    invoke-static {v6}, Le9/d;->e3(Le9/c;)Z
    ...
    invoke-static/range {p1 .. p1}, Lm6/a0;->j(I)I
    ...
    :cond_22
    iget-object v9, v0, Lm6/x;->j:Landroid/media/CamcorderProfile;
    ...
    iget-object v3, v0, Lm6/x;->g:Landroid/util/Range;
    ...
    invoke-virtual {v3, v2}, Lx0/f0;->getComponentValue(I)Ljava/lang/String;
    ...
    :goto_12
    iget-object v3, v0, Lm6/x;->h:Ljava/lang/String;
    ...
    invoke-static {v3}, Le9/d;->W(Le9/c;)I
    ...
    invoke-virtual {v7}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->c2()Z
    ...
    invoke-virtual/range {p0 .. p0}, Lm6/x;->i()Z

    move-result v7

    if-eqz v7, :cond_2b

    iput v8, v0, Lm6/x;->a:I
    ...
    invoke-virtual {v7, v2}, Lx0/e0;->getComponentValue(I)Ljava/lang/String;
    ...
    :cond_2f
    invoke-static {v2, v6}, Lcom/android/camera/z2;->e4(II)Z
    ...
    invoke-static {v7}, Lcom/android/camera/z2;->e3(Le9/c;)Z
    ...
    invoke-virtual {v2}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->b2()Z
    ...
    invoke-virtual/range {p0 .. p0}, Lm6/x;->h()Z
    ...
    :cond_38
    iput v5, v0, Lm6/x;->a:I

    :cond_39
    :goto_1a
    iget v2, v0, Lm6/x;->a:I

    if-eqz v2, :cond_3f

    if-ge v2, v12, :cond_3f

    iput v12, v0, Lm6/x;->a:I
    ...
    invoke-virtual {v3}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->x0()I
    ...
    invoke-virtual {v2}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->I4()I

    move-result v8

    mul-int/2addr v8, v12

    invoke-virtual {v2}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->G4()I
    ...
    invoke-virtual {v2}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->H4()I
    ...
    iget-object v6, v0, Lm6/x;->h:Ljava/lang/String;

    iget-object v3, v3, Lx0/l1;->j:Lx0/a0;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v6}, Lx0/a0;->d(Ljava/lang/String;)I
    ...
    :cond_3f
    :goto_1d
    iget-object v2, v0, Lm6/x;->j:Landroid/media/CamcorderProfile;
    ...
    invoke-virtual {v6, v1}, Lk6/e;->D(I)Le9/c;
    ...
    :cond_40
    iget v6, v1, Le9/c;->a:I

    const-class v7, Landroid/media/MediaRecorder;

    invoke-virtual {v1, v6, v7}, Le9/c;->P(ILjava/lang/Class;)Ljava/util/List;
    ...
    invoke-static {v1, v6, v7, v3, v2}, Lcom/android/camera/s5;->L(Ljava/util/List;DII)Lfe/c;

    move-result-object v1

    iput-object v1, v0, Lm6/x;->c:Lfe/c;
    ...
    invoke-virtual {v0, v1}, Lm6/x;->e(I)V
...
.method public final m(Landroid/util/Size;I)V
    ...
    invoke-virtual {v1, p1}, Le9/c;->M(Landroid/util/Size;)[Landroid/util/Range;
    ...
    :cond_2
    iput-object v2, p0, Lm6/x;->g:Landroid/util/Range;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
