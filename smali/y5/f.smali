...
.method public final run()V
    ...
    check-cast v0, Lmj/d0;

    iget v1, p0, Ly5/f;->b:I

    iget-object p0, p0, Ly5/f;->d:Ljava/lang/Object;

    check-cast p0, Lpi/e;

    iget-boolean v2, v0, Lmj/d0;->k:Z
    ...
    :cond_0
    iget-object v2, v0, Lmj/d0;->g:Ljava/util/HashMap;

    sget-object v3, Lfi/a;->a:[Ljava/lang/String;
    ...
    iget-object v2, v2, Lzi/b;->c:Lcom/faceunity/core/entity/FUAnimationBundleData;
    ...
    sget-object v3, Lfi/a;->b:[I

    aget v5, v3, v1

    const-string v6, ".png"

    invoke-static {v4, v5, v6}, Landroidx/activity/e;->f(Ljava/lang/StringBuilder;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v5, v6, v6, v2, v4}, Lpi/f;-><init>(IILcom/faceunity/core/entity/FUAnimationBundleData;Ljava/lang/String;)V

    aget v3, v3, v1

    iput v3, v5, Lpi/f;->j:I
    ...
    iget-object v6, v0, Lmj/d0;->j:Lcom/faceunity/core/avatar/model/Avatar;
    ...
    iget-object v1, v0, Lmj/d0;->c:Lpi/c;
    ...
    :cond_2
    invoke-static {p0, v5}, Lpi/c;->a(Lpi/e;Lpi/f;)V
