...
.field private mStreamMetadata:Lhe/e;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->mComputeRenderController:Lm6/g;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/camera/q0;-><init>(Ljava/lang/Object;I)V
...
.method public static synthetic Dd(Lcom/android/camera/features/mode/cinemaster/CinemasterModule;)V
    .locals 0
...
.method public static synthetic Md(Ljava/lang/String;ILd7/t;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->lambda$onCineMonitorStateChanged$2(Ljava/lang/String;ILd7/t;)V

    return-void
.end method

.method public static synthetic Ud(Lcom/android/camera/features/mode/cinemaster/CinemasterModule;)V
    .locals 0
...
.method private getTagsListener(Lcom/android/camera/module/VideoBase$f;)Lcom/android/camera/module/VideoBase$f;
    ...
    invoke-direct {v0, v1, p0, p1}, Lx2/b;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    return-object v0
.end method

.method public static synthetic hd(Ld7/t;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->lambda$setVideoCastStateImpl$4(Ld7/t;)V
...
.method private initStreamMetadata()V
    ...
    invoke-static {v3, v0, v4, v1}, Landroidx/activity/result/a;->d(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct {v3}, Lhe/e;-><init>()V

    iput-object v3, p0, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->mStreamMetadata:Lhe/e;
...
.method public static synthetic kd(Ld7/t;)Ljava/lang/Boolean;
    .locals 0

    invoke-static {p0}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->lambda$onBackPressed$6(Ld7/t;)Ljava/lang/Boolean;
...
.method private static synthetic lambda$new$7(Ld7/i3;)V
    .locals 2
...
.method private lambda$new$9()V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->mStreamMetadata:Lhe/e;

    if-eqz v2, :cond_0

    iput-boolean v0, v2, Lhe/e;->d:Z

    invoke-direct {p0, v2}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->sendStreamMetadata(Lhe/e;)V
...
.method private static synthetic lambda$onBackPressed$6(Ld7/t;)Ljava/lang/Boolean;
    .locals 1

    const/4 v0, 0x0

    invoke-interface {p0, v0}, Ld7/t;->handleExitRequest(Z)Z
    ...
    :cond_0
    invoke-interface {p0}, Ld7/t;->isBottomShow()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-interface {p0}, Ld7/t;->hidePopupBottom()V
    ...
    :cond_1
    invoke-interface {p0}, Ld7/t;->hideGuide()Z
...
.method private static synthetic lambda$onCineMonitorStateChanged$2(Ljava/lang/String;ILd7/t;)V
    .locals 0

    invoke-interface {p2, p0, p1}, Ld7/t;->onRemoteMonitorStateChanged(Ljava/lang/String;I)V
...
.method private lambda$onCineMonitorStateChanged$3(Landroid/os/Bundle;)V
    ...
    invoke-direct {v1, p1, v0, v2}, Lx2/d;-><init>(Ljava/lang/Object;II)V
...
.method private static synthetic lambda$setVideoCastStateImpl$4(Ld7/t;)V
    .locals 1

    invoke-interface {p0}, Ld7/t;->getMonitorCount()I

    move-result p0

    const/4 v0, 0x0

    invoke-static {v0, p0}, Lq7/a;->s0(II)V

    return-void
.end method

.method private static synthetic lambda$updateExposureTime$0(Ljava/lang/String;Le9/a;)V
    .locals 2
...
.method public static synthetic ld(Lcom/android/camera/features/mode/cinemaster/CinemasterModule;Landroid/os/Bundle;)V
    .locals 0
...
.method public static synthetic md(Lcom/android/camera/features/mode/cinemaster/CinemasterModule;Landroid/os/Bundle;)V
    .locals 0
...
.method public static synthetic nd(Ljava/lang/String;Le9/a;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->lambda$updateExposureTime$0(Ljava/lang/String;Le9/a;)V
...
.method private sendStreamMetadata(Lhe/e;)V
    .locals 5
    ...
    iget-byte v4, p1, Lhe/e;->b:B

    aput-byte v4, v1, v3

    iget-byte v3, p1, Lhe/e;->c:B
    ...
    iget-object p1, p0, Lcom/android/camera/y4;->a:Ljava/lang/Object;
    ...
    :try_start_1
    invoke-virtual {p0, v0}, Lbf/d;->a(Landroid/os/Bundle;)V
    :try_end_1
    ...
    :try_start_2
    sget-object v0, Lcom/android/camera/y4;->q:Ljava/lang/String;

    const-string v1, "customClientRequest failed"

    invoke-static {v0, v4, v1, p0}, Lgf/a;->c(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Exception;)V
...
.method public static synthetic vd(Lcom/android/camera/features/mode/cinemaster/CinemasterModule;Lcom/android/camera/module/VideoBase$f;Ljava/util/List;)V
    .locals 0
...
.method public static synthetic yd(Ld7/i3;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->lambda$new$7(Ld7/i3;)V
...
.method public getNextUpdateDelay(Ljava/lang/String;)J
    ...
    iget-object p0, p0, Lm6/p;->d:Ljava/lang/String;
...
.method public isRecording()Z
    ...
    invoke-interface {v1}, Ld7/t;->isClientVisible()Z
    ...
    invoke-interface {p0}, Ld7/t;->isRemoteRecoding()Z
...
.method public onCineMonitorHandleCameraParamRequest()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->mStreamMetadata:Lhe/e;

    if-eqz v1, :cond_0

    invoke-direct {p0, v1}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->sendStreamMetadata(Lhe/e;)V
...
.method public onCreate(II)V
    ...
    iget-object v0, p0, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->mComputeRenderController:Lm6/g;
    ...
    invoke-static {p1, v0}, Lcom/android/camera/z2;->J(ILe9/c;)[F
    ...
    invoke-direct {v0, v2, p1}, Lmk/k;-><init>(FF)V

    invoke-interface {p2, v1, v0}, Lcom/android/camera/ui/v0;->P0(Lkk/d;Lmk/k;)V

    goto :goto_0

    :cond_0
    invoke-interface {p2, v1}, Lcom/android/camera/ui/v0;->S(Lkk/d;)V

    :goto_0
    sget-object p1, Lkk/d;->x:Lkk/d;

    invoke-interface {p2, p1}, Lcom/android/camera/ui/v0;->S(Lkk/d;)V

    sget-object p1, Lkk/d;->e:Lkk/d;

    invoke-interface {p2, p1}, Lcom/android/camera/ui/v0;->W(Lkk/d;)Lrk/n;
...
.method public onDestroy()V
    ...
    iget-object v1, p0, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->mComputeRenderController:Lm6/g;

    invoke-virtual {v1, v0}, Lm6/g;->a(Lcom/android/camera/ui/v0;)V

    sget-object v1, Lkk/d;->w:Lkk/d;

    invoke-interface {v0, v1}, Lcom/android/camera/ui/v0;->H0(Lkk/d;)V

    sget-object v1, Lkk/d;->x:Lkk/d;
...
.method public onPreviewSessionSuccess(Landroid/hardware/camera2/CameraCaptureSession;)V
    ...
    iget-object v0, p0, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->mStreamMetadata:Lhe/e;

    invoke-direct {p0, v0}, Lcom/android/camera/features/mode/cinemaster/CinemasterModule;->sendStreamMetadata(Lhe/e;)V
...
.method public onVideoCastStateChanged(Landroid/os/Bundle;)V
    ...
    invoke-direct {v1, v2, p0, p1}, Lcom/android/camera/p1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public updateAutoHibernation(Z)V
    ...
    invoke-interface {p1}, Ld7/t;->isScreenPrompt()Z
...
.method public updateExposureTime()V
    ...
    invoke-direct {v2, v0, v3}, Lx2/c;-><init>(Ljava/lang/String;I)V
