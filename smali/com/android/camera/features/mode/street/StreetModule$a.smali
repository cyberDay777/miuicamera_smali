...
.method public final onShutterButtonFocus(ZI)V
    ...
    invoke-static {p1}, Lcom/android/camera/features/mode/street/StreetModule;->access$600(Lcom/android/camera/features/mode/street/StreetModule;)Lw7/k;

    move-result-object p1

    const/16 v1, 0x8c

    invoke-virtual {p1, v1}, Lw7/k;->getCountDownTimes(I)I
    ...
    invoke-virtual {v3}, Lcom/android/camera/module/Camera2Module;->getImageModuleState()Lb6/g;

    move-result-object v3

    iget-wide v3, v3, Lb6/g;->B:J
    ...
    iget-object v3, v3, Lcom/android/camera/module/Camera2Module;->mNightManager:Lb6/v;

    iget-boolean v3, v3, Lb6/v;->o:Z
    ...
    invoke-static {v3}, Lcom/android/camera/features/mode/street/StreetModule;->access$700(Lcom/android/camera/features/mode/street/StreetModule;)Lcom/android/camera/v3;
    ...
    iget-object v3, v3, Lcom/android/camera/module/Camera2Module;->mAiSceneMgr:Lb6/b;

    iget-boolean v3, v3, Lb6/b;->c:Z
    ...
    invoke-virtual {p1}, Lcom/android/camera/module/m;->getAppStateMgr()Lz5/b;
    ...
    invoke-virtual {p1}, Lcom/android/camera/module/Camera2Module;->getImageModuleState()Lb6/g;
    ...
    iget-wide v7, v7, Lb6/g;->B:J

    invoke-direct {p2, v7, v8}, Lge/a;-><init>(J)V

    iput-object p2, p1, Lcom/android/camera/module/Camera2Module;->mCaptureButtonStatus:Lge/a;

    invoke-virtual {p0, v1}, Lb6/e;->onShutterButtonClick(I)Z
    ...
    iput-wide v5, p1, Lb6/g;->B:J

    iget-object p1, p0, Lcom/android/camera/features/mode/street/StreetModule$a;->f:Lcom/android/camera/features/mode/street/StreetModule;

    iput-object v3, p1, Lcom/android/camera/module/Camera2Module;->mCaptureButtonStatus:Lge/a;
    ...
    iget-object p2, p1, Lcom/android/camera/module/Camera2Module;->mCaptureButtonStatus:Lge/a;

    invoke-virtual {p1}, Lcom/android/camera/module/Camera2Module;->getImageModuleState()Lb6/g;

    move-result-object p1

    iget-wide v0, p1, Lb6/g;->B:J

    invoke-virtual {p2, v0, v1}, Lge/a;->d(J)V

    iget-object p1, p0, Lcom/android/camera/features/mode/street/StreetModule$a;->f:Lcom/android/camera/features/mode/street/StreetModule;

    iget-object p1, p1, Lcom/android/camera/module/Camera2Module;->mCaptureButtonStatus:Lge/a;
    ...
    iput-object v3, p0, Lcom/android/camera/module/Camera2Module;->mCaptureButtonStatus:Lge/a;
    ...
    invoke-virtual {p0, v3}, Le9/a;->n0(Lge/a;)V
...
.method public final onShutterButtonLongClickCancel(Z)V
    ...
    :cond_2
    iget-boolean v1, v0, Lcom/android/camera/module/m;->mInStartingFocusRecording:Z

    if-eqz v1, :cond_8

    :cond_3
    iput-boolean v3, v0, Lcom/android/camera/module/m;->mInStartingFocusRecording:Z
    ...
    invoke-virtual {v0, v4}, Lcom/android/camera/module/m;->enableCameraControls(Z)V
    ...
    :cond_8
    iget-object v1, v0, Lcom/android/camera/module/Camera2Module;->mMultiCap:Lb6/r;
    ...
    iput-boolean v4, v1, Le9/z;->M1:Z

    :cond_9
    iget-boolean v1, p0, Lb6/e;->e:Z
    ...
    invoke-virtual {p0, p1}, Lb6/e;->onShutterButtonClick(I)Z
...
.method public final onShutterDragging()Z
    ...
    iget-object v1, v1, Lcom/android/camera/module/m;->mCameraManager:Lz5/k;
    ...
    iget-object v6, v1, Lcom/android/camera/module/Camera2Module;->mCaptureButtonStatus:Lge/a;

    invoke-virtual {v1}, Lcom/android/camera/module/Camera2Module;->getImageModuleState()Lb6/g;

    move-result-object v1

    iget-wide v7, v1, Lb6/g;->B:J

    invoke-virtual {v6, v7, v8}, Lge/a;->c(J)V
    ...
    iput-wide v3, v1, Lb6/g;->B:J

    iget-object v1, p0, Lcom/android/camera/features/mode/street/StreetModule$a;->f:Lcom/android/camera/features/mode/street/StreetModule;

    const/4 v3, 0x0

    iput-object v3, v1, Lcom/android/camera/module/Camera2Module;->mCaptureButtonStatus:Lge/a;
    ...
    invoke-virtual {v1, v3}, Le9/a;->n0(Lge/a;)V
    ...
    invoke-virtual {v1}, Lcom/android/camera/module/m;->isIgnoreTouchEvent()Z
