...
.field public final f:Lcom/android/camera/i3$a;

.field public final g:Lcom/android/camera/j0;

.field public final h:Landroidx/room/d;
...
.method public constructor <init>(Lcom/android/camera/Camera;)V
    ...
    iput-object v0, p0, Lcom/android/camera/i3;->f:Lcom/android/camera/i3$a;

    new-instance v0, Lcom/android/camera/j0;

    const/4 v1, 0x1

    invoke-direct {v0, p0, v1}, Lcom/android/camera/j0;-><init>(Lcom/android/camera/i3;I)V

    iput-object v0, p0, Lcom/android/camera/i3;->g:Lcom/android/camera/j0;
    ...
    iput-object v0, p0, Lcom/android/camera/i3;->h:Landroidx/room/d;
...
.method public static a(Lcom/android/camera/Camera;Lcom/android/camera/d5;Landroid/net/Uri;)Landroid/content/Intent;
    .locals 8
    ...
    iget-boolean p2, p1, Lcom/android/camera/d5;->e:Z

    if-eqz p2, :cond_b

    iget p2, p1, Lcom/android/camera/d5;->i:I
    ...
    invoke-static {v6, p2}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget v6, p1, Lcom/android/camera/d5;->j:I
    ...
    invoke-virtual {p2}, Ltb/a;->pg()V

    if-eqz p1, :cond_11

    iget-wide v5, p1, Lcom/android/camera/d5;->k:J
    ...
    iget-object p0, p2, Ltb/a;->g:L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;
...
.method public static b(Lcom/android/camera/Camera;Landroid/net/Uri;)V
    ...
    invoke-virtual {v0, v2}, Lh1/c;->H(Ljava/lang/Long;)Lf1/b;
    ...
    invoke-static {p0, p1}, Lr7/u;->w(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {p0, p1}, Ltf/j;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    invoke-static {p1, v0, v2, p0}, La1/c0;->d(Ljava/lang/String;ZLjava/lang/String;Z)Ljava/lang/String;
...
.method public static d(Lcom/android/camera/Camera;)V
    ...
    invoke-direct {v2, v3, p0, v0}, Lcom/android/camera/n1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
# virtual methods
.method public final c(Lcom/android/camera/Camera;Lcom/android/camera/d5;)V
    .locals 8
    .param p2    # Lcom/android/camera/d5;
    ...
    iget-object v3, p1, Lcom/android/camera/ActivityBase;->b0:Lcom/android/camera/ui/v0;

    if-eqz v3, :cond_4

    invoke-virtual {p1}, Lcom/android/camera/ActivityBase;->Hb()Z
    ...
    invoke-virtual {v4}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->G3()Z
    ...
    sget-object v4, Lkk/a;->g:Lkk/a;

    invoke-interface {v3, v4, p1}, Lcom/android/camera/ui/v0;->p0(Lkk/a;Z)V

    goto :goto_1

    :cond_2
    sget-object p1, Lkk/a;->g:Lkk/a;

    invoke-interface {v3, p1, v5}, Lcom/android/camera/ui/v0;->n0(Lkk/a;Ljava/lang/Object;)V

    goto :goto_1

    :cond_3
    :goto_0
    sget-object p1, Lkk/a;->a:Lkk/a;

    invoke-interface {v3, p1, v5}, Lcom/android/camera/ui/v0;->n0(Lkk/a;Ljava/lang/Object;)V

    :cond_4
    :goto_1
    iget-object p1, p0, Lcom/android/camera/i3;->b:Landroid/os/Messenger;
    ...
    sget-object p1, Lcom/android/camera/u4;->f:Lcom/android/camera/u4$a;

    invoke-virtual {p1}, Lsf/c;->b()Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/android/camera/u4;

    monitor-enter p1

    :try_start_0
    iget-object v4, p2, Lcom/android/camera/d5;->a:Landroid/net/Uri;

    iget-object v5, p2, Lcom/android/camera/d5;->b:Landroid/graphics/Bitmap;

    invoke-virtual {p1, v4, v5}, Lcom/android/camera/u4;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;)Z
    ...
    :cond_6
    :try_start_1
    invoke-virtual {p1}, Lcom/android/camera/u4;->c()Landroid/os/ParcelFileDescriptor;
    ...
    :try_start_3
    iget-object v7, p1, Lcom/android/camera/u4;->e:Landroid/net/Uri;
    :try_end_3
    ...
    :try_start_5
    iget v7, p1, Lcom/android/camera/u4;->d:I
    :try_end_5
    ...
    :try_start_7
    iget v7, p1, Lcom/android/camera/u4;->b:I
    :try_end_7
    ...
    :try_start_9
    iget v7, p1, Lcom/android/camera/u4;->c:I
    :try_end_9
    ...
    iget-object p2, p2, Lcom/android/camera/d5;->n:Ljava/lang/Boolean;
    ...
    :try_start_b
    iget v0, p1, Lcom/android/camera/u4;->b:I
    :try_end_b
    ...
    :try_start_d
    iget v0, p1, Lcom/android/camera/u4;->c:I
    :try_end_d
