...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v5, v2}, Lcom/android/camera/module/m;->setActivity(Lcom/android/camera/Camera;)V

    :cond_0
    invoke-virtual {v5}, Lcom/android/camera/module/m;->isCreated()Z
    ...
    :cond_2
    iget-object p0, v5, Lcom/android/camera/module/m;->mCameraManager:Lz5/k;

    invoke-interface {p0}, Lz5/k;->G0()V

    invoke-virtual {v5}, Lcom/android/camera/module/m;->onCameraException()V
    ...
    iget-object p0, v5, Lcom/android/camera/module/m;->mActivity:Lcom/android/camera/Camera;

    invoke-virtual {p0}, Lcom/android/camera/ActivityBase;->h9()Lcom/android/camera/x2;

    move-result-object p0

    iget-object p1, v5, Lcom/android/camera/module/m;->mCameraManager:Lz5/k;
    ...
    iget-object v0, v5, Lcom/android/camera/module/m;->mCameraManager:Lz5/k;
    ...
    invoke-static {v5}, Lcom/android/camera/module/WideSelfieModule;->access$100(Lcom/android/camera/module/WideSelfieModule;)La9/c;
    ...
    iget-object v1, v5, Lcom/android/camera/module/m;->mCameraManager:Lz5/k;
    ...
    iget-object v2, v5, Lcom/android/camera/module/m;->mCameraManager:Lz5/k;
    ...
    :cond_4
    iput p1, p0, La9/c;->i:I

    iput v0, p0, La9/c;->j:I

    iput v1, p0, La9/c;->g:I

    iput v2, p0, La9/c;->h:I

    iget-object v0, p0, La9/c;->a:Landroid/content/Context;
    ...
    iput v1, p0, La9/c;->l:I

    iget v1, p0, La9/c;->j:I
    ...
    invoke-static {p1}, La9/c;->a(Landroid/hardware/camera2/CameraCharacteristics;)Landroid/util/SizeF;

    move-result-object p1

    iput-object p1, p0, La9/c;->k:Landroid/util/SizeF;
    :try_end_0
    ...
    :cond_5
    invoke-virtual {v5}, Lcom/android/camera/module/m;->onCameraOpenedFail()V
    ...
    :cond_9
    iget-object p0, v5, Lcom/android/camera/module/m;->mHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v5}, Lcom/android/camera/module/m;->getWindow()Landroid/view/Window;
    ...
    invoke-virtual {v5}, Lcom/android/camera/module/m;->getScreenDelay()I
