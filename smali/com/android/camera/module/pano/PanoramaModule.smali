...
.method public static synthetic D5(Lcom/android/camera/module/pano/PanoramaModule;)V
    .locals 0
...
.method public static synthetic N5(Ljava/util/concurrent/atomic/AtomicReference;)V
    .locals 0
...
.method public static synthetic U5(Ld7/f3;)V
    ...
    invoke-static {p0}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$onSaveCompleted$8(Ld7/f3;)V

    return-void
.end method

.method public static synthetic Y3(Lcom/android/camera/module/pano/PanoramaModule;Ld7/n2;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$startShooting$0(Ld7/n2;)V

    return-void
.end method

.method public static synthetic Z5(Lcom/android/camera/Camera;)V
    .locals 0
...
.method public static synthetic a4(Ld7/f2;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$stopShooting$5(Ld7/f2;)V
...
.method private addImageAsApplication(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;II)V
    ...
    iget v13, v8, Lcom/android/camera/module/m;->mModuleIndex:I
    ...
    invoke-static/range {v9 .. v14}, Lrc/c;->k(Ljava/io/FileDescriptor;Landroid/location/Location;JI[B)V
    :try_end_1
    ...
    invoke-static/range {p2 .. p2}, La/d;->h(Ljava/lang/String;)Z
    ...
    :cond_3
    :try_start_5
    new-instance v12, Lrc/d;

    invoke-direct {v12, v2}, Lrc/d;-><init>(Ljava/lang/String;)V
    :try_end_5
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_6

    :try_start_6
    invoke-static {v12, v4, v9, v10, v0}, Lrc/c;->j(Lrc/d;Landroid/location/Location;JI)V
    :try_end_6
    ...
    :try_start_a
    invoke-virtual {v12, v14, v15}, Lrc/d;->g(Ljava/io/OutputStream;[B)Lrc/f;

    move-result-object v0

    :goto_3
    invoke-static {v10, v0}, Lrc/c;->c(Ljava/io/FileInputStream;Ljava/io/OutputStream;)V
    :try_end_a
    ...
    invoke-static {v10}, Lrc/c;->a(Ljava/io/InputStream;)V

    invoke-static {v14}, Lrc/c;->b(Ljava/io/OutputStream;)V
    ...
    invoke-static {v1}, Lrc/c;->b(Ljava/io/OutputStream;)V
    ...
    invoke-static/range {v9 .. v25}, Lr7/u;->m(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;ILjava/lang/String;JIILandroid/location/Location;ZZJ)Landroid/net/Uri;
    ...
    invoke-static {v0, v2}, Lr7/j;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;
    ...
    iput v2, v1, Lq7/a$b;->a:I

    iput-boolean v9, v1, Lq7/a$b;->b:Z

    const/4 v3, -0x2

    iput v3, v1, Lq7/a$b;->c:I

    iput-object v11, v1, Lq7/a$b;->g:Lcom/android/camera/fragment/beauty/p;

    invoke-virtual {v8, v1}, Lcom/android/camera/module/m;->trackPictureTaken(Lq7/a$b;)V

    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/module/m;->getActivity()Lcom/android/camera/Camera;

    move-result-object v1

    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/module/m;->isCreated()Z
    ...
    invoke-direct {v3, v4, v1}, Lcom/android/camera/p0;-><init>(ILcom/android/camera/Camera;)V

    invoke-virtual {v1, v3}, Landroid/app/Activity;->runOnUiThread(Ljava/lang/Runnable;)V

    if-eqz v0, :cond_f

    invoke-virtual {v1, v0, v9, v12, v9}, Lcom/android/camera/ActivityBase;->Jc(Landroid/net/Uri;ZLjava/lang/String;Z)V
    ...
    invoke-virtual {v0, v3, v9, v9, v2}, Lcom/android/camera/ThumbnailUpdater;->f(Lcom/android/camera/d5;ZZZ)V
...
.method public static synthetic b5(Lcom/android/camera/module/pano/PanoramaModule;)V
    .locals 0
...
.method private getQuality()I
    ...
    invoke-static {p0}, Lcom/android/camera/z2;->I(Z)Lcom/android/camera/f3;

    move-result-object v0

    invoke-virtual {v0, p0}, Lcom/android/camera/f3;->a(Z)I
...
.method public static synthetic i4(Lcom/android/camera/module/pano/PanoramaModule;Lio/reactivex/FlowableEmitter;Ljava/util/concurrent/atomic/AtomicReference;)V
    .locals 0
...
.method private static synthetic lambda$launchShootingTask$4(Ljava/lang/Throwable;)V
    ...
    invoke-static {p0, v0}, Landroidx/constraintlayout/core/a;->i(Ljava/lang/Throwable;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method private static synthetic lambda$onSaveCompleted$8(Ld7/f3;)V
    .locals 0
...
.method private synthetic lambda$onStopShooting$6(ZLd7/n2;)V
    .locals 1
    ...
    invoke-interface {p2, p1}, Ld7/n2;->d2(I)V

    goto :goto_0

    :cond_0
    invoke-interface {p2}, Ld7/n2;->Kd()V
    ...
    invoke-interface {p2}, Ld7/n2;->tf()V
...
.method private synthetic lambda$startShooting$0(Ld7/n2;)V
    .locals 2
...
.method private static synthetic lambda$stopShooting$5(Ld7/f2;)V
    .locals 3
    ...
    invoke-interface {p0, v0}, Ld7/f2;->tb(Landroid/graphics/Bitmap;)V
...
.method private launchShootingTask()Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct {v1, v2, p0, v0}, Lc2/h;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v3, v5, v4}, Lio/reactivex/Flowable;->observeOn(Lio/reactivex/Scheduler;ZI)Lio/reactivex/Flowable;

    move-result-object v1

    new-instance v4, Lcom/android/camera/n0;

    invoke-direct {v4, v0, v2}, Lcom/android/camera/n0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, v5, p0, v0}, Lcom/android/camera/module/pano/a;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method private onSaveCompleted()V
    ...
    invoke-static {v4, v1}, La1/c0;->g(ILjava/util/Optional;)V
    ...
    invoke-interface {v5}, Lz5/f;->isPaused()Z
    ...
    const-class v1, Ld7/a3;

    invoke-virtual {p0, v1}, Lz6/e;->e(Ljava/lang/Class;)Ljava/util/Optional;

    move-result-object p0

    const/16 v1, 0x11

    invoke-static {v1, p0}, Landroidx/constraintlayout/core/b;->i(ILjava/util/Optional;)V
    ...
    invoke-virtual {v4}, Lcom/android/camera/ActivityBase;->ka()Lcom/android/camera/ThumbnailUpdater;
...
.method private savePanoramaFile([Landroid/net/Uri;Ljava/lang/String;II)Z
    ...
    invoke-static {v12, v1}, Ltf/f;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private savePanoramaPicture()V
    ...
    invoke-virtual {v0, v8, v1}, Lje/c;->e(II)V
    ...
    invoke-static {v4, v8}, Lr7/u;->e(Ljava/lang/String;Z)Ljava/lang/String;
...
.method private startBurstRequest(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/FlowableEmitter;)V
    ...
    invoke-virtual {v1}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->n1()Z
    ...
    iput-object v3, v1, Le9/z;->a:Landroid/location/Location;
    ...
    invoke-virtual {v3, v2}, Lcom/android/camera/f3;->a(Z)I

    move-result v3

    invoke-virtual {v1, v3}, Le9/y;->I(I)V
    ...
    invoke-static {v3}, Lb6/o;->a(Lz5/k;)Lfe/c;

    move-result-object v3

    iget-object v1, v1, Le9/y;->a:Le9/z;

    iget-object v4, v1, Le9/z;->F:Lfe/c;
    ...
    iput-object v3, v1, Le9/z;->F:Lfe/c;
    ...
    invoke-virtual {v1, v3}, Le9/y;->y(Z)V
    ...
    iget-boolean v3, v1, Le9/z;->i1:Z

    if-eqz v3, :cond_3

    iput-boolean v2, v1, Le9/z;->i1:Z
    ...
    invoke-virtual {v1, v2}, Le9/y;->R(I)V
    ...
    invoke-virtual {p0, p2, v1, p1}, Le9/a;->f(ILe9/a$l;Lr7/i;)V
...
.method private startSaveTask()Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/camera/module/pano/d;-><init>(Lz6/a;I)V
...
.method public static synthetic t5(Lcom/android/camera/module/pano/PanoramaModule;Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Boolean;)V
    .locals 0
...
.method public static synthetic u5(Lcom/android/camera/module/pano/PanoramaModule;ZLd7/n2;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$onStopShooting$6(ZLd7/n2;)V
...
.method public stopShooting(ZZ)V
    ...
    invoke-interface {p1}, Lz5/k;->Q0()Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2}, Le9/a;->W0(Z)V
