...
.method public static a(Landroid/view/View;)V
    ...
    invoke-static {v2}, Lcom/android/camera/r4;->a(Landroid/view/View;)V
    ...
    invoke-static {p0, v0}, Lt9/a;->d(Landroid/widget/TextView;Landroid/graphics/Typeface;)V
...
.method public static b(Landroid/content/Context;ILjava/lang/String;)Lmiuix/appcompat/app/ProgressDialog;
    ...
    invoke-static {p0}, Lcom/android/camera/r4;->a(Landroid/view/View;)V

    return-object v0
.end method

.method public static c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Runnable;Ljava/lang/CharSequence;Ltg/a;Ljava/lang/String;Ljava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;
    .locals 12
...
.method public static d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Runnable;Ljava/lang/CharSequence;Ltg/a;Ljava/lang/String;Ljava/lang/Runnable;Ljava/lang/String;ZLjava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;
    .locals 1

    new-instance v0, Lcom/android/camera/g4;

    invoke-direct {v0, p4, p8, p6}, Lcom/android/camera/g4;-><init>(Ljava/lang/Runnable;Ljava/lang/Runnable;Ltg/a;)V

    new-instance p4, Lcom/android/camera/h4;

    invoke-direct {p4, p11}, Lcom/android/camera/h4;-><init>(Ljava/lang/Runnable;)V

    new-instance p6, Le9/g0;

    invoke-direct {p6, v0, p4}, Le9/g0;-><init>(Landroid/content/DialogInterface$OnClickListener;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    :cond_0
    new-instance p0, Lcom/android/camera/i4;

    invoke-direct {p0}, Lcom/android/camera/i4;-><init>()V
    ...
    new-instance p2, Le9/f0;

    invoke-direct {p2, p6}, Le9/f0;-><init>(Le9/g0;)V
