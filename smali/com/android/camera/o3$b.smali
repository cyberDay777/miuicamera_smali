.class public final Lcom/android/camera/o3$b;
...
.field public final synthetic h:Lcom/android/camera/o3;


# direct methods
.method public constructor <init>(Lcom/android/camera/o3;)V
    .locals 2

    iput-object p1, p0, Lcom/android/camera/o3$b;->h:Lcom/android/camera/o3;
    ...
    iput-object p1, p0, Lcom/android/camera/o3$b;->a:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/android/camera/o3$b;->f:Ljava/lang/Object;
    ...
    invoke-virtual {p1}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->q2()Z
...
.method public static j(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    invoke-virtual {v4, v3}, Ll9/d;->equals(Ljava/lang/Object;)Z
...
.method public final a(Landroid/util/SparseArray;II)Landroid/util/SparseArray;
    ...
    :goto_0
    :try_start_0
    iget-boolean v1, p0, Lcom/android/camera/o3$b;->g:Z
    ...
    :try_start_1
    iget-object v1, p0, Lcom/android/camera/o3$b;->f:Ljava/lang/Object;
    ...
    :try_start_3
    iget-object v0, p0, Lcom/android/camera/o3$b;->e:Landroid/util/SparseArray;

    invoke-static {p1, v0}, Lcom/android/camera/o3$b;->j(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    iget-object v0, p0, Lcom/android/camera/o3$b;->d:Lje/t;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lje/t;->j()Z
    ...
    iget-object v3, p0, Lcom/android/camera/o3$b;->d:Lje/t;
    ...
    iget-object p1, p0, Lcom/android/camera/o3$b;->d:Lje/t;

    iget-object v0, p1, Lje/t;->j:Ljava/lang/Object;
    ...
    iget-object p2, p1, Lje/t;->j:Ljava/lang/Object;
    ...
    :try_start_8
    iget-object p1, p1, Lje/t;->e:Landroid/util/SparseArray;
    ...
    :try_start_9
    invoke-static {p1}, Ll9/c;->b(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    iget-object v4, p0, Lcom/android/camera/o3$b;->a:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :goto_1
    iget-object v3, p0, Lcom/android/camera/o3$b;->a:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :try_start_12
    iget-object v5, v3, Lje/t;->e:Landroid/util/SparseArray;
    ...
    :try_start_13
    invoke-static {p1, v5}, Lcom/android/camera/o3$b;->j(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z

    move-result v4

    if-eqz v4, :cond_5

    invoke-virtual {v3}, Lje/t;->j()Z
    ...
    iget-object v0, v3, Lje/t;->j:Ljava/lang/Object;
    ...
    :cond_4
    iput-object p1, p0, Lcom/android/camera/o3$b;->e:Landroid/util/SparseArray;

    iput-object v3, p0, Lcom/android/camera/o3$b;->d:Lje/t;
    ...
    :try_start_18
    iget-object v3, v3, Lje/t;->e:Landroid/util/SparseArray;
    ...
    :try_start_19
    invoke-static {v3}, Ll9/c;->b(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    invoke-virtual {p0}, Lcom/android/camera/o3$b;->f()Lje/t;

    move-result-object v1

    iget-object v3, v1, Lje/t;->j:Ljava/lang/Object;
    ...
    :try_start_25
    iget-object p2, v1, Lje/t;->j:Ljava/lang/Object;
    ...
    :try_start_27
    iget-object p2, p0, Lcom/android/camera/o3$b;->a:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object p2, p0, Lcom/android/camera/o3$b;->d:Lje/t;
    ...
    iput-object v1, p0, Lcom/android/camera/o3$b;->d:Lje/t;

    invoke-virtual {v1, p1}, Lje/t;->l(Landroid/util/SparseArray;)Landroid/util/SparseArray;
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-virtual {v3, v4, v5}, Lje/c;->e(II)V
    ...
    iget-object v4, p0, Lje/t;->j:Ljava/lang/Object;

    monitor-enter v4

    :try_start_1
    iget-object v5, p0, Lje/t;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v5}, Lje/n;->n()Z

    move-result v6

    if-nez v6, :cond_4

    invoke-virtual {v5}, Lje/n;->w()Z

    move-result v6

    if-eqz v6, :cond_4

    iget-object p1, p0, Lje/t;->b:Lje/n;

    if-eq p1, v5, :cond_3

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lje/n;->v()V

    :cond_2
    iput-object v5, p0, Lje/t;->b:Lje/n;
    ...
    :cond_4
    iget-object v3, p0, Lje/t;->b:Lje/n;

    if-eqz v3, :cond_5

    invoke-virtual {v3}, Lje/n;->v()V
    ...
    iget-object v5, p0, Lje/t;->C:Lje/t$e;

    invoke-direct {v3, v5, p1}, Lje/i;-><init>(Lje/t$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    :cond_7
    new-instance v3, Lje/a0;

    iget-object v5, p0, Lje/t;->C:Lje/t$e;

    invoke-direct {v3, v5, p1}, Lje/a0;-><init>(Lje/t$e;Lcom/xiaomi/engine/BufferFormat;)V

    :goto_1
    iget v5, p0, Lje/t;->a:I

    if-lez v5, :cond_8

    iput v5, v3, Lje/n;->a:I

    :cond_8
    iput v5, v3, Lje/n;->e:I

    invoke-virtual {v3}, Lje/b;->I()V

    invoke-virtual {v3, p1}, Lje/n;->b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;

    move-result-object v5

    iget-object v6, p0, Lje/t;->y:Lje/t$a;
    ...
    invoke-virtual {v3, v5}, Lje/b;->H(Lcom/xiaomi/engine/TaskSession;)V

    iget-object v5, p0, Lje/t;->c:Ljava/util/HashMap;

    invoke-virtual {v5, p1, v3}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iput-object v3, p0, Lje/t;->b:Lje/n;
...
.method public final e()Ljava/util/Iterator;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/camera/o3$b;->a:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final f()Lje/t;
    ...
    iget-object v1, p0, Lcom/android/camera/o3;->e:Lcom/android/camera/o3$a;

    invoke-direct {v0, v1}, Lje/t;-><init>(Lcom/android/camera/o3$a;)V

    iget v1, p0, Lcom/android/camera/o3;->c:I
    ...
    :cond_0
    iget-boolean v1, p0, Lcom/android/camera/o3;->d:Z

    iput-boolean v1, v0, Lje/t;->p:Z
    ...
    iget v2, p0, Lcom/android/camera/o3;->c:I
    ...
    iget-boolean p0, p0, Lcom/android/camera/o3;->d:Z
...
.method public final i()Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/o3$b;->e()Ljava/util/Iterator;
...
.method public final k()Z
    ...
    invoke-virtual {v1}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->J4()Z

    move-result v1

    if-eqz v1, :cond_5

    iget-object v1, p0, Lje/t;->b:Lje/n;

    iget-object v3, p0, Lje/t;->l:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v4, p0, Lje/t;->k:Ljava/util/HashMap;
    ...
    iget-object v7, v6, Lje/q;->Q:Lje/n;

    if-ne v7, v1, :cond_1

    iget-boolean v7, v6, Lje/q;->x:Z

    if-nez v7, :cond_3

    iget v6, v6, Lje/q;->R:I
    ...
    iget-object p0, p0, Lje/t;->b:Lje/n;

    if-eqz p0, :cond_6

    invoke-virtual {p0, v5}, Lje/n;->o(I)Z
...
.method public final l(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    iget-object p0, p0, Lje/t;->m:Lje/t$g;
    ...
    invoke-virtual {p0, p1, p2}, Lje/p;->f(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public final m(IJ)V
    ...
    iget-object v1, p1, Lje/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v2, p2, p3}, La/c;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    :goto_0
    iget-object v2, p0, Lje/t$g;->a:Lje/t;

    invoke-virtual {v2, p2, p3}, Lje/t;->r(J)Lje/q;
    ...
    iget-object v3, v1, Lge/b;->f:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lje/t$g;->a:Lje/t;

    iget v4, v1, Lge/b;->a:I

    invoke-static {v3, v1, v4}, Lje/t;->h(Lje/t;Lge/b;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v1

    iput-object v1, v2, Lje/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;

    :cond_1
    new-instance v1, Lje/v;

    iget-object p0, p0, Lje/t$g;->a:Lje/t;

    iget-object p0, p0, Lje/t;->z:Lje/t$b;

    const/4 v2, 0x1

    invoke-direct {v1, p2, p3, p0, v2}, Lje/v;-><init>(JLje/t$b;Z)V
    ...
    iget-object p0, p1, Lje/p;->a:Landroid/os/HandlerThread;
    ...
    iget-object p0, p1, Lje/p;->b:Lje/p$a;
    ...
    iget-object p2, p1, Lje/p;->b:Lje/p$a;
    ...
    invoke-virtual {p1, v1}, Lje/p;->i(Lje/v;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final n(Lje/q;)V
    ...
    iget-object v1, p0, Lje/t$g;->a:Lje/t;
    ...
    invoke-virtual {v1, v0, v2}, Lje/c;->e(II)V

    :cond_0
    iget-wide v7, p1, Lje/q;->e:J

    iget-object v1, p1, Lje/q;->M:Lge/d;

    iget-object v3, p1, Lje/q;->p:Ljava/lang/String;
    ...
    invoke-static {v3, v7, v8, p1}, Lje/t;->g(Lje/t;JLje/q;)V

    iget-object v3, p1, Lje/q;->o0:Lje/q$a;
    ...
    :cond_1
    iget v3, p1, Lje/q;->B:I

    const/4 v5, 0x4

    if-eq v3, v5, :cond_2

    iput-boolean v4, p1, Lje/q;->x:Z

    :cond_2
    iget-object v3, p0, Lje/t$g;->a:Lje/t;

    iget-object v3, v3, Lje/t;->b:Lje/n;

    iput-object v3, p1, Lje/q;->Q:Lje/n;

    :cond_3
    iget-object v3, p0, Lje/t$g;->a:Lje/t;

    iget-object v11, v3, Lje/t;->b:Lje/n;

    instance-of v3, v11, Lje/i;
    ...
    :goto_0
    iget v6, p1, Lje/q;->C:I

    iget-boolean v10, p1, Lje/q;->H:Z

    new-instance v13, Lge/b;

    iget v4, p1, Lje/q;->B:I

    iget-object v9, p1, Lje/q;->a0:Ljava/lang/String;

    move-object v3, v13

    invoke-direct/range {v3 .. v11}, Lge/b;-><init>(IIIJLjava/lang/String;ZLje/n;)V

    iget v3, p1, Lje/q;->j0:I

    iput v3, v13, Lge/b;->x:I

    iget-object v3, p0, Lje/t$g;->a:Lje/t;

    iget-object v3, v3, Lje/t;->z:Lje/t$b;

    iput-object v3, v13, Lge/b;->q:Lje/p$e;

    iget-boolean v3, p1, Lje/q;->K:Z

    iput-boolean v3, v13, Lge/b;->l:Z

    iput-object v1, v13, Lge/b;->o:Lge/d;

    iget-object v1, p1, Lje/q;->h0:Lge/a;

    iput-object v1, v13, Lge/b;->v:Lge/a;

    iget-boolean v1, p1, Lje/q;->P:Z

    iput-boolean v1, v13, Lge/b;->m:Z
    ...
    invoke-direct {v0, v2, p0, v13, p1}, Lcom/android/camera/h1;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
