...
.field public b:Lcom/android/camera/x4;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/camera/y4;->q:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput-object v0, p0, Lcom/android/camera/y4;->a:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/camera/y4;->c:Z
    ...
    iput-object v2, p0, Lcom/android/camera/y4;->f:Lte/c;

    iput v0, p0, Lcom/android/camera/y4;->g:I

    const/4 v2, -0x1

    iput v2, p0, Lcom/android/camera/y4;->h:I

    new-instance v2, Ljava/util/LinkedHashSet;

    invoke-direct {v2}, Ljava/util/LinkedHashSet;-><init>()V

    iput-object v2, p0, Lcom/android/camera/y4;->i:Ljava/util/LinkedHashSet;

    iput v0, p0, Lcom/android/camera/y4;->o:I

    iput v0, p0, Lcom/android/camera/y4;->p:I

    iput-object p1, p0, Lcom/android/camera/y4;->j:Lcom/android/camera/ActivityBase;

    new-instance v2, Lte/c$b;

    invoke-direct {v2}, Lte/c$b;-><init>()V

    iput-object v2, p0, Lcom/android/camera/y4;->m:Lte/c$b;

    iput-boolean v0, v2, Lte/c$b;->j:Z

    const/16 v2, 0x10

    new-array v2, v2, [F

    iput-object v2, p0, Lcom/android/camera/y4;->n:[F
    ...
    invoke-static {v2}, Landroidx/core/view/b0;->a(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;

    move-result-object v2

    invoke-static {v2}, Landroidx/core/view/z;->c(Landroid/view/WindowMetrics;)Landroid/graphics/Rect;
    ...
    invoke-static {v2, v3}, La/d;->c(Ljava/lang/String;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    :cond_2
    iput-boolean v0, p0, Lcom/android/camera/y4;->k:Z
...
.method public final a()Z
    ...
    iget-object v0, p0, Lcom/android/camera/y4;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, Lcom/android/camera/y4;->c:Z
    ...
    invoke-static {v1, v3, v2, p0}, Lgf/a;->c(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Exception;)V
...
.method public final b(Lcom/android/gallery3d/ui/a;Lk2/e;)V
    ...
    iget-object v0, p0, Lcom/android/camera/y4;->f:Lte/c;
    ...
    sget-object p0, Lcom/android/camera/y4;->q:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/camera/y4;->f:Lte/c;

    if-eqz v1, :cond_7

    iget-object v1, p0, Lcom/android/camera/y4;->m:Lte/c$b;
    ...
    iget-object p2, p0, Lcom/android/camera/y4;->m:Lte/c$b;

    iget v1, p0, Lcom/android/camera/y4;->p:I

    iput v1, p2, Lte/c$b;->i:I

    iget-boolean v1, p0, Lcom/android/camera/y4;->e:Z
    ...
    :goto_0
    iput-boolean v3, p2, Lte/c$b;->k:Z
    ...
    iget p1, p0, Lcom/android/camera/y4;->o:I

    if-eqz p1, :cond_3

    iget-boolean p1, p0, Lcom/android/camera/y4;->l:Z

    if-eqz p1, :cond_3

    iget-object p1, p2, Lk2/e;->c:[F

    iget-object p2, p0, Lcom/android/camera/y4;->n:[F

    invoke-static {p1, v2, p2, v2, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object p1, p0, Lcom/android/camera/y4;->n:[F

    invoke-static {p1, v2, v6, v6, v5}, Landroid/opengl/Matrix;->translateM([FIFFF)V

    iget-object v7, p0, Lcom/android/camera/y4;->n:[F
    ...
    iget-object p1, p0, Lcom/android/camera/y4;->m:Lte/c$b;
    ...
    :cond_3
    iget-boolean p1, p0, Lcom/android/camera/y4;->k:Z

    if-eqz p1, :cond_4

    iget-object p1, p0, Lcom/android/camera/y4;->f:Lte/c;
    ...
    invoke-virtual {p1, p2, v1}, Lte/c;->e(II)V
    ...
    :cond_5
    iget v1, p0, Lcom/android/camera/y4;->o:I
    ...
    iget-object p0, p0, Lcom/android/camera/y4;->m:Lte/c$b;

    invoke-virtual {p1, p0}, Lte/c;->a(Lte/c$b;)V
...
.method public final varargs c([I)V
    ...
    :cond_1
    :goto_1
    iget-object p0, p0, Lcom/android/camera/y4;->f:Lte/c;

    if-eqz p0, :cond_2

    iget-object p0, p0, Lte/c;->l:Lte/c$a;
...
.method public final e(Z)V
    ...
    iget-object v1, p0, Lcom/android/camera/y4;->a:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iput-boolean p1, p0, Lcom/android/camera/y4;->e:Z

    iget-object p1, p0, Lcom/android/camera/y4;->d:Lbf/d;
    ...
    iput-boolean p1, p0, Lcom/android/camera/y4;->c:Z

    iget-object p1, p0, Lcom/android/camera/y4;->j:Lcom/android/camera/ActivityBase;

    invoke-static {p1, p0, p0, p0}, Lbf/d;->b(Lcom/android/camera/ActivityBase;Lbf/d$b;Lbf/d$d;Lbf/d$c;)Lbf/d;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/y4;->d:Lbf/d;
    ...
    iget-boolean v0, p0, Lcom/android/camera/y4;->c:Z
    ...
    iget-boolean p1, p0, Lcom/android/camera/y4;->c:Z
    ...
    invoke-virtual {p1}, Lcom/android/camera/Camera;->pg()I

    move-result p1

    invoke-virtual {p0, p1}, Lcom/android/camera/y4;->d(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {p0, p1}, Lbf/d;->f(Landroid/os/Bundle;)V
    :try_end_1
    .catch Lbf/d$g; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {p1, v2, v0, p0}, Lgf/a;->c(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Exception;)V
...
.method public final f()V
    ...
    iget-object v1, p0, Lcom/android/camera/y4;->i:Ljava/util/LinkedHashSet;

    invoke-interface {v1}, Ljava/util/Set;->clear()V

    const/4 v1, 0x0

    iput v1, p0, Lcom/android/camera/y4;->g:I
    ...
    invoke-virtual {v1, p0}, Lcom/android/camera/effect/t;->removeChangeListener(Lcom/android/camera/effect/t$a;)Z
    ...
    iget-object v1, v1, Lte/c;->l:Lte/c$a;
    ...
    iput-object v1, p0, Lcom/android/camera/y4;->f:Lte/c;

    :cond_0
    iget-object v1, p0, Lcom/android/camera/y4;->d:Lbf/d;
    ...
    invoke-virtual {p0, v1}, Lbf/d;->g(Landroid/os/Bundle;)V
    :try_end_1
    .catch Lbf/d$g; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {v1, v2, v3, p0}, Lgf/a;->c(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Exception;)V
