...
.method public final dismiss(II)Z
    ...
    invoke-virtual {v1, v2}, Lx0/p0;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v0}, La1/l0;->getItems()Ljava/util/List;
    ...
    invoke-static {v1, p1}, Landroidx/appcompat/widget/c;->j(ILjava/util/Optional;)V
    ...
    invoke-virtual {p0, p2, v5}, Lcom/android/camera/fragment/fastmotion/FragmentFastMotionPro;->lh(IZ)V
...
.method public final ec(Lcom/android/camera/data/data/a;ZI)V
    .locals 8
    ...
    invoke-direct {v3, v2, p1, p2}, Lq4/d;-><init>(ILjava/lang/Object;Z)V
    ...
    invoke-virtual {v2, p3}, Lx0/y0;->reset(I)V
...
.method public final initView(Landroid/view/View;)V
    ...
    invoke-virtual {p1}, La1/g1;->S()La1/k0;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/fragment/fastmotion/FragmentFastMotionPro;->k:La1/k0;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/camera/fragment/fastmotion/FragmentFastMotionPro;->lh(IZ)V
...
.method public final lh(IZ)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/fastmotion/FragmentFastMotionPro;->l3()V
    ...
    iget-object v5, v2, Lx0/l1;->r:Lx0/p0;

    invoke-virtual {v5, v3}, Lx0/p0;->getComponentValue(I)Ljava/lang/String;

    move-result-object v12

    invoke-virtual {v5, v3, v12}, Lx0/p0;->k(ILjava/lang/String;)V
    ...
    iget-object v12, v2, Lx0/l1;->s:Lx0/v0;

    invoke-virtual {v12, v3}, Lx0/v0;->getComponentValue(I)Ljava/lang/String;

    move-result-object v13

    invoke-virtual {v12, v3, v13}, Lx0/v0;->d(ILjava/lang/String;)V
    ...
    iget-object v1, v2, Lx0/l1;->v:Lx0/q0;
    ...
    invoke-direct {v1, v12, v11}, Lg2/a0;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v0, v6, Lcom/android/camera/fragment/fastmotion/FragmentFastMotionPro;->k:La1/k0;

    if-eqz v0, :cond_5

    iput-boolean v8, v0, La1/k0;->b:Z
    ...
    invoke-direct {v1, v10}, Lcom/android/camera/v0;-><init>(I)V
    ...
    invoke-interface {v0}, Ld7/j0;->c6()V
    ...
    invoke-interface {v0, v8}, Ld7/b0;->L3(Z)V
...
.method public final notifySpecifyDataSetChange(I)V
    ...
    invoke-direct {v1, p0, p1, v2}, Lq4/c;-><init>(Lz6/a;II)V
...
.method public final onDestroyView()V
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/fastmotion/FragmentFastMotionPro;->k:La1/k0;

    if-eqz p0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, La1/k0;->b:Z
...
.method public final onManuallyDataChanged(Lcom/android/camera/data/data/a;Ljava/lang/String;Ljava/lang/String;ZII)V
    ...
    invoke-static {p3, p2}, La1/c0;->i(ILjava/util/Optional;)V
    ...
    invoke-direct {p3, p4}, Lg0/m;-><init>(I)V
...
.method public final recheckClickCondition(Lcom/android/camera/data/data/a;)Z
    ...
    invoke-interface {p0, v1, p1, v2, v3}, Ld7/d3;->alertRecommendTipHint(ILjava/lang/String;J)V
...
.method public final showOrHideExtra(Lcom/android/camera/data/data/a;IZ)V
    ...
    invoke-direct {p3, v2}, Lcom/android/camera/m1;-><init>(I)V
    ...
    invoke-direct {p2, p3}, Le0/c;-><init>(I)V
    ...
    invoke-interface {v2}, Ld7/m2;->isAdded()Z

    move-result v5

    if-eqz v5, :cond_2

    invoke-interface {v2}, Ld7/m2;->getCurrentTitle()I
    ...
    invoke-static {p2, p1}, Landroidx/appcompat/widget/c;->h(ILjava/util/Optional;)V
    ...
    invoke-interface {v2, p1}, Ld7/m2;->resetData(Lcom/android/camera/data/data/a;)V
...
.method public final updateEVState(I)V
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lx0/p0;->getDefaultValue(I)Ljava/lang/String;
