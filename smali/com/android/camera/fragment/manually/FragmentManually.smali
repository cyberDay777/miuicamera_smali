...
.method public final initManuallyDataList()Ljava/util/List;
    ...
    iget-object v1, v1, Lx0/l1;->E:Lx0/s0;

    iget-boolean v1, v1, Lx0/s0;->g:Z
    ...
    iget-object v4, v0, Lx0/l1;->E:Lx0/s0;
    ...
    invoke-virtual {v5, v4, v6}, Lx0/y0;->g(ILjava/lang/String;)V
    ...
    invoke-virtual {v6, v4, v7}, Lx0/t0;->c(ILjava/lang/String;)V
    ...
    invoke-virtual {v6, v4}, Lx0/p0;->getComponentValue(I)Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v6, v4, v7}, Lx0/p0;->k(ILjava/lang/String;)V
    ...
    iget-object v4, v4, Lx0/l1;->D:Lx0/k0;

    iget-boolean v4, v4, Lx0/c1;->C:Z
    ...
    invoke-virtual {v6, v4, v7}, Lx0/k0;->C(ILjava/lang/String;)V
    ...
    invoke-virtual {v6, v4}, Lx0/v0;->getComponentValue(I)Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v6, v4, v7}, Lx0/v0;->d(ILjava/lang/String;)V
...
.method public final notifyAfterFrameAvailable(I)V
    ...
    iget-object p1, p0, Lcom/android/camera/fragment/manually/FragmentManually;->q:Lko/b;
    ...
    invoke-direct {v0, p0}, Ly4/c;-><init>(Lcom/android/camera/fragment/manually/FragmentManually;)V
...
.method public final notifySpecifyDataSetChange(I)V
    ...
    invoke-direct {v1, p0, p1, v2}, Ly4/b;-><init>(Ljava/lang/Object;II)V
...
.method public final onBackEvent(I)Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/manually/FragmentManually;->nh()V
...
.method public final onCustomWheelScroll(Lcom/android/camera/data/data/a;ZZII)V
    ...
    invoke-direct {v2, v3, p1, p3}, Lq4/d;-><init>(ILjava/lang/Object;Z)V
    ...
    invoke-virtual {v2, v0}, Lx0/y0;->c(I)I
    ...
    invoke-virtual {v2, p4}, Lx0/y0;->reset(I)V
...
.method public final onManuallyDataChanged(Lcom/android/camera/data/data/a;Ljava/lang/String;Ljava/lang/String;ZII)V
    ...
    new-instance p3, Lcom/android/camera/x;

    const/16 p4, 0x1d

    invoke-direct {p3, p4}, Lcom/android/camera/x;-><init>(I)V
    ...
    new-instance p3, Lcom/android/camera/m1;

    const/16 p4, 0x17

    invoke-direct {p3, p4}, Lcom/android/camera/m1;-><init>(I)V
...
.method public final onNewLenSwitched(Ljava/lang/String;)V
    ...
    :cond_2
    invoke-interface {v1}, Ld7/s1;->getModuleIndex()I
    ...
    invoke-interface {v1, v0, p0}, Ld7/s1;->c7(Lx0/o0;I)V
    ...
    invoke-interface {p0, p1}, Ld7/r1;->updateExposureModeAssociateParam(I)V

    invoke-interface {p0, p1}, Ld7/r1;->updateEVState(I)V

    :cond_5
    invoke-interface {v2}, Ld7/f3;->refreshExtraMenu()V

    if-eqz p0, :cond_7

    invoke-interface {p0}, Ld7/r1;->notifyDataSetChange()V
...
.method public final onRecordingPrepare()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/fragment/manually/FragmentManually;->lh(I)V
...
.method public final provideAnimateElement(ILjava/util/List;I)V
    ...
    new-instance v6, Lcom/android/camera/x0;

    const/16 v7, 0x8

    invoke-direct {v6, v7}, Lcom/android/camera/x0;-><init>(I)V
    ...
    invoke-direct {v8, v7}, Lcom/android/camera/y0;-><init>(I)V
    ...
    invoke-static {v7, v6}, Landroidx/constraintlayout/core/parser/a;->i(ILjava/util/Optional;)Ljava/util/Optional;
    ...
    :cond_5
    iget v6, p0, Lcom/android/camera/fragment/manually/FragmentManually;->f:I
    ...
    :cond_c
    invoke-virtual {p0, v2}, Lcom/android/camera/fragment/manually/FragmentManually;->lh(I)V

    goto :goto_6

    :cond_d
    invoke-virtual {p0, v5}, Lcom/android/camera/fragment/manually/FragmentManually;->lh(I)V
...
.method public final provideRotateItem(Ljava/util/List;I)V
    ...
    invoke-interface {p0, p1, p2}, Ld7/m2;->provideRotateItem(Ljava/util/List;I)V
...
.method public final recheckClickCondition(Lcom/android/camera/data/data/a;)Z
    ...
    invoke-direct {v4, v5}, Lcom/android/camera/z1;-><init>(I)V
    ...
    invoke-interface {v0, v3, v4}, Lf7/a;->dismiss(II)Z
    ...
    invoke-static {v5, v0}, Landroid/support/v4/media/session/d;->i(ILjava/util/Optional;)V

    invoke-interface {p0, v2, p1, v3, v4}, Ld7/d3;->alertRecommendTipHint(ILjava/lang/String;J)V
    ...
    invoke-static {v6, v0}, Landroidx/concurrent/futures/a;->k(ILjava/util/Optional;)V
...
.method public final resetManually()V
    ...
    :goto_1
    iget-object v6, p0, Lcom/android/camera/fragment/manually/FragmentManually;->g:Ljava/util/ArrayList;
    ...
    invoke-interface {v0, v1}, Ld7/m2;->resetData(Lcom/android/camera/data/data/a;)V
    ...
    invoke-direct {v1, v3, v2}, Lg2/a0;-><init>(Ljava/lang/Object;I)V
...
.method public final showOrHideExtra(Lcom/android/camera/data/data/a;IZ)V
    ...
    :cond_1
    invoke-interface {v5}, Ld7/m2;->isAdded()Z

    move-result v4

    if-eqz v4, :cond_5

    invoke-interface {v5}, Ld7/m2;->getCurrentTitle()I
    ...
    invoke-interface {v5, p1}, Ld7/m2;->resetData(Lcom/android/camera/data/data/a;)V
    ...
    invoke-interface {p1, p3}, Ld7/j;->v(I)I
    ...
    invoke-direct {p3, v4}, Lcom/android/camera/p2;-><init>(I)V
    ...
    invoke-direct {p3, v4}, Le0/e;-><init>(I)V
    ...
    new-instance p3, Lcom/android/camera/z1;

    const/16 v4, 0x17

    invoke-direct {p3, v4}, Lcom/android/camera/z1;-><init>(I)V
    ...
    invoke-static {p3, p1}, Landroidx/appcompat/widget/c;->j(ILjava/util/Optional;)V
    ...
    invoke-interface {v5, v2}, Ld7/m2;->setClickEnable(Z)V
