...
# direct methods
.method public constructor <init>(Landroid/content/Context;ILy4/j;)V
    .locals 7
    ...
    iput-object p3, p0, Lcom/android/camera/fragment/manually/adapter/b;->mZoomValueListener:Ly4/j;
    ...
    invoke-static {p3, p2}, La/c;->g(ILjava/util/Optional;)Ljava/util/Optional;

    move-result-object p2

    sget-object p3, Lc9/b$a;->c:Landroid/util/Range;
...
.method public final a(ILandroid/graphics/Canvas;ZIFZZ)V
    ...
    invoke-static {v4, v3, p5, v3}, Landroidx/appcompat/graphics/drawable/a;->a(FFFF)F
...
.method public final initStyle(Landroid/content/Context;)V
    ...
    invoke-static {}, Lt9/a;->a()Landroid/graphics/Typeface;
...
.method public final onChangeValue(Ljava/lang/String;I)V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/manually/adapter/b;->mZoomValueListener:Ly4/j;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Ly4/j;->onManuallyDataChanged(Ljava/lang/String;I)V
...
.method public final onPositionSelect(Landroid/view/View;FII)V
    ...
    invoke-interface {v0, p2, v1, p4}, Ly4/j;->onZoomItemSlideOn(IZI)V

    :cond_2
    iget-object p2, p0, Lcom/android/camera/fragment/manually/adapter/b;->mZoomValueListener:Ly4/j;

    if-eqz p2, :cond_3

    invoke-interface {p2, p1, p3}, Ly4/j;->onManuallyDataChanged(Ljava/lang/String;I)V
