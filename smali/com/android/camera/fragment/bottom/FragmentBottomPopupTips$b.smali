...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/android/camera/fragment/bottom/FragmentBottomPopupTips;->rb()Z
.end annotation
...
.method public final onComplete()V
    ...
    :cond_2
    iget-object v6, v6, Le5/b;->o:Le5/b$b;

    if-eqz v6, :cond_3

    invoke-interface {v6, v4}, Le5/b$b;->a(Landroid/view/View;)V
    ...
    iget-object v5, v3, Le5/b;->o:Le5/b$b;

    if-eqz v5, :cond_8

    invoke-interface {v5, v4}, Le5/b$b;->a(Landroid/view/View;)V

    :cond_8
    iget v5, v3, Le5/a;->g:I
    ...
    :cond_9
    iget-object v5, v3, Le5/a;->a:Landroid/view/View$OnClickListener;

    if-eqz v5, :cond_a

    new-instance v5, Lk4/j;

    invoke-direct {v5, p0, v3}, Lk4/j;-><init>(Lcom/android/camera/fragment/bottom/FragmentBottomPopupTips;Le5/b;)V

    invoke-virtual {v4, v5}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    :cond_a
    iget-boolean v3, v3, Le5/b;->p:Z
    ...
    invoke-virtual {p0, v4}, Lcom/android/camera/fragment/bottom/FragmentBottomPopupTips;->vh(Landroid/view/View;)V
    ...
    invoke-static {p0}, Lcom/android/camera/fragment/bottom/FragmentBottomPopupTips;->lh(Lcom/android/camera/fragment/bottom/FragmentBottomPopupTips;)I

    move-result v1

    const/4 v2, 0x0

    invoke-virtual {p0, v2, v0, v1}, Lcom/android/camera/fragment/bottom/FragmentBottomPopupTips;->ph(Ljava/util/List;Landroid/widget/FrameLayout;I)V
