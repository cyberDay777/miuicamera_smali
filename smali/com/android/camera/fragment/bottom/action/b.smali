...
.method public constructor <init>(Landroid/view/ViewGroup;ZLcom/android/camera/fragment/bottom/action/e;)V
    ...
    invoke-static {v0, v2}, Lo9/a;->b(II)I
    ...
    invoke-direct {v6, v5}, Lg5/p;-><init>(Lg5/p$a;)V
    ...
    invoke-static {}, Lcom/android/camera2/compat/theme/custom/mm/top/TopBarUtils;->getMasterFilterItemBuilder()Lg5/p$a;

    move-result-object v3

    invoke-static {v3, v3, v0}, Landroidx/constraintlayout/core/a;->l(Lg5/p$a;Lg5/p$a;Ljava/util/ArrayList;)V

    goto :goto_0

    :cond_1
    invoke-virtual {v3}, La1/g1;->B0()Z
    ...
    invoke-static {}, Lcom/android/camera2/compat/theme/custom/mm/top/TopBarUtils;->getShineItemBuilder()Lg5/p$a;
    ...
    invoke-static {}, Lcom/android/camera2/compat/theme/custom/mm/top/TopBarUtils;->getUseGuideItemBuilder()Lg5/p$a;
    ...
    const-class v4, Ld7/t2;

    invoke-virtual {v3, v4}, Lz6/e;->d(Ljava/lang/Class;)Lz6/a;

    move-result-object v3

    check-cast v3, Ld7/t2;

    invoke-interface {v3}, Ld7/t2;->x6()Z
    ...
    new-instance v3, Lg5/p$a;

    invoke-direct {v3}, Lg5/p$a;-><init>()V

    const/16 v5, 0x213

    iput v5, v3, Lg5/p$a;->a:I

    new-instance v5, La4/g;

    invoke-direct {v5, v2}, La4/g;-><init>(I)V

    iput-object v5, v3, Lg5/p$a;->c:Lg5/p$c;

    new-instance v5, La4/h;

    invoke-direct {v5, v4}, La4/h;-><init>(I)V

    iput-object v5, v3, Lg5/p$a;->e:Landroid/view/View$OnClickListener;
    ...
    invoke-direct {v5, v2}, La4/i;-><init>(I)V

    iput-object v5, v3, Lg5/p$a;->c:Lg5/p$c;

    new-instance v5, Lw2/c;

    invoke-direct {v5, v4}, Lw2/c;-><init>(I)V
    ...
    invoke-static {v5, v6}, Lcom/android/camera/fragment/bottom/action/b;->a(Lg5/p;Landroid/widget/ImageView;)V
...
.method public static a(Lg5/p;Landroid/widget/ImageView;)V
    .locals 6
    ...
    iget-object v1, v1, Lx0/l1;->e:Lx0/m;

    invoke-virtual {v1, v3}, Lx0/m;->s(I)Z

    move-result v1

    xor-int/lit8 v1, v1, 0x1

    iput-boolean v1, p0, Lg5/p;->d:Z

    :cond_0
    const/4 v1, 0x0

    iget-object v4, p0, Lg5/p;->f:Lg5/p$c;
    ...
    iget-boolean v1, v3, Lg5/v;->g:Z

    const/4 v4, 0x0

    iget-boolean v5, v3, Lg5/v;->f:Z
    ...
    :cond_7
    iget-object p0, v3, Lg5/v;->e:Ljava/lang/String;
...
.method public final c(I)V
    ...
    invoke-static {v1, v0}, Lcom/android/camera/fragment/bottom/action/b;->a(Lg5/p;Landroid/widget/ImageView;)V
    ...
    invoke-static {p0, p1}, Lcom/android/camera/fragment/bottom/action/b;->a(Lg5/p;Landroid/widget/ImageView;)V
