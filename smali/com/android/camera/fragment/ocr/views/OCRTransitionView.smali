...
.method public final b(Lcom/xiaomi/ocr/sdk_ocr/OCRData$RegionData;Landroid/graphics/Rect;Lgp/j;Lcom/android/camera/fragment/ocr/FragmentOCRContent;)V
    .locals 26
    ...
    invoke-direct {v7, v1}, Lj5/d;-><init>(F)V

    invoke-static {v3, v7}, La/e;->Q([FLql/l;)[F
    ...
    invoke-static {v9}, Lcom/android/camera/h5;->H([F)[Landroid/graphics/PointF;
    ...
    invoke-static {v4, v3}, Lcom/android/camera/h5;->t(Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    invoke-static {v3, v4, v8, v9}, Lcom/android/camera/h5;->s(FFFF)Landroid/graphics/PointF;
    ...
    invoke-static {v3, v2}, Lcom/android/camera/h5;->t(Landroid/graphics/PointF;Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    invoke-static {v2, v4}, Landroidx/constraintlayout/core/parser/a;->e(Ljava/lang/String;F)Ljava/lang/String;
    ...
    invoke-static {v2, v3, v1, v8}, Ltf/b;->f(Landroid/graphics/Bitmap;IFZ)Landroid/graphics/Bitmap;
    ...
    invoke-direct/range {v0 .. v5}, Lj5/c;-><init>(Lcom/android/camera/fragment/ocr/views/OCRTransitionView;IIFLandroid/graphics/PointF;)V
