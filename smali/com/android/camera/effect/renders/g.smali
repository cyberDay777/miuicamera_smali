...
.method public final varargs c([I)V
    ...
    :cond_0
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->isKaleidoscopeEnable()Z
    ...
    :cond_1
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->isNeedDrawExposure()Z
    ...
    :cond_2
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->isDrawTilt()Z
    ...
    :cond_4
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->isNeedDrawPeaking()Z
    ...
    :cond_5
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->isMakeupEnable()Z
    ...
    :cond_6
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->getCvEffectForPreview()I
    ...
    :cond_7
    invoke-virtual {v1, v7}, Lcom/android/camera/effect/t;->getEffectForPreview(Z)I
...
.method public final draw(Lk2/b;)Z
    ...
    invoke-virtual {v1, v2}, Lcom/android/camera/effect/t;->getEffectForPreview(Z)I
    ...
    invoke-virtual {v4}, Lcom/android/camera/effect/t;->getCvEffectForPreview()I
    ...
    invoke-virtual {v0}, Lcom/android/camera/effect/t;->isBackGroundBlur()Z
    ...
    invoke-virtual {v4}, Lcom/android/camera/effect/t;->needDestroyMakeup()Z
    ...
    invoke-virtual {v4, v5}, Lcom/android/camera/effect/t;->setDestroyMakeup(Z)V
    ...
    invoke-virtual {v4}, Lcom/android/camera/effect/t;->isBeautyFrameReady()Z
    ...
    invoke-virtual {v7}, Lcom/android/camera/effect/t;->getCurrentKaleidoscope()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lcom/android/camera/effect/t;->isBackGroundBlur()Z
    ...
    invoke-virtual {p1}, Lcom/android/camera/effect/t;->getBlurAnimationValue()I
