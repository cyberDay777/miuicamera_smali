...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/camera/d5;->o:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public constructor <init>(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)V
    ...
    iput-boolean v0, p0, Lcom/android/camera/d5;->d:Z

    iput-boolean v0, p0, Lcom/android/camera/d5;->e:Z

    iput-boolean v0, p0, Lcom/android/camera/d5;->h:Z

    const/4 v1, -0x1

    iput v1, p0, Lcom/android/camera/d5;->i:I

    iput v1, p0, Lcom/android/camera/d5;->j:I

    const-wide/16 v1, -0x1

    iput-wide v1, p0, Lcom/android/camera/d5;->k:J

    iput-boolean v0, p0, Lcom/android/camera/d5;->l:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/android/camera/d5;->n:Ljava/lang/Boolean;

    iput-object p1, p0, Lcom/android/camera/d5;->a:Landroid/net/Uri;
    ...
    :goto_2
    iput-object p2, p0, Lcom/android/camera/d5;->b:Landroid/graphics/Bitmap;
...
.method public static b(Landroid/database/Cursor;)Lcom/android/camera/d5$a;
    .locals 18
    ...
    invoke-static {v2, v3}, Ltf/f;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v17, Lcom/android/camera/d5$a;
    ...
    invoke-direct/range {v4 .. v16}, Lcom/android/camera/d5$a;-><init>(JIJLjava/lang/String;IIZZJ)V
    :try_end_0
    ...
    invoke-static {v0, v2}, Landroidx/appcompat/view/menu/a;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/d5;
    .locals 1
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lcom/android/camera/d5;-><init>(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)V

    return-object v0
.end method

.method public static d([BIILandroid/net/Uri;Z)Lcom/android/camera/d5;
    .locals 11
    ...
    :cond_1
    iget-object v4, v0, Lrc/d;->o:[B

    if-nez v4, :cond_2

    invoke-virtual {v0}, Lrc/d;->r()[B

    move-result-object v4

    iput-object v4, v0, Lrc/d;->o:[B

    :cond_2
    iget v4, v0, Lrc/d;->p:I
    ...
    :cond_4
    iget-object v4, v0, Lrc/d;->f:[Ljava/util/HashMap;
    ...
    iget-object v3, v0, Lrc/d;->i:Ljava/nio/ByteOrder;

    invoke-virtual {v7, v3}, Lrc/d$d;->k(Ljava/nio/ByteOrder;)I

    move-result v3

    iget-object v0, v0, Lrc/d;->i:Ljava/nio/ByteOrder;

    invoke-virtual {v4, v0}, Lrc/d$d;->k(Ljava/nio/ByteOrder;)I
    ...
    :cond_5
    :goto_1
    iget-object v3, v0, Lrc/d;->o:[B

    iget v0, v0, Lrc/d;->n:I
    ...
    :cond_8
    invoke-static {p3, v3, p1, p4}, Lcom/android/camera/d5;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/d5;
...
.method public static e(Landroid/content/Context;Landroid/net/Uri;)Lcom/android/camera/d5;
    .locals 32
    ...
    invoke-static {v0, v3, v4, v5, v11}, Lcom/android/camera/d5;->k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v8, v6, v5, v11}, Lcom/android/camera/d5;->l(IIILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v17 .. v23}, Lcom/android/camera/d5;->f(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/app/Application;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {v2, v3, v0, v0}, Lcom/android/camera/d5;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/d5;
    ...
    invoke-virtual {v0, v9, v10}, Lcom/android/camera/d5;->m(J)V
    ...
    iput-boolean v2, v0, Lcom/android/camera/d5;->e:Z
...
.method public static f(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/app/Application;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {p1 .. p6}, Lcom/android/camera/d5;->g(Landroid/media/MediaMetadataRetriever;IIIILandroid/media/MediaMetadataRetriever$BitmapParams;)Landroid/graphics/Bitmap;
...
.method public static h(Landroid/content/ContentResolver;)Lcom/android/camera/d5$a;
    .locals 10
    ...
    invoke-static {v3, v4}, Landroidx/concurrent/futures/a;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v5}, Landroidx/concurrent/futures/a;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/android/camera/d5;->b(Landroid/database/Cursor;)Lcom/android/camera/d5$a;
    ...
    invoke-static {p0}, Lcom/android/camera/d5;->b(Landroid/database/Cursor;)Lcom/android/camera/d5$a;
...
.method public static i(Landroid/content/Context;Landroid/content/ContentResolver;)Lcom/android/camera/d5;
    .locals 23
    ...
    sget-object v2, Lcom/android/camera/d5;->o:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-static {v15}, Ltf/j;->a(Ljava/io/Closeable;)V

    invoke-static {v12}, Ltf/j;->a(Ljava/io/Closeable;)V

    invoke-static {v14}, Ltf/j;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {v1, v6}, Ltf/j;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z

    move-result v1

    if-eqz v1, :cond_7

    invoke-static {v0, v6}, Lr7/j;->c(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {v6, v0, v1, v1}, Lcom/android/camera/d5;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/d5;

    move-result-object v0

    if-eqz v0, :cond_b

    iput-boolean v9, v0, Lcom/android/camera/d5;->e:Z

    iput v2, v0, Lcom/android/camera/d5;->i:I

    iput v8, v0, Lcom/android/camera/d5;->j:I

    const/4 v1, 0x1

    iput-boolean v1, v0, Lcom/android/camera/d5;->c:Z

    iput-boolean v7, v0, Lcom/android/camera/d5;->h:Z
    ...
    invoke-static/range {v16 .. v16}, Ltf/j;->a(Ljava/io/Closeable;)V
...
.method public static j(J)Lcom/android/camera/d5;
    .locals 11
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-static {v3, p0, p1}, La/c;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lh1/c;->u()Lpp/a;
    ...
    invoke-direct {v5, v3}, Ltp/e;-><init>(Lpp/a;)V
    ...
    iput-object v7, v5, Ltp/e;->f:Ljava/lang/Integer;

    sget-object v7, Lcom/android/camera/db/greendao/SaveTaskDao$Properties;->Id:Lpp/d;

    iget-object v8, v5, Ltp/e;->b:Ljava/lang/StringBuilder;
    ...
    iput-object v8, v5, Ltp/e;->b:Ljava/lang/StringBuilder;
    ...
    iget-object v9, v5, Ltp/e;->a:Ltp/f;

    invoke-virtual {v9, v7}, Ltp/f;->a(Lpp/d;)V
    ...
    iget-object v10, v7, Lpp/d;->e:Ljava/lang/String;
    ...
    iget-object v7, v7, Lpp/d;->b:Ljava/lang/Class;
    ...
    iget-object v7, v5, Ltp/e;->g:Ljava/lang/String;
    ...
    :cond_2
    iget-object v7, v5, Ltp/e;->b:Ljava/lang/StringBuilder;

    const-string v8, " DESC"

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5}, Ltp/e;->a()Ltp/d;
    ...
    iget-object v8, v5, Ltp/a;->e:Ljava/lang/Thread;

    if-ne v7, v8, :cond_8

    iget-object v7, v5, Ltp/a;->a:Lpp/a;

    iget-object v7, v7, Lpp/a;->b:Lqp/b;

    iget-object v7, v7, Lqp/b;->a:Landroid/database/sqlite/SQLiteDatabase;

    iget-object v8, v5, Ltp/a;->c:Ljava/lang/String;

    iget-object v9, v5, Ltp/a;->d:[Ljava/lang/String;
    ...
    iget-object v5, v5, Ltp/a;->b:Lw4/i;

    iget-object v5, v5, Lw4/i;->a:Ljava/lang/Object;
    ...
    :try_start_0
    invoke-virtual {v5, v7}, Lpp/a;->h(Landroid/database/Cursor;)Ljava/util/ArrayList;
    ...
    invoke-static {p1, p0}, Lr7/u;->w(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-static {p0, p1, v0, v4}, Lcom/android/camera/d5;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/d5;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera/d5;->m(J)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
...
.method public static k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p4, v8}, Lr7/u;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
...
.method public final m(J)V
    ...
    iput-wide p1, p0, Lcom/android/camera/d5;->k:J

    const-string v0, "setFileSize: "

    const-string v1, ", mUri: "

    invoke-static {v0, p1, p2, v1}, Landroidx/concurrent/futures/c;->e(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-object p2, p0, Lcom/android/camera/d5;->a:Landroid/net/Uri;
...
.method public final n(J)V
    ...
    iput-object v0, p0, Lcom/android/camera/d5;->f:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/android/camera/d5;->g:Ljava/lang/String;
...
.method public final o(Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Lcom/android/camera/d5;->a:Landroid/net/Uri;
    ...
    iget-object p0, p0, Lcom/android/camera/d5;->a:Landroid/net/Uri;
    ...
    iput-boolean v2, p0, Lcom/android/camera/d5;->d:Z
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/camera/d5;->a:Landroid/net/Uri;
    ...
    iget-object v1, p0, Lcom/android/camera/d5;->b:Landroid/graphics/Bitmap;
    ...
    iget-boolean v1, p0, Lcom/android/camera/d5;->c:Z
    ...
    iget-boolean v1, p0, Lcom/android/camera/d5;->d:Z
    ...
    iget v1, p0, Lcom/android/camera/d5;->i:I
    ...
    iget v1, p0, Lcom/android/camera/d5;->j:I
    ...
    iget-boolean p0, p0, Lcom/android/camera/d5;->l:Z
