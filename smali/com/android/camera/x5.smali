...
.method public final accept(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lw9/c;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    const/4 v2, 0x1

    if-lez p1, :cond_0

    iput-boolean v2, p0, Lw9/c;->l:Z
    ...
    check-cast v5, Ld7/q2;

    invoke-interface {v5}, Ld7/q2;->isDoingAction()Z
    ...
    check-cast v4, Ld7/q2;

    invoke-interface {v4}, Ld7/q2;->isBlockSnap()Z
    ...
    invoke-interface {v4}, Ld7/x1;->p2()Z
    ...
    invoke-interface {p1, v3}, Ld7/o;->onShutterButtonClick(I)Z

    iput-boolean v2, p0, Lw9/c;->k:Z

    const/16 p1, 0x30

    invoke-virtual {v0, p1}, Ljava/util/concurrent/atomic/AtomicInteger;->set(I)V

    iput-boolean v1, p0, Lw9/c;->m:Z
    ...
    :cond_4
    :goto_1
    iget-boolean p1, p0, Lw9/c;->m:Z

    if-nez p1, :cond_6

    iget p1, p0, Lw9/c;->i:I
    ...
    invoke-interface {v0, v2}, Ld7/d3;->reInitAlert(Z)V

    :cond_5
    iput-boolean v2, p0, Lw9/c;->m:Z
    ...
    invoke-static {p0, p1, v1, v1, v1}, Lcom/android/camera/f5;->d(Landroid/content/Context;Ljava/lang/String;ZII)V
    ...
    iget-object p0, p0, Lqj/c;->b:Ljava/util/LinkedList;
