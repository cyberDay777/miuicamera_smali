...
# direct methods
.method public constructor <init>(Lr7/e$a;)V
    .locals 4

    invoke-direct {p0, p1}, Lr7/b;-><init>(Lr7/b$a;)V

    iget-object v0, p1, Lr7/e$a;->m:Landroid/hardware/camera2/CaptureResult;

    iput-object v0, p0, Lr7/e;->u:Landroid/hardware/camera2/CaptureResult;

    const/4 v0, 0x0

    iput-object v0, p0, Lr7/e;->w:Landroid/media/ImageWriter;

    iput-object v0, p0, Lr7/b;->c:Landroid/net/Uri;

    iget-object v1, p1, Lr7/e$a;->n:Lje/q;

    iput-object v1, p0, Lr7/b;->d:Lje/q;

    iput-object v0, p0, Lr7/b;->e:[B

    const/4 v2, 0x0

    iput-boolean v2, p0, Lr7/b;->f:Z

    iget-object v3, p1, Lr7/e$a;->o:Landroid/media/Image;

    iput-object v3, p0, Lr7/b;->g:Landroid/media/Image;

    iput v2, p0, Lr7/b;->h:I

    iput v2, p0, Lr7/b;->i:I

    iput v2, p0, Lr7/b;->j:I

    iput v2, p0, Lr7/b;->k:I

    iput-boolean v2, p0, Lr7/b;->l:Z

    iput-object v0, p0, Lr7/b;->m:Landroid/os/Handler;

    iget-object p1, p1, Lr7/e$a;->p:Lr7/b$b;

    iput-object p1, p0, Lr7/b;->t:Lr7/b$b;

    iget-object p1, v1, Lje/q;->q:Lje/r;

    iget-object p1, p1, Lje/r;->B:Landroid/util/Size;
    ...
    :cond_0
    iget-object p1, p0, Lr7/b;->g:Landroid/media/Image;
...
.method public static e(Landroid/media/Image;Landroid/util/Size;)[B
    ...
    sget-object p1, Lfe/f;->a:Ljava/lang/Boolean;
    ...
    invoke-static {v0, p1}, La5/f;->d([ILjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v11, v4, v12}, Landroidx/appcompat/widget/b;->d(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v5, v2, v4}, Lnk/g;->c(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, v2, v4}, Lnk/g;->c(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
...
.method public final f(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    invoke-static {v3, v15}, Landroidx/appcompat/view/menu/a;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v15, v4}, Landroidx/concurrent/futures/a;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v3 .. v19}, Lr7/u;->m(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;ILjava/lang/String;JIILandroid/location/Location;ZZJ)Landroid/net/Uri;
    ...
    iget-object v15, v1, Lr7/b;->m:Landroid/os/Handler;
    ...
    :try_start_3
    invoke-direct {v0, v5, v13, v14, v4}, Ls9/e$b;-><init>(Ljava/io/FileDescriptor;III)V
    ...
    new-instance v5, Ls9/e$b;

    invoke-direct {v5, v0, v13, v14, v4}, Ls9/e$b;-><init>(Ljava/lang/String;III)V
    ...
    iget-object v4, v4, Lje/q;->q:Lje/r;

    iget v4, v4, Lje/r;->u:I

    iput-object v15, v0, Ls9/e$b;->j:Landroid/os/Handler;

    move/from16 v15, p12

    invoke-virtual {v0, v15}, Ls9/e$b;->b(I)V

    invoke-virtual {v0, v4}, Ls9/e$b;->c(I)V

    invoke-virtual {v0}, Ls9/e$b;->a()Ls9/e;

    move-result-object v0

    const/4 v4, 0x0

    invoke-virtual {v0, v4}, Ls9/e;->c(Z)V

    iget v4, v0, Ls9/e;->a:I

    const/4 v5, 0x1

    if-ne v4, v5, :cond_5

    iget-object v4, v0, Ls9/e;->i:Ls9/c;

    iget v13, v4, Ls9/c;->d:I

    if-ne v13, v5, :cond_4

    iget-object v4, v4, Ls9/c;->y:Landroid/view/Surface;
    ...
    iput-object v4, v1, Lr7/e;->w:Landroid/media/ImageWriter;
    ...
    iput-boolean v4, v0, Ls9/e;->m:Z

    iget-object v4, v0, Ls9/e;->i:Ls9/c;

    iget-object v4, v4, Ls9/c;->a:Landroid/media/MediaCodec;
    ...
    iget-object v4, v1, Lr7/e;->w:Landroid/media/ImageWriter;
    ...
    invoke-virtual {v0, v4, v2}, Ls9/e;->a(I[B)V
    ...
    :goto_7
    iget-object v2, v1, Lr7/e;->w:Landroid/media/ImageWriter;
    ...
    iput-object v2, v1, Lr7/e;->w:Landroid/media/ImageWriter;
    ...
    iget-object v7, v1, Lr7/b;->d:Lje/q;

    iget-object v7, v7, Lje/q;->q:Lje/r;

    iget-object v7, v7, Lje/r;->B:Landroid/util/Size;

    move-object/from16 p6, v8

    iget-object v8, v1, Lr7/b;->m:Landroid/os/Handler;
    ...
    invoke-direct {v0, v5, v13, v14, v12}, Ls9/e$b;-><init>(Ljava/io/FileDescriptor;III)V
    ...
    new-instance v12, Ls9/e$b;

    invoke-direct {v12, v0, v13, v14, v5}, Ls9/e$b;-><init>(Ljava/lang/String;III)V

    move-object v0, v12

    :goto_9
    iget-object v1, v1, Lr7/b;->d:Lje/q;

    iget-object v1, v1, Lje/q;->q:Lje/r;

    iget v1, v1, Lje/r;->u:I

    iput-object v8, v0, Ls9/e$b;->j:Landroid/os/Handler;

    invoke-virtual {v0, v15}, Ls9/e$b;->b(I)V

    invoke-virtual {v0, v1}, Ls9/e$b;->c(I)V
    ...
    invoke-virtual {v0, v1}, Ls9/e;->c(Z)V

    const/4 v1, 0x1

    iput-boolean v1, v0, Ls9/e;->m:Z

    iget-object v1, v0, Ls9/e;->i:Ls9/c;

    iget-object v1, v1, Ls9/c;->a:Landroid/media/MediaCodec;
    ...
    invoke-static {v4, v7}, Lr7/e;->e(Landroid/media/Image;Landroid/util/Size;)[B
    ...
    invoke-virtual {v0, v1}, Ls9/e;->b([B)V
    ...
    invoke-virtual {v0, v1, v2}, Ls9/e;->a(I[B)V
    ...
    :goto_c
    invoke-static/range {p3 .. p3}, Lbn/b;->a(Landroid/os/ParcelFileDescriptor;)V
...
.method public final g()V
    ...
    iget-object v0, v14, Lr7/b;->d:Lje/q;

    iget-object v15, v0, Lje/q;->p:Ljava/lang/String;
    ...
    iget-wide v11, v0, Lje/q;->J:J

    iget-object v0, v0, Lje/q;->q:Lje/r;

    iget v10, v0, Lje/r;->J:I

    iget v8, v0, Lje/r;->u:I

    iget-object v9, v0, Lje/r;->y:Landroid/location/Location;

    iget v7, v0, Lje/r;->b0:I
    ...
    iget-object v0, v14, Lr7/e;->u:Landroid/hardware/camera2/CaptureResult;

    iget v2, v14, Lr7/b;->i:I

    iget v3, v14, Lr7/b;->j:I

    const-string v14, "buildExif: resultLen = "

    sget-object v17, Lrc/c;->a:[B

    move-object/from16 v17, v13

    new-instance v13, Lrc/d;

    invoke-direct {v13}, Lrc/d;-><init>()V
    ...
    :try_start_0
    invoke-static/range {v1 .. v11}, Lcom/android/camera/g3;->c(IIIJLandroid/location/Location;Landroid/hardware/camera2/CaptureResult;JLrc/d;Z)V
    :try_end_0
    ...
    invoke-virtual {v13, v0, v2}, Lrc/d;->g(Ljava/io/OutputStream;[B)Lrc/f;

    move-result-object v3

    const/4 v4, 0x1

    invoke-virtual {v3, v4}, Lrc/f;->a(Z)V
    ...
    invoke-static {v4, v5, v0}, Landroidx/concurrent/futures/b;->e(JLjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v15}, Lh1/c;->I(Ljava/lang/String;)Lf1/b;
    ...
    :cond_2
    invoke-static {v13}, Lr7/u;->n(Ljava/lang/String;)Z
    ...
    invoke-static {v13}, Lr7/u;->o(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v4, v13, v2}, Landroidx/activity/result/a;->e(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, v10, Lr7/b;->a:Landroid/content/Context;

    invoke-static {v2, v15, v1}, Lr7/u;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-static {v15}, Lr7/u;->C(Ljava/lang/String;)Z

    move-result v4

    iget-object v2, v10, Lr7/b;->g:Landroid/media/Image;

    iget v8, v10, Lr7/b;->i:I

    iget v6, v10, Lr7/b;->j:I
    ...
    invoke-virtual/range {v1 .. v13}, Lr7/e;->f(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    :try_start_2
    invoke-static {v0, v15}, Lu7/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    ...
    :goto_6
    iget-object v8, v12, Lr7/b;->a:Landroid/content/Context;

    iget v0, v12, Lr7/b;->i:I

    iget v1, v12, Lr7/b;->j:I
    ...
    invoke-static {v8, v15, v2}, Lr7/u;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-static/range {v1 .. v12}, Lr7/u;->y(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
    ...
    invoke-static {v0, v15}, Landroidx/appcompat/view/menu/a;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, v13, Lr7/b;->g:Landroid/media/Image;

    iget v0, v13, Lr7/b;->i:I

    iget v9, v13, Lr7/b;->j:I
    ...
    iget-object v1, v15, Lr7/b;->d:Lje/q;

    iget-boolean v1, v1, Lje/q;->D:Z

    if-eqz v1, :cond_11

    iget-object v1, v15, Lr7/b;->a:Landroid/content/Context;

    invoke-static {v1, v0}, Lcom/android/camera/d5;->e(Landroid/content/Context;Landroid/net/Uri;)Lcom/android/camera/d5;

    move-result-object v1

    if-eqz v1, :cond_10

    iget-object v2, v15, Lr7/b;->b:Lr7/q;

    check-cast v2, Lr7/i;

    const/4 v3, 0x1

    invoke-virtual {v2, v1, v3}, Lr7/i;->u(Lcom/android/camera/d5;Z)V

    goto :goto_11

    :cond_10
    iget-object v1, v15, Lr7/b;->b:Lr7/q;
    ...
    invoke-virtual/range {v1 .. v6}, Lr7/i;->p(Landroid/net/Uri;ZLjava/lang/String;IZ)V
...
.method public final run()V
    ...
    iget-object v0, p0, Lr7/b;->t:Lr7/b$b;

    iget-object v1, p0, Lr7/b;->g:Landroid/media/Image;

    iget-object v2, p0, Lr7/b;->d:Lje/q;
    ...
    iget-object v0, v0, Lje/u;->a:Lje/t;
    ...
    iget-object v1, v2, Lje/q;->L:Landroid/media/Image;

    invoke-static {v0, v1}, Lje/t;->b(Lje/t;Landroid/media/Image;)V

    invoke-virtual {v2}, Lje/q;->i()V

    invoke-static {v0, v2}, Lje/t;->c(Lje/t;Lje/q;)Z

    move-result v1

    if-eqz v1, :cond_0

    iget-object v1, v0, Lje/t;->h:Lje/t$i;

    if-eqz v1, :cond_0

    check-cast v1, Lcom/android/camera/o3$a;

    invoke-virtual {v1, v2}, Lcom/android/camera/o3$a;->a(Lje/q;)V

    :cond_0
    iget-wide v1, v2, Lje/q;->e:J

    invoke-virtual {v0, v1, v2}, Lje/t;->u(J)Lje/q;
    ...
    iget-object v5, p0, Lr7/b;->d:Lje/q;

    iget-wide v5, v5, Lje/q;->f:J
    ...
    invoke-static {v4, v0, v1}, La/c;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    invoke-virtual {v2, v3}, Ls6/g;->e([Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lr7/b;->g:Landroid/media/Image;

    iput-object v0, p0, Lr7/b;->d:Lje/q;

    iput-object v0, p0, Lr7/b;->t:Lr7/b$b;
