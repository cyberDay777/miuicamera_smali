...
.field public m:La6/b$b;

.field public n:Lcom/android/camera/effect/x;
...
.method public constructor <init>(II)V
    ...
    iput-object v0, p0, La6/h;->a:Ljava/lang/Object;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, La6/h;->e:Ljava/util/ArrayList;

    iput p1, p0, La6/h;->f:I

    iput p2, p0, La6/h;->g:I

    return-void
.end method

.method public static final a(IILjava/lang/String;)La6/h;
    .locals 7
    ...
    invoke-direct {v0, p0, p1}, La6/h;-><init>(II)V

    iget-object p0, v0, La6/h;->a:Ljava/lang/Object;

    monitor-enter p0

    :try_start_0
    iput-boolean v5, v0, La6/h;->h:Z
    ...
    :try_start_1
    iget-object p1, v0, La6/h;->a:Ljava/lang/Object;
...
.method public final b(Ljava/util/List;)V
    ...
    iget-object v0, p0, La6/h;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-boolean v1, p0, La6/h;->j:Z
    ...
    iget-object v2, p0, La6/h;->e:Ljava/util/ArrayList;
    ...
    :cond_1
    iget p1, p0, La6/h;->k:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, La6/h;->k:I

    iget-object p0, p0, La6/h;->a:Ljava/lang/Object;
...
.method public final c()Z
    ...
    invoke-virtual {p0}, La6/h;->d()V

    :try_start_0
    new-instance v0, La6/b;

    iget-object v1, p0, La6/h;->b:Landroid/opengl/EGLContext;

    iget-boolean v2, p0, La6/h;->c:Z

    invoke-direct {v0, v1, v2}, La6/b;-><init>(Landroid/opengl/EGLContext;Z)V

    iput-object v0, p0, La6/h;->l:La6/b;
    :try_end_0
    ...
    new-instance v2, La6/b$b;

    invoke-direct {v2, v0, v1}, La6/b$b;-><init>(La6/b;Ljava/lang/Object;)V

    invoke-virtual {v2}, La6/b$b;->a()V

    iput-object v2, p0, La6/h;->m:La6/b$b;
    ...
    iput-object v0, p0, La6/h;->n:Lcom/android/camera/effect/x;

    iget v1, p0, La6/h;->f:I

    iget v2, p0, La6/h;->g:I

    invoke-virtual {v0, v1, v2}, Lcom/android/camera/effect/x;->f(II)V

    const/4 v0, 0x0

    iput-object v0, p0, La6/h;->d:Ljava/lang/Object;
...
.method public final d()V
    ...
    iget-object v0, p0, La6/h;->e:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, p0, La6/h;->m:La6/b$b;
    ...
    iget-object v3, v0, La6/b$b;->b:Landroid/opengl/EGLSurface;

    iget-object v4, v0, La6/b$b;->a:La6/b;
    ...
    iget-object v4, v4, La6/b;->c:Landroid/opengl/EGLDisplay;
    ...
    iput-object v3, v0, La6/b$b;->b:Landroid/opengl/EGLSurface;

    iput-object v2, p0, La6/h;->m:La6/b$b;

    :cond_1
    iget-object v0, p0, La6/h;->n:Lcom/android/camera/effect/x;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lcom/android/camera/effect/x;->n()V

    iget-object v0, p0, La6/h;->n:Lcom/android/camera/effect/x;

    invoke-virtual {v0}, Lcom/android/gallery3d/ui/a;->m()V

    iput-object v2, p0, La6/h;->n:Lcom/android/camera/effect/x;

    :cond_2
    iget-object v0, p0, La6/h;->l:La6/b;
    ...
    iget-object v3, v0, La6/b;->c:Landroid/opengl/EGLDisplay;
    ...
    iget-object v4, v0, La6/b;->b:Landroid/opengl/EGLContext;
    ...
    iget-object v6, v0, La6/b;->c:Landroid/opengl/EGLDisplay;

    invoke-virtual {v3, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v6, v0, La6/b;->b:Landroid/opengl/EGLContext;
    ...
    iput-object v3, v0, La6/b;->b:Landroid/opengl/EGLContext;

    iget-object v6, v0, La6/b;->d:Landroid/opengl/EGLContext;
    ...
    iget-object v4, v0, La6/b;->d:Landroid/opengl/EGLContext;
    ...
    iput-object v1, v0, La6/b;->d:Landroid/opengl/EGLContext;

    :cond_5
    iget-object v1, v0, La6/b;->c:Landroid/opengl/EGLDisplay;
    ...
    iput-object v1, v0, La6/b;->c:Landroid/opengl/EGLDisplay;

    sget-object v1, Landroid/opengl/EGL14;->EGL_NO_CONTEXT:Landroid/opengl/EGLContext;

    iput-object v1, v0, La6/b;->b:Landroid/opengl/EGLContext;

    iput-object v2, p0, La6/h;->l:La6/b;
...
.method public final e()V
    ...
    iput-boolean v1, p0, La6/h;->j:Z

    iget-object v1, p0, La6/h;->a:Ljava/lang/Object;
...
.method public final f(Landroid/opengl/EGLContext;Landroid/view/Surface;)V
    ...
    :cond_2
    iput-object p1, p0, La6/h;->b:Landroid/opengl/EGLContext;

    iput-object p2, p0, La6/h;->d:Ljava/lang/Object;

    const/4 p1, 0x1

    iput-boolean p1, p0, La6/h;->c:Z

    iput-boolean p1, p0, La6/h;->i:Z

    iget-object p1, p0, La6/h;->a:Ljava/lang/Object;
...
.method public final g()V
    ...
    :goto_0
    :try_start_0
    iget-object v1, p0, La6/h;->e:Ljava/util/ArrayList;
...
.method public final run()V
    ...
    :try_start_0
    iput-boolean v2, p0, La6/h;->i:Z

    iput-boolean v2, p0, La6/h;->j:Z

    iput v2, p0, La6/h;->k:I

    const/4 v1, 0x1

    iput-boolean v1, p0, La6/h;->h:Z

    iget-object v3, p0, La6/h;->a:Ljava/lang/Object;
    ...
    :cond_0
    iget-boolean v0, p0, La6/h;->i:Z

    if-eqz v0, :cond_1

    iput-boolean v2, p0, La6/h;->i:Z

    invoke-virtual {p0}, La6/h;->c()Z
    ...
    iget-object v5, p0, La6/h;->n:Lcom/android/camera/effect/x;
    ...
    iget-object v4, v0, La6/b$b;->b:Landroid/opengl/EGLSurface;

    iget-object v0, v0, La6/b$b;->a:La6/b;

    iget-object v0, v0, La6/b;->c:Landroid/opengl/EGLDisplay;
