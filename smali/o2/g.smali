...
.method public static c(Lo2/d;Z)V
    .locals 9

    new-instance v8, Lm9/f;

    iget-object v0, p0, Lo2/d;->f:Landroid/util/Size;
    ...
    iget-object v0, p0, Lo2/d;->a:Lo2/b;

    iget v4, v0, Lo2/b;->c:I

    iget v5, v0, Lo2/b;->d:I

    iget v6, p0, Lo2/d;->i:I

    iget v7, p0, Lo2/d;->j:I

    move-object v0, v8

    move v3, p1

    invoke-direct/range {v0 .. v7}, Lm9/f;-><init>(IIZIIII)V

    iget p1, v8, Lm9/g;->a:I
    ...
    :cond_0
    iget-object p1, v8, Lm9/g;->b:Lorg/json/JSONObject;
    ...
    iget-object v0, p0, Lo2/d;->c:Landroid/hardware/HardwareBuffer;

    iget-object v2, v8, Lm9/f;->c:Ljava/util/ArrayList;
    ...
    iget-object v3, v8, Lm9/f;->d:Ljava/util/ArrayList;
...
# virtual methods
.method public final a()Lok/b;
    .locals 3

    iget-object v0, p0, Lo2/g;->a:Lok/b;
    ...
    iput-object v0, p0, Lo2/g;->a:Lok/b;
    ...
    :cond_1
    :goto_0
    iget-object p0, p0, Lo2/g;->a:Lok/b;
...
.method public final b(Lo2/d;)V
    ...
    iget-object v1, p1, Lo2/d;->g:Landroid/util/Size;
    ...
    iget-object v0, p1, Lo2/d;->c:Landroid/hardware/HardwareBuffer;
    ...
    invoke-direct {v2, v6, p0, p1}, Lcom/android/camera/p1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-direct {v0, v2}, Lbg/a;-><init>(Ljava/lang/Runnable;)V

    invoke-virtual {p0}, Lo2/g;->a()Lok/b;

    move-result-object p0

    iget-object p0, p0, Lok/b;->b:Lnk/j;
    ...
    invoke-virtual {v0, p0, v6, v7}, Lbg/a;->a(Landroid/os/Handler;J)Z

    :cond_2
    :goto_0
    iget-object p0, p1, Lo2/d;->b:Lo2/e;

    iget-boolean p0, p0, Lo2/e;->p:Z

    if-eqz p0, :cond_3

    iget-object p0, p1, Lo2/d;->c:Landroid/hardware/HardwareBuffer;
    ...
    invoke-static {v4, v5, p0, p1}, Landroidx/activity/e;->d(JLjava/lang/StringBuilder;Ljava/lang/String;)Ljava/lang/String;
