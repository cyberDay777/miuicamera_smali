...
.method public constructor <init>(Lo2/g;)V
    ...
    iput-object p1, p0, Lo2/a;->a:Lo2/g;
...
# virtual methods
.method public final a(Lo2/d;Z)V
    .locals 19
    ...
    iget-object v2, v0, Lo2/d;->b:Lo2/e;

    if-eqz p2, :cond_0

    iget-object v3, v2, Lo2/e;->m:Le0/q;

    goto :goto_0

    :cond_0
    iget-object v3, v2, Lo2/e;->l:Le0/q;
    ...
    :cond_1
    iget-object v4, v0, Lo2/d;->g:Landroid/util/Size;
    ...
    iget-wide v5, v2, Lo2/e;->a:J

    iget-object v9, v3, Le0/q;->o:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    iget-object v5, v3, Le0/q;->k:Landroid/graphics/Rect;

    :goto_1
    const-string v6, "applyAIWatermark -> "

    invoke-static {v6, v5}, La/d;->c(Ljava/lang/String;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    iget-object v11, v3, Le0/q;->a:Ljava/lang/String;

    iget-boolean v12, v3, Le0/q;->l:Z
    ...
    invoke-static {v14, v6, v15, v11}, Landroidx/appcompat/widget/b;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/HashMap;
    ...
    invoke-static {v12, v11}, Lq7/a;->s(Ljava/lang/String;Ljava/util/Map;)V

    sget-boolean v11, Lq7/b;->d:Z
    ...
    :cond_7
    :goto_3
    iget-wide v11, v2, Lo2/e;->a:J

    const/4 v6, 0x4

    new-array v6, v6, [I

    iget-object v13, v3, Le0/q;->n:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v11, v12}, La5/f;->d([ILjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v3, v3, Le0/q;->m:Landroid/graphics/Bitmap;
    ...
    invoke-static {v5}, La/e;->y([I)Landroid/graphics/Rect;
    ...
    iget-object v3, v3, Lo2/a;->a:Lo2/g;

    invoke-static {v3, v0, v2, v1}, Lo2/f;->b(Lo2/g;Lo2/d;Lcom/android/camera/effect/renders/z;Landroid/graphics/Rect;)V
