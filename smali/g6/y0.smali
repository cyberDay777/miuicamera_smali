...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    new-instance v0, Lg6/y0$a;

    invoke-direct {v0, p0}, Lg6/y0$a;-><init>(Lg6/y0;)V

    iput-object v0, p0, Lg6/y0;->k:Lg6/y0$a;

    iput-object p1, p0, Lg6/y0;->a:Lcom/android/camera/ActivityBase;

    invoke-virtual {p1}, Landroid/app/Activity;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Lg6/y0;->b:Landroid/content/Context;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lg6/y0;->c:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lg6/y0;->d:Ljava/util/ArrayList;
...
.method public final B(Ljava/lang/String;)J
    ...
    invoke-virtual {p0}, Lg6/y0;->init()V

    iget-object v0, p0, Lg6/y0;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Lg6/y0;->g:Ljava/util/concurrent/ConcurrentHashMap;

    :cond_0
    iget-object v0, p0, Lg6/y0;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Lg6/y0;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lg6/y0;->b:Landroid/content/Context;
    ...
    iget-object v1, p0, Lg6/y0;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lg6/y0;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    iget-object p0, p0, Lg6/y0;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final Bd(Ljava/lang/String;Landroid/content/Context;ZLjava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;
    .locals 19
    ...
    invoke-static {v0, v4}, Landroidx/appcompat/view/menu/a;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, v6, Lg6/y0;->a:Lcom/android/camera/ActivityBase;

    invoke-virtual {v0}, Landroidx/fragment/app/FragmentActivity;->getSupportFragmentManager()Landroidx/fragment/app/FragmentManager;

    move-result-object v0

    invoke-static {v0, v6}, Lcom/android/camera/fragment/CtaNoticeFragment;->fh(Landroidx/fragment/app/FragmentManager;Lcom/android/camera/fragment/CtaNoticeFragment$a;)Z
    ...
    :cond_0
    invoke-static/range {p2 .. p2}, La/e;->K(Landroid/content/Context;)Z
    ...
    invoke-static {v7, v0, v1}, Lcom/android/camera/f5;->b(Landroid/content/Context;IZ)V

    return-object v2

    :cond_1
    invoke-static/range {p2 .. p2}, La/e;->L(Landroid/content/Context;)Z

    move-result v0

    invoke-virtual/range {p0 .. p1}, Lg6/y0;->B(Ljava/lang/String;)J

    move-result-wide v8

    invoke-virtual/range {p0 .. p1}, Lg6/y0;->R(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v11}, Lq7/a;->s(Ljava/lang/String;Ljava/util/Map;)V

    const v10, 0x7f140c9e

    const v2, 0x7f140484

    const v11, 0x7f14048f
    ...
    invoke-virtual {v0, v3, v5}, Lle/a;->g(Ljava/lang/String;Z)Z

    move-result v0

    if-eqz v0, :cond_4

    sget-boolean v15, Ltb/b;->m:Z
    ...
    invoke-direct/range {v0 .. v5}, Lg6/w0;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v6, v2}, Landroidx/room/b;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, v6, v3}, Landroidx/appcompat/widget/d;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static/range {v7 .. v18}, Lcom/android/camera/r4;->d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Runnable;Ljava/lang/CharSequence;Ltg/a;Ljava/lang/String;Ljava/lang/Runnable;Ljava/lang/String;ZLjava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;

    move-result-object v0

    iput-object v0, v6, Lg6/y0;->l:Lmiuix/appcompat/app/AlertDialog;

    const-string v0, "attr_feature_install_wifi_show"

    invoke-static {v0}, Lq7/a;->a0(Ljava/lang/String;)V

    iget-object v0, v6, Lg6/y0;->l:Lmiuix/appcompat/app/AlertDialog;

    return-object v0

    :cond_4
    invoke-virtual/range {p0 .. p1}, Lg6/y0;->S(Ljava/lang/String;)Z
    ...
    new-instance v9, Lg6/x0;

    move-object/from16 v0, p4

    invoke-direct {v9, v6, v7, v4, v0}, Lg6/x0;-><init>(Lg6/y0;Landroid/content/Context;Ljava/lang/String;Ljava/lang/Runnable;)V
...
.method public final J0(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Lg6/y0;->e:Lcom/google/android/play/core/splitinstall/SplitInstallManager;
...
.method public final R(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object p0, p0, Lg6/y0;->h:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final S(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lg6/y0;->J0(Ljava/lang/String;)Z
    ...
    :cond_0
    iget-object v0, p0, Lg6/y0;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Lg6/y0;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Lg6/y0;->j:Lcom/google/android/play/core/splitinstall/SplitInstallStateUpdatedListener;
    ...
    iget-object p0, p0, Lg6/y0;->i:Lcom/android/camera/data/observeable/d;
...
.method public final i(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lg6/y0;->f:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final init()V
    ...
    iget-object v0, p0, Lg6/y0;->e:Lcom/google/android/play/core/splitinstall/SplitInstallManager;
    ...
    iget-object v5, p0, Lg6/y0;->b:Landroid/content/Context;

    invoke-direct {v4, v5}, Lo6/c;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v4, v5}, Lo6/b;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v4, v5}, Lo6/d;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v4, v5}, Lo6/e;-><init>(Landroid/content/Context;)V
    ...
    iget-object v4, p0, Lg6/y0;->b:Landroid/content/Context;

    new-instance v5, Ln6/c;

    invoke-direct {v5}, Ln6/c;-><init>()V
    ...
    invoke-static {v0, v1, v2, v4}, Landroidx/activity/e;->d(JLjava/lang/StringBuilder;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lg6/y0;->b:Landroid/content/Context;
    ...
    iput-object v0, p0, Lg6/y0;->e:Lcom/google/android/play/core/splitinstall/SplitInstallManager;

    iget-object v1, p0, Lg6/y0;->k:Lg6/y0$a;
    ...
    iput-object v1, p0, Lg6/y0;->i:Lcom/android/camera/data/observeable/d;
    ...
    iget-object v2, p0, Lg6/y0;->c:Ljava/util/ArrayList;
...
.method public final l()V
    ...
    iget-object v0, p0, Lg6/y0;->i:Lcom/android/camera/data/observeable/d;
    ...
    :cond_2
    iget-object v1, p0, Lg6/y0;->i:Lcom/android/camera/data/observeable/d;
    ...
    invoke-virtual {p0, v0}, Lg6/y0;->S(Ljava/lang/String;)Z
...
.method public final m(Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1}, Lg6/y0;->i(Ljava/lang/String;)V
...
.method public final p0(Ljava/lang/String;ZLandroid/content/Context;ZLjava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;
    ...
    invoke-virtual {p0, p1, p5}, Lg6/y0;->m(Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, p2, p4}, Lz0/c;->g(IZ)Ljava/lang/String;
    ...
    new-instance v5, Lg6/y0$b;

    invoke-direct {v5, p0, p1, p5}, Lg6/y0$b;-><init>(Lg6/y0;Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    invoke-static {p1}, Lq7/a;->a0(Ljava/lang/String;)V
...
.method public final unRegisterProtocol()V
    ...
    iput-object v0, p0, Lg6/y0;->b:Landroid/content/Context;

    iput-object v0, p0, Lg6/y0;->a:Lcom/android/camera/ActivityBase;
    ...
    invoke-virtual {p0, v1}, Lg6/y0;->i(Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lg6/y0;->c:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    iget-object v0, p0, Lg6/y0;->d:Ljava/util/ArrayList;
...
.method public final yc(Ljava/lang/String;)Z
    ...
    iget-object p0, p0, Lg6/y0;->c:Ljava/util/ArrayList;
