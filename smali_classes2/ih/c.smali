...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lih/c;->a:Ljava/lang/Object;

    const/16 v0, 0x10e

    iput v0, p0, Lih/c;->g:I
    ...
    iput-object v1, p0, Lih/c;->h:Lcom/faceunity/wrapper/faceunity$AvatarInfo;

    const/4 v2, 0x0

    iput-boolean v2, p0, Lih/c;->i:Z

    const/16 v2, 0x96

    new-array v2, v2, [F

    iput-object v2, p0, Lih/c;->j:[F

    const/4 v2, 0x4

    new-array v3, v2, [I

    iput-object v3, p0, Lih/c;->k:[I

    const/4 v3, 0x1

    iput v3, p0, Lih/c;->q:I

    iput-boolean v3, p0, Lih/c;->r:Z

    iput v0, p0, Lih/c;->s:I

    iput v2, p0, Lih/c;->t:I

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lih/c;->b:Ljava/util/LinkedList;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lih/c;->c:Ljava/util/LinkedList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lih/c;->d:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lih/c;->e:Ljava/util/ArrayList;
...
.method public final a(I)V
    ...
    invoke-virtual {p0, p1}, Lih/c;->c(I)V
...
.method public final b()V
    ...
    iget-object v0, p0, Lih/c;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lih/c;->d:Ljava/util/ArrayList;

    iget-object v2, p0, Lih/c;->b:Ljava/util/LinkedList;
    ...
    :cond_0
    iget-object v1, p0, Lih/c;->e:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lih/c;->e:Ljava/util/ArrayList;
...
.method public final c(I)V
    ...
    invoke-static {v1, v0}, Laj/a;->n(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final e(II)I
    ...
    invoke-static {v0, p2, p1}, Laj/a;->o(ILjava/lang/String;Ljava/lang/String;)V

    :cond_1
    iget-object p1, p0, Lih/c;->a:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    iget-object p2, p0, Lih/c;->b:Ljava/util/LinkedList;
    ...
    iget-object p1, p0, Lih/c;->c:Ljava/util/LinkedList;
    ...
    iget-object p0, p0, Lih/c;->c:Ljava/util/LinkedList;
...
.method public final f(Ljava/lang/Runnable;)V
    ...
    :try_start_0
    iget-object v1, p0, Lih/c;->b:Ljava/util/LinkedList;

    if-eqz v1, :cond_0

    iget-object p0, p0, Lih/c;->b:Ljava/util/LinkedList;
...
.method public final g(Ljava/lang/Runnable;)V
    ...
    iget-object v0, p0, Lih/c;->b:Ljava/util/LinkedList;
