...
.method public constructor <init>(Landroid/graphics/Paint;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lek/f;->g:Ljava/lang/String;

    iput-object p1, p0, Lek/f;->h:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lek/f;->i:Landroid/graphics/Rect;
...
.method public a(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lek/f;->h:Landroid/graphics/Paint;
    ...
    iget-object v3, p0, Lek/f;->i:Landroid/graphics/Rect;

    iget-object v4, p0, Lek/f;->g:Ljava/lang/String;

    if-ne v1, v2, :cond_0

    iget p0, p0, Lek/f;->j:I
...
.method public c()Landroid/util/Size;
    ...
    iget-object v0, p0, Lek/f;->g:Ljava/lang/String;

    invoke-virtual {v0}, Ljava/lang/String;->length()I

    move-result v1

    iget-object v2, p0, Lek/f;->h:Landroid/graphics/Paint;

    const/4 v3, 0x0

    iget-object v4, p0, Lek/f;->i:Landroid/graphics/Rect;
