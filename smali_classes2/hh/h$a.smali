...
.field public final synthetic l:Lhh/h;


# direct methods
.method public constructor <init>(Lhh/h;Landroid/content/Context;Landroid/view/View$OnClickListener;Landroid/widget/RelativeLayout;)V
    .locals 10

    iput-object p1, p0, Lhh/h$a;->l:Lhh/h;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    const/16 p1, 0x68

    iput p1, p0, Lhh/h$a;->a:I

    const/4 p1, 0x3

    new-array v0, p1, [I

    iput-object v0, p0, Lhh/h$a;->b:[I

    const/4 v1, 0x0

    iput-boolean v1, p0, Lhh/h$a;->k:Z

    iput-object p2, p0, Lhh/h$a;->j:Landroid/content/Context;

    iput-object p4, p0, Lhh/h$a;->c:Landroid/widget/RelativeLayout;

    new-instance p4, Landroid/widget/ImageView;

    invoke-direct {p4, p2}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object p4, p0, Lhh/h$a;->g:Landroid/widget/ImageView;
    ...
    invoke-virtual {v3, v4, v5}, Lt0/d;->a(IZ)I
    ...
    iput-object v6, p0, Lhh/h$a;->h:Landroid/widget/ImageView;
    ...
    invoke-virtual {v7, v4, v5}, Lt0/d;->a(IZ)I
    ...
    iput-object v7, p0, Lhh/h$a;->i:Landroid/widget/ImageView;
    ...
    invoke-virtual {v2, v4, v5}, Lt0/d;->a(IZ)I
    ...
    iput-object p3, p0, Lhh/h$a;->d:Landroid/widget/RelativeLayout$LayoutParams;

    new-instance p3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {p3, p1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iput-object p3, p0, Lhh/h$a;->e:Landroid/widget/RelativeLayout$LayoutParams;

    new-instance p3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {p3, p1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iput-object p3, p0, Lhh/h$a;->f:Landroid/widget/RelativeLayout$LayoutParams;
...
.method public final a(III)V
    ...
    iget-boolean v2, v0, Lhh/h$a;->k:Z

    iget-object v3, v0, Lhh/h$a;->i:Landroid/widget/ImageView;

    iget-object v4, v0, Lhh/h$a;->g:Landroid/widget/ImageView;

    iget-object v5, v0, Lhh/h$a;->h:Landroid/widget/ImageView;

    const/4 v6, 0x1

    if-nez v2, :cond_0

    iget-object v2, v0, Lhh/h$a;->c:Landroid/widget/RelativeLayout;
    ...
    iput-boolean v6, v0, Lhh/h$a;->k:Z

    :cond_0
    iget-object v2, v0, Lhh/h$a;->l:Lhh/h;

    iget-boolean v7, v2, Lhh/h;->g:Z

    if-nez v7, :cond_9

    iget-boolean v7, v2, Lhh/h;->f:Z
    ...
    invoke-direct {v1, v0}, Lhh/e;-><init>(Lhh/h$a;)V
    ...
    invoke-direct {v4, v0}, Lhh/f;-><init>(Lhh/h$a;)V
    ...
    invoke-direct {v2, v0}, Lhh/g;-><init>(Lhh/h$a;)V
    ...
    iput v8, v0, Lhh/h$a;->a:I

    iget v8, v2, Lhh/h;->e:I

    sub-int v9, v8, p1

    iget-object v12, v0, Lhh/h$a;->j:Landroid/content/Context;
    ...
    iget-wide v9, v2, Lhh/h;->d:D

    goto :goto_3

    :cond_7
    iget-wide v9, v2, Lhh/h;->a:D
    ...
    invoke-direct {v3, v0, v1, v8}, Lhh/b;-><init>(Lhh/h$a;II)V
    ...
    invoke-direct {v4, v0, v1, v8}, Lhh/c;-><init>(Lhh/h$a;II)V
    ...
    invoke-direct {v2, v0, v1, v8}, Lhh/d;-><init>(Lhh/h$a;II)V
...
.method public final b()V
    ...
    iget-object v1, p0, Lhh/h$a;->g:Landroid/widget/ImageView;

    iget-object v3, p0, Lhh/h$a;->j:Landroid/content/Context;
    ...
    iget-object v1, p0, Lhh/h$a;->h:Landroid/widget/ImageView;
    ...
    iget-object v1, p0, Lhh/h$a;->i:Landroid/widget/ImageView;
    ...
    iget-object v4, p0, Lhh/h$a;->g:Landroid/widget/ImageView;

    const/4 v5, 0x0

    aput-object v4, v3, v5

    iget-object v4, p0, Lhh/h$a;->h:Landroid/widget/ImageView;
    ...
    invoke-virtual {v2, v4, p0}, Lt0/d;->a(IZ)I
