...
.field public final Q:Lch/f$b;

.field public final U:Lch/f$c;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lch/f;->o:Ljava/lang/String;

    new-instance v1, Lch/f$b;

    invoke-direct {v1, p0}, Lch/f$b;-><init>(Lch/f;)V

    iput-object v1, p0, Lch/f;->Q:Lch/f$b;

    new-instance v1, Lch/f$c;

    invoke-direct {v1, p0}, Lch/f$c;-><init>(Lch/f;)V

    iput-object v1, p0, Lch/f;->U:Lch/f$c;

    iput-object p1, p0, Lch/f;->a:Landroid/content/Context;
    ...
    iput-object p1, p0, Lch/f;->x:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lch/f;->y:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Ljava/lang/Thread;->start()V

    new-instance p1, Landroid/os/Handler;

    iget-object v1, p0, Lch/f;->y:Landroid/os/HandlerThread;
    ...
    iput-object p1, p0, Lch/f;->M:Landroid/os/Handler;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lch/f;->q:Z

    iput-boolean p1, p0, Lch/f;->P:Z

    const/4 v1, 0x1

    iput-boolean v1, p0, Lch/f;->r:Z

    iput-boolean v1, p0, Lch/f;->t:Z

    iput-object v0, p0, Lch/f;->o:Ljava/lang/String;

    iput p1, p0, Lch/f;->m:I

    iput p1, p0, Lch/f;->n:I

    invoke-virtual {p0}, Lch/f;->c()V
...
.method public static b(I)J
    ...
    sget-object v0, Lrg/h;->d:Ljava/lang/String;
...
.method public final declared-synchronized a(JJ)V
    ...
    :try_start_0
    iget-object v0, p0, Lch/f;->g:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;
...
.method public final c()V
    ...
    iget-object v0, p0, Lch/f;->a:Landroid/content/Context;
    ...
    iput-object v0, p0, Lch/f;->u:Ljava/lang/String;
    ...
    iput-object v0, p0, Lch/f;->g:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;
    ...
    iget-object v1, p0, Lch/f;->g:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;

    invoke-direct {v0, v1}, Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;-><init>(Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;)V

    iput-object v0, p0, Lch/f;->h:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;
...
.method public final e()Z
    ...
    iget-object v3, p0, Lch/f;->o:Ljava/lang/String;
    ...
    :goto_0
    iget v3, p0, Lch/f;->m:I

    iget v4, p0, Lch/f;->n:I
...
.method public final h()V
    ...
    iget-object v1, p0, Lch/f;->x:Landroid/os/Handler;

    new-instance v2, Lch/e;

    invoke-direct {v2, p0, v0}, Lch/e;-><init>(Ljava/lang/Object;I)V
...
.method public final i(JLjava/lang/String;)V
    ...
    iput-boolean v0, p0, Lch/f;->P:Z

    iput-wide p1, p0, Lch/f;->w:J

    iget-object p1, p0, Lch/f;->M:Landroid/os/Handler;

    new-instance p2, Landroidx/room/n;

    const/16 v0, 0xc

    invoke-direct {p2, v0, p0, p3}, Landroidx/room/n;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public final k(Z)V
    ...
    invoke-direct {v1, v2, p0, p1}, Log/g;-><init>(ILjava/lang/Object;Z)V
...
.method public final l()V
    ...
    invoke-virtual {v0, v1, v2}, Lyg/b;->c(II)V
    ...
    invoke-virtual {v0, v1, v3}, Lje/c;->e(II)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v3

    iput-wide v3, p0, Lch/f;->O:J

    invoke-virtual {p0, v2}, Lch/f;->k(Z)V
    ...
    invoke-static {v0, v2, v1}, Lyg/c;->c(Landroid/view/View;ZZ)Z

    iget-object v0, p0, Lch/f;->e:Lcom/xiaomi/mimoji/gif/GifEditLayout;

    invoke-virtual {v0, v1}, Lcom/xiaomi/mimoji/gif/GifEditLayout;->setIsAllowInput(Z)V

    iget-object v0, p0, Lch/f;->M:Landroid/os/Handler;
    ...
    iget-object p0, p0, Lch/f;->u:Ljava/lang/String;
...
.method public final onSurfaceTextureAvailable(Landroid/graphics/SurfaceTexture;II)V
    ...
    iget-object p2, p0, Lch/f;->f:Landroid/view/Surface;
    ...
    iput-object p2, p0, Lch/f;->f:Landroid/view/Surface;

    iget-object p1, p0, Lch/f;->h:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;
    ...
    :cond_0
    iget-object p1, p0, Lch/f;->u:Ljava/lang/String;
    ...
    iget-wide p2, p0, Lch/f;->w:J

    invoke-virtual {p0, p2, p3, p1}, Lch/f;->i(JLjava/lang/String;)V
...
.method public final onSurfaceTextureUpdated(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lch/f;->c:Landroid/widget/ImageView;

    const/4 v1, 0x0

    invoke-static {v0, v1, v1}, Lyg/c;->c(Landroid/view/View;ZZ)Z
    ...
    invoke-static {v0, p1, v1}, Lyg/c;->c(Landroid/view/View;ZZ)Z

    iget-object p0, p0, Lch/f;->e:Lcom/xiaomi/mimoji/gif/GifEditLayout;
