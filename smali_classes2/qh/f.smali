...
.method public synthetic constructor <init>(Lcom/xiaomi/mimoji/mimojifu/fragment/edit/FragmentMimojiFuEdit;ZZ)V
    ...
    iput-object p1, p0, Lqh/f;->a:Lcom/xiaomi/mimoji/mimojifu/fragment/edit/FragmentMimojiFuEdit;

    iput-boolean p2, p0, Lqh/f;->b:Z

    iput-boolean p3, p0, Lqh/f;->c:Z
...
.method public final run()V
    ...
    iget-object v1, v0, Lqh/f;->a:Lcom/xiaomi/mimoji/mimojifu/fragment/edit/FragmentMimojiFuEdit;

    iget-boolean v2, v0, Lqh/f;->b:Z

    iget-boolean v3, v0, Lqh/f;->c:Z
    ...
    invoke-virtual {v9}, Lcom/xiaomi/mimoji/mimojifu/fragment/edit/FragmentMimojiFuEditBottomList;->nh()V
    ...
    invoke-virtual {v1}, Lcom/xiaomi/mimoji/mimojifu/fragment/edit/FragmentMimojiFuEdit;->mh()V
    ...
    sget-object v10, Lsh/e;->l:Lsh/e;

    iget-object v10, v10, Lsh/e;->c:Lih/d;

    iget-object v10, v10, Lih/d;->d:Ljava/lang/String;
    ...
    sget-object v11, Lsh/e;->l:Lsh/e;

    iget-object v11, v11, Lsh/e;->c:Lih/d;

    iget-object v11, v11, Lih/d;->a:Ljava/lang/String;
    ...
    invoke-static {v10}, Lnh/b;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v10}, Lrg/h;->f(Ljava/util/HashMap;Lcom/xiaomi/mimoji/mimojifu/bean/MimojiFuAvatarInfo;)V

    const-string v10, "attr_mimoji_type"

    invoke-virtual {v1}, Lcom/xiaomi/mimoji/mimojifu/fragment/edit/FragmentMimojiFuEdit;->oh()Ljava/lang/String;
    ...
    iget-object v10, v10, Lih/d;->a:Ljava/lang/String;

    new-instance v11, Lsg/a$b;

    invoke-direct {v11}, Lsg/a$b;-><init>()V
    ...
    invoke-static {v13, v2}, Lq7/a;->y0(Ljava/lang/String;Ljava/util/Map;)V

    const-string v2, "MIMOJI_CREATE"

    invoke-static {v2, v6}, Lg6/q;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v13, v13, Lsh/e;->c:Lih/d;

    iget-object v13, v13, Lih/d;->a:Ljava/lang/String;
    ...
    invoke-static {v12, v13}, Lg6/q;->b(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-static {v14, v8, v4, v4}, Lg6/q;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-wide/16 v14, 0x0

    invoke-static {v14, v15}, Lcom/android/camera/z2;->H4(J)V

    :cond_5
    invoke-static {v13}, Lg6/q;->q(Ljava/io/File;)Ljava/lang/String;
    ...
    iget-object v4, v1, Lcom/xiaomi/mimoji/mimojifu/fragment/edit/FragmentMimojiFuEdit;->r0:Lrg/i;

    iget-object v4, v4, Lrg/i;->c:Lcom/xiaomi/mimoji/mimojifu/bean/c;

    iput-boolean v9, v4, Ll7/g;->c:Z
    :try_end_2
    ...
    :goto_6
    iput-object v10, v11, Lsg/a$b;->o:Ljava/lang/String;

    const-string v4, "originPhoto.jpg"

    invoke-static {v10, v4}, Landroidx/concurrent/futures/a;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iput-object v4, v11, Lsg/a$b;->n:Ljava/lang/String;

    iput-object v2, v11, Lsg/a$b;->s:Ljava/lang/String;

    new-instance v2, Lsg/a;

    invoke-direct {v2, v11}, Lsg/a;-><init>(Lsg/a$b;)V

    const/4 v4, 0x7

    invoke-virtual {v2, v4}, Ll7/f;->setState(I)V
    ...
    invoke-virtual {v4, v2, v5}, Lrg/i;->k(Lsg/e;Ljava/lang/Integer;)V
    ...
    iget-object v3, v1, Lcom/xiaomi/mimoji/mimojifu/fragment/edit/FragmentMimojiFuEdit;->r0:Lrg/i;

    invoke-virtual {v3, v9}, Lrg/i;->b(I)I

    move-result v3

    invoke-interface {v2, v3}, Lwg/g;->E0(I)V

    invoke-interface {v2}, Lcom/android/camera/z4$a;->releaseRender()V

    invoke-static {}, Lsh/e;->d()Lsh/e;

    move-result-object v2

    invoke-virtual {v2, v0}, Lsh/e;->f(I)V
    ...
    :goto_7
    invoke-interface {v2, v0, v7}, Lwg/g;->Z(IZ)V
    ...
    invoke-static {v0, v7}, Lyg/c;->b(Landroid/view/View;Z)V
