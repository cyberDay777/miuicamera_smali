...
.method public final destroy()V
    ...
    iget-object v0, p0, Lzg/a;->a:Llh/b;
    ...
    invoke-virtual {v0}, Lmh/c;->c()V

    iput-object v1, p0, Lzg/a;->a:Llh/b;

    iput v2, p0, Lcom/android/camera/effect/renders/u;->mProgram:I

    :cond_0
    iget-object v0, p0, Lzg/a;->b:Llh/c;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lmh/c;->c()V

    iput-object v1, p0, Lzg/a;->b:Llh/c;
...
.method public final draw(Lk2/b;)Z
    ...
    iget-object p0, p0, Lzg/a;->b:Llh/c;

    if-eqz p0, :cond_2

    invoke-virtual {p0, v0, v1, p1}, Llh/c;->d(I[F[F)V
    ...
    iget-object p0, p0, Lzg/a;->a:Llh/b;

    if-eqz p0, :cond_2

    invoke-virtual {p0, v0, v1, p1}, Llh/b;->d(I[F[F)V
...
.method public final initShader()V
    ...
    iput-object v0, p0, Lzg/a;->a:Llh/b;
    ...
    iput-object v0, p0, Lzg/a;->b:Llh/c;

    :cond_1
    iget-object v0, p0, Lzg/a;->a:Llh/b;

    iget v1, v0, Lmh/c;->a:I

    iput v1, p0, Lcom/android/camera/effect/renders/u;->mProgram:I

    invoke-virtual {v0}, Llh/b;->b()V
