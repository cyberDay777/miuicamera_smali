...
.method public constructor <init>(Lmj/b;)V
    ...
    iput-object p1, p0, Lmj/q;->a:Lmj/b;
...
.method public final onCompleted()V
    ...
    iget-object p0, p0, Lmj/q;->a:Lmj/b;
    ...
    iget-object v0, v0, Lti/b;->k:Lorg/json/JSONObject;

    sget-object v3, Lmi/a;->a:Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, Lmj/b;->z:Lcom/faceunity/core/avatar/model/Avatar;

    if-eqz v0, :cond_4

    iget-object v4, p0, Lmj/b;->b:Lti/b;

    if-eqz v4, :cond_3

    invoke-virtual {v4}, Lti/b;->e()Ljava/util/ArrayList;

    move-result-object v4

    iget-object v5, p0, Lmj/b;->b:Lti/b;

    if-eqz v5, :cond_2

    invoke-virtual {v5}, Lti/b;->f()Ljava/util/HashMap;

    move-result-object v5

    iget-object v6, p0, Lmj/b;->b:Lti/b;

    if-eqz v6, :cond_1

    invoke-virtual {v6}, Lti/b;->g()Ljava/util/ArrayList;

    move-result-object v1

    new-instance v6, Lni/b;

    invoke-direct {v6, v0}, Lni/b;-><init>(Lcom/faceunity/core/avatar/model/Avatar;)V

    invoke-virtual {v6, v4, v5, v1}, Lni/b;->a(Ljava/util/ArrayList;Ljava/util/HashMap;Ljava/util/ArrayList;)V

    iput-object v6, p0, Lmj/b;->t:Lni/b;
    ...
    :cond_4
    iget-object v0, p0, Lmj/b;->g:Loi/c;
    ...
    invoke-virtual {p0, v12}, Lni/b;->c(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
