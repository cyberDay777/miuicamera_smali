...
.method public constructor <init>(Leh/k;)V
    ...
    iput-object v0, p0, Leh/k$b;->a:Ljava/lang/ref/WeakReference;
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object v0, v0, Leh/k$b;->a:Ljava/lang/ref/WeakReference;
    ...
    iget-object v0, v2, Leh/k;->e:Lcom/arcsoft/avatar2/AvatarEngine;
    ...
    :cond_2
    invoke-virtual {v2}, Leh/k;->c()V

    iget-object v0, v2, Leh/k;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;
    ...
    :try_start_0
    iget-object v8, v2, Leh/k;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;
    ...
    sget-object v10, Lr7/u;->e:Ljava/lang/String;
    ...
    invoke-static {v10, v11}, Lg6/q;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v10, Lr7/r$a;

    invoke-direct {v10}, Lr7/r$a;-><init>()V

    invoke-virtual {v8}, Ljava/nio/ByteBuffer;->array()[B

    move-result-object v8

    iput-object v8, v10, Lr7/b$a;->b:[B

    iput-boolean v4, v10, Lr7/b$a;->c:Z

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v11

    invoke-static {v11, v12}, Lcom/android/camera/k3;->a(J)Ljava/lang/String;

    move-result-object v8

    iput-object v8, v10, Lr7/h$a;->n:Ljava/lang/String;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v11

    iput-wide v11, v10, Lr7/b$a;->k:J
    ...
    iput v0, v10, Lr7/b$a;->f:I

    const/16 v0, 0xb4

    iput v0, v10, Lr7/b$a;->g:I

    iput-boolean v4, v10, Lr7/h$a;->o:Z

    const/4 v0, -0x1

    iput v0, v10, Lr7/h$a;->s:I

    iget-object v0, v10, Lr7/h$a;->q:Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    iget-object v8, v2, Leh/k;->f:Landroid/content/Context;

    if-eqz v0, :cond_4

    :try_start_1
    iget-object v0, v10, Lr7/h$a;->m:Landroid/net/Uri;
    ...
    iput-object v0, v10, Lr7/h$a;->m:Landroid/net/Uri;
    ...
    iget-object v0, v8, Lcom/android/camera/Camera;->U0:Lr7/i;

    new-instance v8, Lr7/r;

    invoke-direct {v8, v10}, Lr7/r;-><init>(Lr7/r$a;)V

    iget-object v10, v10, Lr7/b$a;->j:Lge/f;

    const/4 v11, 0x0

    invoke-virtual {v0, v8, v11, v10}, Lr7/i;->g(Lr7/h;Landroid/hardware/camera2/TotalCaptureResult;Lge/f;)V
    ...
    :goto_1
    invoke-interface {v6, v9, v0}, Lwg/c$a;->Rb(Ljava/lang/String;Z)V
    :try_end_1
    ...
    invoke-static {v0, v8}, Landroidx/activity/e;->e(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-interface {v6}, Lwg/c$a;->Va()V
    ...
    iget-object v1, v2, Leh/k;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;
    ...
    iget-object v1, v2, Leh/k;->u:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    sget-object v3, Lrg/h;->q:Ljava/lang/String;

    invoke-static {v3}, Lg6/q;->e(Ljava/lang/String;)V

    invoke-static {v3}, Lg6/q;->o(Ljava/lang/String;)V

    sget-object v3, Lrg/h;->r:Ljava/lang/String;
    ...
    sget-object v6, Lrg/h;->q:Ljava/lang/String;
    ...
    invoke-static {v4, v8}, Landroidx/appcompat/view/menu/a;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v7, v2, Leh/k;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;
    ...
    iget-object v4, v2, Leh/k;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;

    invoke-virtual {v4, v3}, Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;->emoProcess(Lcom/arcsoft/avatar2/emoticon/EmoInfo;)V

    iget-object v3, v2, Leh/k;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;
    ...
    invoke-interface {v0}, Lwg/c$a;->Va()V

    goto/16 :goto_d

    :cond_c
    iput-boolean v5, v2, Leh/k;->m:Z
    ...
    :cond_d
    invoke-virtual {v2, v4}, Leh/k;->b(Z)V
    ...
    iget-object v1, v2, Leh/k;->e:Lcom/arcsoft/avatar2/AvatarEngine;
    ...
    :cond_11
    iput-boolean v4, v2, Leh/k;->k:Z

    invoke-virtual {v2}, Leh/k;->d()V
    ...
    :cond_12
    invoke-virtual {v2, v5}, Leh/k;->b(Z)V
    ...
    invoke-virtual {v2, v0}, Leh/k;->a(Ljava/lang/String;)Z
    ...
    iget-object v6, v2, Leh/k;->t:Lcom/arcsoft/avatar2/emoticon/AvatarEmoManager;

    sget-object v7, Lhh/a;->D:Landroid/util/Size;
    ...
    sget-object v8, Leh/k;->x:[I

    aget v8, v8, v3

    invoke-interface {v7, v4, v3, v8}, Lwg/c$a;->v9(Lcom/arcsoft/avatar2/emoticon/EmoInfo;II)V
    ...
    :cond_1b
    iget-object v1, v2, Leh/k;->a:Ljava/lang/Object;

    monitor-enter v1

    :try_start_2
    iget v6, v2, Leh/k;->l:I
    ...
    iget v7, v2, Leh/k;->l:I

    sub-int/2addr v7, v4

    iput v7, v2, Leh/k;->l:I
    ...
    iget-object v1, v2, Leh/k;->i:Ljava/lang/String;
    ...
    iget-object v0, v2, Leh/k;->i:Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lhh/a;->g()V

    :cond_20
    iput-boolean v4, v2, Leh/k;->o:Z

    invoke-static {}, Lhh/a;->c()Lhh/a;

    move-result-object v0

    iget v0, v0, Lhh/a;->c:I
    ...
    iget-object v7, v2, Leh/k;->f:Landroid/content/Context;

    invoke-virtual {v1, v0, v7}, Lhh/a;->d(ILandroid/content/Context;)Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v10, v8, Ldh/a;->b:Ljava/lang/String;
    ...
    iget-object v8, v8, Ldh/a;->a:Ljava/util/ArrayList;
    ...
    invoke-static {v3, v7}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_23
    iget-object v11, v2, Leh/k;->r:Lgh/b;

    iget-object v12, v2, Leh/k;->e:Lcom/arcsoft/avatar2/AvatarEngine;

    invoke-static {}, Lhh/a;->c()Lhh/a;

    move-result-object v13

    iget-object v13, v13, Lhh/a;->i:Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigValue;

    iget v13, v13, Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigValue;->gender:I

    sget-object v21, Leh/k;->w:[F

    iput-boolean v9, v11, Lgh/b;->q:Z

    iput-boolean v9, v11, Lgh/b;->r:Z
    ...
    iget-object v3, v11, Lgh/b;->o:[F

    iput-object v3, v11, Lgh/b;->p:[F

    goto/16 :goto_9

    :pswitch_0
    iget-object v3, v11, Lgh/b;->f:[F

    iput-object v3, v11, Lgh/b;->p:[F

    iput-boolean v4, v11, Lgh/b;->r:Z

    goto :goto_9

    :pswitch_1
    iget-object v3, v11, Lgh/b;->g:[F
    ...
    :cond_29
    :pswitch_5
    iget-object v3, v11, Lgh/b;->l:[F

    iput-object v3, v11, Lgh/b;->p:[F

    iput-boolean v4, v11, Lgh/b;->q:Z
    ...
    iget-object v3, v11, Lgh/b;->m:[F

    goto :goto_8

    :cond_2c
    iget-object v3, v11, Lgh/b;->n:[F
    ...
    :cond_2d
    iget-object v3, v11, Lgh/b;->a:[F

    iput-object v3, v11, Lgh/b;->p:[F

    :goto_9
    iget-boolean v3, v11, Lgh/b;->q:Z

    if-eqz v3, :cond_2f

    iget-object v3, v11, Lgh/b;->s:Ljava/util/ArrayList;
    ...
    iput-object v3, v11, Lgh/b;->s:Ljava/util/ArrayList;
    ...
    :cond_2f
    iget-boolean v3, v11, Lgh/b;->r:Z

    if-eqz v3, :cond_31

    iget-object v3, v11, Lgh/b;->t:Ljava/util/ArrayList;
    ...
    iput-object v3, v11, Lgh/b;->t:Ljava/util/ArrayList;
    ...
    :goto_a
    iget-object v1, v2, Leh/k;->h:Landroid/os/Handler;

    invoke-virtual {v1}, Landroid/os/Handler;->obtainMessage()Landroid/os/Message;

    move-result-object v1

    iget-boolean v4, v2, Leh/k;->n:Z

    if-eqz v4, :cond_32

    const/4 v1, 0x0

    iput-boolean v1, v2, Leh/k;->m:Z

    iput-boolean v1, v2, Leh/k;->n:Z

    iput-boolean v1, v2, Leh/k;->o:Z

    invoke-static {}, Lhh/a;->c()Lhh/a;

    move-result-object v1

    invoke-virtual {v1}, Lhh/a;->g()V

    invoke-static {}, Lhh/a;->c()Lhh/a;

    move-result-object v1

    iget-object v1, v1, Lhh/a;->k:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v2, v8}, Leh/k;->e(Ljava/util/ArrayList;)V

    const/4 v0, 0x1

    invoke-virtual {v2, v0}, Leh/k;->b(Z)V
    ...
    iget-boolean v9, v2, Leh/k;->m:Z

    if-eqz v9, :cond_33

    const/4 v4, 0x0

    iput-boolean v4, v2, Leh/k;->m:Z
    ...
    iget-object v4, v4, Lhh/a;->k:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, v2, Leh/k;->h:Landroid/os/Handler;
    ...
    iget-object v3, v2, Leh/k;->h:Landroid/os/Handler;
