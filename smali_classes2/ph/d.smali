...
# static fields
.field public static volatile b:Lph/d;
...
.method public static b(Lorg/json/JSONObject;I)Lih/j0;
    .locals 10
    ...
    new-instance v8, Lih/j0;

    invoke-direct {v8}, Lih/j0;-><init>()V
    ...
    :cond_2
    iput p1, v8, Lih/j0;->h:I

    iput v5, v8, Lih/j0;->k:I
    ...
    iput-object p1, v8, Lih/j0;->f:Ljava/lang/String;
    ...
    :try_start_1
    const-class v3, Lcom/android/camera/e4;
    ...
    :cond_6
    iput-object v2, v8, Lih/j0;->j:[Ljava/lang/Integer;
    ...
    :cond_9
    iput-object v1, v8, Lih/j0;->i:[Ljava/lang/String;
    ...
    :cond_a
    iput-object v9, v8, Lih/j0;->l:[Ljava/lang/Integer;
    :try_end_2
...
.method public final a(ILjava/lang/Object;)Ljava/util/ArrayList;
    ...
    instance-of v1, p2, Ljh/b$b;

    if-eqz v1, :cond_0

    check-cast p2, Ljh/b$b;
    ...
    :goto_0
    iget-object p0, p0, Lph/d;->a:Lorg/json/JSONObject;
    ...
    invoke-static {v1, p1}, Lph/d;->b(Lorg/json/JSONObject;I)Lih/j0;
