...
.field public static final m:Lfb/x;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lfb/x;->g:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lfb/x;->h:Ljava/util/regex/Pattern;
    ...
    sput-object v1, Lfb/x;->i:[Ljava/lang/String;
    ...
    sput-object v1, Lfb/x;->j:Ljava/util/TimeZone;

    sget-object v3, Ljava/util/Locale;->US:Ljava/util/Locale;

    sput-object v3, Lfb/x;->k:Ljava/util/Locale;

    new-instance v4, Ljava/text/SimpleDateFormat;

    invoke-direct {v4, v2, v3}, Ljava/text/SimpleDateFormat;-><init>(Ljava/lang/String;Ljava/util/Locale;)V

    sput-object v4, Lfb/x;->l:Ljava/text/SimpleDateFormat;
...
.method public constructor <init>()V
    ...
    .line 2
    iput-boolean v0, p0, Lfb/x;->f:Z

    .line 3
    sget-object v0, Lfb/x;->k:Ljava/util/Locale;

    iput-object v0, p0, Lfb/x;->b:Ljava/util/Locale;
...
.method public constructor <init>(Ljava/util/TimeZone;Ljava/util/Locale;Ljava/lang/Boolean;Z)V
    ...
    .line 6
    iput-object p1, p0, Lfb/x;->a:Ljava/util/TimeZone;

    .line 7
    iput-object p2, p0, Lfb/x;->b:Ljava/util/Locale;

    .line 8
    iput-object p3, p0, Lfb/x;->c:Ljava/lang/Boolean;

    .line 9
    iput-boolean p4, p0, Lfb/x;->f:Z
...
.method public static n(Ljava/lang/StringBuffer;I)V
    ...
    :cond_1
    invoke-static {p0, v0}, Lfb/x;->m(Ljava/lang/StringBuffer;I)V
    ...
    :goto_1
    invoke-static {p0, p1}, Lfb/x;->m(Ljava/lang/StringBuffer;I)V
...
.method public final c(Ljava/util/TimeZone;)Ljava/util/Calendar;
    ...
    iget-object v0, p0, Lfb/x;->d:Ljava/util/Calendar;

    if-nez v0, :cond_0

    sget-object v0, Lfb/x;->n:Ljava/util/GregorianCalendar;
    ...
    iput-object v0, p0, Lfb/x;->d:Ljava/util/Calendar;
    ...
    :cond_1
    invoke-virtual {p0}, Lfb/x;->isLenient()Z
...
.method public final clone()Ljava/lang/Object;
    ...
    iget-object v1, p0, Lfb/x;->a:Ljava/util/TimeZone;

    iget-object v2, p0, Lfb/x;->c:Ljava/lang/Boolean;

    iget-boolean v3, p0, Lfb/x;->f:Z

    iget-object p0, p0, Lfb/x;->b:Ljava/util/Locale;

    invoke-direct {v0, v1, p0, v2, v3}, Lfb/x;-><init>(Ljava/util/TimeZone;Ljava/util/Locale;Ljava/lang/Boolean;Z)V
...
.method public final format(Ljava/util/Date;Ljava/lang/StringBuffer;Ljava/text/FieldPosition;)Ljava/lang/StringBuffer;
    ...
    iget-object p3, p0, Lfb/x;->a:Ljava/util/TimeZone;

    if-nez p3, :cond_0

    sget-object p3, Lfb/x;->j:Ljava/util/TimeZone;

    :cond_0
    invoke-virtual {p0, p3}, Lfb/x;->c(Ljava/util/TimeZone;)Ljava/util/Calendar;
    ...
    invoke-static {p2, v1}, Lfb/x;->n(Ljava/lang/StringBuffer;I)V
    ...
    invoke-static {p2, v1}, Lfb/x;->m(Ljava/lang/StringBuffer;I)V
    ...
    invoke-static {p2, p1}, Lfb/x;->m(Ljava/lang/StringBuffer;I)V
    ...
    :cond_6
    invoke-static {p2, v0}, Lfb/x;->m(Ljava/lang/StringBuffer;I)V
...
.method public final getTimeZone()Ljava/util/TimeZone;
    ...
    iget-object p0, p0, Lfb/x;->a:Ljava/util/TimeZone;
...
.method public final isLenient()Z
    ...
    iget-object p0, p0, Lfb/x;->c:Ljava/lang/Boolean;
...
.method public final k(Ljava/lang/String;)Ljava/util/Date;
    ...
    iget-object v3, v0, Lfb/x;->a:Ljava/util/TimeZone;
    ...
    :cond_0
    sget-object v3, Lfb/x;->j:Ljava/util/TimeZone;

    :goto_0
    invoke-virtual {v0, v3}, Lfb/x;->c(Ljava/util/TimeZone;)Ljava/util/Calendar;
    ...
    sget-object v2, Lfb/x;->g:Ljava/util/regex/Pattern;
    ...
    invoke-static/range {p1 .. p1}, Lfb/x;->j(Ljava/lang/String;)I

    move-result v0

    invoke-static {v5, v1}, Lfb/x;->d(ILjava/lang/String;)I

    move-result v2

    add-int/lit8 v6, v2, -0x1

    invoke-static {v4, v1}, Lfb/x;->d(ILjava/lang/String;)I
    ...
    :cond_2
    sget-object v6, Lfb/x;->h:Ljava/util/regex/Pattern;
    ...
    invoke-static {v12, v1}, Lfb/x;->d(ILjava/lang/String;)I
    ...
    invoke-static {v6, v1}, Lfb/x;->d(ILjava/lang/String;)I
    ...
    invoke-static {v15, v1}, Lfb/x;->d(ILjava/lang/String;)I
    ...
    invoke-static {v2, v1}, Lfb/x;->d(ILjava/lang/String;)I
    ...
    iget-object v0, v0, Lfb/x;->c:Ljava/lang/Boolean;
...
.method public final l(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    ...
    :try_start_0
    invoke-virtual {p0, p1}, Lfb/x;->k(Ljava/lang/String;)Ljava/util/Date;
    ...
    sget-object v0, Lja/e;->b:Ljava/lang/String;
    ...
    :cond_b
    iget-object v0, p0, Lfb/x;->e:Ljava/text/DateFormat;

    if-nez v0, :cond_10

    sget-object v0, Lfb/x;->l:Ljava/text/SimpleDateFormat;

    iget-object v1, p0, Lfb/x;->a:Ljava/util/TimeZone;

    iget-object v2, p0, Lfb/x;->c:Ljava/lang/Boolean;

    sget-object v3, Lfb/x;->k:Ljava/util/Locale;

    iget-object v4, p0, Lfb/x;->b:Ljava/util/Locale;
    ...
    sget-object v1, Lfb/x;->j:Ljava/util/TimeZone;
    ...
    :cond_f
    iput-object v0, p0, Lfb/x;->e:Ljava/text/DateFormat;

    :cond_10
    iget-object p0, p0, Lfb/x;->e:Ljava/text/DateFormat;
...
.method public final parse(Ljava/lang/String;)Ljava/util/Date;
    ...
    .line 3
    invoke-virtual {p0, p1, v0}, Lfb/x;->l(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    ...
    .line 5
    sget-object v2, Lfb/x;->i:[Ljava/lang/String;
...
.method public final parse(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    ...
    .line 15
    :try_start_0
    invoke-virtual {p0, p1, p2}, Lfb/x;->l(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
...
.method public final setLenient(Z)V
    ...
    iget-object v0, p0, Lfb/x;->c:Ljava/lang/Boolean;
    ...
    iput-object p1, p0, Lfb/x;->c:Ljava/lang/Boolean;

    const/4 p1, 0x0

    iput-object p1, p0, Lfb/x;->e:Ljava/text/DateFormat;
...
.method public final setTimeZone(Ljava/util/TimeZone;)V
    ...
    iget-object v0, p0, Lfb/x;->a:Ljava/util/TimeZone;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lfb/x;->a:Ljava/util/TimeZone;

    aput-object v2, v0, v1

    const/4 v1, 0x2

    iget-object v2, p0, Lfb/x;->b:Ljava/util/Locale;
