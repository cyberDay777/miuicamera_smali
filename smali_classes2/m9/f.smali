...
.method public constructor <init>(IIZIIII)V
    ...
    iput-object v4, v0, Lm9/f;->c:Ljava/util/ArrayList;

    new-instance v5, Ljava/util/ArrayList;

    invoke-direct {v5}, Ljava/util/ArrayList;-><init>()V

    iput-object v5, v0, Lm9/f;->d:Ljava/util/ArrayList;

    iput v2, v0, Lm9/f;->e:I

    iput v3, v0, Lm9/f;->f:I

    invoke-static {}, Lcom/android/camera/effect/t;->getInstance()Lcom/android/camera/effect/t;

    move-result-object v6

    invoke-virtual {v6}, Lcom/android/camera/effect/t;->getCvEffectForPreview()I
    ...
    invoke-virtual {v7}, Lcom/android/camera/effect/t;->getToneEffectForPreview()I
    ...
    invoke-virtual {v8}, Lcom/android/camera/effect/t;->geVibranceEffectForPreview()I
    ...
    invoke-virtual {v9}, Lcom/android/camera/effect/t;->gePortraitEffectForPreview()I
    ...
    invoke-virtual {v10}, Lcom/android/camera/effect/t;->isFilterSoftFocusNeeded()Z
    ...
    invoke-virtual {v11}, Lcom/android/camera/effect/t;->isFilterBlackSoftNeeded()Z
    ...
    invoke-virtual {v12}, Lcom/android/camera/effect/t;->isFilterWhiteSoftNeeded()Z
    ...
    sget v14, Lcom/android/camera/effect/v;->h:I

    if-eq v7, v14, :cond_2

    iget v13, v0, Lm9/g;->a:I

    or-int/2addr v13, v15

    iput v13, v0, Lm9/g;->a:I

    :cond_2
    sget v13, Lcom/android/camera/effect/v;->i:I
    ...
    :cond_3
    sget v15, Lcom/android/camera/effect/v;->j:I

    if-eq v9, v15, :cond_4

    iget v2, v0, Lm9/g;->a:I

    or-int/lit8 v2, v2, 0x10

    iput v2, v0, Lm9/g;->a:I
    ...
    invoke-static/range {p4 .. p4}, Lm9/e;->b(I)V
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/camera/effect/t;->isIndiaColorLookupTableAvailable()Z
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/android/camera/effect/t;->getAiColorCorrectionVersion()I
    ...
    invoke-virtual {v9, v1}, Lcom/android/camera/effect/t;->isFilterDarkNeeded(I)Z
    ...
    invoke-virtual {v9, v1}, Lcom/android/camera/effect/t;->isFilterNoiseNeeded(I)Z
    ...
    invoke-virtual {v9, v1}, Lcom/android/camera/effect/t;->isFilterSharpenNeeded(I)Z
    ...
    invoke-virtual {v2}, Lcom/android/camera/effect/t;->isIndiaColorLookupTableAvailable()Z
    ...
    invoke-virtual {v9}, Lcom/android/camera/effect/t;->getAiColorCorrectionVersion()I
    ...
    invoke-virtual {v10, v6}, Lcom/android/camera/effect/t;->getCvStyleEffectDegree(I)I
    ...
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->isCvStyleDarkNeeded()Z
    ...
    invoke-virtual {v6}, Lcom/android/camera/effect/t;->getAiColorCorrectionVersion()I
    ...
    invoke-virtual {v9, v7}, Lcom/android/camera/effect/t;->getDegree(I)I
    ...
    invoke-virtual {v7, v8}, Lcom/android/camera/effect/t;->getVibranceDegree(I)I
    ...
    invoke-virtual {v6}, Lcom/android/camera/effect/t;->isIndiaColorLookupTableAvailable()Z
    ...
    invoke-virtual {v7}, Lcom/android/camera/effect/t;->getAiColorCorrectionVersion()I
    ...
    invoke-virtual {v8, v1}, Lcom/android/camera/effect/t;->getPortraitStyleDegree(I)I
    ...
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->getPortraitStyleDarkStrength()F
    ...
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->getPortraitStyleNoiseStrength()F
    ...
    invoke-virtual/range {p0 .. p0}, Lm9/f;->c()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->getEffectAttribute()Lcom/android/camera/effect/u;
    ...
    iget-object v1, v1, Lcom/android/camera/effect/u;->a:Landroid/graphics/RectF;

    invoke-direct {v4, v1}, Landroid/graphics/RectF;-><init>(Landroid/graphics/RectF;)V

    sub-int v1, p6, p7

    invoke-static {v4, v1}, Lm9/f;->b(Landroid/graphics/RectF;I)V
    ...
    iget-object v4, v1, Lcom/android/camera/effect/u;->b:Landroid/graphics/PointF;

    invoke-direct {v2, v4}, Landroid/graphics/PointF;-><init>(Landroid/graphics/PointF;)V

    sub-int v4, p6, p7

    invoke-static {v4, v2}, Lm9/f;->a(ILandroid/graphics/PointF;)V

    new-instance v5, Landroid/graphics/PointF;

    iget-object v6, v1, Lcom/android/camera/effect/u;->c:Landroid/graphics/PointF;

    invoke-direct {v5, v6}, Landroid/graphics/PointF;-><init>(Landroid/graphics/PointF;)V

    invoke-static {v4, v5}, Lm9/f;->a(ILandroid/graphics/PointF;)V
    ...
    iget v1, v1, Lcom/android/camera/effect/u;->e:F
    ...
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->isFilterSoftFocusNeeded()Z
    ...
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->isFilterBlackSoftNeeded()Z
    ...
    invoke-virtual {v1}, Lcom/android/camera/effect/t;->isFilterWhiteSoftNeeded()Z
...
.method public static a(ILandroid/graphics/PointF;)V
    ...
    invoke-static {p1, p0, v0}, Landroidx/constraintlayout/core/b;->b(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method public static b(Landroid/graphics/RectF;I)V
    ...
    invoke-static {p0, p1, v0}, Landroidx/constraintlayout/core/b;->b(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method public final c()Ljava/lang/String;
    ...
    iget-object v5, v1, Lcom/android/camera/effect/u;->a:Landroid/graphics/RectF;

    invoke-direct {v2, v5}, Landroid/graphics/RectF;-><init>(Landroid/graphics/RectF;)V

    sub-int/2addr p0, v4

    invoke-static {v2, p0}, Lm9/f;->b(Landroid/graphics/RectF;I)V
    ...
    iget-object v5, v1, Lcom/android/camera/effect/u;->b:Landroid/graphics/PointF;
    ...
    invoke-virtual {v6}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->X0()Z
    ...
    invoke-static {p0, v2}, Lm9/f;->a(ILandroid/graphics/PointF;)V

    invoke-static {p0, v5}, Lm9/f;->a(ILandroid/graphics/PointF;)V
    ...
    iget p0, v1, Lcom/android/camera/effect/u;->e:F
    ...
    iget p0, v1, Lcom/android/camera/effect/u;->d:I
    ...
    invoke-static {v0, v1, v2, p0}, Landroidx/constraintlayout/core/a;->g(Ljava/lang/StringBuilder;DLjava/lang/String;)Ljava/lang/String;
