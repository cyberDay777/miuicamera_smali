...
.field public final l:Lcom/android/camera/ui/v0;

.field public m:Lcom/android/camera/ActivityBase;

.field public final n:Ld7/j1;

.field public o:Lwg/c;
...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput v0, p0, Lfh/c;->f:I

    const-string v0, ""

    iput-object v0, p0, Lfh/c;->j:Ljava/lang/String;

    iput-object v0, p0, Lfh/c;->k:Ljava/lang/String;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lfh/c;->t:Ljava/lang/Object;

    const/4 v0, 0x1

    new-array v1, v0, [I

    iput-object v1, p0, Lfh/c;->u:[I

    iput-boolean v0, p0, Lfh/c;->y:Z

    const/4 v0, -0x1

    iput v0, p0, Lfh/c;->O:I

    new-instance v0, Lk2/p;

    invoke-direct {v0}, Lk2/p;-><init>()V

    iput-object v0, p0, Lfh/c;->U:Lk2/p;

    new-instance v0, Lfh/c$b;

    invoke-direct {v0}, Lfh/c$b;-><init>()V

    iput-object v0, p0, Lfh/c;->V:Lfh/c$b;
    ...
    iput-object p1, p0, Lfh/c;->m:Lcom/android/camera/ActivityBase;

    iget-object v0, p1, Lcom/android/camera/ActivityBase;->b0:Lcom/android/camera/ui/v0;

    iput-object v0, p0, Lfh/c;->l:Lcom/android/camera/ui/v0;
    ...
    iput-object v0, p0, Lfh/c;->b:Landroid/content/Context;

    invoke-static {}, Ld7/j1;->a()Ld7/j1;

    move-result-object v0

    iput-object v0, p0, Lfh/c;->n:Ld7/j1;

    invoke-static {}, Lwg/c;->a()Lwg/c;

    move-result-object v0

    iput-object v0, p0, Lfh/c;->o:Lwg/c;
    ...
    iput-object v2, p0, Lfh/c;->p:Landroid/os/Handler;
    ...
    iput-object v2, p0, Lfh/c;->q:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lfh/c;->r:Landroid/os/Handler;
    ...
    iput-object p1, p0, Lfh/c;->a:Lrg/i;

    new-instance v0, Lfh/c$a;

    invoke-direct {v0}, Lfh/c$a;-><init>()V

    iput-object v0, p0, Lfh/c;->w:Lfh/c$a;

    iput-boolean v1, p1, Lrg/i;->b:Z
...
.method public final A(I)V
    ...
    iput p1, p0, Lfh/c;->f:I

    iget-object p0, p0, Lfh/c;->o:Lwg/c;

    if-eqz p0, :cond_0

    invoke-interface {p0, p1}, Lwg/c;->A(I)V
...
.method public final Ag(Landroid/graphics/Rect;IIZ[IZZ)Z
    ...
    invoke-virtual {v4, v5}, Lc1/a;->a(Ljava/lang/Class;)Lc1/d;

    move-result-object v4

    check-cast v4, Lrg/i;

    iget-object v5, v0, Lfh/c;->e:Lcom/arcsoft/avatar2/RecordModule;
    ...
    invoke-virtual {v4}, Lrg/i;->d()Z

    move-result v5

    if-nez v5, :cond_8

    invoke-virtual {v4}, Lrg/i;->e()Z
    ...
    iget-object v1, v0, Lfh/c;->e:Lcom/arcsoft/avatar2/RecordModule;
    ...
    iget-object v11, v0, Lfh/c;->e:Lcom/arcsoft/avatar2/RecordModule;

    const/16 v12, 0x5a

    iget-boolean v13, v0, Lfh/c;->h:Z

    iget v14, v0, Lfh/c;->f:I

    const/4 v15, 0x0

    const/16 v16, 0x0

    iget-object v1, v0, Lfh/c;->u:[I

    const/16 v18, 0x0

    invoke-virtual/range {p0 .. p0}, Lfh/c;->l()Z

    move-result v5

    if-eqz v5, :cond_3

    iget v5, v0, Lfh/c;->O:I
    ...
    iget-object v1, v0, Lfh/c;->l:Lcom/android/camera/ui/v0;

    invoke-interface {v1}, Lcom/android/camera/ui/v0;->X0()Lcom/android/gallery3d/ui/g;

    move-result-object v9

    invoke-interface {v9}, Lcom/android/gallery3d/ui/g;->d()V

    iget-object v10, v0, Lfh/c;->U:Lk2/p;
    ...
    :goto_4
    iget-object v9, v0, Lfh/c;->e:Lcom/arcsoft/avatar2/RecordModule;

    const/16 v10, 0x5a

    iget-boolean v11, v0, Lfh/c;->h:Z

    iget v12, v0, Lfh/c;->f:I

    const/4 v13, 0x0

    const/4 v14, 0x0

    iget-object v15, v0, Lfh/c;->u:[I
...
.method public final B(Z)V
    ...
    invoke-static {v1, p1}, Lcom/android/camera/z2;->A4(ILjava/lang/String;)V

    goto :goto_2

    :cond_4
    iget-boolean v1, v2, La1/u0;->l:Z
    ...
    invoke-static {p1, v1}, Lcom/android/camera/z2;->A4(ILjava/lang/String;)V
...
.method public final I(Landroid/media/Image;)I
    ...
    iput-object p1, p0, Lfh/c;->o:Lwg/c;
    ...
    :cond_2
    iget-object p1, p0, Lfh/c;->a:Lrg/i;

    iget-boolean p1, p1, Lrg/i;->b:Z
    ...
    :cond_3
    iget-object v0, p0, Lfh/c;->o:Lwg/c;
    ...
    iget-object p1, p0, Lfh/c;->t:Ljava/lang/Object;

    monitor-enter p1

    :try_start_1
    iget-object v3, p0, Lfh/c;->c:Lcom/arcsoft/avatar2/AvatarEngine;

    if-eqz v3, :cond_4

    const/16 v5, 0x5a

    iget-boolean v6, p0, Lfh/c;->h:Z

    iget v7, p0, Lfh/c;->g:I
    ...
    iget-object p1, p0, Lfh/c;->o:Lwg/c;

    invoke-interface {p1, v1}, Lwg/c;->vc(Z)V

    iget-object p0, p0, Lfh/c;->o:Lwg/c;

    invoke-interface {p0, v10}, Lwg/c;->K0(Z)V
    ...
    invoke-interface {p1, v1}, Lwg/c;->K0(Z)V

    iget-object p0, p0, Lfh/c;->o:Lwg/c;

    invoke-interface {p0, v10}, Lwg/c;->vc(Z)V
    ...
    :cond_8
    invoke-virtual {p0, v4}, Lfh/c;->R(Lcom/arcsoft/avatar2/util/ASVLOFFSCREEN;)V
    ...
    iget-object p1, p0, Lfh/c;->c:Lcom/arcsoft/avatar2/AvatarEngine;

    iget v0, p0, Lfh/c;->g:I

    iget v1, p0, Lfh/c;->f:I

    iget-boolean p0, p0, Lfh/c;->h:Z

    invoke-static {v0, v1, p0}, Lrg/h;->b(IIZ)I
    ...
    iget p1, p0, Lfh/c;->Q:I

    if-lez p1, :cond_a

    sub-int/2addr p1, v10

    iput p1, p0, Lfh/c;->Q:I
    ...
    iget-object v3, p0, Lfh/c;->a:Lrg/i;
    ...
    invoke-virtual {v3, v0}, Lrg/i;->a(Ljava/lang/Integer;)Lsg/e;
    ...
    iget-object p0, p1, Lsg/a;->x:Ljava/lang/String;
...
.method public final J6(Lsg/a;I)V
    ...
    iget-object p0, p1, Lsg/a;->k:Ljava/lang/String;
...
.method public final Lc(Lsg/b;Z)V
    ...
    iget-object p0, p0, Lfh/c;->a:Lrg/i;

    const/4 v0, 0x0

    if-eqz p1, :cond_1

    iget-object v1, p1, Lsg/b;->a:Lcom/arcsoft/avatar2/BackgroundInfo;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, v0, p2}, Lrg/i;->k(Lsg/e;Ljava/lang/Integer;)V
...
.method public final R(Lcom/arcsoft/avatar2/util/ASVLOFFSCREEN;)V
    ...
    invoke-interface {v0, v2}, Lwg/c;->vc(Z)V

    iget-object v0, p0, Lfh/c;->o:Lwg/c;

    invoke-interface {v0, v1}, Lwg/c;->K0(Z)V

    :cond_0
    iget-object v0, p0, Lfh/c;->t:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    invoke-virtual {p0}, Lfh/c;->i()V

    iget-object v3, p0, Lfh/c;->e:Lcom/arcsoft/avatar2/RecordModule;

    if-eqz v3, :cond_1

    iget v4, p0, Lfh/c;->g:I

    iget v5, p0, Lfh/c;->f:I

    iget-boolean v6, p0, Lfh/c;->h:Z

    invoke-static {v4, v5, v6}, Lrg/h;->b(IIZ)I

    move-result v4

    invoke-virtual {p0}, Lfh/c;->l()Z
    ...
    iput-boolean p1, p0, Lfh/c;->P:Z

    const/16 v0, 0xa

    if-eqz p1, :cond_2

    iget p1, p0, Lfh/c;->O:I

    if-eqz p1, :cond_3

    iput v1, p0, Lfh/c;->O:I
    ...
    :goto_2
    iget-boolean v3, p0, Lfh/c;->y:Z

    if-eq v3, p1, :cond_7

    iput-boolean p1, p0, Lfh/c;->y:Z
    ...
    :cond_6
    invoke-virtual {p0, v1}, Lfh/c;->B(Z)V
...
.method public final X9(Lsg/a;Z)Z
    ...
    iget-object v2, p1, Lsg/a;->x:Ljava/lang/String;
    ...
    iput v3, p0, Lfh/c;->O:I

    :cond_2
    iget-object v3, p0, Lfh/c;->a:Lrg/i;

    invoke-virtual {v3, p1, v0}, Lrg/i;->k(Lsg/e;Ljava/lang/Integer;)V

    iget-object v0, p1, Lsg/a;->j:Ljava/lang/String;
    ...
    invoke-static {v5, v0, v6, v3}, Landroidx/appcompat/graphics/drawable/a;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lfh/c;->t:Ljava/lang/Object;

    monitor-enter v4

    :try_start_0
    iget-object v5, p0, Lfh/c;->e:Lcom/arcsoft/avatar2/RecordModule;

    sget-object v6, Lhh/a;->t:Ljava/lang/String;

    iget-object v7, p0, Lfh/c;->w:Lfh/c$a;
    ...
    iget-object v5, p0, Lfh/c;->j:Ljava/lang/String;
    ...
    :goto_0
    iput-object v6, p0, Lfh/c;->k:Ljava/lang/String;
    ...
    invoke-static {v3}, Lhh/a;->e(Ljava/lang/String;)Z
    ...
    iget-object p1, p0, Lfh/c;->e:Lcom/arcsoft/avatar2/RecordModule;
    ...
    invoke-static {p1, v2, v2}, Lq7/a;->v0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    iget-object v0, p1, Lsg/a;->d:Ljava/util/List;
    ...
    iput-object v0, p1, Lsg/a;->d:Ljava/util/List;

    iget-boolean v0, p1, Lsg/a;->h:Z
    ...
    invoke-static {v0, v2, v2}, Lq7/a;->v0(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget v0, p1, Lsg/a;->e:I

    if-ltz v0, :cond_8

    iget v2, p1, Lsg/a;->f:I

    if-lez v2, :cond_8

    iget-object v2, p0, Lfh/c;->c:Lcom/arcsoft/avatar2/AvatarEngine;

    iget-object p1, p1, Lsg/a;->d:Ljava/util/List;
    ...
    iget-object v0, p0, Lfh/c;->d:Lsg/b;
    ...
    invoke-virtual {p0, v2, v0}, Lrg/i;->k(Lsg/e;Ljava/lang/Integer;)V
...
.method public final be()V
    ...
    iput-object v0, p0, Lfh/c;->i:Landroid/util/Size;
    ...
    invoke-direct {v0, p0, v1}, Lcom/xiaomi/microfilm/vlogpro/mode/c;-><init>(Ljava/lang/Object;I)V

    iget-object p0, p0, Lfh/c;->l:Lcom/android/camera/ui/v0;
...
.method public final i()V
    ...
    iget-object v1, p0, Lfh/c;->a:Lrg/i;

    iget-boolean v2, v1, Lrg/i;->d:Z
    ...
    iget-object v2, p0, Lfh/c;->e:Lcom/arcsoft/avatar2/RecordModule;
    ...
    invoke-virtual {v1, v5}, Lrg/i;->a(Ljava/lang/Integer;)Lsg/e;
    ...
    iget-object v1, p0, Lfh/c;->d:Lsg/b;

    if-eqz v1, :cond_1

    iget-object v1, v1, Lsg/b;->a:Lcom/arcsoft/avatar2/BackgroundInfo;

    invoke-virtual {v1}, Lcom/arcsoft/avatar2/BackgroundInfo;->getName()Ljava/lang/String;

    move-result-object v1

    iget-object v9, v5, Lsg/b;->a:Lcom/arcsoft/avatar2/BackgroundInfo;
    ...
    invoke-direct {v1, v5}, Lsg/b;-><init>(Lsg/b;)V

    iput-object v1, p0, Lfh/c;->d:Lsg/b;

    iget-object v1, p0, Lfh/c;->c:Lcom/arcsoft/avatar2/AvatarEngine;
    ...
    iget-object v9, v1, Lsg/b;->a:Lcom/arcsoft/avatar2/BackgroundInfo;
    ...
    iget v9, v1, Lsg/b;->g:I

    if-gez v9, :cond_3

    :cond_5
    iput-wide v5, v1, Lsg/b;->h:J
    ...
    iget-object v1, p0, Lfh/c;->e:Lcom/arcsoft/avatar2/RecordModule;
    ...
    iget v2, v1, Lsg/b;->g:I

    iget-object v5, v1, Lsg/b;->a:Lcom/arcsoft/avatar2/BackgroundInfo;
    ...
    iput v9, v1, Lsg/b;->g:I

    :cond_9
    iget v5, v1, Lsg/b;->g:I

    add-int/2addr v5, v7

    iput v5, v1, Lsg/b;->g:I

    goto :goto_2

    :cond_a
    iput v4, v1, Lsg/b;->g:I

    :goto_2
    :try_start_0
    new-instance v1, Ljava/io/FileInputStream;

    iget-object v5, p0, Lfh/c;->d:Lsg/b;

    iget-object v5, v5, Lsg/b;->a:Lcom/arcsoft/avatar2/BackgroundInfo;
    ...
    iget-object v6, p0, Lfh/c;->d:Lsg/b;

    iget-object v6, v6, Lsg/b;->a:Lcom/arcsoft/avatar2/BackgroundInfo;
    ...
    :goto_3
    :try_start_3
    iput-object v8, p0, Lfh/c;->d:Lsg/b;
    ...
    :cond_e
    iget-object p0, p0, Lfh/c;->c:Lcom/arcsoft/avatar2/AvatarEngine;
...
.method public final l()Z
    ...
    iget-object v2, p0, Lfh/c;->a:Lrg/i;
    ...
    invoke-virtual {v2, v3}, Lrg/i;->b(I)I
    ...
    iget-object p0, v1, Lsg/a;->x:Ljava/lang/String;
...
.method public final m()V
    ...
    invoke-virtual {v1}, Lhh/a;->f()Lcom/arcsoft/avatar2/AvatarEngine;

    move-result-object v1

    iput-object v1, p0, Lfh/c;->c:Lcom/arcsoft/avatar2/AvatarEngine;
    ...
    sget-object v4, Lhh/a;->r:Ljava/lang/String;
    ...
    iget-object v4, v4, Lhh/a;->h:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v0, p0, Lfh/c;->j:Ljava/lang/String;

    iget-object v2, v1, Lsg/a;->j:Ljava/lang/String;
    ...
    iget-object v0, v1, Lsg/a;->j:Ljava/lang/String;
    ...
    :cond_3
    iget-object v0, v1, Lsg/a;->x:Ljava/lang/String;

    invoke-static {v0}, Lhh/a;->e(Ljava/lang/String;)Z

    move-result v2

    if-nez v2, :cond_4

    iget-object v1, p0, Lfh/c;->k:Ljava/lang/String;
    ...
    :cond_4
    iget v0, v1, Lsg/a;->e:I

    if-lez v0, :cond_5

    iget-object v1, v1, Lsg/a;->d:Ljava/util/List;
    ...
    iput-object v3, p0, Lfh/c;->o:Lwg/c;

    if-eqz v3, :cond_8

    sget-object v1, Lhh/a;->t:Ljava/lang/String;

    iput-object v1, p0, Lfh/c;->j:Ljava/lang/String;

    iget-object v2, p0, Lfh/c;->c:Lcom/arcsoft/avatar2/AvatarEngine;

    invoke-virtual {v2, v1}, Lcom/arcsoft/avatar2/AvatarEngine;->setTemplatePath(Ljava/lang/String;)V

    iget-object v1, p0, Lfh/c;->o:Lwg/c;

    invoke-interface {v1, v0}, Lwg/c;->K0(Z)V
    ...
    :cond_8
    invoke-virtual {v1}, Lrg/i;->reset()V

    invoke-virtual {p0}, Lfh/c;->m()V
...
.method public final m4(Landroid/graphics/Bitmap;)V
    ...
    iget-object p1, p0, Lfh/c;->j:Ljava/lang/String;
    ...
    iput-object p1, p0, Lfh/c;->k:Ljava/lang/String;
    ...
    iget-object v11, p0, Lfh/c;->t:Ljava/lang/Object;
    ...
    new-instance v10, Landroidx/constraintlayout/core/state/e;

    const/16 v8, 0x8

    invoke-direct {v10, v8}, Landroidx/constraintlayout/core/state/e;-><init>(I)V
    ...
    :goto_0
    iget-object v0, p0, Lfh/c;->r:Landroid/os/Handler;

    new-instance v1, Lfh/b;

    invoke-direct {v1, p0, p1}, Lfh/b;-><init>(Lfh/c;I)V

    invoke-virtual {v0, v1}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    iget-object p1, p0, Lfh/c;->m:Lcom/android/camera/ActivityBase;
    ...
    iget-object p1, p0, Lfh/c;->r:Landroid/os/Handler;
...
.method public final q2()Ljava/util/HashMap;
    ...
    invoke-virtual {v1, v0}, Lrg/i;->a(Ljava/lang/Integer;)Lsg/e;
    ...
    iget-object v3, p0, Lfh/c;->j:Ljava/lang/String;

    sget-object v7, Lhh/a;->t:Ljava/lang/String;
    ...
    sget-object v8, Lhh/a;->u:Ljava/lang/String;
    ...
    sget-object v8, Lhh/a;->v:Ljava/lang/String;
    ...
    sget-object v8, Lhh/a;->w:Ljava/lang/String;
    ...
    sget-object v8, Lhh/a;->x:Ljava/lang/String;
    ...
    sget-object v8, Lhh/a;->z:Ljava/lang/String;
    ...
    sget-object v8, Lhh/a;->y:Ljava/lang/String;
    ...
    invoke-static {v2, v0}, Lrg/h;->e(Ljava/util/HashMap;Lcom/arcsoft/avatar2/AvatarConfig$ASAvatarConfigValue;)V
    ...
    invoke-virtual {v1, p0}, Lrg/i;->a(Ljava/lang/Integer;)Lsg/e;
    ...
    invoke-static {v0, p0, v5}, Landroidx/activity/e;->f(Ljava/lang/StringBuilder;ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lsg/b;->a:Lcom/arcsoft/avatar2/BackgroundInfo;
...
.method public final releaseRender()V
    ...
    iget-object v4, p0, Lfh/c;->l:Lcom/android/camera/ui/v0;
    ...
    invoke-direct {v1, p0, v0, v2}, Lj4/c;-><init>(Lz6/a;II)V

    invoke-interface {v4, v1}, Lcom/android/camera/ui/v0;->K0(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v1, v3}, Lrg/i;->b(I)I
    ...
    invoke-interface {p0}, Lwg/c;->releaseRender()V
...
.method public final rf(IIIIZ)V
    ...
    invoke-static {v0, v3, v2, v5, v4}, Landroidx/constraintlayout/core/parser/a;->h(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v0, v5, v2, v6, v4}, Landroidx/concurrent/futures/b;->m(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    :goto_0
    iput v0, v1, Lfh/c;->g:I

    const/16 v0, 0x9

    iput v0, v1, Lfh/c;->O:I

    iget-object v2, v1, Lfh/c;->a:Lrg/i;

    iput-boolean v8, v2, Lrg/i;->b:Z
    ...
    sget-object v6, Lrg/h;->f:Ljava/lang/String;
    ...
    :goto_2
    iget-object v11, v1, Lfh/c;->b:Landroid/content/Context;
    ...
    :try_start_0
    invoke-static {v6}, Lg6/q;->e(Ljava/lang/String;)V

    invoke-static {v6}, Lg6/q;->o(Ljava/lang/String;)V
    :try_end_0
    ...
    sget-object v9, Lrg/h;->a:Ljava/lang/String;
    ...
    sget-object v0, Lrg/h;->f:Ljava/lang/String;

    invoke-static {v0}, Lg6/q;->e(Ljava/lang/String;)V

    :goto_4
    const-string v0, "avatar start init | "

    invoke-static {v0, v5}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lhh/a;->f()Lcom/arcsoft/avatar2/AvatarEngine;

    move-result-object v0

    iput-object v0, v1, Lfh/c;->c:Lcom/arcsoft/avatar2/AvatarEngine;

    const/high16 v4, 0x3f800000    # 1.0f

    invoke-virtual {v0, v10, v4}, Lcom/arcsoft/avatar2/AvatarEngine;->setRenderScene(ZF)V

    iget v0, v2, Lrg/i;->k:I
    ...
    iput-object v2, v1, Lfh/c;->i:Landroid/util/Size;
    ...
    iput-object v4, v1, Lfh/c;->i:Landroid/util/Size;
    ...
    iget-object v0, v1, Lfh/c;->V:Lfh/c$b;
    ...
    iput-object v2, v1, Lfh/c;->e:Lcom/arcsoft/avatar2/RecordModule;

    iget-object v0, v1, Lfh/c;->i:Landroid/util/Size;
    ...
    iget-object v6, v1, Lfh/c;->c:Lcom/arcsoft/avatar2/AvatarEngine;
    ...
    sget-object v2, Lhh/a;->t:Ljava/lang/String;

    iget-object v3, v1, Lfh/c;->w:Lfh/c$a;
    ...
    iget-object v2, v1, Lfh/c;->i:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, v1, Lfh/c;->i:Landroid/util/Size;
    ...
    :cond_7
    invoke-virtual {v1, v8}, Lfh/c;->B(Z)V

    iget-object v0, v1, Lfh/c;->p:Landroid/os/Handler;

    new-instance v2, Landroidx/room/h;

    const/16 v3, 0x1b

    invoke-direct {v2, v1, v3}, Landroidx/room/h;-><init>(Ljava/lang/Object;I)V
...
.method public final t(Z)V
    ...
    iget-object p0, p0, Lfh/c;->r:Landroid/os/Handler;

    new-instance v1, Le9/p0;

    const/4 v2, 0x2

    invoke-direct {v1, v2, v0, p1}, Le9/p0;-><init>(ILjava/lang/Object;Z)V
...
.method public final w5()V
    ...
    iget-object v4, v1, Lfh/c;->b:Landroid/content/Context;

    const-string v5, "mAvatarTemplatePath = "

    const-string v6, "init model spend time = "

    iget-object v7, v1, Lfh/c;->a:Lrg/i;

    iget-boolean v0, v7, Lrg/i;->d:Z

    const/4 v8, 0x1

    if-eqz v0, :cond_0

    invoke-virtual {v1, v8}, Lfh/c;->t(Z)V
    ...
    :try_start_0
    invoke-virtual {v7, v8}, Lrg/i;->i(Z)V

    invoke-static {v8}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    invoke-virtual {v7, v12, v0}, Lrg/i;->k(Lsg/e;Ljava/lang/Integer;)V

    sget-object v0, Lrg/h;->g:Ljava/lang/String;
    ...
    invoke-virtual {v0, v10, v13, v14}, Lle/a;->j(Ljava/lang/String;J)J
    ...
    :cond_2
    sget-object v0, Lrg/h;->h:Ljava/lang/String;
    ...
    :goto_2
    sget-object v8, Lrg/h;->f:Ljava/lang/String;

    invoke-static {v8}, Lg6/q;->e(Ljava/lang/String;)V

    invoke-static {v8}, Lg6/q;->o(Ljava/lang/String;)V
    :try_end_5
    ...
    sget-object v4, Lrg/h;->a:Ljava/lang/String;
    ...
    invoke-virtual {v7, v11}, Lrg/i;->i(Z)V

    invoke-static {v2}, Lcom/android/camera/z2;->I4(Ljava/lang/String;)V

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0, v5}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v2, v1, Lfh/c;->j:Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lfh/c;->m()V
    ...
    iput-boolean v2, v7, Lrg/i;->b:Z

    invoke-virtual {v1, v11}, Lfh/c;->t(Z)V
    :try_end_7
    ...
    invoke-static {v12}, Lcom/android/camera/z2;->I4(Ljava/lang/String;)V

    sget-object v0, Lrg/h;->a:Ljava/lang/String;
