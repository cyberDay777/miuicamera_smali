...
# direct methods
.method public constructor <init>(Le9/r0;IZ)V
    .locals 1
    ...
    iput-boolean v0, p0, Le9/e1;->x:Z

    iput p1, p0, Le9/e1;->A:I

    iput-boolean p1, p0, Le9/e1;->B:Z

    iput p2, p0, Le9/e1;->y:I

    iput-boolean p3, p0, Le9/e1;->w:Z
...
.method public final m(Landroid/media/Image;I)V
    ...
    :cond_0
    iget-object v0, p0, Le9/e1;->v:Landroid/hardware/camera2/TotalCaptureResult;

    invoke-interface {p2, p1, v0}, Le9/a$l;->onPictureTakenImageConsumed(Landroid/media/Image;Landroid/hardware/camera2/TotalCaptureResult;)Z
    ...
    :cond_1
    iget p2, p0, Le9/e1;->A:I

    const/4 v0, 0x1

    add-int/2addr p2, v0

    iput p2, p0, Le9/e1;->A:I
    ...
    iget-object p1, p0, Le9/e1;->v:Landroid/hardware/camera2/TotalCaptureResult;

    iget-object v1, p0, Le9/c1;->g:Le9/a$l;
    ...
    invoke-interface {v1, p2, p1}, Le9/a$l;->onPictureTaken([BLandroid/hardware/camera2/CaptureResult;)V
    ...
    :goto_0
    iget-boolean p1, p0, Le9/e1;->B:Z

    if-eqz p1, :cond_3

    iget p1, p0, Le9/e1;->A:I

    iget p2, p0, Le9/e1;->z:I

    if-ne p1, p2, :cond_3

    iget p1, p0, Le9/e1;->u:I

    invoke-virtual {p0, p1, v0}, Le9/e1;->s(IZ)V
...
.method public final p()V
    ...
    invoke-virtual {v2}, Ltb/a;->dg()Z

    move-result v3

    iget v4, p0, Le9/e1;->y:I

    if-eqz v3, :cond_0

    if-lez v4, :cond_0

    iget v3, p0, Le9/e1;->z:I
    ...
    :try_start_0
    new-instance v3, Le9/d1;

    invoke-direct {v3, p0}, Le9/d1;-><init>(Le9/e1;)V

    invoke-virtual {p0}, Le9/e1;->r()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v8, p0, Le9/c1;->c:Landroid/os/Handler;
    ...
    iget v11, p0, Le9/e1;->z:I

    add-int/2addr v11, v2

    iput v11, p0, Le9/e1;->z:I

    iput v10, p0, Le9/e1;->t:I

    if-ne v11, v4, :cond_3

    iput v10, p0, Le9/e1;->u:I
...
.method public final r()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v6, v3, Le9/a2;->a:Landroid/media/ImageReader;
    ...
    invoke-virtual {v0, v1, p0}, Le9/r0;->n1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-static {p0}, Le9/d;->k1(Le9/c;)Z
    ...
    :cond_6
    invoke-static {p0}, Le9/d;->u2(Le9/c;)Z
    ...
    invoke-virtual {p0}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->z()I
...
.method public final s(IZ)V
    ...
    invoke-virtual {v0, v2}, Le9/r0;->c(Z)V
    ...
    invoke-interface {p1, p2, v3, v4, v2}, Le9/a$l;->onPictureTakenFinished(ZJI)V
    ...
    :goto_0
    invoke-virtual {v0, p2, p0}, Le9/r0;->n2(ZLe9/c1;)V
