...
.method public constructor <init>(Landroid/hardware/camera2/CaptureResult;Le9/r0;Lge/a;)V
    ...
    invoke-direct {p0, p2, p3}, Le9/h1;-><init>(Le9/r0;Lge/a;)V

    const/16 p3, 0xb

    iput p3, p0, Le9/o1;->I:I

    const/4 p3, -0x1

    iput p3, p0, Le9/o1;->N:I

    iput-object p1, p0, Le9/h1;->w:Landroid/hardware/camera2/CaptureResult;

    iget-object p1, p2, Le9/r0;->m0:Le9/p2;

    iput-object p1, p0, Le9/o1;->B:Le9/p2;
...
.method public final B()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v6, v3, Le9/c;->N6:Ljava/lang/Boolean;

    if-nez v6, :cond_2

    sget-object v6, Lp9/g;->U2:Lp9/f;
    ...
    iput-object v6, v3, Le9/c;->N6:Ljava/lang/Boolean;
    ...
    :goto_2
    iget-object v7, v0, Le9/r0;->C:Le9/a2;

    iget-object v8, p0, Le9/c1;->a:Ljava/lang/String;
    ...
    iget-object v6, v7, Le9/a2;->l:Landroid/view/Surface;

    invoke-virtual {v1, v6}, Landroid/hardware/camera2/CaptureRequest$Builder;->addTarget(Landroid/view/Surface;)V

    :cond_4
    iget-object v6, p0, Le9/o1;->K:Landroid/view/Surface;

    invoke-virtual {v1, v6}, Landroid/hardware/camera2/CaptureRequest$Builder;->addTarget(Landroid/view/Surface;)V

    iget v6, v0, Le9/a;->a:I
    ...
    iget-object v6, p0, Le9/o1;->J:Landroid/view/Surface;

    invoke-virtual {v7, v5}, Le9/a2;->p(I)Landroid/view/Surface;
    ...
    invoke-static {v6, v9}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v13, p0, Le9/o1;->L:Landroid/util/Size;

    invoke-virtual {p0, v6, v13, v10, v9}, Le9/h1;->r(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_9
    iget-object v6, p0, Le9/o1;->L:Landroid/util/Size;

    invoke-virtual {p0, v6, v10, v9}, Le9/h1;->t(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v6}, Ltb/a;->ai()Z

    move-result v9

    if-eqz v9, :cond_b

    invoke-virtual {v7}, Le9/a2;->o()Landroid/view/Surface;
    ...
    :cond_b
    iget-object v7, v0, Le9/r0;->F:Le9/y;

    iget-object v7, v7, Le9/y;->a:Le9/z;

    invoke-static {v12, v1, v7}, Le9/c0;->h(ILandroid/hardware/camera2/CaptureRequest$Builder;Le9/z;)V

    invoke-virtual {v0, v1, v12}, Le9/r0;->n1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget v7, v7, Le9/z;->T2:I

    if-eq v7, v12, :cond_e

    if-eq v7, v11, :cond_d

    iget-boolean v9, p0, Le9/o1;->C:Z
    ...
    invoke-static {v9, v7, v10, v2}, Landroidx/activity/result/a;->d(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v2, v3, Le9/c;->D6:Ljava/lang/Boolean;

    if-nez v2, :cond_12

    sget-object v2, Lp9/g;->R2:Lp9/f;

    invoke-virtual {v2}, Lp9/f;->c()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v3, v9}, Le9/c;->k0(Ljava/lang/String;)Z
    ...
    invoke-static {v9, v2}, Lp9/e0;->e(Landroid/hardware/camera2/CameraCharacteristics;Lp9/d0;)Ljava/lang/Object;
    ...
    iput-object v2, v3, Le9/c;->D6:Ljava/lang/Boolean;
    ...
    :cond_16
    iget-object v2, p0, Le9/o1;->B:Le9/p2;

    if-eqz v2, :cond_18

    iget-object v2, v2, Le9/p2;->g:Le9/p2$a;

    iget-boolean v2, v2, Le9/p2$a;->a:Z
    ...
    iget v2, v2, Le9/z;->Y:F

    iget-object v4, p0, Le9/h1;->v:Landroid/graphics/Rect;

    invoke-static {v4, v2}, Lc9/a;->o(Landroid/graphics/Rect;F)Landroid/graphics/Rect;

    move-result-object v2

    const-string v4, "sr set mtkCrop = "

    invoke-static {v4, v2}, La/d;->c(Ljava/lang/String;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    sget-object v2, Lp9/a0;->N3:Lp9/z;

    iget-object v0, v0, Le9/r0;->F:Le9/y;

    iget-object v0, v0, Le9/y;->a:Le9/z;

    iget v0, v0, Le9/z;->U2:I

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    invoke-static {v1, v2, v0}, Lp9/e0;->i(Landroid/hardware/camera2/CaptureRequest$Builder;Lp9/d0;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v3, p0}, Le9/c0;->n0(Landroid/hardware/camera2/CaptureRequest$Builder;Le9/c;Ljava/lang/String;)V
...
.method public final C()V
    ...
    iput-object v2, p0, Le9/o1;->K:Landroid/view/Surface;
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    iget-object v2, p0, Le9/o1;->K:Landroid/view/Surface;

    const/4 v3, 0x1

    if-nez v2, :cond_0

    iput-boolean v3, p0, Le9/o1;->H:Z
    ...
    :cond_2
    invoke-virtual {v0}, Le9/r0;->d2()Z

    move-result v6

    if-nez v6, :cond_4

    invoke-virtual {v0}, Le9/r0;->N()Z
    ...
    invoke-virtual {v7, v6, v8}, Le9/a2;->l(IZ)Landroid/view/Surface;

    move-result-object v7

    iput-object v7, p0, Le9/o1;->J:Landroid/view/Surface;
    ...
    iget-object v7, v5, Le9/z;->J:Lfe/c;

    goto :goto_4

    :cond_7
    iget-object v7, v5, Le9/z;->L:Lfe/c;

    goto :goto_4

    :cond_8
    iget-object v7, v5, Le9/z;->K:Lfe/c;
    ...
    :cond_a
    iget-object v7, v5, Le9/z;->I:Lfe/c;
    ...
    :goto_5
    invoke-virtual {v7}, Lfe/c;->c()Landroid/util/Size;

    move-result-object v7

    iput-object v7, p0, Le9/o1;->M:Landroid/util/Size;

    iget-object v7, p0, Le9/o1;->J:Landroid/view/Surface;

    invoke-static {v7}, Lsf/e;->b(Landroid/view/Surface;)Landroid/util/Size;

    move-result-object v7

    iput-object v7, p0, Le9/o1;->L:Landroid/util/Size;
    ...
    iget-object v11, p0, Le9/o1;->M:Landroid/util/Size;
    ...
    iget-object v11, p0, Le9/o1;->L:Landroid/util/Size;
    ...
    iget-object v7, v5, Le9/z;->h:Lfe/c;
    ...
    :cond_c
    iget v11, v7, Lfe/c;->a:I

    :goto_6
    if-nez v7, :cond_d

    iget-object v12, p0, Le9/o1;->L:Landroid/util/Size;
    ...
    iget v13, v5, Le9/z;->S:I

    invoke-direct {v7, v11, v12, v13}, Lcom/xiaomi/camera/imagecodec/OutputConfiguration;-><init>(III)V

    iget-object v11, p0, Le9/h1;->w:Landroid/hardware/camera2/CaptureResult;

    sget-object v12, Lr6/a;->b:Lr6/a;

    invoke-virtual {v12}, Lr6/a;->a()Lcom/android/camera/o3$b;
    ...
    iget v12, v5, Le9/z;->T2:I

    if-eq v12, v8, :cond_13

    if-eq v12, v9, :cond_12

    invoke-static {v11}, Le9/d0;->q(Landroid/hardware/camera2/CaptureResult;)Ljava/lang/Integer;

    move-result-object v2

    iget v9, v5, Le9/z;->e0:I
    ...
    invoke-static {v9, v12, v10, v3, v13}, Landroidx/constraintlayout/core/parser/a;->h(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v11}, Lfe/a;->b(Landroid/hardware/camera2/CaptureResult;)Landroid/os/Parcelable;

    move-result-object v2

    iget-wide v9, v5, Le9/z;->o0:J

    const-string v13, "default exposureTime: "

    invoke-static {v13, v9, v10}, La/c;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    sget-object v12, Lp9/c0;->o1:Lp9/b0;

    invoke-static {v8, v12}, Lp9/e0;->f(Landroid/hardware/camera2/CaptureResult;Lp9/d0;)Ljava/lang/Object;
    ...
    :cond_16
    iget-object v12, p0, Le9/h1;->w:Landroid/hardware/camera2/CaptureResult;

    sget-object v13, Lp9/c0;->n1:Lp9/b0;

    invoke-static {v12, v13}, Lp9/e0;->f(Landroid/hardware/camera2/CaptureResult;Lp9/d0;)Ljava/lang/Object;
    ...
    invoke-static {v8, v9, v10}, La/c;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v8, p0, Le9/o1;->L:Landroid/util/Size;
    ...
    iput-object v0, p0, Le9/o1;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;

    const-string v0, "featureType "

    const-string v1, ", initFeatureSetting: "

    invoke-static {v0, v3, v1}, Landroidx/appcompat/widget/b;->d(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-object v1, p0, Le9/o1;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
...
.method public final D()Z
    ...
    invoke-static {v0}, Le9/d0;->p(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    :cond_0
    iget-boolean v0, p0, Le9/o1;->H:Z

    if-nez v0, :cond_1

    invoke-virtual {p0}, Le9/o1;->C()V

    :cond_1
    iget-object p0, p0, Le9/o1;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
...
.method public final n()V
    ...
    iget-boolean v2, p0, Le9/o1;->C:Z

    if-eqz v2, :cond_4

    const/16 v2, 0x9

    invoke-static {v3, v0, v2}, Le9/d;->l0(Le9/c;II)Z
    ...
    :goto_2
    iput-boolean v0, p0, Le9/c1;->m:Z

    iget v0, p0, Le9/o1;->I:I
    ...
    iget-object v0, v0, Le9/z;->e:Lfe/c;

    iput-object v0, p0, Le9/c1;->o:Lfe/c;
...
.method public final p()V
    ...
    :try_start_0
    new-instance v3, Le9/n1;

    invoke-direct {v3, p0}, Le9/n1;-><init>(Le9/o1;)V

    invoke-virtual {p0}, Le9/o1;->B()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v4

    iget-object v5, p0, Le9/o1;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    iget-object v7, v1, Le9/r0;->F:Le9/y;

    iget-object v7, v7, Le9/y;->a:Le9/z;

    iget-boolean v7, v7, Le9/z;->c3:Z
    ...
    iget-object v9, p0, Le9/o1;->M:Landroid/util/Size;

    invoke-virtual {v9}, Landroid/util/Size;->getWidth()I

    move-result v9

    iget-object v10, p0, Le9/o1;->M:Landroid/util/Size;
    ...
    invoke-virtual {p0, v4, v8, v5}, Le9/h1;->u(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;

    move-result-object v4

    if-eqz v4, :cond_4

    invoke-virtual {p0, v4}, Le9/h1;->z(Lcom/xiaomi/engine/PreProcessData;)V
    ...
    iput-object v3, p0, Le9/h1;->x:Ljava/lang/String;

    invoke-virtual {v1}, Ljava/lang/Object;->hashCode()I

    move-result v3

    iget p0, p0, Le9/o1;->D:I

    invoke-static {v3, p0}, Lcom/android/camera/p3;->a(II)V
    :try_end_0
