...
.method public final F()I
    ...
    iget-boolean v0, v0, Le9/p2$a;->Q:Z
...
.method public final M(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V
    ...
    iget-object v2, p0, Le9/s0;->B:Lje/q;
    ...
    :cond_5
    iget-object v12, p0, Le9/s0;->B:Lje/q;

    iget-boolean v12, v12, Lje/q;->H:Z
    ...
    :cond_6
    iget-object v11, p0, Le9/c1;->h:Lje/o;
    ...
    :cond_7
    new-instance v10, Lje/q;

    iget-object v12, p0, Le9/s0;->B:Lje/q;

    invoke-direct {v10, v12}, Lje/q;-><init>(Lje/q;)V

    invoke-virtual {v10, v1, v9}, Lje/q;->a(I[B)V

    invoke-virtual {v10, v7, v8}, Lje/q;->a(I[B)V

    iput v4, v10, Lje/q;->c:I

    iget-object v7, p0, Le9/s0;->K:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v12, p0, Le9/s0;->M:Ljava/lang/String;
    ...
    iget-object v7, v7, Le9/c;->d:Landroid/hardware/camera2/CameraCharacteristics;

    check-cast v11, Lr7/i;

    invoke-virtual {v11, v10, v0, v7, v6}, Lr7/i;->q(Lje/q;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    ...
    iget-object v7, p0, Le9/s0;->M:Ljava/lang/String;
    ...
    iget v7, p0, Le9/c1;->i:I

    iput v7, v10, Lje/q;->r:I
    ...
    invoke-virtual {v0, v9}, Lje/q;->h([B)V
    ...
    :cond_13
    invoke-virtual {p0, v0, p1, v1, v5}, Le9/s0;->K(Lje/q;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
...
.method public final S()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget v5, v5, Le9/z;->R0:I

    const/16 v7, 0x14

    if-ne v5, v7, :cond_2

    iget-object v2, v2, Le9/a2;->j:Landroid/media/ImageReader;
    ...
    :goto_0
    sget-object v5, Lp9/a0;->c4:Lp9/z;

    invoke-static {v2}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v8

    invoke-static {v1, v5, v8}, Lp9/e0;->j(Landroid/hardware/camera2/CaptureRequest$Builder;Lp9/d0;Ljava/lang/Object;)V
    ...
    iput-wide v8, p0, Le9/y0;->Y:J

    sget-object v2, Lcom/android/camera/s5;->a:Ljava/lang/String;

    invoke-static {v8, v9}, Lrc/c;->e(J)Ljava/lang/String;

    move-result-object v2

    invoke-static {v8, v9}, Lrc/c;->f(J)Ljava/lang/String;
    ...
    invoke-static {v8, v2, v9, v2}, Landroidx/appcompat/graphics/drawable/a;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8, v2}, Landroidx/appcompat/view/menu/a;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-boolean v9, v8, Le9/p2$a;->C:Z

    if-eqz v9, :cond_6

    iget v8, v8, Le9/p2$a;->D:I
    ...
    iget-boolean v8, v8, Le9/p2$a;->P:Z
    ...
    iget-boolean v8, v8, Le9/p2$a;->Q:Z
    ...
    invoke-static {v1, v4}, Le9/c0;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V

    invoke-static {v1, v4}, Le9/c0;->f(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V

    goto :goto_2

    :cond_9
    invoke-static {v1, v7}, Le9/c0;->a(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V

    invoke-static {v1, v7}, Le9/c0;->f(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    iget-object v8, p0, Le9/s0;->M:Ljava/lang/String;

    if-eqz v8, :cond_c

    invoke-static {v1, v5, v8}, Le9/c0;->n0(Landroid/hardware/camera2/CaptureRequest$Builder;Le9/c;Ljava/lang/String;)V
    ...
    sget-object p0, Lp9/a0;->q4:Lp9/z;

    invoke-static {v7}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v8

    invoke-static {v1, p0, v8}, Lp9/e0;->j(Landroid/hardware/camera2/CaptureRequest$Builder;Lp9/d0;Ljava/lang/Object;)V
    ...
    iget-object v2, v2, Le9/p2$a;->R:Ljava/util/ArrayList;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v2, v1}, Lr9/u;->a(Ljava/util/ArrayList;Landroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    invoke-static {v1, p0}, Le9/c0;->E(Landroid/hardware/camera2/CaptureRequest$Builder;Le9/z;)V
...
.method public final T()V
    ...
    :cond_0
    iget-object v0, p0, Le9/s0;->C:Landroid/hardware/camera2/TotalCaptureResult;
    ...
    invoke-direct {v1, v2}, Lje/q;-><init>(Lje/q;)V

    iget-object v2, p0, Le9/y0;->W:[B

    const/4 v3, 0x3

    invoke-virtual {v1, v3, v2}, Lje/q;->a(I[B)V

    iget v2, p0, Le9/c1;->i:I

    iput v2, v1, Lje/q;->r:I
    ...
    iget-object v2, p0, Le9/s0;->C:Landroid/hardware/camera2/TotalCaptureResult;
    ...
    invoke-virtual {v0, v1, v2, p0, v3}, Lr7/i;->q(Lje/q;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
...
.method public final m(Landroid/media/Image;I)V
    ...
    iput-object p2, p0, Le9/y0;->W:[B

    invoke-virtual {p1}, Landroid/media/Image;->close()V

    invoke-virtual {p0}, Le9/y0;->T()V

    invoke-virtual {p0}, Le9/s0;->O()V
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Le9/s0;->m(Landroid/media/Image;I)V
...
.method public final p()V
    ...
    :try_start_0
    new-instance v3, Le9/x0;

    invoke-direct {v3, p0}, Le9/x0;-><init>(Le9/y0;)V

    invoke-virtual {p0}, Le9/y0;->S()Landroid/hardware/camera2/CaptureRequest$Builder;
