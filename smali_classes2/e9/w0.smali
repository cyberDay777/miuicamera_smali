...
# direct methods
.method public constructor <init>(Le9/r0;ZLandroid/view/Surface;Le9/p2;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0, p4}, Le9/s0;-><init>(Le9/r0;Lge/a;Le9/p2;)V

    iput-object p3, p0, Le9/w0;->W:Landroid/view/Surface;

    iput-boolean p2, p0, Le9/w0;->Y:Z

    return-void
.end method

.method public static S(Le9/w0;ZI)V
    .locals 4
    ...
    invoke-interface {p2, p1, v1, v2, v3}, Le9/a$l;->onPictureTakenFinished(ZJI)V
...
.method public final T()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-static {v1, v5, v2}, Lp9/e0;->j(Landroid/hardware/camera2/CaptureRequest$Builder;Lp9/d0;Ljava/lang/Object;)V

    iget-object v2, v0, Le9/r0;->C:Le9/a2;

    iget-object v5, v2, Le9/a2;->a:Landroid/media/ImageReader;
    ...
    sget-object v2, Lp9/a0;->m4:Lp9/z;
    ...
    invoke-static {v0}, Le9/d;->k1(Le9/c;)Z
    ...
    :cond_1
    iget-object v2, p0, Le9/c1;->g:Le9/a$l;

    iget-object v5, p0, Le9/w0;->X:Ljava/lang/String;

    if-nez v5, :cond_2

    if-eqz v2, :cond_2

    instance-of v5, v2, Lb6/r$b;

    if-eqz v5, :cond_2

    check-cast v2, Lb6/r$b;

    invoke-virtual {v2}, Lb6/r$b;->a()Ljava/lang/String;
    ...
    iput-object v2, p0, Le9/w0;->X:Ljava/lang/String;
    ...
    iget-object p0, p0, Le9/w0;->X:Ljava/lang/String;
    ...
    invoke-static {v1, p0, v0}, Lp9/e0;->i(Landroid/hardware/camera2/CaptureRequest$Builder;Lp9/d0;Ljava/lang/Object;)V
...
.method public final p()V
    ...
    invoke-virtual {v1}, Le9/r0;->d0()V

    :try_start_0
    new-instance v3, Le9/v0;

    invoke-direct {v3, p0}, Le9/v0;-><init>(Le9/w0;)V

    invoke-virtual {p0}, Le9/w0;->T()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v4

    iget-object v5, p0, Le9/w0;->W:Landroid/view/Surface;
    ...
    invoke-virtual {v0, v5}, Ls6/g;->d(Ljava/lang/String;)J
