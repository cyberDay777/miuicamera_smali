...
.method public constructor <init>(Le9/r0;Landroid/view/Surface;)V
    .locals 1
    ...
    iput-boolean p1, p0, Le9/q1;->C:Z

    sget-object p1, Lge/d;->b:Lge/d;

    iput-object p1, p0, Le9/q1;->D:Lge/d;

    iput-object p2, p0, Le9/q1;->E:Landroid/view/Surface;

    return-void
.end method

.method public static B(Le9/q1;ZI)V
    .locals 5
...
.method public final C()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v0, v5, Le9/r0;->t:Landroid/hardware/camera2/CameraDevice;
    ...
    :cond_2
    iget-object v6, v5, Le9/r0;->C:Le9/a2;
    ...
    iget-object v10, v5, Le9/r0;->C:Le9/a2;
    ...
    :cond_5
    iget-object v1, v5, Le9/r0;->F:Le9/y;
    ...
    :cond_6
    :goto_2
    invoke-virtual {v5}, Le9/r0;->A()I

    move-result v6

    iput v6, p0, Le9/c1;->s:I

    invoke-virtual {v5}, Le9/r0;->e2()Z

    move-result v9

    iget-object v10, v5, Le9/r0;->C:Le9/a2;

    invoke-virtual {v10, v6, v9}, Le9/a2;->l(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v10, v4}, Le9/a2;->p(I)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v9, v6, v1}, Le9/h1;->t(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    :goto_4
    iget-object v1, v5, Le9/r0;->C:Le9/a2;
    ...
    invoke-virtual {v1}, Le9/a2;->v()Landroid/view/Surface;
    ...
    iget-object v6, v5, Le9/r0;->z:Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v5, v0, v8}, Le9/r0;->n1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-boolean v6, v1, Le9/z;->r1:Z

    if-eqz v6, :cond_a

    iput-boolean v4, v1, Le9/z;->r1:Z

    :cond_a
    iget-object v5, v5, Le9/r0;->E:Le9/c;

    invoke-static {v8, v0, v5, v1}, Le9/c0;->M(ILandroid/hardware/camera2/CaptureRequest$Builder;Le9/c;Le9/z;)V
    ...
    iput-object v6, v1, Lcom/android/camera/fragment/beauty/p;->a:Ljava/lang/String;

    sget-object v6, Ls0/b;->g:Ljava/util/Map;

    iget-object v7, v5, Le9/c;->f:Ljava/util/HashSet;

    invoke-static {v0, v6, v7, v1}, Lcom/android/camera2/compat/MiCameraCompat;->applyBeautyParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;Ljava/util/HashSet;Lcom/android/camera/fragment/beauty/p;)V

    invoke-static {v5}, Le9/d;->o0(Le9/c;)Z
    ...
    invoke-static {v0, v5, v4}, Le9/c0;->x0(Landroid/hardware/camera2/CaptureRequest$Builder;Le9/c;Z)V

    invoke-static {v0, v5, v4}, Le9/c0;->q0(Landroid/hardware/camera2/CaptureRequest$Builder;Le9/c;Z)V
    ...
    invoke-static {v5}, Le9/d;->k1(Le9/c;)Z
...
.method public final p()V
    ...
    invoke-virtual {v2, v3}, Ls6/g;->d(Ljava/lang/String;)J

    :cond_0
    :try_start_0
    new-instance v2, Le9/p1;

    invoke-direct {v2, p0}, Le9/p1;-><init>(Le9/q1;)V

    invoke-virtual {p0}, Le9/q1;->C()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v3

    iget-object v5, p0, Le9/q1;->E:Landroid/view/Surface;
