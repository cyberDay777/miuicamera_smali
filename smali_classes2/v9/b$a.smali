...
.method public final onPreviewFrame(Landroid/media/Image;Le9/a;I)Z
    ...
    iget-object p2, p0, Lv9/b$a;->a:Lv9/b;

    iget-boolean p2, p2, Lv9/b;->c:Z
    ...
    :cond_0
    iget-object p0, p0, Lv9/b$a;->a:Lv9/b;
    ...
    invoke-virtual {v1, p1}, Lv9/a;->e(Landroid/media/Image;)Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-virtual {v1}, Lv9/a;->d()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-virtual {v1, p1, p3}, Lv9/a;->f(Landroid/media/Image;I)V
    ...
    invoke-direct {p2, p1, p3}, Lv9/c;-><init>(Landroid/media/Image;I)V

    :cond_3
    invoke-virtual {v1, p2}, Lv9/a;->g(Lv9/c;)V
