...
.field public final s:Le9/c;

.field public t:Ld9/d;

.field public final u:Landroid/os/Handler;

.field public final v:Ld9/c;
...
# direct methods
.method public constructor <init>(Lcom/android/camera/Camera;ZLjava/util/List;Le9/c;)V
    .locals 16
    ...
    iput-object v3, v1, Ld9/j;->j:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v3, v4}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v3, v1, Ld9/j;->k:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v3, v4}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v3, v1, Ld9/j;->l:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v3, v4}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v3, v1, Ld9/j;->m:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v3, Landroid/graphics/Rect;

    invoke-direct {v3}, Landroid/graphics/Rect;-><init>()V

    iput-object v3, v1, Ld9/j;->o:Landroid/graphics/Rect;

    new-instance v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v3, v4}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v3, v1, Ld9/j;->w:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v3, Ljava/lang/ref/WeakReference;

    invoke-direct {v3, v0}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v3, v1, Ld9/j;->r:Ljava/lang/ref/WeakReference;

    move-object/from16 v3, p4

    iput-object v3, v1, Ld9/j;->s:Le9/c;
    ...
    iput-object v5, v1, Ld9/j;->q:Lcom/android/camera/ui/GLTextureView;

    new-instance v0, Ld9/g;

    invoke-direct {v0, v1}, Ld9/g;-><init>(Ld9/j;)V
    ...
    iput-object v0, v1, Ld9/j;->u:Landroid/os/Handler;
    ...
    iput-object v5, v1, Ld9/j;->p:Ljava/lang/String;
    ...
    iput-object v0, v1, Ld9/j;->p:Ljava/lang/String;

    :goto_0
    iget-object v6, v1, Ld9/j;->p:Ljava/lang/String;
    ...
    invoke-static {v2, v0}, Ld9/j;->b(Ljava/util/List;F)Landroid/util/Size;

    move-result-object v0

    iput-object v0, v1, Ld9/j;->f:Landroid/util/Size;

    invoke-static {v2, v8}, Ld9/j;->b(Ljava/util/List;F)Landroid/util/Size;
    ...
    :pswitch_3
    invoke-static {v2, v7}, Ld9/j;->b(Ljava/util/List;F)Landroid/util/Size;
    ...
    :pswitch_5
    invoke-static/range {p4 .. p4}, Le9/d;->W2(Le9/c;)Z
    ...
    invoke-static {v2, v3}, Ld9/j;->b(Ljava/util/List;F)Landroid/util/Size;
    ...
    iput-object v2, v1, Ld9/j;->g:Landroid/util/Size;

    :cond_b
    iget-object v0, v1, Ld9/j;->f:Landroid/util/Size;

    if-eqz v0, :cond_c

    iget-object v0, v1, Ld9/j;->g:Landroid/util/Size;
    ...
    iput-object v3, v1, Ld9/j;->f:Landroid/util/Size;

    new-instance v3, Landroid/util/Size;

    invoke-direct {v3, v2, v0}, Landroid/util/Size;-><init>(II)V

    iput-object v3, v1, Ld9/j;->g:Landroid/util/Size;
    ...
    iput-object v0, v1, Ld9/j;->g:Landroid/util/Size;

    :cond_11
    :goto_9
    new-instance v0, Ld9/c;

    iget-object v2, v1, Ld9/j;->q:Lcom/android/camera/ui/GLTextureView;

    iget-object v3, v1, Ld9/j;->g:Landroid/util/Size;

    move/from16 v4, p2

    invoke-direct {v0, v2, v3, v4}, Ld9/c;-><init>(Lcom/android/camera/ui/GLTextureView;Landroid/util/Size;Z)V

    iput-object v0, v1, Ld9/j;->v:Ld9/c;

    const v0, 0x7f080788

    iput v0, v1, Ld9/j;->h:I
    ...
    :goto_a
    iput v0, v1, Ld9/j;->i:I

    invoke-virtual/range {p0 .. p0}, Ld9/j;->c()V
...
.method public final a()Landroid/view/Surface;
    ...
    iget-object v1, p0, Ld9/j;->f:Landroid/util/Size;
    ...
    iput-object v0, p0, Ld9/j;->a:Landroid/graphics/SurfaceTexture;

    iget-object v2, p0, Ld9/j;->f:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, p0, Ld9/j;->f:Landroid/util/Size;
    ...
    iget-object v2, p0, Ld9/j;->a:Landroid/graphics/SurfaceTexture;

    invoke-direct {v0, v2}, Landroid/view/Surface;-><init>(Landroid/graphics/SurfaceTexture;)V

    iput-object v0, p0, Ld9/j;->e:Landroid/view/Surface;

    iget-object v0, p0, Ld9/j;->a:Landroid/graphics/SurfaceTexture;

    new-instance v2, Ld9/e;

    invoke-direct {v2, p0}, Ld9/e;-><init>(Ld9/j;)V

    invoke-virtual {v0, v2}, Landroid/graphics/SurfaceTexture;->setOnFrameAvailableListener(Landroid/graphics/SurfaceTexture$OnFrameAvailableListener;)V

    iget-object v0, p0, Ld9/j;->r:Ljava/lang/ref/WeakReference;
    ...
    new-instance v2, Ld9/j$a;

    invoke-direct {v2, p0}, Ld9/j$a;-><init>(Ld9/j;)V
    ...
    invoke-direct {v4, v0, v5}, Lcom/android/camera/t1;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_0
    iget-object p0, p0, Ld9/j;->e:Landroid/view/Surface;
...
.method public final c()V
    ...
    iget-object v1, p0, Ld9/j;->v:Ld9/c;
    ...
    :cond_0
    invoke-virtual {v1}, Ld9/c;->c()V

    invoke-virtual {v1}, Ld9/c;->a()V
    ...
    iput v0, v1, Ld9/c;->a:I

    iput v0, v1, Ld9/c;->d:I

    iget-object v0, v1, Ld9/c;->i:Landroid/view/View;
    ...
    invoke-virtual {v1}, Ld9/c;->b()Landroid/graphics/Rect;

    move-result-object v0

    iget-object v1, p0, Ld9/j;->q:Lcom/android/camera/ui/GLTextureView;
...
.method public final d()V
    ...
    iget-object v0, p0, Ld9/j;->u:Landroid/os/Handler;
...
.method public final e(F)V
    ...
    invoke-virtual {v0}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->W0()F
    ...
    iget-object p1, p0, Ld9/j;->v:Ld9/c;

    if-eqz p1, :cond_0

    iget-object p0, p0, Ld9/j;->w:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput v1, p1, Ld9/c;->a:I

    iput v1, p1, Ld9/c;->d:I

    iget-object p0, p1, Ld9/c;->i:Landroid/view/View;
