...
# direct methods
.method public static a(Lli/a;)V
    .locals 10
    ...
    sget-object v3, Lxi/b;->a:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lvi/a;->j(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v1, v3}, Lh1/b;->z(ILjava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    invoke-static {v4}, Lkj/c;->e(Ljava/lang/String;)Z
    ...
    invoke-static {v7, v1, v3}, Lh1/b;->z(ILjava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v5, Lji/a;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v4, v1}, Lh1/b;->z(ILjava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lvh/g$a;->a:Lvh/g;

    iget-object v1, v0, Lvh/g;->Q:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, v0, v3}, Lcom/xiaomi/idm/api/a;-><init>(Ljava/lang/Object;I)V

    iget-object v3, v0, Lvh/g;->h:Ljava/util/concurrent/ExecutorService;
    ...
    :cond_4
    iget-object v1, v0, Lvh/g;->P:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v2}, Lvi/a;->h()I

    move-result v2

    invoke-direct {v1, v2}, Lbi/m;-><init>(I)V

    iput-object v1, v0, Lvh/g;->t:Lbi/m;

    iget-object v1, v1, Lbi/m;->a:Lbi/l;

    iput-object v1, v0, Lvh/g;->b0:Lbi/l;
    ...
    iget-object v0, v0, Lvh/g;->r:Lcom/faceunity/core/faceunity/FUAIKit;
    ...
    invoke-direct {v0, p0, v2}, Lmg/b;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v6, v4, p0}, Lh1/b;->z(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v4, v0}, Lh1/b;->z(ILjava/lang/String;Ljava/lang/String;)V

    iget-object p0, p0, Lvh/g$a;->a:Lvh/g;

    const/4 v0, 0x0

    iput-object v0, p0, Lvh/g;->o0:Lli/a;
...
.method public static b(Ljava/lang/String;Lli/a;)V
    .locals 13
    ...
    iput-object v4, v0, Lkj/b;->a:[B

    iput-object v5, v0, Lkj/b;->b:[B
    ...
    invoke-direct/range {v6 .. v11}, Lii/a;-><init>(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lli/a;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    invoke-static {v12, v3}, Lfp/c;->m(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct/range {v3 .. v9}, Lii/b;-><init>([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lli/a;Ljava/util/concurrent/atomic/AtomicInteger;)V

    invoke-static {v12, p0}, Lfp/c;->m(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
