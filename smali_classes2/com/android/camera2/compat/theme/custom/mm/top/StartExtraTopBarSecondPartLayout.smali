...
.method public static synthetic a(Lcom/android/camera2/compat/theme/custom/mm/top/StartExtraTopBarSecondPartLayout;ILg5/p;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera2/compat/theme/custom/mm/top/StartExtraTopBarSecondPartLayout;->lambda$updateData$2(ILg5/p;)V

    return-void
.end method

.method public static synthetic b(Lg5/p;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/StartExtraTopBarSecondPartLayout;->lambda$updateData$1(Lg5/p;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic c(Ljava/util/List;Lg5/p;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/StartExtraTopBarSecondPartLayout;->lambda$updateData$0(Ljava/util/List;Lg5/p;)V

    return-void
.end method

.method private static lambda$updateData$0(Ljava/util/List;Lg5/p;)V
    .locals 2

    iget v0, p1, Lg5/p;->a:I
...
.method private static lambda$updateData$1(Lg5/p;Landroid/view/View;)V
    .locals 0

    iget-object p0, p0, Lg5/p;->h:Landroid/view/View$OnClickListener;
...
.method private lambda$updateData$2(ILg5/p;)V
    .locals 3
    ...
    iget-object v1, p2, Lg5/p;->f:Lg5/p$c;

    invoke-interface {v1, p1}, Lg5/p$c;->updateResource(I)Lg5/v;
    ...
    invoke-virtual {v1, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/StrikethroughImageViewHolder;->updateView(Lg5/v;)V

    new-instance v1, Lc3/h;

    const/4 v2, 0x4

    invoke-direct {v1, p2, v2}, Lc3/h;-><init>(Ljava/lang/Object;I)V
...
.method public notifyItemChanged(I)V
    ...
    iget v3, v2, Lg5/p;->c:I

    if-ne v3, p1, :cond_2

    iget v3, p0, Lcom/android/camera2/compat/theme/custom/mm/top/StartExtraTopBarSecondPartLayout;->mMode:I

    iget-object v2, v2, Lg5/p;->f:Lg5/p$c;

    invoke-interface {v2, v3}, Lg5/p$c;->updateResource(I)Lg5/v;
    ...
    invoke-virtual {v3, v2}, Lcom/android/camera2/compat/theme/custom/mm/top/StrikethroughImageViewHolder;->updateView(Lg5/v;)V

    iget v2, v2, Lg5/v;->i:I
...
.method public updateData(ILjava/util/List;Landroid/view/View$OnClickListener;Lcom/android/camera2/compat/theme/custom/mm/top/IExtraTopBarUIConfig;)V
    ...
    invoke-direct {p3, p0, p1, p4}, Lj9/b;-><init>(Ljava/lang/Object;II)V
