...
.method public static synthetic B(Lf7/h;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->lambda$alertFlashFrontAdjustSwitchLayout$2(Lf7/h;)V
...
.method private executeFunction(Ljava/util/function/Consumer;)V
    ...
    invoke-direct {v0, v1}, La1/y;-><init>(I)V
...
.method public static synthetic i(Ld7/b0;Ld7/f3;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->lambda$reInitAlertAction$6(Ld7/b0;Ld7/f3;)V
...
.method private static synthetic lambda$alertFlashFrontAdjustSwitchLayout$2(Lf7/h;)V
    .locals 2
...
.method private static synthetic lambda$alertFlashFrontAdjustSwitchLayout$3(Ld7/b0;)V
    .locals 1
...
.method private static synthetic lambda$reInitAlertAction$6(Ld7/b0;Ld7/f3;)V
    .locals 1

    const/4 v0, 0x1

    invoke-interface {p1, p0, v0}, Ld7/f3;->showTips(Ld7/b0;Z)V

    return-void
.end method

.method public static synthetic m(Ld7/b0;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->lambda$alertFlashFrontAdjustSwitchLayout$3(Ld7/b0;)V
...
.method private reInitAlertAction(Z)V
    ...
    invoke-direct {v2, p1, v3}, Lf4/g;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    invoke-interface {p1}, Ld7/b0;->df()V

    invoke-interface {p1}, Ld7/b0;->Vg()V

    invoke-interface {p1}, Ld7/b0;->H1()V

    invoke-interface {p1}, Ld7/b0;->ze()V

    invoke-interface {p1, v1}, Ld7/b0;->qg(Z)V

    invoke-interface {p1}, Ld7/b0;->hb()V

    invoke-interface {p1}, Ld7/b0;->xa()V

    invoke-interface {p1}, Ld7/b0;->t0()V

    invoke-interface {p1, v1}, Ld7/b0;->L3(Z)V

    invoke-interface {p1}, Ld7/b0;->t7()V

    invoke-interface {p1}, Ld7/b0;->F8()V
    ...
    invoke-interface {p1, v0}, Ld7/b0;->K3(Z)V

    invoke-interface {p1}, Ld7/b0;->kg()V

    invoke-interface {p1}, Ld7/b0;->B9()V

    invoke-interface {p1}, Ld7/b0;->ea()V

    invoke-interface {p1}, Ld7/b0;->J4()V

    invoke-interface {p1}, Ld7/b0;->Zb()V

    invoke-interface {p1}, Ld7/b0;->R6()V

    invoke-interface {p1}, Ld7/b0;->w0()V

    invoke-interface {p1}, Ld7/b0;->E7()V
...
.method public alert960FpsDirectOverheatHint(I)V
    ...
    invoke-virtual {v1, v2}, Lx0/a0;->getComponentValue(I)Ljava/lang/String;
...
.method public alertSlowMotionDisableRecordTip(I)Z
    ...
    iget v2, v1, Lcom/android/camera/b5;->a:I
    ...
    iget v1, v1, Lcom/android/camera/b5;->b:I
...
.method public alertSuperNightSeTip(I)V
    ...
    invoke-static {v0}, Lz9/a;->b(Ljava/lang/String;)Z
...
.method public registerProtocol()V
    ...
    invoke-virtual {v0, v1, v2}, Lz6/e;->c(Ljava/lang/Class;Lz6/a;)V
...
.method public updateLyingDirectHint(ZZ)V
    ...
    invoke-interface {v0, p1}, Ld7/f3;->setIsShowTopLyingDirectHint(Z)V
    ...
    invoke-interface {v0}, Ld7/f3;->isShowTopLyingDirectHint()Z
