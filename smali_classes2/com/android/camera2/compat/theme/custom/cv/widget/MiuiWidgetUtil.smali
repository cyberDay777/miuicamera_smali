...
.method public static synthetic a(ILd7/b0;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/cv/widget/MiuiWidgetUtil;->lambda$setWidgetCameraFilter$0(ILd7/b0;)V
...
.method private static checkMasterFilterId(Ljava/util/ArrayList;I)I
    ...
    iget v1, v0, Lcom/android/camera/effect/v;->c:I

    if-ne v1, p1, :cond_0

    iget p0, v0, Lcom/android/camera/effect/v;->g:I
...
.method private static initFilterComponent(Ljava/util/ArrayList;)V
    ...
    :goto_0
    invoke-virtual {v1, v0, p0}, La1/n0;->e(ILjava/util/ArrayList;)V

    const/4 p0, 0x0

    invoke-virtual {v1, v0, p0}, La1/n0;->f(IZ)V
...
.method private static synthetic lambda$setWidgetCameraFilter$0(ILd7/b0;)V
    .locals 0
...
.method private static mutexByCclockWidget(I)V
    ...
    invoke-virtual {v0, p0}, Lx0/e0;->getPersistValue(I)Ljava/lang/String;
    ...
    iget-object v2, v2, Lx0/l1;->u:Lx0/f;
    ...
    invoke-virtual {v1, p0}, La1/r0;->isSwitchOn(I)Z

    move-result v2

    if-eqz v2, :cond_3

    invoke-virtual {v1, p0}, La1/r0;->e(I)V
    ...
    invoke-static {p0, v2}, Lcom/android/camera/z2;->W4(IZ)V

    invoke-virtual {v0, p0}, Lcom/android/camera/data/data/a;->reset(I)V

    :cond_4
    invoke-static {p0, v2}, Lcom/android/camera/z2;->V4(IZ)V
...
.method private static mutexByCvLensWidget(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p0, v0}, Lx0/w;->toSwitch(IZ)V
    ...
    iget-object p0, p0, Lx0/l1;->l:Lx0/a;
...
.method private static mutexByMasterFilterWidget(I)V
    ...
    invoke-virtual {v0, p0}, La1/r0;->e(I)V
    ...
    invoke-static {p0, v0}, Lcom/android/camera/z2;->W4(IZ)V
    ...
    invoke-virtual {p0, v0}, Lx0/p;->m(I)Z
    ...
    invoke-virtual {p0, v0, v1}, Lx0/p;->setComponentValue(ILjava/lang/String;)V
...
.method public static setCameraWidget(Landroid/content/pm/PackageManager;Landroid/content/Context;)V
    ...
    invoke-virtual {v1}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->W3()Z
...
.method private static setWidgetCameraCcLock(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v1, v2}, La1/u0;->B(IZ)V
...
.method private static setWidgetCameraFilter(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/camera/effect/t;->getFilterInfo(I)Ljava/util/ArrayList;
    ...
    invoke-direct {v3, p0, v1}, Lw7/f;-><init>(II)V
    ...
    invoke-static {p0, v1, v2, v3, v4}, Landroidx/concurrent/futures/a;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static setWidgetCameraLens(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    :goto_2
    invoke-static {p0}, Lcom/android/camera/z2;->y4(Ljava/lang/String;)V
...
.method private static setWidgetCameraMasterFilter(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/effect/t;->getFilterInfo(I)Ljava/util/ArrayList;
    ...
    invoke-virtual {v2}, La1/g1;->Z()Lx0/h1;
    ...
    invoke-virtual {v2, v0, v3}, Lle/a;->q(Ljava/lang/String;Ljava/lang/String;)Lle/a;

    :cond_2
    iget-object v0, v2, La1/g1;->O:La1/u0;

    const-string v2, "18"

    iput-object v2, v0, La1/u0;->d:Ljava/lang/String;

    invoke-static {p0}, Lcom/android/camera/z2;->a5(I)V
    ...
    invoke-direct {v0, v2}, Lg6/f0;-><init>(I)V
...
.method public static setWidgetIntentInfo(Landroid/content/Intent;)V
    ...
    invoke-static {p0}, Lcom/android/camera/w2;->d(Landroid/content/Intent;)Lcom/android/camera/w2;
...
.method private static setWidgetProStyleMode(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v1, v2}, Lx0/y;->setComponentValue(ILjava/lang/String;)V
...
.method private static updateDefaultWidget(Landroid/content/Context;Landroid/content/pm/PackageManager;)V
    ...
    invoke-virtual {v0}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->W3()Z
