...
.method private onLongExposeFinish(Lk4/c;Lf8/b;)V
    .locals 1

    iget-object p0, p2, Lf8/b;->j:Ljava/util/ArrayList;
    ...
    iget v0, p1, Lc8/d;->h:F

    invoke-virtual {p1, v0}, Lc8/d;->l(F)V
    ...
    :cond_0
    iget-object p0, p2, Lf8/b;->d:Lf8/x;

    iget p1, p0, Lf8/x;->W:F

    invoke-virtual {p0, p1}, Lf8/x;->u(F)V

    iget-object p0, p2, Lf8/b;->d:Lf8/x;

    iget p1, p0, Lf8/x;->a0:I

    invoke-virtual {p0, p1}, Lf8/x;->t(I)V

    iget-object p0, p2, Lf8/b;->f:Lf8/q;

    iget p1, p0, Lf8/q;->T:I
...
.method public handleIntoPattern(Lf8/b0;Lf8/b;)Z
    .locals 17
    ...
    iput v2, v1, Lf8/b;->i:F

    iget-object v2, v1, Lf8/b;->d:Lf8/x;

    iget v3, v2, Lc8/d;->g:F

    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4}, Lf8/x;->s(FI)V

    iget-object v2, v1, Lf8/b;->f:Lf8/q;

    invoke-virtual {v2, v4}, Lf8/q;->q(I)V
    ...
    iget-object v10, v1, Lf8/b;->e:Lf8/z;
    ...
    iget-object v0, v1, Lf8/b;->d:Lf8/x;
    ...
    :cond_4
    :pswitch_0
    iget-object v6, v1, Lf8/b;->c:Lf8/s;
    ...
    invoke-virtual {v6, v13, v7, v5, v4}, Lc8/d;->m(FFII)V

    iget-object v6, v1, Lf8/b;->d:Lf8/x;

    invoke-virtual {v6, v12, v5}, Lf8/x;->s(FI)V

    iget-object v6, v1, Lf8/b;->d:Lf8/x;

    iget v7, v1, Lf8/b;->i:F

    mul-float/2addr v7, v13

    invoke-virtual {v6, v7, v15, v5, v4}, Lc8/d;->m(FFII)V

    invoke-virtual {v10, v12, v3, v5, v4}, Lc8/d;->m(FFII)V

    invoke-virtual {v10}, Lf8/z;->p()V
    ...
    iget-object v0, v1, Lf8/b;->f:Lf8/q;

    const v5, 0x2effffff

    const/16 v6, 0x2e

    invoke-virtual {v0, v12, v3, v5, v6}, Lc8/d;->m(FFII)V
    ...
    :goto_5
    invoke-virtual {v0, v13}, Lf8/q;->q(I)V

    iget-object v0, v1, Lf8/b;->g:Lf8/r;

    invoke-virtual {v0, v11}, Lc8/d;->i(I)V

    iput v4, v0, Lc8/d;->e:I

    iget-object v1, v1, Lf8/b;->k:Landroid/content/Context;

    const v2, 0x7f080676

    invoke-virtual {v0, v2, v1}, Lf8/r;->q(ILandroid/content/Context;)V
    ...
    iget-object v0, v1, Lf8/b;->c:Lf8/s;
    ...
    invoke-virtual {v0, v13, v9, v7, v4}, Lc8/d;->m(FFII)V

    iget-object v0, v1, Lf8/b;->d:Lf8/x;

    invoke-virtual {v0, v12, v6}, Lf8/x;->s(FI)V

    iget-object v0, v1, Lf8/b;->d:Lf8/x;

    iget v6, v1, Lf8/b;->i:F

    const v7, -0x1ee4e5

    invoke-virtual {v0, v6, v15, v7, v11}, Lc8/d;->m(FFII)V
    ...
    invoke-virtual {v0, v12, v3, v8, v5}, Lc8/d;->m(FFII)V
    ...
    :cond_b
    iget-object v9, v1, Lf8/b;->c:Lf8/s;
    ...
    invoke-virtual {v9, v13, v11, v7, v4}, Lc8/d;->m(FFII)V

    iget-object v7, v1, Lf8/b;->d:Lf8/x;

    invoke-virtual {v7, v12, v6}, Lf8/x;->s(FI)V
    ...
    iget v9, v1, Lf8/b;->i:F

    mul-float/2addr v9, v13

    invoke-virtual {v7, v9, v15, v6, v4}, Lc8/d;->m(FFII)V
...
.method public handleLongExposeCaptureCompleted(Lk4/c;Lf8/b;)Z
    .locals 2

    iget p0, p1, Lk4/c;->a:I
...
.method public handlePrepareRecording(Lk4/c;Lf8/b;)Z
    .locals 13
    ...
    invoke-virtual {p0, v11}, Lf8/x;->t(I)V

    iget-object p0, p2, Lf8/b;->d:Lf8/x;

    iget p1, p0, Lc8/d;->g:F

    invoke-virtual {p0, p1}, Lf8/x;->v(F)V

    iget-object p0, p2, Lf8/b;->d:Lf8/x;

    invoke-virtual {p0, v5}, Lf8/x;->w(F)V

    iget-object p0, p2, Lf8/b;->c:Lf8/s;

    invoke-virtual {p0, v6}, Lf8/s;->q(Z)V

    iget-object p0, p2, Lf8/b;->c:Lf8/s;

    const/4 p1, 0x0

    iput p1, p0, Lf8/s;->G:F
    ...
    invoke-virtual {p0, p1}, Lc8/d;->l(F)V

    iget-object p0, p2, Lf8/b;->c:Lf8/s;

    iget p0, p0, Lc8/d;->n:F
    ...
    iget-object p1, p2, Lf8/b;->c:Lf8/s;

    iget v0, p1, Lc8/d;->y:F
    ...
    invoke-virtual {p1, p0}, Lc8/d;->n(F)Lc8/d;
    ...
    invoke-virtual {p0, v11}, Lf8/s;->q(Z)V
    ...
    iget-object p1, p2, Lf8/b;->f:Lf8/q;
    ...
    :cond_1
    :pswitch_1
    iget-boolean v0, p1, Lk4/c;->l:Z

    if-eqz v0, :cond_2

    invoke-virtual {p0, p1, p2}, Lcom/android/camera2/compat/theme/custom/cv/MiThemeOperationBottomCV;->onLongExposePrepare(Lk4/c;Lf8/b;)V

    goto/16 :goto_2

    :cond_2
    iget-boolean p0, p1, Lk4/c;->p:Z

    if-eqz p0, :cond_3

    iget-object p0, p2, Lf8/b;->f:Lf8/q;

    iget v0, p0, Lf8/q;->T:I

    iput v0, p0, Lf8/q;->S:I

    iput v4, p0, Lf8/q;->U:I

    iget v0, p0, Lf8/q;->b0:F

    iput v0, p0, Lf8/q;->a0:F

    iput v12, p0, Lf8/q;->c0:F

    invoke-virtual {p0}, Lf8/q;->h()V

    :cond_3
    iget-boolean p0, p1, Lk4/c;->n:Z
    ...
    iput-object v7, p0, Lf8/q;->P:Ljava/lang/String;

    iput-boolean v6, p0, Lf8/q;->N:Z
    ...
    invoke-virtual {p0, v11}, Lc8/d;->i(I)V
    ...
    iget-object p0, p2, Lf8/b;->g:Lf8/r;

    invoke-virtual {p0, v11}, Lc8/d;->i(I)V

    iget-object p0, p2, Lf8/b;->g:Lf8/r;

    iput-boolean v6, p0, Lc8/d;->b:Z

    iget-object p0, p0, Lf8/r;->I:Landroid/graphics/Paint;

    invoke-virtual {p0, v6}, Landroid/graphics/Paint;->setFakeBoldText(Z)V

    iget-object p0, p2, Lf8/b;->j:Ljava/util/ArrayList;

    iget-object p1, p2, Lf8/b;->g:Lf8/r;
    ...
    invoke-virtual {p0, p1}, Lf8/r;->r(F)V
    ...
    iget-object p1, p2, Lf8/b;->j:Ljava/util/ArrayList;
    ...
    :cond_8
    iget-boolean v0, p1, Lk4/c;->d:Z

    if-eqz v0, :cond_9

    iget-object p0, p2, Lf8/b;->d:Lf8/x;

    invoke-virtual {p0, v2}, Lc8/d;->j(I)V

    iget-object p0, p2, Lf8/b;->d:Lf8/x;

    invoke-virtual {p0}, Lf8/x;->h()V

    iget-object p0, p2, Lf8/b;->d:Lf8/x;

    invoke-virtual {p0, v4}, Lc8/d;->i(I)V
    ...
    invoke-virtual {p1, v0, v6}, Lt0/d;->a(IZ)I
...
.method public handleScaleDown(Lf8/b;)Z
    .locals 2

    iget-object p0, p1, Lf8/b;->c:Lf8/s;

    iget v0, p0, Lc8/d;->g:F

    const v1, 0x3f733333    # 0.95f

    mul-float/2addr v0, v1

    invoke-virtual {p0, v0}, Lc8/d;->n(F)Lc8/d;

    iget-object p0, p1, Lf8/b;->d:Lf8/x;

    iget v0, p0, Lc8/d;->g:F

    mul-float/2addr v0, v1

    invoke-virtual {p0, v0}, Lf8/x;->n(F)Lc8/d;

    iget-object p0, p1, Lf8/b;->d:Lf8/x;

    iget v0, p0, Lf8/x;->W:F

    mul-float/2addr v0, v1

    invoke-virtual {p0, v0}, Lf8/x;->u(F)V

    iget-object p0, p1, Lf8/b;->f:Lf8/q;

    iget p1, p0, Lc8/d;->m:I
...
.method public handleStartRecording(Lk4/c;Lf8/b;)Z
    .locals 3

    iget p2, p1, Lk4/c;->a:I
...
.method public handleStopRecording(Lk4/c;Lf8/b;)Z
    .locals 5
    ...
    :cond_3
    :pswitch_1
    invoke-direct {p0, p1, p2}, Lcom/android/camera2/compat/theme/custom/cv/MiThemeOperationBottomCV;->onLongExposeFinish(Lk4/c;Lf8/b;)V
    ...
    invoke-virtual {p0, p1}, Lf8/x;->x(F)V

    iget-object p0, p2, Lf8/b;->d:Lf8/x;

    invoke-virtual {p0, v2}, Lf8/x;->w(F)V

    goto/16 :goto_2

    :cond_5
    :pswitch_2
    iget-boolean p0, p1, Lk4/c;->c:Z
    ...
    invoke-virtual {p0, p1}, Lf8/x;->n(F)Lc8/d;
    ...
    iget p2, p1, Lc8/d;->g:F

    invoke-virtual {p1, p2}, Lc8/d;->n(F)Lc8/d;

    iget p2, p1, Lc8/d;->i:I
...
.method public handleSuspendShutterIntoPattern(Lf8/b0;Lf8/f0;)Z
    .locals 4
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    invoke-virtual {p0, v1, v2, v0, v3}, Lc8/d;->m(FFII)V
    ...
    invoke-virtual {p0, v1, p1, p2, v0}, Lc8/d;->m(FFII)V
...
.method public handleSuspendShutterScaleDown(Lf8/f0;)Z
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "supportSuspendShutter"
...
.method public handleThemeChanged(ZLf8/b0;Lf8/b;)Z
    .locals 4

    iget p0, p2, Lf8/b0;->a:I
    ...
    :cond_4
    iget-object v3, p3, Lf8/b;->c:Lf8/s;

    invoke-virtual {v3, v2}, Lc8/d;->j(I)V

    iget-object v2, p3, Lf8/b;->c:Lf8/s;

    iget v2, v2, Lc8/d;->m:I

    invoke-virtual {v3, v2}, Lc8/d;->i(I)V

    invoke-virtual {v3}, Lc8/d;->h()V

    iget-object v2, p3, Lf8/b;->d:Lf8/x;

    iget v3, v2, Lf8/x;->X:F

    invoke-virtual {v2, v3, v1}, Lf8/x;->s(FI)V

    iget-object v1, p3, Lf8/b;->d:Lf8/x;

    invoke-virtual {v1, p2}, Lf8/x;->t(I)V

    invoke-virtual {v1}, Lf8/x;->h()V

    iget-object v1, p3, Lf8/b;->f:Lf8/q;

    invoke-virtual {v1, v0}, Lc8/d;->j(I)V

    iget-object v0, p3, Lf8/b;->f:Lf8/q;
    ...
    :goto_3
    invoke-virtual {v0, p2}, Lf8/q;->q(I)V
...
.method public onLongExposePrepare(Lk4/c;Lf8/b;)V
    .locals 3
    ...
    invoke-virtual {p0, v0}, Lf8/q;->s(F)V

    iget-object p0, p2, Lf8/b;->c:Lf8/s;

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lf8/s;->q(Z)V

    iget-object p0, p2, Lf8/b;->c:Lf8/s;

    iget v2, p0, Lc8/d;->g:F

    mul-float/2addr v2, v1

    invoke-virtual {p0, v2}, Lc8/d;->n(F)Lc8/d;
    ...
    iget v2, p0, Lf8/x;->W:F

    mul-float/2addr v2, v1

    invoke-virtual {p0, v2}, Lf8/x;->u(F)V

    iget-object p0, p2, Lf8/b;->d:Lf8/x;

    invoke-virtual {p0, v0}, Lf8/x;->t(I)V

    iget-object p0, p2, Lf8/b;->d:Lf8/x;

    iput-boolean p1, p0, Lf8/x;->O:Z
...
.method public playPickersAnimation(Ll4/x;)V
    .locals 0

    invoke-virtual {p1}, Ll4/x;->c()V
...
.method public setExitViewRecourseAndColor(Landroid/content/Context;Landroid/widget/ImageView;)V
    ...
    invoke-virtual {p0, p1, v2}, Lt0/d;->a(IZ)I
...
.method public setMoreModePopUpIconColor(Landroid/widget/ImageView;)V
    ...
    invoke-virtual {p0, p1, v1, v0}, Lt0/d;->f(Landroid/widget/ImageView;IZ)V
