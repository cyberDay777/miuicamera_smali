...
.method public constructor <init>(Le9/r0;Lge/a;Le9/p2;)V
    ...
    iput p1, p0, Lf9/a;->J:I

    iput-object p3, p0, Lf9/a;->B:Le9/p2;

    iget p1, p3, Le9/p2;->a:I

    iput p1, p0, Lf9/a;->J:I

    iget p1, p3, Le9/p2;->d:I
...
.method public B(Z)V
    ...
    invoke-static {p1, p0}, Lcom/android/camera/p3;->a(II)V
...
.method public abstract D(Lf9/a$c;)V
.end method

.method public final E(Lf9/a$c;)V
    .locals 6
    ...
    :cond_0
    iget-object v1, p0, Le9/h1;->A:Lcom/xiaomi/engine/BufferFormat;

    if-nez v1, :cond_1

    new-instance v1, Lcom/xiaomi/engine/BufferFormat;

    iget-object v3, p0, Le9/h1;->u:Lfe/c;
    ...
    invoke-virtual {p0, p1, v1, v0}, Le9/h1;->u(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p0, p1}, Le9/h1;->z(Lcom/xiaomi/engine/PreProcessData;)V
...
.method public final G()Lf9/a$c;
    ...
    iget-object v0, v0, Le9/r0;->t:Landroid/hardware/camera2/CameraDevice;
    ...
    invoke-virtual {p0}, Lf9/a;->J()Lf9/a$d;
    ...
    iget-object v3, v1, Lf9/a$d;->a:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lf9/a$d;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    new-instance p0, Lf9/a$c;

    invoke-direct {p0}, Lf9/a$c;-><init>()V

    iput-object v0, p0, Lf9/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    iget-boolean v0, v1, Lf9/a$d;->c:Z

    iput-boolean v0, p0, Lf9/a$c;->c:Z

    iget-boolean v0, v1, Lf9/a$d;->b:Z

    iput-boolean v0, p0, Lf9/a$c;->b:Z

    return-object p0
.end method

.method public final H(Lf9/a$c;)V
    .locals 2
    ...
    invoke-static {p1, v0, p0}, Le9/c0;->n0(Landroid/hardware/camera2/CaptureRequest$Builder;Le9/c;Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method public abstract I()Lf9/a$b;
.end method

.method public abstract J()Lf9/a$d;
.end method

.method public abstract K()Z
.end method

.method public L(Lje/q;)V
    .locals 1
    .annotation build Landroidx/annotation/CallSuper;
    .end annotation
...
.method public abstract M(Lf9/a$c;)V
.end method
...
.method public final k()Z
    ...
    iget v1, v0, Le9/p2;->f:I

    const/4 v2, 0x1

    if-ne v1, v2, :cond_0

    iget-boolean p0, p0, Le9/h1;->y:Z
...
.method public final n()V
    ...
    invoke-static {v1}, Le9/d;->O(Le9/c;)I
...
.method public final p()V
    ...
    iget-object v3, p0, Lf9/a;->B:Le9/p2;

    iget v4, v3, Le9/p2;->f:I
    ...
    :cond_0
    :try_start_0
    new-instance v4, Lf9/a$a;

    invoke-virtual {p0}, Lf9/a;->I()Lf9/a$b;

    move-result-object v7

    invoke-direct {v4, p0, v7}, Lf9/a$a;-><init>(Lf9/a;Lf9/a$b;)V

    invoke-virtual {p0}, Lf9/a;->G()Lf9/a$c;

    move-result-object v7

    invoke-virtual {p0, v7}, Lf9/a;->D(Lf9/a$c;)V

    iget-object v8, v7, Lf9/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    const/4 v9, 0x3

    invoke-virtual {v0, v8, v9}, Le9/r0;->n1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    invoke-virtual {p0, v7}, Lf9/a;->M(Lf9/a$c;)V

    invoke-virtual {p0, v7}, Lf9/a;->H(Lf9/a$c;)V

    iget v8, v3, Le9/p2;->f:I
    :try_end_0
    ...
    iget-object v12, p0, Le9/c1;->c:Landroid/os/Handler;
    ...
    iget-object v2, v3, Le9/p2;->g:Le9/p2$a;
    ...
    :goto_0
    iget-object v5, v3, Le9/p2;->g:Le9/p2$a;

    iget v5, v5, Le9/p2$a;->c:I

    if-ge v2, v5, :cond_1

    iget-object v5, v7, Lf9/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    invoke-virtual {p0, v5, v2}, Lf9/a;->C(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    sget-object v8, Landroid/hardware/camera2/CaptureRequest;->CONTROL_ENABLE_ZSL:Landroid/hardware/camera2/CaptureRequest$Key;

    iget-boolean v13, v3, Le9/p2;->c:Z
    ...
    :cond_2
    invoke-virtual {p0, v7}, Lf9/a;->E(Lf9/a$c;)V

    invoke-virtual {v0}, Le9/r0;->N1()Landroid/hardware/camera2/CameraCaptureSession;
    ...
    iput-object v1, p0, Le9/h1;->x:Ljava/lang/String;
    ...
    iget-object v2, v7, Lf9/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    invoke-virtual {p0, v2, v6}, Lf9/a;->C(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    sget-object v5, Landroid/hardware/camera2/CaptureRequest;->CONTROL_ENABLE_ZSL:Landroid/hardware/camera2/CaptureRequest$Key;

    iget-boolean v3, v3, Le9/p2;->c:Z
    ...
    :goto_2
    invoke-virtual {p0, v9}, Lf9/a;->B(Z)V
    :try_end_1
    ...
    :catch_1
    invoke-virtual {p0, v6}, Lf9/a;->B(Z)V

    const/16 p0, 0x100

    invoke-virtual {v0, p0}, Le9/a;->W(I)V
