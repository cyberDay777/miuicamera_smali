...
.field public volatile l:Lvg/b$b;

.field public volatile m:Lvg/b$a;

.field public volatile n:Lvg/b$c;
...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput v0, p0, Lvg/b;->g:I

    const/4 v0, 0x0

    iput-boolean v0, p0, Lvg/b;->j:Z

    iput-boolean v0, p0, Lvg/b;->k:Z
    ...
    iput-object p1, p0, Lvg/b;->a:Lrg/i;
...
.method public final Gf()V
    ...
    iget-object v0, p0, Lvg/b;->a:Lrg/i;
    ...
    :cond_0
    invoke-virtual {p0, v3}, Lvg/b;->Me(Z)V

    invoke-virtual {p0}, Lvg/b;->m()V

    return-void
.end method

.method public final Ia(Ljava/util/ArrayList;)V
    .locals 14
    ...
    iput-object v0, p0, Lvg/b;->e:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lvg/b;->n:Lvg/b$c;

    if-nez v0, :cond_1

    new-instance v0, Lvg/b$c;

    invoke-direct {v0, p0}, Lvg/b$c;-><init>(Lvg/b;)V

    iput-object v0, p0, Lvg/b;->n:Lvg/b$c;
    ...
    iput v1, v0, Lvg/b$c;->b:I

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lvg/b;->Me(Z)V
    ...
    sget-object v1, Lrg/h;->q:Ljava/lang/String;
    ...
    invoke-static {v2, v0, v3, v1}, Landroidx/appcompat/graphics/drawable/a;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lvg/b;->n:Lvg/b$c;

    iput v12, v2, Lvg/b$c;->a:I
    ...
    iget-object v9, p0, Lvg/b;->n:Lvg/b$c;
    ...
    invoke-virtual {p0, v11}, Lvg/b;->Me(Z)V
    ...
    invoke-interface {p0}, Lwg/c$a;->se()V
...
.method public final Tf(Landroid/view/Surface;)V
    ...
    iget-object v1, p0, Lvg/b;->c:Lcom/android/camera/ui/TextureVideoView;

    invoke-static {v1}, Lyg/c;->a(Landroid/view/View;)Z
    ...
    :cond_0
    iput-boolean v0, p0, Lvg/b;->i:Z

    iget p1, p0, Lvg/b;->h:I
...
.method public final V0()V
    ...
    invoke-virtual {p0, v0}, Lvg/b;->Tf(Landroid/view/Surface;)V
...
.method public final Vd(Lcom/android/camera/ui/TextureVideoView;Ljava/lang/String;)V
    .locals 2
    ...
    iput-object p1, p0, Lvg/b;->c:Lcom/android/camera/ui/TextureVideoView;

    iput-object p2, p0, Lvg/b;->d:Ljava/lang/String;

    const/4 p1, 0x0

    iput-object p1, p0, Lvg/b;->e:Ljava/lang/String;

    iget-object p1, p0, Lvg/b;->m:Lvg/b$a;
    ...
    iput-object p1, p0, Lvg/b;->m:Lvg/b$a;

    :cond_0
    iget-object p1, p0, Lvg/b;->n:Lvg/b$c;

    if-nez p1, :cond_1

    new-instance p1, Lvg/b$c;

    invoke-direct {p1, p0}, Lvg/b$c;-><init>(Lvg/b;)V

    iput-object p1, p0, Lvg/b;->n:Lvg/b$c;

    :cond_1
    iget-object p1, p0, Lvg/b;->l:Lvg/b$b;

    if-nez p1, :cond_2

    new-instance p1, Lvg/b$b;

    invoke-direct {p1, p0}, Lvg/b$b;-><init>(Lvg/b;)V

    iput-object p1, p0, Lvg/b;->l:Lvg/b$b;

    :cond_2
    iget-object p1, p0, Lvg/b;->c:Lcom/android/camera/ui/TextureVideoView;

    iget-object p2, p0, Lvg/b;->l:Lvg/b$b;
...
.method public final e9(III)V
    ...
    iput p3, p0, Lvg/b;->h:I

    const-string p3, "setRecordParameter:  "

    const-string v1, " | "

    invoke-static {p3, p1, v1, p2, v1}, Landroidx/constraintlayout/core/parser/a;->h(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final declared-synchronized i()V
    ...
    invoke-interface {v0}, Lwg/e;->Ye()V
    ...
    :goto_0
    invoke-virtual {p0, v2}, Lvg/b;->Me(Z)V
    :try_end_0
...
.method public final declared-synchronized l(ILjava/lang/String;)V
    ...
    invoke-interface {v1, p1, p2}, Lwg/e;->v0(ILjava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {p1, v3}, Lg6/q;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, p0, Lvg/b;->b:Landroid/content/Context;
    ...
    invoke-interface {v1, p2}, Lwg/e;->s4([Ljava/lang/String;)V
    :try_end_1
...
.method public final l5()V
    ...
    iget-object v0, p0, Lvg/b;->e:Ljava/lang/String;
    ...
    iget-boolean v0, p0, Lvg/b;->j:Z

    if-eqz v0, :cond_0

    iget-object p0, p0, Lvg/b;->e:Ljava/lang/String;
...
.method public final m()V
    ...
    :try_start_0
    invoke-virtual {p0}, Lvg/b;->l5()V

    const/4 v0, 0x0

    iput-object v0, p0, Lvg/b;->e:Ljava/lang/String;

    iget-object v1, p0, Lvg/b;->n:Lvg/b$c;
    ...
    :cond_0
    iget-object v1, p0, Lvg/b;->m:Lvg/b$a;

    if-eqz v1, :cond_1

    iput-object v0, p0, Lvg/b;->m:Lvg/b$a;
    ...
    iput-object v0, p0, Lvg/b;->l:Lvg/b$b;
    ...
    iput-object v0, p0, Lvg/b;->c:Lcom/android/camera/ui/TextureVideoView;
...
.method public final y6(ILjava/lang/String;)V
    .locals 17
    ...
    invoke-static {v3, v4}, Landroidx/appcompat/view/menu/a;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-wide v2, v1, Lvg/b;->p:J

    const/4 v2, 0x1

    invoke-virtual {v1, v2}, Lvg/b;->Me(Z)V

    if-nez v0, :cond_0

    iput-boolean v5, v1, Lvg/b;->k:Z

    :cond_0
    monitor-enter p0

    :try_start_0
    iget-object v2, v1, Lvg/b;->m:Lvg/b$a;

    if-nez v2, :cond_1

    new-instance v2, Lvg/b$a;

    invoke-direct {v2, v1}, Lvg/b$a;-><init>(Lvg/b;)V

    iput-object v2, v1, Lvg/b;->m:Lvg/b$a;
    ...
    iget-object v3, v1, Lvg/b;->o:Ljava/util/HashMap;
    ...
    iput-object v3, v1, Lvg/b;->o:Ljava/util/HashMap;
    ...
    iget-object v2, v1, Lvg/b;->o:Ljava/util/HashMap;
    ...
    iput v0, v2, Lvg/b$a;->a:I

    const-wide/16 v5, 0x7d0

    sget-object v7, Lrg/h;->l:Ljava/lang/String;
    ...
    iget-object v0, v1, Lvg/b;->m:Lvg/b$a;
    ...
    invoke-virtual {v1, v0, v2}, Lvg/b;->l(ILjava/lang/String;)V
