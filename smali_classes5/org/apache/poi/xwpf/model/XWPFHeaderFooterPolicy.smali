...
.method private commit(Lorg/apache/poi/xwpf/usermodel/XWPFHeaderFooter;)Lorg/apache/xmlbeans/XmlOptions;
    ...
    invoke-static {p1, v0, v1, v2}, Landroidx/appcompat/widget/b;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/HashMap;
...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    sget-object p1, Llq/c;->F:Lorg/apache/xmlbeans/SchemaType;
    ...
    invoke-interface {p0}, Llq/c;->i()Llq/e;

    move-result-object p0

    const-string p1, "_x0000_t136"

    invoke-interface {p0, p1}, Llq/e;->setId(Ljava/lang/String;)V

    invoke-interface {p0}, Llq/e;->f()V

    invoke-interface {p0}, Llq/e;->a()V

    invoke-interface {p0}, Llq/e;->k()V

    invoke-interface {p0}, Llq/e;->l()V

    invoke-interface {p0}, Llq/e;->d()Llq/b;
