...
.method public final d(Landroid/content/Context;Landroid/content/res/Configuration;)V
    ...
    invoke-static {v7}, Lfp/c;->l(Ljava/lang/String;)V
    ...
    invoke-static {v10}, Lfp/c;->l(Ljava/lang/String;)V
    ...
    invoke-static {v10, v0, v9}, Landroidx/constraintlayout/core/parser/a;->l(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-static {v13}, Lfp/c;->l(Ljava/lang/String;)V
    ...
    sget-boolean v2, Lyn/a;->e:Z

    sget v5, Lmiuix/autodensity/i;->b:F

    if-nez v2, :cond_1a

    sget-boolean v2, Lyn/a;->g:Z

    if-eqz v2, :cond_1b

    :cond_1a
    invoke-static/range {p1 .. p1}, Lbn/a;->b(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    :cond_1b
    sget-boolean v2, Lyn/a;->f:Z

    if-eqz v2, :cond_1c

    invoke-static/range {p1 .. p1}, Lyn/b;->c(Landroid/content/Context;)Z
