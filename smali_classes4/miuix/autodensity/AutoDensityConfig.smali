...
.method private constructor <init>(Landroid/app/Application;)V
    ...
    iget-object v2, v0, Lgm/c;->a:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v3, v0, Lgm/c;->c:Lgm/c$b;

    if-nez v3, :cond_0

    new-instance v3, Lgm/c$b;

    invoke-direct {v3}, Lgm/c$b;-><init>()V

    iput-object v3, v0, Lgm/c;->c:Lgm/c$b;
    ...
    iget-object v3, v3, Lgm/c$b;->a:Ljava/util/ArrayList;
    ...
    iget-object p0, v0, Lgm/c;->b:Ljava/lang/Object;

    monitor-enter p0

    :try_start_1
    iget-object p1, v0, Lgm/c;->d:Lgm/c$a;

    if-nez p1, :cond_1

    new-instance p1, Lgm/c$a;

    invoke-direct {p1}, Lgm/c$a;-><init>()V

    iput-object p1, v0, Lgm/c;->d:Lgm/c$a;
    ...
    iget-object v0, p1, Lgm/c$a;->a:Ljava/util/ArrayList;
    ...
    iput-object v0, p1, Lgm/c$a;->a:Ljava/util/ArrayList;

    :cond_2
    iget-object p1, p1, Lgm/c$a;->a:Ljava/util/ArrayList;
...
.method private changeCurrentConfig(Landroid/app/Activity;)V
    ...
    invoke-static {p1, v0, v1}, Lro/a;->c(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
...
.method private removeCurrentConfig(Landroid/app/Activity;)V
    ...
    invoke-static {p1, p0, v0, v1}, Lro/a;->i(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Lmiuix/responsive/page/manager/BaseResponseStateManager$a;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public prepareInApplication(Landroid/app/Application;)V
    ...
    invoke-static {v0, v1, v2, v4, v3}, Lro/a;->g(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sput-object v0, Lfp/c;->d:Ljava/lang/String;
...
.method public processBeforeActivityConfigChanged(Landroid/app/Activity;Landroid/content/res/Configuration;)V
    ...
    invoke-static {p1, v0, v4, v3}, Lbn/a;->j(Landroid/content/Context;Lbn/i;Landroid/content/res/Configuration;Z)V

    invoke-virtual {p0, p1, p2, v0}, Lmiuix/autodensity/e;->onDensityChangedBeforeActivityConfigChanged(Landroid/app/Activity;Landroid/content/res/Configuration;Lbn/i;)V
    ...
    invoke-static {p1, v1, v4, v3}, Lbn/a;->j(Landroid/content/Context;Lbn/i;Landroid/content/res/Configuration;Z)V

    invoke-virtual {p0, p1, p2, v1}, Lmiuix/autodensity/e;->onDensityChangedBeforeActivityConfigChanged(Landroid/app/Activity;Landroid/content/res/Configuration;Lbn/i;)V
