...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 8
    sget v0, Llo/m;->stretchablePickerPreferenceStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lmiuix/preference/StretchablePickerPreference;->j:Lco/a;
    ...
    .line 5
    sget-object v0, Llo/t;->StretchablePickerPreference:[I
    ...
    .line 6
    sget p2, Llo/t;->StretchablePickerPreference_show_lunar:I
...
.method public final e(JZ)V
    ...
    iget-object p3, p0, Lmiuix/preference/StretchablePickerPreference;->j:Lco/a;

    const/4 v1, 0x1

    invoke-virtual {p3, v1}, Lco/a;->v(I)I

    move-result v1

    const/4 v2, 0x5

    invoke-virtual {p3, v2}, Lco/a;->v(I)I

    move-result v2

    const/16 v3, 0x9

    invoke-virtual {p3, v3}, Lco/a;->v(I)I
    ...
    invoke-static {v0, v1, p1, p2}, Lco/c;->a(Landroid/content/Context;IJ)Ljava/lang/String;

    move-result-object p1

    const-string p2, " "

    invoke-static {p3, p2, p1}, Landroidx/concurrent/futures/b;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, p3, p1, p2}, Lco/c;->a(Landroid/content/Context;IJ)Ljava/lang/String;
...
.method public final onBindViewHolder(Landroidx/preference/PreferenceViewHolder;)V
    ...
    sget v2, Llo/q;->datetime_picker:I
    ...
    invoke-direct {v0, p0, v3, v2}, Llo/u;-><init>(Lmiuix/preference/StretchablePickerPreference;Lmiuix/slidingwidget/widget/SlidingButton;Lmiuix/pickerwidget/widget/DateTimePicker;)V
    ...
    new-instance p1, Llo/w;

    invoke-direct {p1, p0, v2}, Llo/w;-><init>(Lmiuix/preference/StretchablePickerPreference;Lmiuix/pickerwidget/widget/DateTimePicker;)V
    ...
    invoke-virtual {p0, v0, v1, p1}, Lmiuix/preference/StretchablePickerPreference;->e(JZ)V

    new-instance p1, Llo/v;

    invoke-direct {p1, p0}, Llo/v;-><init>(Lmiuix/preference/StretchablePickerPreference;)V
