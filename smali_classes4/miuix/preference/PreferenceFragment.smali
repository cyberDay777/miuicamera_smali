...
.method public final fh()V
    ...
    sget v3, Llo/m;->preferenceCardPageBackground:I

    invoke-static {v3, v2}, Lrn/c;->f(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v3}, Lmiuix/appcompat/app/AppCompatActivity;->i4()Z
    ...
    sget v4, Llo/m;->preferenceCardPageNoFloatingBackground:I

    invoke-static {v4, v3}, Lrn/c;->f(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0}, Lbn/a;->f(Landroid/content/Context;)Z
...
.method public final getActionBar()Lmiuix/appcompat/app/ActionBar;
    ...
    invoke-interface {v0}, Lmiuix/appcompat/app/n;->getActionBar()Lmiuix/appcompat/app/ActionBar;
...
.method public final gh(Landroid/content/Context;Lzm/b;II)Z
    .locals 11
    ...
    invoke-virtual {p3}, Lmiuix/appcompat/app/AppCompatActivity;->i4()Z
    ...
    :cond_3
    invoke-virtual {p0, v3}, Lmiuix/preference/PreferenceFragment;->R(I)Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {v1}, Lzm/b$a;->a(I)Lzm/b;

    move-result-object v1

    iput-object v1, p0, Lmiuix/preference/PreferenceFragment;->j:Lzm/b;

    if-eqz v1, :cond_3

    iget-boolean v2, p0, Lmiuix/preference/PreferenceFragment;->h:Z

    iput-boolean v2, v1, Lzm/b;->a:Z
    ...
    invoke-virtual {p0, p1, v1, v2, v2}, Lmiuix/preference/PreferenceFragment;->gh(Landroid/content/Context;Lzm/b;II)Z
    ...
    iget-object v1, p0, Lmiuix/preference/PreferenceFragment;->j:Lzm/b;

    iget-boolean v2, v1, Lzm/b;->a:Z

    if-eqz v2, :cond_2

    invoke-virtual {v1}, Lzm/b;->a()I
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lmiuix/preference/PreferenceFragment;->R(I)Z
    ...
    iget-object v1, p0, Lmiuix/preference/PreferenceFragment;->d:Llo/h;

    if-eqz v1, :cond_3

    invoke-virtual {v1, p1}, Llo/h;->R(I)Z
    ...
    iget-object v0, p0, Lmiuix/preference/PreferenceFragment;->d:Llo/h;
    ...
    invoke-virtual {v0, p1}, Llo/h;->e(Landroid/content/Context;)V

    iget-object p1, p0, Lmiuix/preference/PreferenceFragment;->d:Llo/h;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Lmiuix/preference/PreferenceFragment;->j:Lzm/b;

    if-eqz v3, :cond_0

    iput-boolean v2, v3, Lzm/b;->a:Z
    ...
    sget v1, Llo/m;->preferenceCardStyleEnable:I

    invoke-static {v1, v0, p1}, Lrn/c;->h(ILandroid/content/Context;I)I
...
.method public final onCreateAdapter(Landroidx/preference/PreferenceScreen;)Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    invoke-direct {v0, p1, v1}, Llo/h;-><init>(Landroidx/preference/PreferenceGroup;Z)V

    iput-object v0, p0, Lmiuix/preference/PreferenceFragment;->d:Llo/h;

    const/4 p1, 0x0

    iput-boolean p1, v0, Llo/h;->o:Z

    iget v1, p0, Lmiuix/preference/PreferenceFragment;->k:I

    invoke-virtual {v0, v1}, Llo/h;->R(I)Z
    ...
    iput p1, v0, Llo/h;->w:I

    :cond_1
    iget-object p0, p0, Lmiuix/preference/PreferenceFragment;->d:Llo/h;
...
.method public final onCreateRecyclerView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroidx/recyclerview/widget/RecyclerView;
    ...
    sget p3, Llo/r;->miuix_preference_recyclerview:I
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/n;->x8()Z
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/n;->b7()Landroid/content/Context;
    ...
    sget v2, Llo/m;->windowActionBarOverlay:I

    invoke-static {v0, v2, v1}, Lrn/c;->c(Landroid/content/Context;IZ)Z
    ...
    invoke-static {v0}, Lzm/b$a;->a(I)Lzm/b;

    move-result-object v0

    iput-object v0, p0, Lmiuix/preference/PreferenceFragment;->j:Lzm/b;

    if-eqz v0, :cond_5

    iget-boolean v2, p0, Lmiuix/preference/PreferenceFragment;->h:Z

    iput-boolean v2, v0, Lzm/b;->a:Z
    ...
    iget-object v2, p0, Lmiuix/preference/PreferenceFragment;->j:Lzm/b;

    iget-boolean v3, v2, Lzm/b;->a:Z
    ...
    iget-object v0, p0, Lmiuix/preference/PreferenceFragment;->j:Lzm/b;
    ...
    invoke-virtual {p0, v0, v3, v2, v1}, Lmiuix/preference/PreferenceFragment;->gh(Landroid/content/Context;Lzm/b;II)Z
...
.method public final onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lmiuix/preference/PreferenceFragment;->Ic()Landroid/graphics/Rect;
