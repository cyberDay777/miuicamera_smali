...
.method public constructor <init>(Lmiuix/appcompat/widget/Spinner;Landroid/content/Context;)V
    ...
    invoke-direct {p0, p2, p1}, Lko/c;-><init>(Landroid/content/Context;Landroid/view/View;)V
    ...
    iget-object p2, p0, Lko/c;->d:Lho/a;

    sget v0, Lhm/a$f;->miuix_appcompat_drop_down_menu_padding_single_item:I
    ...
    sget v1, Lhm/a$f;->miuix_appcompat_drop_down_item_min_height:I
    ...
    iput p1, p2, Lho/a;->d:I

    const p1, 0x800053

    invoke-super {p0, p1}, Lko/c;->c(I)V
...
.method public final i(Landroid/widget/ListAdapter;Landroid/content/Context;)[[I
    ...
    iget-object p0, p0, Lko/c;->f:Landroid/widget/ListView;
    ...
    iget-object p2, p0, Lko/c;->b:Landroid/view/View;
    ...
    iget-object p0, p0, Lko/c;->b:Landroid/view/View;
...
.method public final j(Landroid/view/View;)Z
    ...
    invoke-super {p0, p1}, Lko/c;->j(Landroid/view/View;)Z
...
.method public final setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, Lko/c;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public final show(II)V
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/l;->i4()Z
    ...
    sget v5, Lhm/a$h;->action_bar_overlay_layout:I
    ...
    invoke-virtual {p0, v1}, Lko/c;->n(Landroid/view/View;)V
    ...
    invoke-virtual {v1}, Lho/a;->toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lko/c;->l(Landroid/view/View;)V

    :cond_4
    iget-object v5, v1, Lho/a;->q:Landroid/graphics/Rect;

    invoke-virtual {v5}, Landroid/graphics/Rect;->centerX()I

    move-result v5

    iget-object v6, v1, Lho/a;->p:Landroid/graphics/Rect;
    ...
    invoke-super {p0, v5}, Lko/c;->c(I)V
    ...
    :goto_3
    iget-object v5, p0, Lko/c;->e:Lfp/c;

    invoke-virtual {v5, v1}, Lfp/c;->h(Lho/a;)I

    move-result v6

    invoke-virtual {v5, v1}, Lfp/c;->i(Lho/a;)I

    move-result v5

    iget v7, v1, Lho/a;->g:I

    invoke-virtual {p0, v7}, Landroid/widget/PopupWindow;->setWidth(I)V

    iget v1, v1, Lho/a;->h:I
    ...
    invoke-virtual {p0, v4, v3, v6, v5}, Lko/c;->showAtLocation(Landroid/view/View;III)V
    ...
    :cond_7
    :goto_4
    iget-object v1, p0, Lko/c;->f:Landroid/widget/ListView;
