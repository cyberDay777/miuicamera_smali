...
.field public final U:Lmiuix/appcompat/app/d;

.field public final V:Ljm/h;
...
.field public g0:Lmiuix/appcompat/app/i$a;
...
.field public i0:Lmiuix/appcompat/app/i$c;

.field public final j0:Lmiuix/appcompat/app/i$b;
...
.method public constructor <init>(Lmiuix/appcompat/app/AppCompatActivity;Lmiuix/appcompat/app/AppCompatActivity$a;Lmiuix/appcompat/app/AppCompatActivity$b;)V
    ...
    iput-boolean p1, p0, Lmiuix/appcompat/app/i;->W:Z

    iput-boolean p1, p0, Lmiuix/appcompat/app/i;->Y:Z

    iput-boolean p1, p0, Lmiuix/appcompat/app/i;->Z:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lmiuix/appcompat/app/i;->c0:Landroid/view/ViewGroup;

    iput-boolean p1, p0, Lmiuix/appcompat/app/i;->e0:Z

    new-instance p1, Lmiuix/appcompat/app/i$b;

    invoke-direct {p1, p0}, Lmiuix/appcompat/app/i$b;-><init>(Lmiuix/appcompat/app/i;)V

    iput-object p1, p0, Lmiuix/appcompat/app/i;->j0:Lmiuix/appcompat/app/i$b;
    ...
    iput-object p1, p0, Lmiuix/appcompat/app/i;->d0:Ljava/lang/String;

    iput-object p2, p0, Lmiuix/appcompat/app/i;->U:Lmiuix/appcompat/app/d;

    iput-object p3, p0, Lmiuix/appcompat/app/i;->V:Ljm/h;
...
.method public final invalidateOptionsMenu()V
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/i;->j0:Lmiuix/appcompat/app/i$b;

    invoke-virtual {p0}, Lmiuix/appcompat/app/i$b;->run()V
...
.method public final o()V
    ...
    :cond_0
    iget-object v0, p0, Lmiuix/appcompat/app/i;->h0:Landroid/view/Window;
    ...
    iget-object v2, p0, Lmiuix/appcompat/app/i;->h0:Landroid/view/Window;
    ...
    instance-of v4, v2, Lmiuix/appcompat/app/i$c;

    if-nez v4, :cond_2

    new-instance v3, Lmiuix/appcompat/app/i$c;

    invoke-direct {v3, p0, v2}, Lmiuix/appcompat/app/i$c;-><init>(Lmiuix/appcompat/app/i;Landroid/view/Window$Callback;)V

    iput-object v3, p0, Lmiuix/appcompat/app/i;->i0:Lmiuix/appcompat/app/i$c;

    invoke-virtual {v0, v3}, Landroid/view/Window;->setCallback(Landroid/view/Window$Callback;)V

    iput-object v0, p0, Lmiuix/appcompat/app/i;->h0:Landroid/view/Window;
    ...
    iput-object v3, p0, Lmiuix/appcompat/app/i;->Q:Landroid/view/LayoutInflater;

    sget-object v3, Lhm/a$m;->Window:[I

    invoke-virtual {v1, v3}, Landroid/app/Activity;->obtainStyledAttributes([I)Landroid/content/res/TypedArray;

    move-result-object v3

    sget v4, Lhm/a$m;->Window_responsiveEnabled:I

    iget-boolean v5, p0, Lmiuix/appcompat/app/i;->W:Z
    ...
    invoke-direct {v4, p0, p0}, Lmiuix/appcompat/app/i$a;-><init>(Lmiuix/appcompat/app/i;Lto/a;)V

    iput-object v4, p0, Lmiuix/appcompat/app/i;->g0:Lmiuix/appcompat/app/i$a;

    :cond_5
    sget v4, Lhm/a$m;->Window_windowLayoutMode:I
    ...
    :cond_6
    sget v4, Lhm/a$m;->Window_windowActionBar:I
    ...
    invoke-virtual {p0, v4}, Lmiuix/appcompat/app/b;->j(I)V

    :cond_7
    sget v4, Lhm/a$m;->Window_windowActionBarOverlay:I
    ...
    :cond_8
    sget v4, Lhm/a$m;->Window_isMiuixFloatingTheme:I

    invoke-virtual {v3, v4, v5}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v4

    iput-boolean v4, p0, Lmiuix/appcompat/app/i;->Y:Z

    sget v4, Lhm/a$m;->Window_windowFloating:I

    invoke-virtual {v3, v4, v5}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v4

    iput-boolean v4, p0, Lmiuix/appcompat/app/i;->Z:Z

    sget v4, Lhm/a$m;->Window_windowTranslucentStatus:I

    invoke-virtual {v3, v4, v5}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v4

    invoke-virtual {p0, v4}, Lmiuix/appcompat/app/b;->m(I)V
    ...
    iput v4, p0, Lmiuix/appcompat/app/i;->a0:I

    iget-boolean v4, p0, Lmiuix/appcompat/app/i;->Y:Z

    const/4 v6, 0x0

    if-eqz v4, :cond_b

    invoke-static {v1}, Lkm/b;->a(Lmiuix/appcompat/app/AppCompatActivity;)I
    ...
    invoke-direct {v4, v1}, Lkm/e;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-direct {v4, v1}, Lkm/c;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-direct {v4, v1}, Lkm/d;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    :goto_2
    iput-object v4, p0, Lmiuix/appcompat/app/i;->b0:Lkm/a;

    iput-object v6, p0, Lmiuix/appcompat/app/i;->c0:Landroid/view/ViewGroup;

    invoke-virtual {v2}, Landroid/view/Window;->getContext()Landroid/content/Context;

    move-result-object v4

    sget v7, Lhm/a$c;->windowActionBar:I

    invoke-static {v4, v7, v5}, Lrn/c;->c(Landroid/content/Context;IZ)Z

    move-result v8

    if-eqz v8, :cond_d

    sget v8, Lhm/a$c;->windowActionBarMovable:I

    invoke-static {v4, v8, v5}, Lrn/c;->c(Landroid/content/Context;IZ)Z

    move-result v8

    if-eqz v8, :cond_c

    sget v8, Lhm/a$j;->miuix_appcompat_screen_action_bar_movable:I
    ...
    :cond_d
    sget v8, Lhm/a$j;->miuix_appcompat_screen_simple:I

    :goto_3
    sget v9, Lhm/a$c;->startingWindowOverlay:I

    invoke-static {v9, v4}, Lrn/c;->b(ILandroid/content/Context;)I
    ...
    invoke-static {v4, v7, v0}, Lrn/c;->c(Landroid/content/Context;IZ)Z
    ...
    sget v7, Lhm/a$c;->windowTranslucentStatus:I

    invoke-static {v7, v4, v5}, Lrn/c;->h(ILandroid/content/Context;I)I

    move-result v4

    invoke-static {v2, v4}, Lcn/a;->a(Landroid/view/Window;I)Z
    ...
    iget-object v7, p0, Lmiuix/appcompat/app/i;->b0:Lkm/a;
    ...
    iput-boolean v7, p0, Lmiuix/appcompat/app/i;->Z:Z

    iget-object v8, p0, Lmiuix/appcompat/app/i;->b0:Lkm/a;

    invoke-virtual {v8, v7}, Lkm/a;->k(Z)V

    iget-object v7, p0, Lmiuix/appcompat/app/i;->b0:Lkm/a;

    iget-boolean v8, p0, Lmiuix/appcompat/app/i;->Z:Z

    invoke-virtual {v7, v4, v8}, Lkm/a;->i(Landroid/view/View;Z)Landroid/view/ViewGroup;

    move-result-object v4

    iput-object v4, p0, Lmiuix/appcompat/app/i;->c0:Landroid/view/ViewGroup;

    iget-boolean v7, p0, Lmiuix/appcompat/app/i;->Z:Z

    invoke-virtual {p0, v7}, Lmiuix/appcompat/app/i;->w(Z)V

    iget-object v7, p0, Lmiuix/appcompat/app/i;->b0:Lkm/a;

    invoke-virtual {v7}, Lkm/a;->m()Z
    ...
    new-instance v8, Lmiuix/appcompat/app/j;

    invoke-direct {v8, p0}, Lmiuix/appcompat/app/j;-><init>(Lmiuix/appcompat/app/i;)V
    ...
    sget v7, Lhm/a$h;->action_bar_overlay_layout:I
    ...
    iput-object v7, p0, Lmiuix/appcompat/app/i;->M:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;
    ...
    iget-object v7, p0, Lmiuix/appcompat/app/i;->M:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;

    iget-boolean v8, p0, Lmiuix/appcompat/app/b;->w:Z

    invoke-virtual {v7, v8}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraHorizontalPaddingEnable(Z)V

    iget-object v7, p0, Lmiuix/appcompat/app/i;->M:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;

    iget-boolean v8, p0, Lmiuix/appcompat/app/b;->x:Z

    invoke-virtual {v7, v8}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraHorizontalPaddingInitEnable(Z)V

    iget-object v7, p0, Lmiuix/appcompat/app/i;->M:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;

    iget-boolean v8, p0, Lmiuix/appcompat/app/b;->y:Z

    invoke-virtual {v7, v8}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingApplyToContentEnable(Z)V

    iget-object v7, p0, Lmiuix/appcompat/app/i;->M:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;

    iget-object v8, p0, Lmiuix/appcompat/app/b;->u:Lzm/b;

    invoke-virtual {v7, v8}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(Lzm/b;)V
    ...
    iget-object v2, p0, Lmiuix/appcompat/app/i;->M:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;
    ...
    iput-object v2, p0, Lmiuix/appcompat/app/i;->P:Landroid/view/ViewGroup;

    :cond_13
    iget-object v2, p0, Lmiuix/appcompat/app/i;->b0:Lkm/a;

    if-eqz v2, :cond_14

    iget-object v4, p0, Lmiuix/appcompat/app/i;->c0:Landroid/view/ViewGroup;

    invoke-virtual {p0}, Lmiuix/appcompat/app/i;->v()Z

    move-result v6

    invoke-virtual {v2, v4, v6}, Lkm/a;->f(Landroid/view/ViewGroup;Z)V
    ...
    invoke-virtual {v2, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->a(Lzm/a;)V
    ...
    sget v4, Lhm/a$h;->action_bar_container:I
    ...
    iput-object v2, p0, Lmiuix/appcompat/app/i;->O:Lmiuix/appcompat/internal/app/widget/ActionBarContainer;
    ...
    sget v6, Lhm/a$d;->abc_split_action_bar_is_narrow:I

    invoke-virtual {v4, v6}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v4

    iput-boolean v4, p0, Lmiuix/appcompat/app/i;->f0:Z

    goto :goto_5

    :cond_19
    sget v4, Lhm/a$m;->Window_windowSplitActionBar:I
    ...
    :goto_5
    iget-boolean v4, p0, Lmiuix/appcompat/app/i;->f0:Z

    if-eqz v4, :cond_1a

    iget-object v4, p0, Lmiuix/appcompat/app/i;->M:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;

    invoke-virtual {p0, v0, v2, v4}, Lmiuix/appcompat/app/b;->c(ZZLmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;)V

    :cond_1a
    sget v0, Lhm/a$m;->Window_endActionMenuEnabled:I
    ...
    sget v0, Lhm/a$m;->Window_hyperActionMenuEnabled:I

    invoke-virtual {v3, v0, v5}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v0

    invoke-virtual {p0, v0}, Lmiuix/appcompat/app/b;->k(Z)V
...
.method public final p(Landroid/content/res/Configuration;)V
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/AppCompatActivity;->a:Lbn/i;
    ...
    iget v1, p0, Lmiuix/appcompat/app/b;->r:I
    ...
    invoke-virtual {v0, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(Lzm/b;)V
...
.method public final q(ILandroid/view/MenuItem;)Z
    ...
    invoke-static {v0, p1, p2}, Lmiuix/appcompat/app/AppCompatActivity;->t5(Lmiuix/appcompat/app/AppCompatActivity;ILandroid/view/MenuItem;)Z
...
.method public final u(Z)V
    ...
    iput-boolean p1, p0, Lmiuix/appcompat/app/b;->w:Z

    iget-object v0, p0, Lmiuix/appcompat/app/b;->u:Lzm/b;
...
.method public final w(Z)V
    ...
    invoke-static {v0}, Landroidx/core/app/e;->e(Landroid/view/Window;)V

    goto :goto_4

    :cond_5
    invoke-static {v0}, Landroidx/core/app/f;->g(Landroid/view/Window;)V
