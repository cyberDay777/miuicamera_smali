...
.field public final l1:Ltm/a;

.field public m0:Landroid/view/View;

.field public final m1:Ltm/a;
...
.field public u1:Lmiuix/appcompat/internal/app/widget/h;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v11, Lhm/a$f;->miuix_appcompat_action_bar_title_horizontal_padding:I
    ...
    sget v11, Lhm/a$f;->miuix_appcompat_action_bar_title_tab_horizontal_padding:I
    ...
    sget v11, Lhm/a$f;->miuix_appcompat_action_bar_title_top_padding:I
    ...
    sget v11, Lhm/a$f;->miuix_appcompat_action_bar_title_bottom_padding:I
    ...
    sget v11, Lhm/a$f;->miuix_appcompat_action_bar_subtitle_bottom_padding:I
    ...
    sget v11, Lhm/a$f;->miuix_appcompat_action_bar_secondary_tab_vertical_padding:I
    ...
    sget v11, Lhm/a$f;->miuix_appcompat_action_bar_up_view_margin_start:I
    ...
    sget v5, Lhm/a$h;->action_bar_collapse_container:I
    ...
    sget v7, Lhm/a$h;->action_bar_movable_container:I
    ...
    sget-object v1, Lhm/a$m;->ActionBar:[I
    ...
    sget v1, Lhm/a$m;->ActionBar_android_navigationMode:I
    ...
    sget v1, Lhm/a$m;->ActionBar_android_title:I
    ...
    sget v1, Lhm/a$m;->ActionBar_android_subtitle:I
    ...
    sget v1, Lhm/a$m;->ActionBar_titleCenter:I
    ...
    sget v1, Lhm/a$m;->ActionBar_android_logo:I
    ...
    sget v1, Lhm/a$m;->ActionBar_android_icon:I
    ...
    sget v4, Lhm/a$m;->ActionBar_navigatorSwitchLayout:I

    sget v5, Lhm/a$j;->miuix_appcompat_action_bar_navigator_switch:I
    ...
    sget v4, Lhm/a$m;->ActionBar_android_homeLayout:I

    sget v5, Lhm/a$j;->miuix_appcompat_action_bar_home:I
    ...
    sget v4, Lhm/a$m;->ActionBar_android_titleTextStyle:I

    invoke-virtual {p2, v4, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I

    sget v4, Lhm/a$m;->ActionBar_android_subtitleTextStyle:I

    invoke-virtual {p2, v4, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I

    sget v4, Lhm/a$m;->ActionBar_android_progressBarPadding:I
    ...
    sget v4, Lhm/a$m;->ActionBar_android_itemPadding:I

    invoke-virtual {p2, v4, v2}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    sget v4, Lhm/a$m;->ActionBar_android_displayOptions:I
    ...
    sget v4, Lhm/a$m;->ActionBar_android_customNavigationLayout:I
    ...
    :cond_2
    sget v0, Lhm/a$m;->ActionBar_android_minHeight:I
    ...
    sget v0, Lhm/a$m;->ActionBar_android_maxHeight:I
    ...
    sget v1, Lhm/a$f;->miuix_appcompat_action_bar_large_font_max_height:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    sget v1, Lhm/a$c;->actionBarTitleAdaptLargeFont:I

    invoke-static {p1, v1, v3}, Lrn/c;->c(Landroid/content/Context;IZ)Z

    move-result v1

    invoke-static {p1}, Lbn/e;->c(Landroid/content/Context;)I
    ...
    sget v0, Lhm/a$m;->ActionBar_showOptionIcons:I
    ...
    invoke-direct {p2, p1, v1, v0}, Ltm/a;-><init>(Landroid/content/Context;ILjava/lang/CharSequence;)V

    iput-object p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->l1:Ltm/a;
    ...
    iput-object p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->m1:Ltm/a;

    new-instance p1, Lvg/a;

    const/16 p2, 0x9

    invoke-direct {p1, p0, p2}, Lvg/a;-><init>(Ljava/lang/Object;I)V
...
.method private setTitleImpl(Ljava/lang/CharSequence;)V
    ...
    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->l1:Ltm/a;

    if-eqz v4, :cond_3

    iput-object p1, v4, Ltm/a;->b:Ljava/lang/CharSequence;

    :cond_3
    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->m1:Ltm/a;
    ...
    :cond_9
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Lpm/a;

    if-eqz p1, :cond_a

    iget-object p1, p1, Lpm/a;->b:Landroid/widget/LinearLayout;
    ...
    :cond_a
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Lpm/b;

    if-eqz p1, :cond_b

    if-nez v3, :cond_b

    iget-object p1, p1, Lpm/b;->b:Landroid/widget/LinearLayout;
...
.method private setTitleVisibility(Z)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Lpm/a;
    ...
    :goto_0
    iget-boolean v5, v0, Lpm/a;->e:Z

    if-nez v5, :cond_1

    if-nez v4, :cond_1

    iget-object v0, v0, Lpm/a;->b:Landroid/widget/LinearLayout;
    ...
    :cond_2
    :goto_1
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Lpm/b;
    ...
    :goto_2
    invoke-virtual {v0, p1}, Lpm/b;->c(I)V
...
.method public final A(Z)V
    ...
    invoke-direct {v1, v0}, Lpm/b;-><init>(Landroid/content/Context;)V

    new-instance v2, Landroid/widget/LinearLayout;

    invoke-direct {v2, v0}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    iput-object v2, v1, Lpm/b;->b:Landroid/widget/LinearLayout;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Landroid/view/View;->setImportantForAccessibility(I)V

    iget-object v2, v1, Lpm/b;->b:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v5, v1, v6}, Lch/e;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v2, v5}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    new-instance v2, Lrm/c;

    sget v5, Lhm/a$c;->expandTitleTheme:I

    invoke-direct {v2, v0, v5}, Lrm/c;-><init>(Landroid/content/Context;I)V

    iput-object v2, v1, Lpm/b;->c:Lrm/c;

    sget v5, Lhm/a$h;->action_bar_title_expand:I

    invoke-virtual {v2, v5}, Landroid/view/View;->setId(I)V

    iget-object v2, v1, Lpm/b;->c:Lrm/c;
    ...
    invoke-static {v2}, Lje/b0;->a(Landroid/widget/TextView;)V

    :cond_0
    iget-object v2, v1, Lpm/b;->b:Landroid/widget/LinearLayout;

    iget-object v7, v1, Lpm/b;->c:Lrm/c;
    ...
    sget v7, Lhm/a$c;->expandSubtitleTheme:I

    invoke-direct {v2, v0, v7}, Lrm/c;-><init>(Landroid/content/Context;I)V

    iput-object v2, v1, Lpm/b;->d:Lrm/c;

    sget v7, Lhm/a$h;->action_bar_subtitle_expand:I

    invoke-virtual {v2, v7}, Landroid/view/View;->setId(I)V

    iget-object v2, v1, Lpm/b;->d:Lrm/c;
    ...
    iget-object v8, v1, Lpm/b;->d:Lrm/c;
    ...
    sget v8, Lhm/a$f;->action_bar_subtitle_top_margin:I
    ...
    sget v8, Lhm/a$f;->action_bar_subtitle_bottom_margin:I
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Lpm/b;

    iget-boolean v0, v1, Lpm/b;->e:Z

    iget-boolean v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->d1:Z

    if-eq v0, v2, :cond_2

    iput-boolean v2, v1, Lpm/b;->e:Z

    iget-object v0, v1, Lpm/b;->b:Landroid/widget/LinearLayout;
    ...
    iget-boolean v1, v0, Lpm/b;->h:Z

    if-eqz v1, :cond_3

    iget-object v1, v0, Lpm/b;->c:Lrm/c;

    invoke-virtual {v1, v5}, Lrm/c;->b(Z)V

    iput-boolean v5, v0, Lpm/b;->h:Z
    ...
    iget-object v2, v0, Lpm/b;->b:Landroid/widget/LinearLayout;
    ...
    :cond_4
    iget-object v0, v0, Lpm/b;->d:Lrm/c;
    ...
    sget v2, Lhm/a$h;->action_bar_expand_container:I
    ...
    :goto_1
    iget-object v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Lpm/b;

    invoke-virtual {v2, v0}, Lpm/b;->b(Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Lpm/b;

    iget-object v0, v0, Lpm/b;->b:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {v0, v1}, Lpm/b;->a(Ljava/lang/CharSequence;)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Lpm/b;
...
.method public final H()V
    ...
    sget v2, Lhm/a$c;->actionBarIndeterminateProgressStyle:I
    ...
    sget v1, Lhm/a$h;->progress_circular:I
...
.method public final I()V
    ...
    sget v7, Lhm/a$f;->miuix_appcompat_action_bar_title_view_padding_horizontal:I
    ...
    invoke-direct {v8, v7, v6, v9}, Ly4/b;-><init>(Ljava/lang/Object;II)V

    invoke-virtual {v7, v8}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    sget v6, Lhm/a$h;->up:I
    ...
    sget v8, Lhm/a$k;->actionbar_button_up_description:I
    ...
    invoke-direct {v8, v2, v6, v1}, Le2/b;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    :goto_1
    iget-object v8, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->A0:Landroid/widget/FrameLayout;
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Lpm/b;
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Lpm/a;
...
.method public final L()Z
    ...
    sget v0, Lhm/a$c;->actionBarTightTitle:I

    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->j0:Landroid/content/Context;

    invoke-static {p0, v0, v1}, Lrn/c;->c(Landroid/content/Context;IZ)Z
...
.method public final Q()V
    ...
    sget v3, Lhm/a$c;->actionBarPaddingStart:I

    invoke-static {v3, v2}, Lrn/c;->e(ILandroid/content/Context;)I
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Lpm/a;

    iget-object v2, v2, Lpm/a;->b:Landroid/widget/LinearLayout;
...
.method public final T(Lmiuix/appcompat/internal/app/widget/l;Lmiuix/appcompat/internal/app/widget/n;Lmiuix/appcompat/internal/app/widget/p;Lmiuix/appcompat/internal/app/widget/q;)V
    .locals 1
...
.method public final W()V
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->u1:Lmiuix/appcompat/internal/app/widget/h;

    if-nez v1, :cond_2

    new-instance v1, Lmiuix/appcompat/internal/app/widget/h;

    invoke-direct {v1, p0, v3}, Lmiuix/appcompat/internal/app/widget/h;-><init>(Ljava/lang/Object;I)V

    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->u1:Lmiuix/appcompat/internal/app/widget/h;

    :cond_2
    const v1, 0xf4240

    iget-object v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->u1:Lmiuix/appcompat/internal/app/widget/h;
...
.method public final Y()V
    ...
    iget-object v0, v0, Lpm/a;->c:Lrm/b;
    ...
    invoke-virtual {v0, v2}, Lpm/a;->c(Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Lpm/a;

    iget-object v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->e0:Ljava/lang/CharSequence;

    invoke-virtual {v0, v2}, Lpm/a;->b(Ljava/lang/CharSequence;)V

    new-instance v0, Lmiuix/appcompat/internal/app/widget/g;

    invoke-direct {v0, p0, v1}, Lmiuix/appcompat/internal/app/widget/g;-><init>(Ljava/lang/Object;I)V
...
.method public final Z()V
    ...
    iget-object v2, v2, Lpm/b;->c:Lrm/c;
    ...
    invoke-virtual {v0, v1}, Lpm/b;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p0}, Lpm/b;->a(Ljava/lang/CharSequence;)V
...
.method public final a0()Z
    ...
    sget v1, Lhm/a$h;->action_bar_expand_container:I
    ...
    invoke-virtual {v0, v2}, Lpm/b;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v2, v4}, Lpm/b;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v1}, Lpm/b;->c(I)V
...
.method public final d0()V
    ...
    :goto_1
    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Lpm/a;

    if-eqz v4, :cond_3

    iget-object v4, v4, Lpm/a;->c:Lrm/b;
...
.method public getCollapseTitle()Lpm/a;
    .locals 1
...
.method public getExpandTitle()Lpm/b;
    .locals 1
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    sget-object v0, Lhm/a$m;->ActionBar:[I
    ...
    sget v2, Lhm/a$f;->miuix_appcompat_action_bar_large_font_max_height:I

    invoke-virtual {v1, v2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v1

    sget v2, Lhm/a$c;->actionBarTitleAdaptLargeFont:I

    const/4 v4, 0x1

    invoke-static {v0, v2, v4}, Lrn/c;->c(Landroid/content/Context;IZ)Z

    move-result v2

    invoke-static {v0}, Lbn/e;->c(Landroid/content/Context;)I
    ...
    iget-object v1, p1, Lpm/b;->c:Lrm/c;

    iget v2, p1, Lpm/b;->f:I

    invoke-virtual {v1, v2}, Landroid/widget/TextView;->setTextAppearance(I)V

    iget-object v1, p1, Lpm/b;->d:Lrm/c;

    iget v2, p1, Lpm/b;->g:I
    ...
    iget-object p1, p1, Lpm/b;->c:Lrm/c;

    invoke-static {p1}, Lje/b0;->a(Landroid/widget/TextView;)V
    ...
    sget v1, Lhm/a$f;->miuix_appcompat_action_bar_title_tab_horizontal_padding:I
    ...
    sget v1, Lhm/a$f;->miuix_appcompat_action_bar_title_top_padding:I
    ...
    sget v1, Lhm/a$f;->miuix_appcompat_action_bar_title_bottom_padding:I
    ...
    sget v1, Lhm/a$f;->miuix_appcompat_action_bar_subtitle_bottom_padding:I
    ...
    sget v0, Lhm/a$f;->miuix_appcompat_action_bar_up_view_margin_start:I
    ...
    sget v0, Lhm/a$f;->miuix_appcompat_action_bar_title_horizontal_padding:I
    ...
    sget v3, Lhm/a$f;->miuix_appcompat_action_bar_title_top_padding:I
    ...
    sget v0, Lhm/a$f;->miuix_appcompat_action_bar_secondary_tab_vertical_padding:I
    ...
    sget v0, Lhm/a$c;->actionBarPaddingStart:I

    invoke-static {v0, p1}, Lrn/c;->e(ILandroid/content/Context;)I
    ...
    sget v1, Lhm/a$c;->actionBarPaddingEnd:I

    invoke-static {v1, v0}, Lrn/c;->e(ILandroid/content/Context;)I
...
.method public final onLayout(ZIIII)V
    ...
    :goto_8
    iget-object v0, v6, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Lpm/a;
    ...
    iget-object v3, v0, Lpm/a;->c:Lrm/b;

    invoke-virtual {v3}, Landroid/widget/TextView;->getPaint()Landroid/text/TextPaint;

    move-result-object v3

    iget v4, v0, Lpm/a;->h:F
    ...
    iput v3, v0, Lpm/a;->h:F

    const/4 v3, 0x1

    iput-boolean v3, v0, Lpm/a;->g:Z
    ...
    iput-boolean v7, v0, Lpm/a;->g:Z

    :cond_13
    :goto_9
    iget-boolean v3, v0, Lpm/a;->g:Z
    ...
    iput v2, v0, Lpm/a;->i:F

    const/4 v2, 0x0

    iput-boolean v2, v0, Lpm/a;->g:Z

    :cond_14
    iget-object v2, v0, Lpm/a;->c:Lrm/b;
    ...
    :goto_c
    sget v0, Lhm/a$c;->actionBarTitleEnableEllipsis:I

    iget-object v2, v6, Lmiuix/appcompat/internal/app/widget/ActionBarView;->j0:Landroid/content/Context;

    const/4 v3, 0x0

    invoke-static {v2, v0, v3}, Lrn/c;->c(Landroid/content/Context;IZ)Z
    ...
    invoke-static/range {v0 .. v5}, Lrn/e;->c(Landroid/view/ViewGroup;Landroid/view/View;IIII)V
...
.method public final onMeasure(II)V
    ...
    sget v2, Lhm/a$h;->miuix_appcompat_navigator_switch_presenter:I
    ...
    iget-object v11, v2, Lom/b;->a:Landroid/view/View;

    iget v2, v2, Lom/b;->b:I
    ...
    iget-object v11, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Lpm/a;
    ...
    iget-object v5, v11, Lpm/a;->c:Lrm/b;
    ...
    iget-object v5, v11, Lpm/a;->d:Lrm/c;
    ...
    iget-object v9, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->M0:Lzm/b;

    if-eqz v9, :cond_32

    iget-boolean v10, v9, Lzm/b;->a:Z

    if-eqz v10, :cond_32

    invoke-virtual {v9}, Lzm/b;->a()I
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-direct {v0, p0, v1}, Lmg/d;-><init>(Ljava/lang/Object;I)V
...
.method public final s()V
    ...
    iget-object v0, v0, Lpm/b;->c:Lrm/c;
    ...
    invoke-virtual {v0, v2}, Lpm/b;->c(I)V
    ...
    iget-object v2, v2, Lpm/b;->b:Landroid/widget/LinearLayout;
...
.method public setDisplayOptions(I)V
    ...
    :cond_e
    iget-object v9, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Lpm/a;

    if-eqz v9, :cond_f

    iget-object v11, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->s0:Landroid/widget/FrameLayout;

    iget-object v9, v9, Lpm/a;->b:Landroid/widget/LinearLayout;

    invoke-virtual {v11, v9}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    :cond_f
    iget-object v9, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Lpm/b;

    if-eqz v9, :cond_10

    iget-object v11, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->t0:Landroid/widget/FrameLayout;

    iget-object v9, v9, Lpm/b;->b:Landroid/widget/LinearLayout;

    invoke-virtual {v11, v9}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    :cond_10
    iput-object v5, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Lpm/a;

    iput-object v5, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Lpm/b;
    ...
    :goto_9
    iget-object v10, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Lpm/a;

    if-eqz v10, :cond_14

    iget-object v10, v10, Lpm/a;->b:Landroid/widget/LinearLayout;
    ...
    :goto_a
    iget-object v11, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Lpm/b;

    if-eqz v11, :cond_15

    iget-object v11, v11, Lpm/b;->b:Landroid/widget/LinearLayout;
    ...
    sget v1, Lhm/a$h;->miuix_appcompat_navigator_switch_presenter:I

    new-instance v2, Lom/b;

    invoke-direct {v2, v0}, Lom/b;-><init>(Landroid/view/View;)V
    ...
    sget v0, Lhm/a$k;->abc_action_bar_up_description:I
    ...
    sget v0, Lhm/a$k;->abc_action_bar_home_description:I
...
.method public setExtraPaddingPolicy(Lzm/b;)V
    .locals 0

    iput-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->M0:Lzm/b;
...
.method public setSplitActionBar(Z)V
    ...
    sget v1, Lhm/a$d;->abc_action_bar_expanded_action_views_exclusive:I
...
.method public setSubtitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Lpm/a;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Lpm/b;->a(Ljava/lang/CharSequence;)V
...
.method public setTitleClickable(Z)V
    ...
    iget-object v1, v0, Lpm/a;->b:Landroid/widget/LinearLayout;
    ...
    :cond_0
    iget-object v0, v0, Lpm/a;->d:Lrm/c;
...
.method public final t()V
    ...
    sget v0, Lhm/a$h;->action_bar_collapse_tab_container:I
...
.method public final u()V
    ...
    sget v0, Lhm/a$h;->action_bar_movable_tab_container:I
...
.method public final v()V
    ...
    invoke-static {v5, v6}, Lbn/e;->b(Landroid/content/Context;F)I
    ...
    invoke-static {v4, v5}, Lrn/e;->d(ILmiuix/appcompat/internal/view/menu/action/b;)V
    ...
    invoke-static {v5, v6}, Lrn/e;->d(ILmiuix/appcompat/internal/view/menu/action/b;)V
    ...
    sget v1, Lhm/a$h;->expanded_menu:I
...
.method public final w()V
    ...
    iget-object v3, v0, Lpm/b;->b:Landroid/widget/LinearLayout;
    ...
    iget-object v3, v0, Lpm/a;->b:Landroid/widget/LinearLayout;
    ...
    sget v7, Lhm/a$h;->action_bar_expand_container:I
    ...
    sget v3, Lhm/a$c;->actionBarTightTitle:I

    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->j0:Landroid/content/Context;

    invoke-static {v4, v3, v6}, Lrn/c;->c(Landroid/content/Context;IZ)Z
...
.method public final z(Z)V
    ...
    invoke-direct {v1, v0}, Lpm/a;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    invoke-static {v0}, Lbn/a;->a(Landroid/content/Context;)Lbn/i;
    ...
    invoke-static {v0, v3, v4, v5}, Lbn/a;->j(Landroid/content/Context;Lbn/i;Landroid/content/res/Configuration;Z)V

    iget-object v3, v3, Lbn/i;->c:Landroid/graphics/Point;
    ...
    iput-boolean v4, v1, Lpm/a;->j:Z

    sget v7, Lhm/a$f;->miuix_appcompat_subtitle_text_size:I
    ...
    iput v7, v1, Lpm/a;->f:F

    new-instance v7, Landroid/widget/LinearLayout;

    invoke-direct {v7, v0}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    iput-object v7, v1, Lpm/a;->b:Landroid/widget/LinearLayout;
    ...
    sget v9, Lhm/a$c;->collapseTitleTheme:I

    invoke-direct {v7, v0, v9}, Lrm/b;-><init>(Landroid/content/Context;I)V

    iput-object v7, v1, Lpm/a;->c:Lrm/b;

    invoke-virtual {v7, v5}, Landroid/view/View;->setVerticalScrollBarEnabled(Z)V

    iget-object v7, v1, Lpm/a;->c:Lrm/b;

    invoke-virtual {v7, v5}, Landroid/view/View;->setHorizontalScrollBarEnabled(Z)V

    sget v7, Lhm/a$c;->actionBarTitleAdaptLargeFont:I

    invoke-static {v0, v7, v6}, Lrn/c;->c(Landroid/content/Context;IZ)Z
    ...
    :goto_3
    iput-boolean v7, v1, Lpm/a;->l:Z

    if-eqz v7, :cond_4

    sget v7, Lhm/a$c;->collapseTitleLargeFontMaxLine:I

    invoke-static {v7, v0, v8}, Lrn/c;->h(ILandroid/content/Context;I)I

    move-result v7

    iput v7, v1, Lpm/a;->m:I
    ...
    iget v10, v1, Lpm/a;->m:I

    invoke-virtual {v7, v10}, Landroid/widget/TextView;->setMaxLines(I)V

    :cond_4
    sget v7, Lhm/a$c;->collapseSubtitleTheme:I
    ...
    invoke-direct {v7, v0, v9}, Lrm/c;-><init>(Landroid/content/Context;I)V

    iput-object v7, v1, Lpm/a;->d:Lrm/c;

    invoke-virtual {v7, v5}, Landroid/view/View;->setVerticalScrollBarEnabled(Z)V

    iget-object v0, v1, Lpm/a;->d:Lrm/c;

    invoke-virtual {v0, v5}, Landroid/view/View;->setHorizontalScrollBarEnabled(Z)V

    iget-object v0, v1, Lpm/a;->b:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v4, v1, v7}, Lcom/xiaomi/mimoji/common/module/c;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, v4}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    iget-object v0, v1, Lpm/a;->c:Lrm/b;

    sget v4, Lhm/a$h;->action_bar_title:I

    invoke-virtual {v0, v4}, Landroid/view/View;->setId(I)V

    iget-object v0, v1, Lpm/a;->b:Landroid/widget/LinearLayout;

    iget-object v4, v1, Lpm/a;->c:Lrm/b;
    ...
    sget v4, Lhm/a$h;->action_bar_subtitle:I
    ...
    invoke-direct {v7, v1, v4}, Lcom/xiaomi/microfilm/vlog/vv/i;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v7, v1, Lpm/a;->d:Lrm/c;
    ...
    sget v3, Lhm/a$f;->miuix_appcompat_action_bar_subtitle_start_margin:I
    ...
    :cond_7
    sget v3, Lhm/a$f;->action_bar_subtitle_top_margin:I
    ...
    sget v3, Lhm/a$f;->action_bar_subtitle_bottom_margin:I
    ...
    :goto_5
    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Lpm/a;

    iget-boolean v0, v1, Lpm/a;->e:Z

    iget-boolean v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->c1:Z

    if-eq v0, v2, :cond_9

    iput-boolean v2, v1, Lpm/a;->e:Z
    ...
    iget-boolean v1, v0, Lpm/a;->k:Z

    if-eqz v1, :cond_a

    iget-object v1, v0, Lpm/a;->c:Lrm/b;

    invoke-virtual {v1, v5}, Lrm/c;->b(Z)V

    iput-boolean v5, v0, Lpm/a;->k:Z
    ...
    iget-object v2, v0, Lpm/a;->b:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {v0, v1}, Lpm/a;->c(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v1}, Lpm/a;->b(Ljava/lang/CharSequence;)V
    ...
    iget-object p0, p0, Lpm/a;->b:Landroid/widget/LinearLayout;
