...
.method public static constructor <clinit>()V
    ...
    sget v0, Lhm/a$j;->miuix_appcompat_popup_menu_item_layout:I
...
.method public final b()V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lko/c;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lko/c;->setHorizontalOffset(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lko/c;

    invoke-virtual {v0, v1}, Lko/c;->setVerticalOffset(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lko/c;

    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/g;->g:Landroid/view/View;

    invoke-virtual {v0, p0}, Lko/c;->p(Landroid/view/View;)V
...
.method public e(Z)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lko/c;
...
.method public final f()Z
    ...
    invoke-direct {v0, v1, v2}, Lko/c;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lko/c;

    const/16 v1, 0x51

    invoke-virtual {v0, v1}, Lko/c;->c(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lko/c;

    iput-object p0, v0, Lko/c;->w:Landroid/widget/PopupWindow$OnDismissListener;

    iput-object p0, v0, Lko/c;->y:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lko/c;

    invoke-virtual {v2, v0}, Lko/c;->setAdapter(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lko/c;

    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Lko/c;->setHorizontalOffset(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lko/c;

    invoke-virtual {v0, v2}, Lko/c;->setVerticalOffset(I)V
    ...
    invoke-virtual {v0, v2}, Lko/c;->j(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, v2}, Lko/c;->showAsDropDown(Landroid/view/View;)V

    :cond_1
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lko/c;

    iget-object v0, v0, Lko/c;->f:Landroid/widget/ListView;
