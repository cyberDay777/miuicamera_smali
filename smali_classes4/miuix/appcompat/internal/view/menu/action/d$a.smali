...
.method public constructor <init>(Lmiuix/appcompat/internal/view/menu/action/d;Landroid/content/Context;Lmiuix/appcompat/internal/view/menu/d;Landroid/view/View;Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;)V
    ...
    sget p3, Lhm/a$c;->overflowMenuMaxHeight:I

    invoke-static {p3, p2}, Lrn/c;->i(ILandroid/content/Context;)Landroid/util/TypedValue;
...
.method public final e(Z)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/b;->b:Lwm/f;

    new-instance v0, Lsm/b;

    invoke-direct {v0, p0}, Lsm/b;-><init>(Lmiuix/appcompat/internal/view/menu/b;)V

    iput-object v0, p1, Lko/c;->w:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {p1}, Lko/c;->dismiss()V
