...
.method public final b()V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/b;->g:Lvm/b;
...
.method public final f()Z
    ...
    invoke-direct {v1, v2, v3}, Lwm/f;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v1, v0, Lmiuix/appcompat/internal/view/menu/b;->b:Lwm/f;

    const v3, 0x800055

    invoke-virtual {v1, v3}, Lko/c;->c(I)V

    iget-object v1, v0, Lmiuix/appcompat/internal/view/menu/b;->b:Lwm/f;

    iput-object v0, v1, Lko/c;->w:Landroid/widget/PopupWindow$OnDismissListener;

    iput-object v0, v1, Lwm/f;->i0:Lwm/f$b;

    new-instance v1, Lvm/b;

    iget-boolean v3, v0, Lmiuix/appcompat/internal/view/menu/b;->f:Z

    invoke-direct {v1, v2, v3}, Lvm/b;-><init>(Landroid/content/Context;Z)V

    iput-object v1, v0, Lmiuix/appcompat/internal/view/menu/b;->g:Lvm/b;
    ...
    iget-object v6, v1, Lvm/b;->g:Ljava/util/HashMap;
    ...
    iget-object v3, v0, Lmiuix/appcompat/internal/view/menu/b;->g:Lvm/b;
    ...
    iget-object v6, v3, Lvm/b;->h:Ljava/util/HashMap;
    ...
    :cond_1
    iget-object v1, v0, Lmiuix/appcompat/internal/view/menu/b;->g:Lvm/b;

    iget-object v3, v1, Lvm/b;->e:Ljava/util/HashMap;

    if-eqz v3, :cond_11

    iget-object v6, v1, Lvm/b;->d:Ljava/util/ArrayList;

    if-eqz v6, :cond_11

    iget-object v7, v1, Lvm/b;->f:Ljava/util/HashMap;
    ...
    new-instance v15, Lvm/e;

    invoke-direct {v15, v11}, Lvm/e;-><init>(Lmiuix/appcompat/internal/view/menu/f;)V

    iput-boolean v14, v15, Lvm/e;->c:Z
    ...
    iget-object v12, v1, Lvm/b;->h:Ljava/util/HashMap;
    ...
    invoke-direct {v2, v4}, Lvm/e;-><init>(Lmiuix/appcompat/internal/view/menu/f;)V
    ...
    invoke-direct {v0, v11}, Lvm/e;-><init>(Lmiuix/appcompat/internal/view/menu/f;)V

    const/4 v2, 0x1

    iput-boolean v2, v0, Lvm/e;->e:Z
    ...
    iget-object v4, v1, Lvm/a;->b:Landroid/view/LayoutInflater;

    invoke-direct {v2, v4, v15, v12}, Lvm/f;-><init>(Landroid/view/LayoutInflater;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-virtual {v1, v0, v6, v2}, Lvm/b;->c(ILjava/util/List;Z)V
    ...
    iget-object v2, v0, Lmiuix/appcompat/internal/view/menu/b;->g:Lvm/b;

    iget-object v3, v1, Lwm/f;->c0:Lwm/f$c;

    iput-object v2, v3, Lwm/f$c;->b:Landroid/widget/ListAdapter;

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lko/c;->setHorizontalOffset(I)V

    iget-object v1, v0, Lmiuix/appcompat/internal/view/menu/b;->b:Lwm/f;

    invoke-virtual {v1, v2}, Lko/c;->setVerticalOffset(I)V

    iget v1, v0, Lmiuix/appcompat/internal/view/menu/b;->i:I

    if-lez v1, :cond_12

    iget-object v2, v0, Lmiuix/appcompat/internal/view/menu/b;->b:Lwm/f;

    iput v1, v2, Lko/c;->l:I
    ...
    invoke-virtual {v1, v2}, Lko/c;->j(Landroid/view/View;)Z
    ...
    invoke-virtual {v1, v2}, Lko/c;->p(Landroid/view/View;)V

    :cond_13
    iget-object v1, v0, Lmiuix/appcompat/internal/view/menu/b;->b:Lwm/f;

    iget-object v1, v1, Lko/c;->f:Landroid/widget/ListView;
...
.method public final isShowing()Z
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:Lwm/f;
...
.method public final j()V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->g:Lvm/b;
    ...
    iget-object v0, v0, Lvm/b;->g:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Lvm/b;->h:Ljava/util/HashMap;
...
.method public onDismiss()V
    ...
    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:Lwm/f;
