...
.method public constructor <init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Lmiuix/internal/view/a$a;)V
    ...
    invoke-direct/range {v0 .. v10}, Lsn/c;-><init>(Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;ZIIIIIIII)V

    iput-object p1, p0, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lsn/c;
...
.method public final applyTheme(Landroid/content/res/Resources$Theme;)V
    ...
    sget-object v1, Lhm/a$m;->CheckWidgetDrawable:[I
    ...
    sget v4, Lhm/a$m;->CheckWidgetDrawable_checkwidget_disableBackgroundColor:I
    ...
    sget v4, Lhm/a$m;->CheckWidgetDrawable_checkwidget_checkOnAlphaBackgroundColor:I
    ...
    sget v4, Lhm/a$m;->CheckWidgetDrawable_checkwidget_checkOnBackgroundColor:I
    ...
    sget v3, Lhm/a$m;->CheckWidgetDrawable_checkwidget_strokeColor:I
    ...
    sget v5, Lhm/a$m;->CheckWidgetDrawable_checkwidget_backgroundNormalAlpha:I
    ...
    sget v3, Lhm/a$m;->CheckWidgetDrawable_checkwidget_backgroundDisableAlpha:I
    ...
    sget v5, Lhm/a$m;->CheckWidgetDrawable_checkwidget_strokeNormalAlpha:I
    ...
    sget v3, Lhm/a$m;->CheckWidgetDrawable_checkwidget_strokeDisableAlpha:I
    ...
    sget v1, Lhm/a$m;->CheckWidgetDrawable_checkwidget_touchAnimEnable:I
    ...
    invoke-direct/range {v3 .. v13}, Lsn/c;-><init>(Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;ZIIIIIIII)V
...
.method public b()I
    ...
    sget p0, Lhm/a$l;->CheckWidgetDrawable_CheckBox:I
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lsn/c;

    if-eqz v0, :cond_1

    iget-object v1, v0, Lsn/c;->d:Lsn/a;

    invoke-virtual {v1, p1}, Lsn/a;->draw(Landroid/graphics/Canvas;)V

    iget-object v1, v0, Lsn/c;->e:Lsn/a;

    invoke-virtual {v1, p1}, Lsn/a;->draw(Landroid/graphics/Canvas;)V

    iget-object v0, v0, Lsn/c;->f:Lsn/a;

    invoke-virtual {v0, p1}, Lsn/a;->draw(Landroid/graphics/Canvas;)V
...
.method public e(IIII)V
    ...
    iget-object p0, p0, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lsn/c;

    if-eqz p0, :cond_0

    iget-object v0, p0, Lsn/c;->d:Lsn/a;

    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object v0, p0, Lsn/c;->e:Lsn/a;

    invoke-virtual {v0, p1, p2, p3, p4}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object p0, p0, Lsn/c;->f:Lsn/a;
...
.method public final onStateChange([I)Z
    ...
    iget-object v1, p0, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lsn/c;
    ...
    iget-object p1, p0, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lsn/c;
    ...
    :cond_6
    iget-object v2, p1, Lsn/c;->h:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_7
    iget-object v2, p1, Lsn/c;->n:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v2, p1, Lsn/c;->i:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_9
    iget-object v2, p1, Lsn/c;->j:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_a
    iget-object v2, p1, Lsn/c;->k:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_b
    iget-object v2, p1, Lsn/c;->o:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_c
    iget-object v2, p1, Lsn/c;->p:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_d
    iget-object v2, p1, Lsn/c;->q:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_e
    iget-object v2, p1, Lsn/c;->m:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_f
    iget-object v2, p1, Lsn/c;->l:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object p1, p1, Lsn/c;->l:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v2, p0, Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;->b:Lsn/c;

    if-eqz v2, :cond_13

    iget-object v3, v2, Lsn/c;->d:Lsn/a;

    iget-object v6, v2, Lsn/c;->e:Lsn/a;

    iget-object v7, v2, Lsn/c;->f:Lsn/a;
    ...
    invoke-virtual {v7, p1}, Lsn/a;->setAlpha(I)V

    const/16 p1, 0x19

    invoke-virtual {v6, p1}, Lsn/a;->setAlpha(I)V

    goto :goto_3

    :cond_11
    invoke-virtual {v7, v1}, Lsn/a;->setAlpha(I)V

    invoke-virtual {v6, v1}, Lsn/a;->setAlpha(I)V

    :goto_3
    iget p1, v2, Lsn/c;->a:I

    invoke-virtual {v3, p1}, Lsn/a;->setAlpha(I)V
    ...
    :cond_15
    iget-object v1, p1, Lsn/c;->h:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_16
    iget-object v1, p1, Lsn/c;->n:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_17
    iget-object v1, p1, Lsn/c;->i:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_18
    iget-object v1, p1, Lsn/c;->j:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v1, p1, Lsn/c;->m:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_1a
    iget-object v1, p1, Lsn/c;->l:Lmiuix/animation/physics/SpringAnimation;
    ...
    invoke-direct {v2, p1}, Lsn/e;-><init>(Lsn/c;)V

    const-wide/16 v6, 0x32

    invoke-virtual {v1, v2, v6, v7}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;J)Z

    iget-boolean v1, p1, Lsn/c;->r:Z

    if-eqz v1, :cond_1c

    iget-object v1, p1, Lsn/c;->k:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_1f
    iget-object v1, p1, Lsn/c;->q:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_20
    :goto_5
    iget-object p1, p1, Lsn/c;->k:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_21
    :goto_6
    iget-object v1, p1, Lsn/c;->f:Lsn/a;
    ...
    invoke-virtual {v1, p1}, Lsn/a;->setAlpha(I)V

    goto :goto_7

    :cond_22
    iget-object p1, p1, Lsn/c;->m:Lmiuix/animation/physics/SpringAnimation;
