...
# instance fields
.field public a:[Llo/h$c;

.field public final b:Llo/h$a;
...
.field public l:Llo/i;

.field public m:Llo/j;

.field public final n:Llo/h$b;
...
.method public static constructor <clinit>()V
    ...
    sget v5, Llo/m;->state_no_title:I

    const/4 v8, 0x4

    aput v5, v0, v8

    sget v8, Llo/m;->state_no_line:I
    ...
    sput-object v0, Llo/h;->x:[I

    new-array v0, v3, [I

    aput v4, v0, v1

    sput-object v0, Llo/h;->y:[I

    new-array v0, v3, [I

    aput v6, v0, v1

    sput-object v0, Llo/h;->M:[I

    new-array v0, v3, [I

    aput v7, v0, v1

    sput-object v0, Llo/h;->O:[I

    new-array v0, v3, [I

    aput v5, v0, v1

    sput-object v0, Llo/h;->P:[I

    new-array v0, v3, [I

    aput v8, v0, v1

    sput-object v0, Llo/h;->Q:[I
...
.method public constructor <init>(Landroidx/preference/PreferenceGroup;Z)V
    ...
    invoke-direct {v0, p0}, Llo/h$a;-><init>(Llo/h;)V

    iput-object v0, p0, Llo/h;->b:Llo/h$a;

    const/4 v0, 0x0

    iput v0, p0, Llo/h;->h:I

    const/4 v1, -0x1

    iput v1, p0, Llo/h;->i:I

    const/4 v1, 0x0

    iput-object v1, p0, Llo/h;->j:Landroid/view/View;

    iput-boolean v0, p0, Llo/h;->k:Z

    iput-object v1, p0, Llo/h;->l:Llo/i;

    iput-object v1, p0, Llo/h;->m:Llo/j;

    new-instance v1, Llo/h$b;

    invoke-direct {v1}, Llo/h$b;-><init>()V

    iput-object v1, p0, Llo/h;->n:Llo/h$b;

    iput-boolean v0, p0, Llo/h;->o:Z

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, Llo/h;->p:Landroid/graphics/Rect;

    iput v0, p0, Llo/h;->q:I

    iput v0, p0, Llo/h;->r:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Llo/h;->u:Ljava/util/ArrayList;

    iput-boolean p2, p0, Llo/h;->t:Z

    invoke-virtual {p0}, Landroidx/preference/PreferenceGroupAdapter;->getItemCount()I

    move-result p2

    new-array p2, p2, [Llo/h$c;

    iput-object p2, p0, Llo/h;->a:[Llo/h$c;

    invoke-virtual {p1}, Landroidx/preference/Preference;->getContext()Landroid/content/Context;

    move-result-object p1

    invoke-virtual {p0, p1}, Llo/h;->e(Landroid/content/Context;)V
...
.method public final e(Landroid/content/Context;)V
    ...
    sget v0, Llo/m;->preferenceRadioSetChildExtraPaddingStart:I

    invoke-static {v0, p1}, Lrn/c;->e(ILandroid/content/Context;)I

    move-result v0

    iput v0, p0, Llo/h;->c:I

    sget v0, Llo/m;->checkablePreferenceItemColorFilterChecked:I

    invoke-static {v0, p1}, Lrn/c;->d(ILandroid/content/Context;)I

    sget v0, Llo/m;->checkablePreferenceItemColorFilterNormal:I
    ...
    sget v1, Llo/o;->miuix_preference_high_light_radius:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Llo/h;->d:I

    sget v0, Llo/m;->preferenceCardGroupMarginStart:I
    ...
    sget v0, Llo/m;->preferenceCardGroupMarginEnd:I

    invoke-static {v0, p1}, Lrn/c;->e(ILandroid/content/Context;)I

    move-result p1

    iput p1, p0, Llo/h;->r:I
...
.method public final g(Landroid/view/View;Lcom/miui/support/drawable/CardStateDrawable;Landroidx/preference/Preference;)Z
    ...
    :cond_0
    instance-of v0, p3, Llo/l;

    if-eqz v0, :cond_1

    check-cast p3, Llo/l;

    invoke-interface {p3}, Llo/l;->c()V

    :cond_1
    iget p0, p0, Llo/h;->d:I
...
.method public final h()V
    ...
    iget-object v0, p0, Llo/h;->j:Landroid/view/View;

    if-eqz v0, :cond_1

    invoke-virtual {p0, v0}, Llo/h;->i(Landroid/view/View;)V

    iget-object v0, p0, Llo/h;->g:Lmiuix/animation/controller/FolmeBlink;
    ...
    iput-object v0, p0, Llo/h;->g:Lmiuix/animation/controller/FolmeBlink;
...
.method public final i(Landroid/view/View;)V
    ...
    sget v4, Llo/q;->preference_highlighted:I
    ...
    :cond_2
    iput v3, p0, Llo/h;->i:I

    iget-object p1, p0, Llo/h;->e:Landroidx/recyclerview/widget/RecyclerView;

    if-eqz p1, :cond_3

    iget-object v0, p0, Llo/h;->m:Llo/j;
...
.method public final onAttachedToRecyclerView(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iget-object v0, p0, Llo/h;->b:Llo/h$a;
    ...
    iput-object p1, p0, Llo/h;->e:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final onBindViewHolder(Landroidx/preference/PreferenceViewHolder;I)V
    ...
    .line 15
    :goto_1
    iget-object v9, v0, Llo/h;->a:[Llo/h$c;

    aget-object v10, v9, v2

    if-eqz v10, :cond_4

    iget v11, v10, Llo/h$c;->b:I
    ...
    .line 17
    new-instance v8, Llo/h$c;

    invoke-direct {v8}, Llo/h$c;-><init>()V
    ...
    .line 38
    :cond_f
    iget-object v8, v0, Llo/h;->a:[Llo/h$c;

    aget-object v8, v8, v2

    iput-object v12, v8, Llo/h$c;->a:[I

    .line 39
    iput v7, v8, Llo/h$c;->b:I
    ...
    iput-object v12, v9, Llo/h$c;->a:[I

    .line 62
    iput v8, v9, Llo/h$c;->b:I
    ...
    iget v8, v8, Llo/h$c;->b:I

    .line 64
    :goto_9
    invoke-virtual {v0, v8, v3}, Llo/h;->f(ILandroidx/preference/Preference;)Z
    ...
    .line 66
    :cond_1b
    iget-object v7, v0, Llo/h;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    .line 68
    new-instance v5, Loo/a;

    invoke-direct {v5, v8, v9, v7}, Loo/a;-><init>(IFLandroid/view/View;)V
    ...
    .line 69
    :cond_1e
    invoke-static {v8, v9, v7}, Loo/b;->a(IFLandroid/view/View;)V
    ...
    .line 70
    :cond_20
    iget v5, v0, Llo/h;->h:I

    .line 71
    iget-boolean v7, v0, Llo/h;->t:Z

    iget-object v9, v0, Llo/h;->p:Landroid/graphics/Rect;
    ...
    .line 78
    iget v12, v0, Llo/h;->r:I

    goto :goto_c

    :cond_23
    iget v12, v0, Llo/h;->q:I

    :goto_c
    if-eqz v7, :cond_24

    .line 79
    iget v7, v0, Llo/h;->q:I

    goto :goto_d

    :cond_24
    iget v7, v0, Llo/h;->r:I
    ...
    .line 84
    new-instance v12, Lkn/b;

    invoke-direct {v12, v7}, Lkn/b;-><init>(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 86
    iget-object v13, v0, Llo/h;->a:[Llo/h$c;

    aget-object v13, v13, v2

    iget-object v13, v13, Llo/h$c;->a:[I

    if-eqz v13, :cond_26

    .line 87
    invoke-virtual {v12, v13}, Lkn/b;->a([I)V
    ...
    sget v12, Llo/q;->miuix_preference_navigation:I

    invoke-virtual {v9, v12}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v9

    iget-object v12, v0, Llo/h;->n:Llo/h$b;
    ...
    sget v11, Llo/m;->preferenceItemForeground:I

    invoke-static {v11, v9}, Lrn/c;->f(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v11, v7, v3}, Llo/h;->g(Landroid/view/View;Lcom/miui/support/drawable/CardStateDrawable;Landroidx/preference/Preference;)Z
    ...
    invoke-virtual {v0, v14, v13, v3}, Llo/h;->g(Landroid/view/View;Lcom/miui/support/drawable/CardStateDrawable;Landroidx/preference/Preference;)Z
    ...
    invoke-direct {v7, v0, v1, v8}, Ly5/j;-><init>(Llo/h;Landroidx/preference/PreferenceViewHolder;I)V

    .line 154
    iget-object v9, v0, Llo/h;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    sget v9, Llo/m;->navigationPreferenceItemForeground:I

    invoke-static {v9, v7}, Lrn/c;->f(ILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    .line 172
    iget v7, v0, Llo/h;->i:I

    if-ne v2, v7, :cond_4d

    .line 173
    iget-boolean v2, v0, Llo/h;->k:Z
    ...
    sget v7, Llo/q;->preference_highlighted:I
    ...
    .line 176
    iget-object v2, v0, Llo/h;->g:Lmiuix/animation/controller/FolmeBlink;
    ...
    iput-object v2, v0, Llo/h;->g:Lmiuix/animation/controller/FolmeBlink;
    ...
    .line 185
    :goto_1e
    iget-object v8, v0, Llo/h;->g:Lmiuix/animation/controller/FolmeBlink;
    ...
    .line 189
    iput-object v6, v0, Llo/h;->j:Landroid/view/View;

    .line 190
    :cond_4b
    iget-object v2, v0, Llo/h;->e:Landroidx/recyclerview/widget/RecyclerView;

    if-eqz v2, :cond_4e

    .line 191
    iget-object v0, v0, Llo/h;->f:Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;
    ...
    .line 194
    invoke-virtual {v0, v6}, Llo/h;->i(Landroid/view/View;)V

    .line 195
    :cond_4e
    :goto_20
    instance-of v0, v3, Llo/f;
    ...
    invoke-interface {v3, v5}, Llo/f;->b(I)V
...
.method public final bridge synthetic onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-virtual {p0, p1, p2}, Llo/h;->onBindViewHolder(Landroidx/preference/PreferenceViewHolder;I)V
...
.method public final onDetachedFromRecyclerView(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iget-object p1, p0, Llo/h;->b:Llo/h$a;
...
.method public final onPreferenceVisibilityChange(Landroidx/preference/Preference;)V
    ...
    iget-object p0, p0, Llo/h;->u:Ljava/util/ArrayList;
...
.method public final onViewDetachedFromWindow(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {p0, p1}, Llo/h;->i(Landroid/view/View;)V
...
.method public final updateBlinkState(Z)V
    ...
    iput-object v0, p0, Llo/h;->m:Llo/j;

    iput-object v0, p0, Llo/h;->l:Llo/i;

    iget-object p1, p0, Llo/h;->g:Lmiuix/animation/controller/FolmeBlink;
