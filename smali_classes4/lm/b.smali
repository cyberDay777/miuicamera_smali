...
.method public final onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    iget-object v2, p0, Llm/c$e;->e:Llm/c;
    ...
    iget-wide p1, p0, Llm/c;->e:J

    invoke-static {p1, p2}, Llm/c;->g(J)Z
    ...
    iput-wide p1, p0, Llm/c;->e:J

    :goto_0
    iget-object p1, p0, Llm/c;->b:Landroid/util/SparseArray;
    ...
    check-cast v3, Llm/c$b;

    iget v3, v3, Llm/c$b;->a:I

    invoke-virtual {p1, p2}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Llm/c$b;

    iget v4, v4, Llm/c$b;->h:I

    invoke-virtual {p0, v4}, Llm/c;->e(I)I
    ...
    :pswitch_1
    invoke-virtual {p0}, Llm/c$e;->F()Lmiuix/appcompat/app/AppCompatActivity;

    move-result-object p0

    if-eqz p0, :cond_14

    iget-object p1, v2, Llm/c;->a:Landroid/os/Handler;

    new-instance p2, Llm/c$d;

    invoke-direct {p2, p0}, Llm/c$d;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-virtual {p0}, Lmiuix/appcompat/app/AppCompatActivity;->U5()Landroid/view/View;
    ...
    invoke-static {p1, p0, v0}, Ljm/i;->a(Landroid/content/Context;Landroid/view/View;Landroid/graphics/Bitmap;)Ltn/l;
    ...
    iput-object p2, v2, Llm/c;->h:Ljava/lang/ref/WeakReference;
    ...
    iget-object p1, v2, Llm/c;->h:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {p0}, Llm/c;->a(Llm/c;)V

    goto/16 :goto_10

    :cond_a
    sget-object p1, Llm/c;->k:Llm/c;

    iget-wide v2, p1, Llm/c;->e:J

    invoke-static {v2, v3}, Llm/c;->g(J)Z
    ...
    iput-wide v2, p1, Llm/c;->e:J

    move p2, v0

    :goto_b
    iget-object v2, p1, Llm/c;->b:Landroid/util/SparseArray;
    ...
    iget-object v4, v4, Llm/c$b;->g:Lmiuix/appcompat/app/AppCompatActivity;

    invoke-virtual {v2, v3}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Llm/c$b;

    iget v5, v5, Llm/c$b;->a:I
    ...
    iget v6, v6, Llm/c$b;->h:I

    invoke-virtual {p1, v6}, Llm/c;->e(I)I
    ...
    invoke-virtual {v4}, Lmiuix/appcompat/app/AppCompatActivity;->q6()V
    ...
    iget-boolean p2, p1, Llm/c;->i:Z

    if-eqz p2, :cond_14

    iput-boolean v0, p1, Llm/c;->i:Z

    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p0

    iget-object p1, p1, Llm/c;->j:Llm/c$a;
    ...
    check-cast p2, Llm/c$b;

    iget-boolean v2, p2, Llm/c$b;->b:Z

    if-nez v2, :cond_11

    iget-object p2, p2, Llm/c$b;->g:Lmiuix/appcompat/app/AppCompatActivity;

    if-eqz p2, :cond_11

    new-instance v2, Lcom/xiaomi/mimoji/common/module/c;

    invoke-direct {v2, p2, v3}, Lcom/xiaomi/mimoji/common/module/c;-><init>(Ljava/lang/Object;I)V
