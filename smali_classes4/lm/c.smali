...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Llm/c;->a:Landroid/os/Handler;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, Llm/c;->b:Landroid/util/SparseArray;

    const/4 v0, 0x1

    iput-boolean v0, p0, Llm/c;->c:Z

    new-instance v0, Llm/c$a;

    invoke-direct {v0, p0}, Llm/c$a;-><init>(Llm/c;)V

    iput-object v0, p0, Llm/c;->j:Llm/c$a;

    return-void
.end method

.method public static a(Llm/c;)V
    .locals 5

    iget-wide v0, p0, Llm/c;->f:J

    invoke-static {v0, v1}, Llm/c;->g(J)Z
    ...
    iput-wide v0, p0, Llm/c;->f:J

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Llm/c;->b:Landroid/util/SparseArray;
    ...
    check-cast v2, Llm/c$b;

    iget-boolean v3, v2, Llm/c$b;->b:Z

    if-nez v3, :cond_1

    iget-object v2, v2, Llm/c$b;->g:Lmiuix/appcompat/app/AppCompatActivity;
    ...
    invoke-direct {v3, v2, v4}, Lvg/a;-><init>(Ljava/lang/Object;I)V
...
.method public final b(ILjava/lang/String;)V
    ...
    iget-object v0, p0, Llm/c;->b:Landroid/util/SparseArray;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Llm/c;->e(I)I
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Llm/c;->c(ILjava/lang/String;)Llm/c$b;

    move-result-object p0

    if-eqz p0, :cond_2

    iget p1, p0, Llm/c$b;->d:I

    if-lez p1, :cond_2

    iget-object p0, p0, Llm/c$b;->g:Lmiuix/appcompat/app/AppCompatActivity;
    ...
    invoke-virtual {p0}, Lkm/a;->e()V

    :cond_2
    return-void
.end method

.method public final c(ILjava/lang/String;)Llm/c$b;
    .locals 1
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    iget-object p0, p0, Llm/c;->b:Landroid/util/SparseArray;
    ...
    iget-object v0, p1, Llm/c$b;->i:Ljava/lang/String;
...
.method public final e(I)I
    ...
    invoke-virtual {p0, v1, v0}, Llm/c;->h(ILandroid/os/Bundle;)Landroid/os/Bundle;
...
.method public final f(Llm/c$b;)V
    .locals 7
    .param p1    # Llm/c$b;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    :cond_0
    iget-object v2, p0, Llm/c;->d:Llm/a;

    if-eqz v2, :cond_4

    :try_start_0
    iget-object v3, p1, Llm/c$b;->c:Llm/c$e;

    iget v4, p1, Llm/c$b;->h:I
    ...
    invoke-interface {v2, v3, v4}, Llm/a;->y(Llm/c$e;Ljava/lang/String;)I

    iget-object v2, p1, Llm/c$b;->c:Llm/c$e;

    iget v3, p1, Llm/c$b;->h:I
    ...
    iget v2, p1, Llm/c$b;->a:I

    iget-object p0, p0, Llm/c;->d:Llm/a;
    :try_end_0
    ...
    :try_start_1
    invoke-interface {p0, v2, v0}, Llm/a;->l(ILjava/lang/String;)V
    :try_end_1
    ...
    :cond_1
    :goto_0
    iget-boolean p0, p1, Llm/c$b;->e:Z

    if-nez p0, :cond_2

    const/4 p0, 0x1

    iput-boolean p0, p1, Llm/c$b;->e:Z

    iget p0, p1, Llm/c$b;->a:I

    iput p0, p1, Llm/c$b;->d:I
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_2 .. :try_end_2} :catch_1

    :cond_2
    iget-object p0, p1, Llm/c$b;->f:Ljava/util/LinkedList;
...
.method public final h(ILandroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :try_start_0
    invoke-interface {p0, p1, p2}, Llm/a;->C(ILandroid/os/Bundle;)Landroid/os/Bundle;
...
.method public final i(Landroid/graphics/Bitmap;Ljava/lang/String;I)V
    ...
    :cond_0
    invoke-virtual {p0, p3, p2}, Llm/c;->c(ILjava/lang/String;)Llm/c$b;
    ...
    iget-object p2, p2, Llm/c$b;->c:Llm/c$e;
    ...
    :try_start_3
    invoke-interface {p0, p1, v5}, Llm/a;->C(ILandroid/os/Bundle;)Landroid/os/Bundle;
    :try_end_3
...
.method public final j(ILjava/lang/String;)V
    ...
    iget-object v0, p0, Llm/c;->d:Llm/a;
    ...
    iget-object p1, p1, Llm/c$b;->c:Llm/c$e;
    ...
    invoke-interface {p0, p1, p2}, Llm/a;->r(Llm/c$e;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
