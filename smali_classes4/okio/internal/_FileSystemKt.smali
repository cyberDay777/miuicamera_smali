...
# direct methods
.method public static final collectRecursively(Lwl/i;Lokio/FileSystem;Lfl/f;Lokio/Path;ZZLil/d;)Ljava/lang/Object;
    .locals 17
    ...
    invoke-direct {v4, v3}, Lokio/internal/_FileSystemKt$collectRecursively$1;-><init>(Lil/d;)V

    :goto_0
    iget-object v3, v4, Lokio/internal/_FileSystemKt$collectRecursively$1;->result:Ljava/lang/Object;

    sget-object v5, Ljl/a;->a:Ljl/a;
    ...
    invoke-static {v3}, Lcom/android/camera/h5;->G(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v4}, Lwl/i;->a(Ljava/lang/Object;Lil/d;)V
    ...
    invoke-virtual {v6, v13}, Lfl/f;->contains(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-virtual {v6, v13}, Lfl/f;->addLast(Ljava/lang/Object;)V
    ...
    invoke-static/range {p0 .. p6}, Lokio/internal/_FileSystemKt;->collectRecursively(Lwl/i;Lokio/FileSystem;Lfl/f;Lokio/Path;ZZLil/d;)Ljava/lang/Object;
    ...
    :cond_c
    invoke-virtual {v11}, Lfl/f;->removeLast()Ljava/lang/Object;
    ...
    :goto_7
    invoke-virtual {v6}, Lfl/f;->removeLast()Ljava/lang/Object;
    ...
    invoke-virtual {v12, v1, v4}, Lwl/i;->a(Ljava/lang/Object;Lil/d;)V
...
.method public static final commonCopy(Lokio/FileSystem;Lokio/Path;Lokio/Path;)V
    ...
    :cond_3
    invoke-static {v0, p1}, Lcom/android/camera/h5;->e(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final commonCreateDirectories(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-virtual {v0, v1}, Lfl/f;->addFirst(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0}, Lfl/f;->isEmpty()Z
...
.method public static final commonDeleteRecursively(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lokio/internal/_FileSystemKt$commonDeleteRecursively$sequence$1;-><init>(Lokio/FileSystem;Lokio/Path;Lil/d;)V

    new-instance p1, Lwl/h;

    invoke-direct {p1}, Lwl/h;-><init>()V

    invoke-static {p1, p1, v0}, Lcom/android/camera/h5;->l(Ljava/lang/Object;Lil/d;Lql/p;)Lil/d;

    move-result-object v0

    iput-object v0, p1, Lwl/h;->d:Lil/d;

    :goto_0
    invoke-virtual {p1}, Lwl/h;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, Lwl/h;->next()Ljava/lang/Object;
...
.method public static final commonListRecursively(Lokio/FileSystem;Lokio/Path;Z)Lwl/g;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0, p2, v1}, Lokio/internal/_FileSystemKt$commonListRecursively$1;-><init>(Lokio/Path;Lokio/FileSystem;ZLil/d;)V
