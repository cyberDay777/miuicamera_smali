...
.method public static subscribe(Ldq/c;Ljava/util/Iterator;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-interface {p0, v0}, Ldq/c;->onSubscribe(Ldq/d;)V
    ...
    invoke-direct {v0, p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableFromIterable$IteratorSubscription;-><init>(Ldq/c;Ljava/util/Iterator;)V
...
.method public subscribeActual(Ldq/c;)V
    ...
    invoke-static {p1, p0}, Lio/reactivex/internal/operators/flowable/FlowableFromIterable;->subscribe(Ldq/c;Ljava/util/Iterator;)V
