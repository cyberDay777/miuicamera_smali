...
.method public constructor <init>(Ldq/c;Lio/reactivex/functions/Function;Lio/reactivex/functions/Function;Lio/reactivex/functions/BiFunction;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->downstream:Ldq/c;
...
.method public drain()V
    ...
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->downstream:Ldq/c;
    ...
    invoke-virtual {v1, v3}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->errorAll(Ldq/c;)V
    ...
    invoke-interface {v3}, Ldq/c;->onComplete()V
    ...
    invoke-interface {v7, v8}, Ldq/b;->subscribe(Ldq/c;)V
    ...
    invoke-interface {v3, v0}, Ldq/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v0, v3, v2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->fail(Ljava/lang/Throwable;Ldq/c;Lio/reactivex/internal/fuseable/SimpleQueue;)V
    ...
    invoke-interface {v3, v8}, Ldq/c;->onNext(Ljava/lang/Object;)V
...
.method public errorAll(Ldq/c;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public fail(Ljava/lang/Throwable;Ldq/c;Lio/reactivex/internal/fuseable/SimpleQueue;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/flowable/FlowableJoin$JoinSubscription;->errorAll(Ldq/c;)V
