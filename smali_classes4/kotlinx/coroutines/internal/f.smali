...
.field public final synthetic c:Lyl/g0;
...
# direct methods
.method public constructor <init>(Lyl/y;I)V
    .locals 0

    invoke-direct {p0}, Lyl/y;-><init>()V

    iput-object p1, p0, Lkotlinx/coroutines/internal/f;->a:Lyl/y;

    iput p2, p0, Lkotlinx/coroutines/internal/f;->b:I

    instance-of p2, p1, Lyl/g0;

    if-eqz p2, :cond_0

    check-cast p1, Lyl/g0;
    ...
    sget-object p1, Lyl/f0;->a:Lyl/g0;

    :cond_1
    iput-object p1, p0, Lkotlinx/coroutines/internal/f;->c:Lyl/g0;
...
.method public final b(Lyl/k;)V
    ...
    iget-object p0, p0, Lkotlinx/coroutines/internal/f;->c:Lyl/g0;

    invoke-interface {p0, p1}, Lyl/g0;->b(Lyl/k;)V
...
.method public final dispatch(Lil/f;Ljava/lang/Runnable;)V
    ...
    iget-object p1, p0, Lkotlinx/coroutines/internal/f;->a:Lyl/y;

    invoke-virtual {p1, p0, p0}, Lyl/y;->dispatch(Lil/f;Ljava/lang/Runnable;)V
...
.method public final dispatchYield(Lil/f;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p1, p0, p0}, Lyl/y;->dispatchYield(Lil/f;Ljava/lang/Runnable;)V
...
.method public final limitedParallelism(I)Lyl/y;
    ...
    :cond_0
    invoke-super {p0, p1}, Lyl/y;->limitedParallelism(I)Lyl/y;
...
.method public final run()V
    ...
    invoke-static {v3, v2}, Lcom/android/camera/h5;->y(Lil/f;Ljava/lang/Throwable;)V
    ...
    iget-object v2, p0, Lkotlinx/coroutines/internal/f;->a:Lyl/y;

    invoke-virtual {v2, p0}, Lyl/y;->isDispatchNeeded(Lil/f;)Z

    move-result v2

    if-eqz v2, :cond_0

    iget-object v0, p0, Lkotlinx/coroutines/internal/f;->a:Lyl/y;

    invoke-virtual {v0, p0, p0}, Lyl/y;->dispatch(Lil/f;Ljava/lang/Runnable;)V
