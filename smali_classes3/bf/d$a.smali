...
# instance fields
.field public d:Lbf/d$b;

.field public e:Lbf/d$d;

.field public f:Lbf/d$c;
...
.method public final G(I)V
    ...
    iget-object p0, p0, Lbf/d$a;->d:Lbf/d$b;

    if-eqz p0, :cond_1

    check-cast p0, Lcom/android/camera/y4;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/camera/y4;->j:Lcom/android/camera/ActivityBase;
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/y4;->d(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    iget-object v0, p0, Lcom/android/camera/y4;->d:Lbf/d;
    ...
    invoke-virtual {p0, v0}, Lbf/d;->f(Landroid/os/Bundle;)V
    :try_end_1
    ...
    invoke-static {v0, v2, v1, p0}, Lgf/a;->c(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Exception;)V
...
.method public final d(ILandroid/os/Bundle;)V
    ...
    iget-object p0, p0, Lbf/d$a;->e:Lbf/d$d;
    ...
    invoke-static {v3}, Lgf/a;->b(Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget p2, p0, Lcom/android/camera/y4;->h:I
    ...
    iget p0, p0, Lcom/android/camera/y4;->h:I
    ...
    iget-object p2, p1, Lcf/o;->c:Lcf/a;

    if-eqz p2, :cond_2

    invoke-virtual {p2}, Lcf/a;->a()Z

    move-result p2

    if-eqz p2, :cond_2

    iget-object p1, p1, Lcf/o;->c:Lcf/a;
    ...
    invoke-static {p2, v1, v0}, Lcf/a;->b(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/Object;)V

    const-string v0, "content"

    invoke-static {p2, v0, p0}, Lcf/a;->b(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/Object;)V

    invoke-virtual {p2}, Lorg/json/JSONObject;->toString()Ljava/lang/String;

    move-result-object p0

    invoke-virtual {p1, p0}, Lcf/a;->e(Ljava/lang/String;)V
...
.method public final p(ILandroid/os/Bundle;)V
    ...
    sget-object p2, Lcom/android/camera/y4;->q:Ljava/lang/String;
    ...
    invoke-static {v1}, Lgf/a;->b(Ljava/lang/Object;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object p2, p0, Lcom/android/camera/y4;->i:Ljava/util/LinkedHashSet;
    ...
    iput v3, p0, Lcom/android/camera/y4;->g:I

    iget-object p2, p0, Lcom/android/camera/y4;->f:Lte/c;
    ...
    invoke-virtual {p2, p0}, Lcom/android/camera/effect/t;->removeChangeListener(Lcom/android/camera/effect/t$a;)Z

    iget-object p2, p0, Lcom/android/camera/y4;->f:Lte/c;

    iget-object p2, p2, Lte/c;->l:Lte/c$a;
    ...
    iput-object p2, p0, Lcom/android/camera/y4;->f:Lte/c;
    ...
    iget-object v6, p0, Lcom/android/camera/y4;->j:Lcom/android/camera/ActivityBase;

    iget-object v7, v6, Lcom/android/camera/ActivityBase;->f:Lcom/android/camera/module/h0;

    iget-object v6, v6, Lcom/android/camera/ActivityBase;->b0:Lcom/android/camera/ui/v0;

    invoke-interface {v6}, Lcom/android/camera/ui/v0;->v0()Landroid/opengl/EGLContext;
    ...
    iget-object v3, p0, Lcom/android/camera/y4;->a:Ljava/lang/Object;

    monitor-enter v3

    :try_start_1
    iget-object v6, p0, Lcom/android/camera/y4;->i:Ljava/util/LinkedHashSet;
    ...
    iget-object v6, p0, Lcom/android/camera/y4;->f:Lte/c;

    if-eqz v6, :cond_a

    iget v2, p0, Lcom/android/camera/y4;->g:I
    ...
    iget p2, p0, Lcom/android/camera/y4;->g:I
    ...
    :cond_a
    iput p2, p0, Lcom/android/camera/y4;->g:I
    ...
    invoke-direct/range {v5 .. v10}, Lte/c;-><init>(Ljava/lang/String;Landroid/opengl/EGLContext;Landroid/view/Surface;II)V

    iput-object p2, p0, Lcom/android/camera/y4;->f:Lte/c;

    int-to-float v1, v12

    invoke-virtual {p2, v1}, Lte/c;->d(F)V
    ...
    invoke-virtual {p1}, Lte/c;->f()V

    invoke-static {}, Lcom/android/camera/effect/t;->getInstance()Lcom/android/camera/effect/t;

    move-result-object p1

    invoke-virtual {p1, p0}, Lcom/android/camera/effect/t;->addChangeListener(Lcom/android/camera/effect/t$a;)V
    ...
    :goto_4
    iget-object p0, p0, Lcom/android/camera/y4;->j:Lcom/android/camera/ActivityBase;
    ...
    invoke-interface {p0, p1, v0}, Lcom/android/camera/module/h0;->onRemoteControlRequest(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method public final s(Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lbf/d$a;->f:Lbf/d$c;
    ...
    invoke-static {v0, p2, v1}, Landroidx/activity/result/a;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    invoke-static {p1}, La/e;->M(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    sget-object v2, Lcom/android/camera/y4;->q:Ljava/lang/String;
    ...
    invoke-interface {p0, p2, p1}, Lcom/android/camera/module/h0;->onRemoteControlRequest(Ljava/lang/String;Landroid/os/Bundle;)V
