...
.field public c:Lbf/d$a;

.field public d:Lbf/d$f;

.field public e:Lbf/b;


# direct methods
.method public constructor <init>(Lcom/android/camera/ActivityBase;Lbf/d$b;Lbf/d$d;Lbf/d$c;)V
    .locals 1
    ...
    iput-boolean v0, p0, Lbf/d;->a:Z

    iput-object p1, p0, Lbf/d;->b:Landroid/content/Context;

    new-instance p1, Lbf/d$a;

    invoke-direct {p1}, Lbf/d$a;-><init>()V

    iput-object p1, p0, Lbf/d;->c:Lbf/d$a;

    iput-object p2, p1, Lbf/d$a;->d:Lbf/d$b;

    iput-object p3, p1, Lbf/d$a;->e:Lbf/d$d;

    iput-object p4, p1, Lbf/d$a;->f:Lbf/d$c;

    return-void
.end method

.method public static b(Lcom/android/camera/ActivityBase;Lbf/d$b;Lbf/d$d;Lbf/d$c;)Lbf/d;
    .locals 6

    new-instance v0, Lbf/d;

    invoke-direct {v0, p0, p1, p2, p3}, Lbf/d;-><init>(Lcom/android/camera/ActivityBase;Lbf/d$b;Lbf/d$d;Lbf/d$c;)V
    ...
    iget-object p2, v0, Lbf/d;->b:Landroid/content/Context;
    ...
    :try_start_0
    iput-boolean p3, v0, Lbf/d;->a:Z

    iget-object v3, v0, Lbf/d;->d:Lbf/d$f;

    if-nez v3, :cond_2

    new-instance v3, Lbf/d$f;

    invoke-direct {v3, v0}, Lbf/d$f;-><init>(Lbf/d;)V
    ...
    iget-object p0, v0, Lbf/d;->b:Landroid/content/Context;
    ...
    :goto_3
    iget-object p0, v0, Lbf/d;->c:Lbf/d$a;
    ...
    invoke-virtual {p0, v1}, Lbf/d$a;->G(I)V
...
.method public final declared-synchronized a(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lbf/d;->c:Lbf/d$a;

    if-eqz v2, :cond_0

    invoke-interface {v1, v2, v0, p1}, Lbf/b;->D(Lbf/c;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    :try_end_1
...
.method public final c()Lbf/b;
    ...
    iget-object p0, p0, Lbf/d;->e:Lbf/b;
    ...
    :cond_0
    new-instance p0, Lbf/d$g;

    invoke-direct {p0}, Lbf/d$g;-><init>()V
...
.method public final declared-synchronized d()Z
    ...
    invoke-interface {v1, v2}, Lbf/b;->A(Lbf/c;)Z
    ...
    :cond_0
    new-instance v1, Lbf/d$g;

    invoke-direct {v1}, Lbf/d$g;-><init>()V
...
.method public final e()V
    ...
    :try_start_0
    iget-object v0, p0, Lbf/d;->d:Lbf/d$f;
    ...
    :cond_0
    iget-object v0, p0, Lbf/d;->e:Lbf/b;
    ...
    :try_start_1
    invoke-interface {v0, v2}, Lbf/b;->h(Lbf/c;)V
    :try_end_1
    ...
    iget-object v2, p0, Lbf/d;->d:Lbf/d$f;
    ...
    :catch_1
    :try_start_4
    iput-object v1, p0, Lbf/d;->e:Lbf/b;
    ...
    :try_start_5
    iget-object v2, p0, Lbf/d;->b:Landroid/content/Context;
    ...
    :catch_2
    :try_start_6
    iput-object v1, p0, Lbf/d;->d:Lbf/d$f;

    :cond_3
    iget-object v0, p0, Lbf/d;->c:Lbf/d$a;

    if-eqz v0, :cond_4

    iput-object v1, v0, Lbf/d$a;->d:Lbf/d$b;

    iput-object v1, v0, Lbf/d$a;->e:Lbf/d$d;

    iput-object v1, v0, Lbf/d$a;->f:Lbf/d$c;

    iput-object v1, p0, Lbf/d;->c:Lbf/d$a;
...
.method public final declared-synchronized f(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lbf/d;->c:Lbf/d$a;

    if-eqz v1, :cond_0

    invoke-interface {v0, v1, p1}, Lbf/b;->B(Lbf/c;Landroid/os/Bundle;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final declared-synchronized g(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, v1, p1}, Lbf/b;->f(Lbf/c;Landroid/os/Bundle;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
