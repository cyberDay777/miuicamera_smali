...
.method public final a(Ljava/lang/reflect/Type;Ljava/util/Set;Lhd/a0;)Lhd/o;
    ...
    :cond_0
    invoke-static/range {p1 .. p1}, Lhd/d0;->c(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    :cond_2
    invoke-static {v2}, Lid/b;->d(Ljava/lang/Class;)Z
    ...
    invoke-static {v0, v1}, Lhd/g$a;->b(Ljava/lang/reflect/Type;Ljava/lang/Class;)V
    ...
    sget-object v4, Lid/b;->d:Ljava/lang/Class;
    ...
    invoke-direct {v10, v9, v2}, Lhd/b;-><init>(Ljava/lang/reflect/Constructor;Ljava/lang/Class;)V
    :try_end_0
    ...
    invoke-direct {v11, v9, v10, v2}, Lhd/c;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Object;Ljava/lang/Class;)V
    :try_end_1
    ...
    new-instance v11, Lhd/d;

    invoke-direct {v11, v7, v2, v10}, Lhd/d;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Class;I)V
    :try_end_2
    ...
    invoke-direct {v10, v4, v2}, Lhd/e;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Class;)V
    :try_end_3
    ...
    invoke-static {v0}, Lhd/d0;->c(Ljava/lang/reflect/Type;)Ljava/lang/Class;

    move-result-object v4

    invoke-static {v4}, Lid/b;->d(Ljava/lang/Class;)Z
    ...
    invoke-interface {v6}, Lhd/k;->ignore()Z
    ...
    invoke-static {v0, v4, v11, v13}, Lid/b;->f(Ljava/lang/reflect/Type;Ljava/lang/Class;Ljava/lang/reflect/Type;Ljava/util/LinkedHashSet;)Ljava/lang/reflect/Type;
    ...
    invoke-virtual {v4, v11, v1, v3}, Lhd/a0;->b(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Lhd/o;
    ...
    :cond_11
    invoke-interface {v6}, Lhd/k;->name()Ljava/lang/String;
    ...
    :goto_a
    new-instance v6, Lhd/g$b;

    invoke-direct {v6, v3, v12, v1}, Lhd/g$b;-><init>(Ljava/lang/String;Ljava/lang/reflect/Field;Lhd/o;)V

    invoke-virtual {v2, v3, v6}, Ljava/util/TreeMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lhd/g$b;
    ...
    invoke-static {v0, v1, v3, v5}, Lid/b;->f(Ljava/lang/reflect/Type;Ljava/lang/Class;Ljava/lang/reflect/Type;Ljava/util/LinkedHashSet;)Ljava/lang/reflect/Type;
    ...
    invoke-direct {v0, v10, v2}, Lhd/g;-><init>(Lhd/f;Ljava/util/TreeMap;)V

    invoke-virtual {v0}, Lhd/o;->d()Lhd/o;
    ...
    invoke-static {v0}, Lid/b;->g(Ljava/lang/reflect/InvocationTargetException;)V
