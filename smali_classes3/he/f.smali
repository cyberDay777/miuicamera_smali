...
.field public j:Lhe/f$a;

.field public k:Lhe/f$b;

.field public l:Lhe/f$c;

.field public m:Lhe/f$d;
...
.method public constructor <init>(Lhe/d;)V
    ...
    iput-object v0, p0, Lhe/f;->i:Ljava/lang/StringBuilder;

    iput-object p1, p0, Lhe/f;->g:Lhe/d;
    ...
    iput-object p1, p0, Lhe/f;->e:Ljava/lang/String;
...
.method public final b()Ljava/lang/String;
    ...
    iget-object v1, v0, Lhe/f;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v1}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getBitRate()J

    move-result-wide v1

    iget-object v3, v0, Lhe/f;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v3}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getVideoCachedBytes()J

    move-result-wide v3

    iget-object v5, v0, Lhe/f;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v5}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getVideoCachedPackets()J

    move-result-wide v5

    iget-object v7, v0, Lhe/f;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v7}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getVideoCachedDuration()J

    move-result-wide v7

    iget-object v9, v0, Lhe/f;->i:Ljava/lang/StringBuilder;

    const/4 v10, 0x0

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->setLength(I)V

    iget-object v11, v0, Lhe/f;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    invoke-static {v9, v14, v11, v13}, La1/c0;->h(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lhe/f;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
...
.method public c()V
    ...
    iget-object p0, p0, Lhe/f;->e:Ljava/lang/String;
...
.method public final d()V
    ...
    iget-object v0, p0, Lhe/f;->g:Lhe/d;
    ...
    iput-object v1, p0, Lhe/c;->a:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Ljava/lang/Thread;->start()V

    new-instance v1, Landroid/os/Handler;

    iget-object v2, p0, Lhe/c;->a:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lhe/c;->b:Landroid/os/Handler;
    ...
    iput-object v1, p0, Lhe/c;->c:Landroid/os/Handler;
...
.method public e()V
    ...
    iget-object v0, p0, Lhe/c;->a:Landroid/os/HandlerThread;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lhe/f;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    if-eqz v1, :cond_0

    iget-object v2, p0, Lhe/c;->b:Landroid/os/Handler;

    new-instance v3, Lcom/android/camera/c;

    const/4 v4, 0x3

    invoke-direct {v3, v4, p0, v1, v0}, Lcom/android/camera/c;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v2, v3}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    const/4 v0, 0x0

    iput-object v0, p0, Lhe/f;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
...
.method public final f(Landroid/view/Surface;)V
    ...
    :cond_0
    iput-object p1, p0, Lhe/c;->d:Landroid/view/Surface;
...
.method public final g()V
    ...
    iget-object v1, p0, Lhe/f;->e:Ljava/lang/String;

    const-string v2, "player start"

    invoke-static {v1, v2, v0}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object p0, p0, Lhe/f;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
...
.method public final onInfo(Ltv/danmaku/ijk/media/player/IMediaPlayer;II)Z
    ...
    new-instance p2, Lcom/android/camera/q0;

    const/16 p3, 0x10

    invoke-direct {p2, p0, p3}, Lcom/android/camera/q0;-><init>(Ljava/lang/Object;I)V
