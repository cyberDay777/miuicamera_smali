...
.method public constructor <init>(Lje/t;)V
    ...
    iput-object p1, p0, Lje/t$c;->a:Lje/t;
...
.method public final a(Lge/b;)V
    ...
    iget-wide v7, p1, Lge/b;->d:J

    iget-object v1, p1, Lge/b;->f:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lje/t$c;->a:Lje/t;

    const/4 v5, 0x0

    iget v6, p1, Lge/b;->a:I

    if-eq v2, v6, :cond_0

    if-ne v0, v6, :cond_5

    iget-boolean v2, v4, Lje/t;->p:Z

    if-eqz v2, :cond_5

    :cond_0
    iget-object v2, p1, Lge/b;->i:Lge/b$a;

    if-eqz v2, :cond_10

    invoke-virtual {v4, v7, v8}, Lje/t;->r(J)Lje/q;

    move-result-object v9

    iget-object v10, v2, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v12, v7, v8, v13}, Landroidx/concurrent/futures/c;->e(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iput-wide v10, v9, Lje/q;->e:J

    invoke-virtual {v4, v7, v8}, Lje/t;->u(J)Lje/q;

    invoke-static {v4, v10, v11, v9}, Lje/t;->g(Lje/t;JLje/q;)V

    :cond_1
    if-ne v0, v6, :cond_4

    iget-boolean v0, v4, Lje/t;->p:Z

    if-eqz v0, :cond_4

    iget-boolean v0, p1, Lge/b;->m:Z

    if-eqz v0, :cond_3

    iget-object v0, p1, Lge/b;->g:Ljava/util/List;
    ...
    iput-object v2, v6, Lje/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iget-object v2, v6, Lje/q;->q:Lje/r;

    iget-boolean v2, v2, Lje/r;->M:Z
    ...
    iget-boolean v5, p1, Lge/b;->s:Z

    iget-object v6, v6, Lje/q;->M:Lge/d;

    move-object v0, p0

    move-wide v3, v7

    invoke-direct/range {v0 .. v6}, Lge/g;-><init>(Ljava/util/ArrayList;ZJZLge/d;)V

    iget v0, p1, Lge/b;->x:I

    iput v0, p0, Lge/g;->f:I

    iget-object p1, p1, Lge/b;->r:Lje/n;

    sget-boolean v0, Lz9/a;->y:Z

    if-nez v0, :cond_7

    iget-object v0, p1, Lje/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {p1, p0}, Lje/n;->e(Lge/g;)I

    goto/16 :goto_3

    :cond_8
    iget-object p1, v4, Lje/t;->C:Lje/t$e;

    invoke-virtual {p1, v5, v7, v8}, Lje/t$e;->c(IJ)V
    ...
    invoke-virtual {p1, v0, v5, v5}, Lje/t$e;->d(Landroid/media/Image;IZ)V

    invoke-virtual {v0}, Landroid/media/Image;->close()V

    invoke-virtual {p0, v0}, Lje/t$c;->b(Landroid/media/Image;)V
    ...
    invoke-static {p1, v7, v8}, La/c;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v4, v1, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :cond_b
    sget-object v8, Lp9/c0;->H1:Lp9/b0;
    ...
    invoke-static {v8, v6}, Landroidx/appcompat/app/b;->d(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/String;
    ...
    invoke-static {v6, v7}, La1/c0;->c(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iget-object v1, v1, Lge/b$a;->d:Landroid/media/Image;

    iput-object v4, v0, Lje/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iget-object v0, p1, Lge/b;->r:Lje/n;
    ...
    invoke-static {v2, v1, v4}, Lfe/f;->h(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;
    ...
    invoke-direct {v4, v2, v5, v6, v7}, Lge/c;-><init>(Landroid/media/Image;IZLo2/g;)V

    invoke-virtual {v0, v4}, Lje/n;->d(Lge/c;)V
    ...
    :cond_d
    invoke-virtual {p0, v1}, Lje/t$c;->b(Landroid/media/Image;)V

    goto :goto_3

    :cond_e
    invoke-virtual {p0, p1, v2}, Lje/t$c;->c(Lge/b;Ljava/lang/String;)V
...
.method public final c(Lge/b;Ljava/lang/String;)V
    .locals 18
    .param p1    # Lge/b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual/range {p1 .. p1}, Lge/b;->a()Lge/g;
    ...
    :cond_0
    iget-object v6, v2, Lge/g;->a:Ljava/util/List;
    ...
    iget-object v11, v0, Lje/t$c;->a:Lje/t;

    iget-wide v12, v1, Lge/b;->d:J

    iget v14, v1, Lge/b;->a:I
    ...
    iget-boolean v15, v1, Lge/b;->s:Z

    if-nez v15, :cond_3

    iget-boolean v15, v9, Lge/b$a;->a:Z

    if-eqz v15, :cond_5

    iget-object v7, v9, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v7}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getTimeStamp()J

    move-result-wide v4

    invoke-virtual {v11, v4, v5}, Lje/t;->r(J)Lje/q;
    ...
    invoke-static {v11, v1, v14}, Lje/t;->h(Lje/t;Lge/b;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v4

    iput-object v4, v7, Lje/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual/range {p1 .. p1}, Lge/b;->b()Z
    ...
    invoke-virtual {v5, v12, v13}, Lje/t;->r(J)Lje/q;
    ...
    invoke-static {v5, v1, v14}, Lje/t;->h(Lje/t;Lge/b;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v4

    iput-object v4, v10, Lje/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    check-cast v2, Lge/b$a;

    invoke-static {v5, v2, v0}, Lje/t;->a(Lje/t;Lge/b$a;Lje/d;)V
    ...
    :cond_8
    iget-object v0, v1, Lge/b;->r:Lje/n;

    iget-boolean v1, v1, Lge/b;->s:Z

    if-eqz v1, :cond_9

    iget-boolean v1, v2, Lge/g;->b:Z

    if-eqz v1, :cond_9

    iget-object v1, v0, Lje/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v1}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_9
    iget-object v1, v5, Lje/t;->b:Lje/n;
    ...
    iput v4, v2, Lge/g;->d:I

    :cond_b
    if-eqz v0, :cond_c

    invoke-virtual {v0, v2}, Lje/n;->e(Lge/g;)I
