...
.method public constructor <init>(Lje/t;)V
    ...
    iput-object p1, p0, Lje/t$e;->a:Lje/t;
...
# virtual methods
.method public final a(J)Lje/q;
    .locals 0

    iget-object p0, p0, Lje/t$e;->a:Lje/t;

    invoke-virtual {p0, p1, p2}, Lje/t;->r(J)Lje/q;
...
.method public final b(Lje/n;)Z
    ...
    iget-object v2, v0, Lge/b;->r:Lje/n;
...
.method public final c(IJ)V
    ...
    iget-object v0, p0, Lje/t$e;->a:Lje/t;

    iget-object v1, v0, Lje/t;->h:Lje/t$i;

    if-eqz v1, :cond_4

    invoke-virtual {p0, p2, p3}, Lje/t$e;->a(J)Lje/q;
    ...
    invoke-virtual {v1, p2}, Ls6/g;->s(Ljava/lang/String;)V

    iget-object p2, v0, Lje/t;->h:Lje/t$i;

    check-cast p2, Lcom/android/camera/o3$a;

    invoke-virtual {p2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p3, p0, Lje/q;->v:Lje/w;

    if-eqz p3, :cond_3

    invoke-interface {p3, p0, p1}, Lje/w;->b(Lje/q;I)V

    goto :goto_2

    :cond_3
    iget-object p2, p2, Lcom/android/camera/o3$a;->a:Lcom/android/camera/o3;

    iget-object p3, p2, Lcom/android/camera/o3;->b:Ljava/lang/ref/WeakReference;
    ...
    iget-object p2, p2, Lcom/android/camera/o3;->b:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {p2, p0, p1}, Lje/w;->b(Lje/q;I)V
...
.method public final d(Landroid/media/Image;IZ)V
    ...
    invoke-static {v2, v4, v1}, Landroidx/concurrent/futures/a;->f(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v10, v0, Lje/t$e;->a:Lje/t;

    const/4 v11, 0x2

    if-ne v1, v11, :cond_0

    invoke-static/range {p1 .. p1}, Lfe/f;->e(Landroid/media/Image;)[B

    move-result-object v0

    if-eqz v0, :cond_13

    iget-object v1, v10, Lje/t;->D:Lje/t$f;

    invoke-virtual {v1, v0, v8}, Lje/t$f;->onJpegAvailable([BLjava/lang/String;)V

    goto/16 :goto_6

    :cond_0
    invoke-virtual {v0, v6, v7}, Lje/t$e;->a(J)Lje/q;
    ...
    invoke-static {v0, v6, v7}, La/c;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v2, v12, Lje/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, v12, Lje/q;->q:Lje/r;

    iget v5, v4, Lje/r;->C:I
    ...
    invoke-static {v14}, Lfe/d;->d(I)Z

    move-result v5

    if-nez v5, :cond_9

    iget-boolean v1, v4, Lje/r;->T:Z
    ...
    iget-object v0, v0, Lje/t$e;->a:Lje/t;
    ...
    invoke-virtual {v1, v0, v8}, Lje/t$f;->onError(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v3, v15}, Lfe/f;->h(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v0

    iget-object v1, v10, Lje/t;->A:Lje/t$c;

    invoke-virtual {v1, v3}, Lje/t$c;->b(Landroid/media/Image;)V
    ...
    new-instance v2, Lr7/e$a;

    invoke-direct {v2}, Lr7/e$a;-><init>()V

    iput-object v0, v2, Lr7/e$a;->o:Landroid/media/Image;

    iput-object v1, v2, Lr7/e$a;->m:Landroid/hardware/camera2/CaptureResult;

    iput-object v12, v2, Lr7/e$a;->n:Lje/q;

    iget-object v0, v10, Lje/t;->q:Lje/u;

    iput-object v0, v2, Lr7/e$a;->p:Lr7/b$b;

    new-instance v0, Lr7/e;

    invoke-direct {v0, v2}, Lr7/e;-><init>(Lr7/e$a;)V

    iget-object v1, v10, Lje/t;->i:Lr7/i;

    iget-object v2, v1, Lr7/i;->o:Landroid/os/HandlerThread;
    ...
    iput-object v2, v1, Lr7/i;->o:Landroid/os/HandlerThread;

    invoke-virtual {v2}, Ljava/lang/Thread;->start()V

    new-instance v2, Landroid/os/Handler;

    iget-object v3, v1, Lr7/i;->o:Landroid/os/HandlerThread;
    ...
    iput-object v2, v1, Lr7/i;->p:Landroid/os/Handler;
    ...
    :cond_7
    iget-object v2, v1, Lr7/i;->p:Landroid/os/Handler;

    iput-object v2, v0, Lr7/b;->m:Landroid/os/Handler;

    invoke-virtual {v1, v0, v15}, Lr7/i;->h(Lr7/b;Z)V

    invoke-static {v14}, Lfe/d;->c(I)Z

    move-result v0

    if-eqz v0, :cond_8

    iget-object v0, v10, Lje/t;->t:Ljava/util/HashMap;
    ...
    iget-object v1, v10, Lje/t;->s:Ljava/util/Map;
    ...
    iput-object v1, v10, Lje/t;->s:Ljava/util/Map;
    ...
    iget-object v1, v10, Lje/t;->r:Ljava/util/Map;
    ...
    iput-object v1, v10, Lje/t;->r:Ljava/util/Map;
    ...
    iget v3, v12, Lje/q;->S:I

    iget v4, v12, Lje/q;->T:I

    iget-object v5, v12, Lje/q;->U:Landroid/graphics/Rect;

    iget v9, v12, Lje/q;->V:F
    ...
    :goto_3
    iget-object v0, v10, Lje/t;->r:Ljava/util/Map;
    ...
    iget-object v0, v10, Lje/t;->s:Ljava/util/Map;
    ...
    invoke-virtual/range {v1 .. v7}, Lje/t$e;->f(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLje/q;J)V
    ...
    invoke-virtual {v10, v6, v7, v0}, Lje/t;->p(JLandroid/media/Image;)V

    goto :goto_6

    :cond_12
    invoke-virtual {v10, v6, v7, v3}, Lje/t;->p(JLandroid/media/Image;)V
...
.method public final e(Landroid/media/Image;)V
    ...
    iget-object p0, p0, Lje/t;->A:Lje/t$c;

    invoke-virtual {p0, p1}, Lje/t$c;->b(Landroid/media/Image;)V

    return-void
.end method

.method public final f(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLje/q;J)V
    .locals 4
    ...
    invoke-static {p2, v3}, Lfe/f;->d(Landroid/media/Image;Z)[B
    ...
    invoke-static {v1, v2, p2, p3}, Landroidx/activity/e;->d(JLjava/lang/StringBuilder;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p4, v0, v3}, Lje/q;->a(I[B)V

    const-string p2, "JPEG"

    invoke-virtual {p4, p2}, Lje/q;->f(Ljava/lang/String;)Z
    ...
    iget-object p2, p0, Lje/t;->i:Lr7/i;

    const/4 p3, 0x0

    invoke-virtual {p2, p4, p1, p3, p3}, Lr7/i;->q(Lje/q;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V

    iget-object p1, p4, Lje/q;->L:Landroid/media/Image;

    invoke-static {p0, p1}, Lje/t;->b(Lje/t;Landroid/media/Image;)V

    invoke-static {p0, p4}, Lje/t;->c(Lje/t;Lje/q;)Z
    ...
    invoke-virtual {p1, p4}, Lcom/android/camera/o3$a;->a(Lje/q;)V

    :cond_3
    const-string p1, "[2] onImageProcessed: parallelTaskHashMap remove "

    invoke-static {p1, p5, p6}, La/c;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    invoke-virtual {p0, p5, p6}, Lje/t;->u(J)Lje/q;
