...
.field public i:Lje/n$b;

.field public j:Lje/n$a;

.field public k:Lje/k;
...
.method public constructor <init>(Lje/t$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    iput-object v0, p0, Lje/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Lje/n;->c:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Lje/n;->d:Ljava/util/concurrent/atomic/AtomicInteger;

    const/4 v0, 0x4

    iput v0, p0, Lje/n;->e:I

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lje/n;->g:Ljava/lang/Object;
    ...
    iput-object v2, p0, Lje/n;->n:Ljava/lang/Object;

    new-instance v2, Ljava/util/LinkedList;

    invoke-direct {v2}, Ljava/util/LinkedList;-><init>()V

    iput-object v2, p0, Lje/n;->o:Ljava/util/LinkedList;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lje/n;->p:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lje/n;->j:Lje/n$a;
    ...
    :goto_0
    iput-boolean p1, p0, Lje/n;->m:Z

    sget-object p1, Ljava/util/Locale;->ENGLISH:Ljava/util/Locale;

    new-array v0, v0, [Ljava/lang/Object;

    invoke-virtual {p0}, Lje/n;->g()Ljava/lang/String;
    ...
    iput-object p1, p0, Lje/n;->l:Ljava/lang/String;

    new-instance v0, Landroid/os/HandlerThread;

    const-string v2, "WorkerThread"

    invoke-static {v2, p1}, Landroidx/appcompat/view/menu/a;->f(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-direct {v0, p1}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object v0, p0, Lje/n;->h:Landroid/os/HandlerThread;

    new-instance p1, Lje/k;

    invoke-direct {p1}, Lje/k;-><init>()V

    iput-object p1, p0, Lje/n;->k:Lje/k;
    ...
    iput-object p0, p1, Lje/k;->a:Landroid/util/Size;
...
.method public abstract e(Lge/g;)I
    .param p1    # Lge/g;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public final h()I
    ...
    iget-object v0, p0, Lje/n;->p:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget p0, p0, Lje/n;->q:I
...
.method public u()V
    ...
    iget-object v0, p0, Lje/n;->h:Landroid/os/HandlerThread;
    ...
    :try_start_1
    iget-object v0, p0, Lje/n;->i:Lje/n$b;
...
.method public final x()V
    ...
    invoke-virtual {p0}, Lje/n;->l()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lje/n;->u()V
