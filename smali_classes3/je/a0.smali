...
.method public constructor <init>(Lje/t$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, Lje/b;-><init>(Lje/t$e;Lcom/xiaomi/engine/BufferFormat;)V
...
# virtual methods
.method public final B(Lge/g;)V
    .locals 11

    iget-object v0, p1, Lge/g;->a:Ljava/util/List;
    ...
    :cond_0
    iget-boolean v1, p1, Lge/g;->b:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, Lje/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-boolean v1, v1, Lge/b$a;->i:Z
    ...
    iget-object v5, v4, Lge/b$a;->d:Landroid/media/Image;

    invoke-static {v5}, Lje/n;->m(Landroid/media/Image;)Z
    ...
    :cond_2
    iget-object v6, v4, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    if-nez v1, :cond_3

    iget v7, p1, Lge/g;->d:I

    invoke-virtual {p0, v6, v5, v3, v7}, Lje/a0;->J(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    :goto_2
    iget v8, p1, Lge/g;->d:I

    invoke-virtual {p0, v6, v5, v7, v8}, Lje/a0;->J(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V

    :goto_3
    iget-object v4, v4, Lge/b$a;->e:Landroid/media/Image;

    iget-object v5, p0, Lje/n;->j:Lje/n$a;

    invoke-static {v4, v5}, Lje/b;->D(Landroid/media/Image;Lje/n$a;)V
...
.method public final J(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-static {v0, v1, v2, v4}, Landroidx/concurrent/futures/b;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_0
    new-instance p1, Lje/a0$a;

    invoke-direct {p1, p0}, Lje/a0$a;-><init>(Lje/a0;)V
    ...
    :cond_2
    new-instance p1, Lje/a0$b;

    invoke-direct {p1}, Lje/a0$b;-><init>()V
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lje/b;->w:Landroid/media/ImageReader;

    new-instance v2, Lje/x;

    invoke-direct {v2, p0}, Lje/x;-><init>(Lje/a0;)V

    iget-object v4, p0, Lje/b;->t:Landroid/os/Handler;
    ...
    iget-object v2, p0, Lje/b;->w:Landroid/media/ImageReader;
    ...
    invoke-direct {v2, p0}, Lje/y;-><init>(Lje/a0;)V
    ...
    iget-object v2, p0, Lje/b;->x:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Lje/b;->y:Landroid/media/ImageReader;

    new-instance v1, Lje/z;

    invoke-direct {v1, p0}, Lje/z;-><init>(Lje/a0;)V

    iget-object v3, p0, Lje/b;->t:Landroid/os/Handler;
    ...
    iget-object p0, p0, Lje/b;->y:Landroid/media/ImageReader;
...
.method public final l()Z
    ...
    iget-object v3, p0, Lje/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    const/4 v4, 0x0

    iget-boolean v5, p0, Lje/n;->m:Z
    ...
    iget-object v0, p0, Lje/n;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lje/n;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v5, p0}, Lje/t$e;->b(Lje/n;)Z
