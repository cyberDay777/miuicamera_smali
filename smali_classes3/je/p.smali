...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lje/p;->c:Landroid/util/LongSparseArray;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0, v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(I)V

    iput-object v0, p0, Lje/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v0, p0, Lje/p;->a:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lje/p;->a:Landroid/os/HandlerThread;

    iget-object v0, v0, Ls6/d;->b:Landroid/os/Looper;

    :goto_0
    new-instance v1, Lje/p$a;

    invoke-direct {v1, p0, v0}, Lje/p$a;-><init>(Lje/p;Landroid/os/Looper;)V

    iput-object v1, p0, Lje/p;->b:Lje/p$a;

    return-void
.end method

.method public static a(Lje/p;)V
    .locals 9
    ...
    iget-object v3, p0, Lje/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p0, p0, Lje/p;->c:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {v2}, Lge/b;->toString()Ljava/lang/String;
...
.method public static b(Lje/p;J)J
    .locals 7

    iget-object p0, p0, Lje/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
...
# virtual methods
.method public final c(JLge/b;Z)Ljava/util/ArrayList;
    .locals 17
    .param p3    # Lge/b;
    ...
    iget-object v2, v2, Lge/b;->u:Ljava/lang/String;
    ...
    :goto_1
    iget-object v10, v5, Lje/p;->c:Landroid/util/LongSparseArray;
    ...
    check-cast v10, Lge/b$a;

    iget-wide v11, v10, Lge/b$a;->o:J
    ...
    iget-object v11, v10, Lge/b$a;->p:Ljava/lang/String;
    ...
    iget-wide v11, v10, Lge/b$a;->q:J

    sub-long v11, v7, v11

    sget-boolean v13, Lz9/a;->i:Z
    ...
    check-cast v1, Lge/b$a;

    iget-wide v1, v1, Lge/b$a;->o:J
...
.method public final d(Lge/b$a;)V
    .locals 14

    invoke-virtual {p1}, Lge/b$a;->c()Z
    ...
    iget-object v0, p0, Lje/p;->c:Landroid/util/LongSparseArray;

    iget-wide v4, p1, Lge/b$a;->o:J

    invoke-virtual {v0, v4, v5}, Landroid/util/LongSparseArray;->remove(J)V

    iget-object v0, p1, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v0}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getSequenceId()I

    move-result v0

    iget-object v2, p1, Lge/b$a;->p:Ljava/lang/String;

    iget-object v4, p1, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v4}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getTimeStamp()J

    move-result-wide v4

    iget-wide v7, p1, Lge/b$a;->n:J

    iget-object v9, p0, Lje/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    new-instance v11, Lg2/o1;

    invoke-direct {v11, v2, v10}, Lg2/o1;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v9, v11}, Lcom/android/camera/x0;-><init>(I)V
    ...
    iget-wide v7, v9, Lge/b;->d:J

    iput-wide v7, p1, Lge/b$a;->n:J

    const-string v2, "ParallelDataZipper"

    const-string v11, "update data bean\'s first timestamp to "

    invoke-static {v11, v7, v8}, La/c;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v0, v9, Lge/b;->f:Ljava/util/ArrayList;

    iget v1, v9, Lge/b;->a:I

    if-ne v1, v3, :cond_1

    iget-wide v1, p1, Lge/b$a;->o:J

    iget-wide v4, p1, Lge/b$a;->n:J
    ...
    :goto_0
    iget p1, v9, Lge/b;->h:I

    add-int/2addr p1, v3

    iput p1, v9, Lge/b;->h:I
    ...
    iget-object p1, v9, Lge/b;->v:Lge/a;

    if-eqz p1, :cond_3

    invoke-virtual {v9}, Lge/b;->b()Z
    ...
    iget-object p1, v9, Lge/b;->q:Lje/p$e;

    check-cast p1, Lje/t$b;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v0, v9, Lge/b;->a:I

    invoke-static {v0}, Lfe/d;->c(I)Z
    ...
    iget-object p1, p1, Lje/t$b;->a:Lje/t;

    iget-object p1, p1, Lje/t;->C:Lje/t$e;

    invoke-virtual {p1, v3, v1, v2}, Lje/t$e;->c(IJ)V

    :cond_2
    iget-object p1, v9, Lge/b;->v:Lge/a;

    new-instance v0, Lje/p$g;

    invoke-direct {v0, p0, v9}, Lje/p$g;-><init>(Lje/p;Lge/b;)V

    new-instance v1, Lje/p$d;

    invoke-direct {v1, p0, v9}, Lje/p$d;-><init>(Lje/p;Lge/b;)V

    iget-object p0, p0, Lje/p;->b:Lje/p$a;
    ...
    invoke-virtual {p1, v0, v1, p0}, Lge/a;->a(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V
    :try_end_0
    ...
    :cond_3
    iget-wide v0, v9, Lge/b;->d:J

    iget-boolean p1, v9, Lge/b;->s:Z
    ...
    iget-object v2, p1, Lje/t$b;->a:Lje/t;

    iget-object v2, v2, Lje/t;->A:Lje/t$c;

    const-string v3, "onPartialDataAvailable"

    invoke-virtual {v2, v9, v3}, Lje/t$c;->c(Lge/b;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v0, v1}, Lje/t;->r(J)Lje/q;

    move-result-object v2

    if-eqz v2, :cond_4

    iput-boolean v6, v2, Lje/q;->x:Z
    ...
    invoke-virtual {v2, v6, v0, v1}, Lje/t$e;->c(IJ)V

    iget-object p1, p1, Lje/t$b;->a:Lje/t;

    invoke-virtual {p1}, Lje/t;->v()V
    ...
    iget-object p1, p0, Lje/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, v9, Lge/b;->w:Lge/b$b;

    invoke-virtual {p0, p1}, Lje/p;->j(Lge/b$b;)V
    ...
    invoke-virtual {p0, v9}, Lje/p;->l(Lge/b;)V
...
.method public final declared-synchronized e(Landroid/media/Image;IIZ)V
    ...
    invoke-direct/range {v1 .. v6}, Lje/p$c;-><init>(Lje/p;Landroid/media/Image;IIZ)V
...
.method public final declared-synchronized f(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    new-instance v1, Lje/p$b;

    invoke-direct {v1, p0, p1, p2}, Lje/p$b;-><init>(Lje/p;Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public final g(Lje/v;)V
    ...
    invoke-virtual {p0, p1}, Lje/p;->i(Lje/v;)V

    :goto_0
    return-void
.end method

.method public final declared-synchronized h(Lge/b;)V
    .locals 3
    .param p1    # Lge/b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    :try_start_0
    iget-object v1, p0, Lje/p;->a:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, Lje/p;->b:Lje/p$a;
...
.method public final i(Lje/v;)V
    ...
    iget-object v8, p0, Lje/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {p0, v1, v2, v0, v6}, Lje/p;->c(JLge/b;Z)Ljava/util/ArrayList;

    move-result-object v4

    iget-boolean v3, p1, Lje/v;->c:Z

    if-eqz v0, :cond_4

    iget-object v5, v0, Lge/b;->q:Lje/p$e;

    iget-object v9, v0, Lge/b;->r:Lje/n;

    iget-object v10, v0, Lge/b;->f:Ljava/util/ArrayList;

    if-eqz v3, :cond_1

    iget-boolean v11, v0, Lge/b;->s:Z

    if-eqz v11, :cond_0

    iget v10, v0, Lge/b;->t:I

    invoke-virtual {v0}, Lge/b;->a()Lge/g;

    move-result-object v11

    if-eqz v11, :cond_2

    iget-object v11, v11, Lge/g;->a:Ljava/util/List;
    ...
    iget-object v0, v0, Lge/b;->w:Lge/b$b;

    invoke-virtual {p0, v0}, Lje/p;->j(Lge/b$b;)V
    ...
    iget-object v5, p1, Lje/v;->a:Lje/p$e;
    ...
    invoke-virtual/range {v0 .. v5}, Lje/t$b;->b(JILjava/util/ArrayList;Lje/n;)V

    goto :goto_3

    :cond_7
    check-cast v5, Lje/t$b;

    invoke-virtual {v5, v1, v2, v4}, Lje/t$b;->a(JLjava/util/ArrayList;)V
...
.method public final j(Lge/b$b;)V
    .locals 1
...
.method public final k(Lge/b;)V
    ...
    iget-wide v2, p1, Lge/b;->d:J

    iget-object v0, p0, Lje/p;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v3, p1, Lge/b;->w:Lge/b$b;

    invoke-virtual {v0, v2, v3}, Landroid/os/Handler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v2

    sget-boolean v3, Lz9/a;->i:Z
    ...
    :goto_1
    iget-object v4, p0, Lje/p;->c:Landroid/util/LongSparseArray;

    invoke-virtual {v4}, Landroid/util/LongSparseArray;->size()I

    move-result v5

    iget-wide v6, p1, Lge/b;->d:J
    ...
    check-cast v4, Lge/b$a;

    iget-boolean v5, v4, Lge/b$a;->m:Z

    if-nez v5, :cond_3

    iget-wide v8, v4, Lge/b$a;->n:J

    cmp-long v5, v8, v6

    if-eqz v5, :cond_2

    iget-object v5, v4, Lge/b$a;->p:Ljava/lang/String;

    iget-object v6, p1, Lge/b;->u:Ljava/lang/String;
    ...
    check-cast v3, Lge/b$a;

    iget-wide v4, v3, Lge/b$a;->o:J
    ...
    :cond_7
    iget-wide v4, v3, Lge/b$a;->n:J

    :goto_3
    iput-wide v6, v3, Lge/b$a;->n:J

    iget v8, p1, Lge/b;->b:I

    iput v8, v3, Lge/b$a;->b:I

    iget-boolean v8, p1, Lge/b;->l:Z

    iput-boolean v8, v3, Lge/b$a;->f:Z

    iget-object v8, p1, Lge/b;->o:Lge/d;

    iput-object v8, v3, Lge/b$a;->h:Lge/d;

    iget-boolean v8, v3, Lge/b$a;->m:Z

    const/4 v9, 0x1

    if-nez v8, :cond_8

    iput-boolean v9, v3, Lge/b$a;->m:Z

    :cond_8
    iget-boolean v8, p1, Lge/b;->m:Z

    iput-boolean v8, v3, Lge/b$a;->i:Z
    ...
    invoke-virtual {v3}, Lge/b$a;->b()V

    invoke-virtual {p0, v3}, Lje/p;->d(Lge/b$a;)V
...
.method public final l(Lge/b;)V
    ...
    iget-wide v3, v2, Lge/b;->d:J

    const-string v0, "tryToConfirm: "

    invoke-static {v0, v3, v4}, La/c;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v6, v2, Lge/b;->q:Lje/p$e;
    ...
    :try_start_0
    iget-object v0, v2, Lge/b;->f:Ljava/util/ArrayList;
    ...
    check-cast v9, Lge/b$a;

    iget-object v9, v9, Lge/b$a;->d:Landroid/media/Image;
    ...
    invoke-virtual {v7, v9}, Ls6/g;->d(Ljava/lang/String;)J

    iget-boolean v7, v2, Lge/b;->e:Z

    if-nez v7, :cond_2d

    if-eqz v0, :cond_2d

    check-cast v6, Lje/t$b;
    ...
    invoke-static {v9, v10, v11, v12}, Landroidx/concurrent/futures/b;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v7, v7, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :goto_4
    iget-object v11, v6, Lje/t$b;->a:Lje/t;

    iget-wide v12, v2, Lge/b;->d:J

    invoke-virtual {v11, v12, v13}, Lje/t;->r(J)Lje/q;

    move-result-object v11

    if-eqz v11, :cond_6

    iget-object v12, v2, Lge/b;->r:Lje/n;

    if-eqz v12, :cond_5

    iput-boolean v8, v12, Lje/n;->f:Z

    :cond_5
    iput-boolean v5, v11, Lje/q;->x:Z

    if-eqz v7, :cond_6

    iput v8, v11, Lje/q;->R:I

    iput-object v12, v11, Lje/q;->Q:Lje/n;
    ...
    iget-object v13, v2, Lge/b;->f:Ljava/util/ArrayList;

    invoke-virtual {v13, v5}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Lge/b$a;

    iget-object v13, v13, Lge/b$a;->d:Landroid/media/Image;
    ...
    :cond_9
    iget-object v13, v12, Lje/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v13}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    iget-boolean v13, v12, Lje/n;->m:Z

    if-eqz v13, :cond_a

    iget-object v13, v12, Lje/n;->c:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v13}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    iget-object v12, v12, Lje/n;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v12, v2, Lge/b;->v:Lge/a;

    if-nez v12, :cond_b

    iget-object v12, v6, Lje/t$b;->a:Lje/t;

    iget-object v12, v12, Lje/t;->C:Lje/t$e;

    iget-wide v13, v2, Lge/b;->d:J

    invoke-virtual {v12, v5, v13, v14}, Lje/t$e;->c(IJ)V
    ...
    iget-boolean v10, v11, Lje/q;->K:Z

    if-eqz v10, :cond_1d

    iget-object v8, v2, Lge/b;->f:Ljava/util/ArrayList;
    ...
    iget-object v13, v13, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    check-cast v15, Lge/b$a;

    move-object/from16 v16, v8

    iget-object v8, v15, Lge/b$a;->g:Landroid/media/Image;

    move-wide/from16 v17, v3

    iget-boolean v3, v15, Lge/b$a;->l:Z
    ...
    iput-object v8, v11, Lje/q;->L:Landroid/media/Image;
    ...
    invoke-static {v4, v8, v15}, Lfe/f;->h(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v4

    iput-object v4, v11, Lje/q;->L:Landroid/media/Image;
    ...
    :cond_16
    :goto_c
    iget-object v4, v15, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v4, v8, v10}, Lfe/f;->h(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;
    ...
    iget-object v4, v12, Lje/t;->A:Lje/t$c;

    invoke-virtual {v4, v8}, Lje/t$c;->b(Landroid/media/Image;)V
    ...
    iget-object v3, v6, Lje/t$b;->a:Lje/t;

    iget-boolean v3, v3, Lje/t;->p:Z
    ...
    iget-object v0, v6, Lje/t$b;->a:Lje/t;
    ...
    iget-object v4, v2, Lge/b;->f:Ljava/util/ArrayList;
    ...
    check-cast v5, Lge/b$a;

    iget-object v5, v5, Lge/b$a;->d:Landroid/media/Image;
    ...
    invoke-static {v5, v10, v3}, Landroidx/concurrent/futures/a;->f(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0, v7, v8}, Lje/t;->r(J)Lje/q;
    ...
    check-cast v12, Lge/b$a;

    iget-object v13, v12, Lge/b$a;->d:Landroid/media/Image;

    invoke-virtual {v10, v13}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v12, v12, Lge/b$a;->g:Landroid/media/Image;
    ...
    iget-boolean v13, v12, Lge/b$a;->a:Z

    if-eqz v13, :cond_21

    iget-object v4, v12, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-object v4, v5, Lje/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, v5, Lje/q;->q:Lje/r;

    new-instance v7, Lcom/xiaomi/camera/imagecodec/ReprocessData;

    iget-boolean v8, v4, Lje/r;->A:Z

    iget-object v12, v4, Lje/r;->B:Landroid/util/Size;
    ...
    iget-object v8, v4, Lje/r;->h:Landroid/util/Size;
    ...
    iget v4, v5, Lje/q;->S:I

    iget v5, v5, Lje/q;->T:I
    ...
    invoke-virtual {v13, v0, v3}, Lje/t$f;->onError(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v7, v8}, La/c;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v0, v2, Lge/b;->r:Lje/n;

    iput-object v0, v11, Lje/q;->Q:Lje/n;

    :cond_27
    iget-object v0, v6, Lje/t$b;->a:Lje/t;

    iget-object v0, v0, Lje/t;->A:Lje/t$c;

    invoke-virtual {v0, v2}, Lje/t$c;->a(Lge/b;)V
    ...
    iget-object v3, v0, Lje/t;->A:Lje/t$c;

    iput-object v3, v2, Lge/b;->p:Lje/d;

    if-eqz v11, :cond_29

    iget-object v3, v11, Lje/q;->q:Lje/r;

    iget-boolean v4, v3, Lje/r;->L:Z

    iput-boolean v4, v2, Lge/b;->k:Z

    iget-boolean v4, v11, Lje/q;->P:Z

    iput-boolean v4, v2, Lge/b;->m:Z

    iget-boolean v4, v3, Lje/r;->A:Z

    iput-boolean v4, v2, Lge/b;->j:Z
    ...
    iput-object v4, v2, Lge/b;->n:Landroid/util/Size;

    :cond_29
    sget-object v3, Lye/a$b;->a:Lye/a;
    ...
    iget v7, v2, Lge/b;->c:I

    if-ne v7, v5, :cond_2c

    iget-object v4, v3, Lye/a;->d:Landroid/os/HandlerThread;
    ...
    iget-object v4, v3, Lye/a;->e:Lye/a$d;
    ...
    new-instance v3, Lye/a$c;

    invoke-direct {v3, v2, v0}, Lye/a$c;-><init>(Lge/b;Lcom/xiaomi/engine/TaskSession;)V
    ...
    invoke-virtual {v3, v2, v0}, Lye/a;->b(Lge/b;Lcom/xiaomi/engine/TaskSession;)V
    ...
    invoke-static {v1, v7, v2}, Landroidx/appcompat/widget/b;->d(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v6, v3, v4, v0}, Lje/t$b;->a(JLjava/util/ArrayList;)V
    ...
    iget-object v0, v2, Lge/b;->w:Lge/b$b;

    invoke-virtual {v1, v0}, Lje/p;->j(Lge/b$b;)V
