...
.field public final e:Lye/a$d;

.field public final f:Lye/a$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lye/a;->c:Ljava/lang/Object;

    new-instance v0, Lye/a$a;

    invoke-direct {v0, p0}, Lye/a$a;-><init>(Lye/a;)V

    iput-object v0, p0, Lye/a;->f:Lye/a$a;
    ...
    iput-object v0, p0, Lye/a;->d:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Ljava/lang/Thread;->start()V

    new-instance v1, Lye/a$d;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v0

    invoke-direct {v1, p0, v0}, Lye/a$d;-><init>(Lye/a;Landroid/os/Looper;)V

    iput-object v1, p0, Lye/a;->e:Lye/a$d;

    return-void
.end method

.method public static a(Lye/a;Lge/b$a;IZ)V
    .locals 17
    ...
    invoke-direct {v12, v1, v0, v2}, Lye/b;-><init>(Lye/a;Lge/b$a;I)V

    const/4 v13, 0x1

    if-nez v2, :cond_0

    iget-object v3, v0, Lge/b$a;->d:Landroid/media/Image;
    ...
    iget-object v3, v0, Lge/b$a;->e:Landroid/media/Image;
    ...
    iget-object v5, v0, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v4, v5, v2}, Landroidx/concurrent/futures/a;->f(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v4, v3, v6}, Lfe/f;->h(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;
    ...
    iget-object v3, v1, Lye/a;->c:Ljava/lang/Object;
    ...
    iput-wide v6, v1, Lye/a;->a:J

    iput-boolean v13, v1, Lye/a;->b:Z
    ...
    iget-object v7, v0, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, v1, Lye/a;->c:Ljava/lang/Object;
    ...
    :try_start_2
    iget-boolean v0, v1, Lye/a;->b:Z

    if-eqz v0, :cond_1

    iget-object v0, v1, Lye/a;->c:Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v3}, Landroidx/constraintlayout/core/b;->b(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
# virtual methods
.method public final b(Lge/b;Lcom/xiaomi/engine/TaskSession;)V
    .locals 33
    ...
    sget-boolean v0, Lz9/a;->x:Z

    iget-object v4, v1, Lge/b;->f:Ljava/util/ArrayList;

    move-object/from16 v6, p0

    iget-object v6, v6, Lye/a;->f:Lye/a$a;
    ...
    iget-object v2, v0, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-object v2, v0, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-boolean v7, v0, Lge/b$a;->a:Z

    iget-boolean v2, v0, Lge/b$a;->m:Z

    if-eqz v2, :cond_0

    invoke-virtual {v0}, Lge/b$a;->b()V

    :cond_0
    iget-object v2, v1, Lge/b;->p:Lje/d;
    ...
    iget-object v8, v5, Lge/b$a;->d:Landroid/media/Image;

    iget-object v9, v5, Lge/b$a;->e:Landroid/media/Image;

    iget-object v5, v5, Lge/b$a;->g:Landroid/media/Image;
    ...
    check-cast v10, Lje/t$c;

    invoke-virtual {v10, v8}, Lje/t$c;->b(Landroid/media/Image;)V
    ...
    check-cast v8, Lje/t$c;

    invoke-virtual {v8, v9}, Lje/t$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v8, v5}, Lje/t$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v0}, Lge/b$a;->c()Z

    move-result v2

    if-eqz v2, :cond_5

    iput-object v0, v1, Lge/b;->i:Lge/b$a;

    invoke-virtual {v6, v1, v3}, Lye/a$a;->a(Lge/b;Z)V
    ...
    iget v14, v1, Lge/b;->b:I

    iget-boolean v15, v1, Lge/b;->l:Z

    iget-object v10, v1, Lge/b;->o:Lge/d;

    const/16 v17, 0x1

    iget-boolean v11, v1, Lge/b;->m:Z
    ...
    invoke-direct/range {v13 .. v18}, Lge/b$a;-><init>(IZLge/d;ZZ)V
    ...
    invoke-static {v12, v9, v10, v11}, Landroidx/concurrent/futures/b;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v14, v13, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v0, v0, Lge/b$a;->d:Landroid/media/Image;
    ...
    iget-object v8, v5, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :goto_3
    invoke-virtual {v2, v0, v3, v3}, Lge/b$a;->d(Landroid/media/Image;IZ)V
    ...
    iget-object v0, v1, Lge/b;->p:Lje/d;
    ...
    iget-object v11, v10, Lge/b$a;->d:Landroid/media/Image;

    invoke-virtual {v11}, Landroid/media/Image;->close()V

    move-object v13, v0

    check-cast v13, Lje/t$c;

    invoke-virtual {v13, v11}, Lje/t$c;->b(Landroid/media/Image;)V

    iget-object v11, v10, Lge/b$a;->e:Landroid/media/Image;
    ...
    :cond_d
    iget-object v10, v10, Lge/b$a;->g:Landroid/media/Image;

    if-eqz v10, :cond_c

    invoke-virtual {v10}, Landroid/media/Image;->close()V

    invoke-virtual {v13, v10}, Lje/t$c;->b(Landroid/media/Image;)V
    ...
    iget-object v4, v5, Lge/b$a;->d:Landroid/media/Image;

    invoke-virtual {v4}, Landroid/media/Image;->close()V

    check-cast v0, Lje/t$c;

    invoke-virtual {v0, v4}, Lje/t$c;->b(Landroid/media/Image;)V

    iput-object v8, v2, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    const/4 v0, 0x1

    iput-boolean v0, v2, Lge/b$a;->a:Z

    iget-boolean v0, v2, Lge/b$a;->m:Z

    if-eqz v0, :cond_f

    invoke-virtual {v2}, Lge/b$a;->b()V

    :cond_f
    iget-boolean v0, v1, Lge/b;->l:Z

    if-eqz v0, :cond_10

    iget-object v0, v5, Lge/b$a;->g:Landroid/media/Image;

    iget-boolean v4, v5, Lge/b$a;->l:Z

    const/4 v8, 0x2

    invoke-virtual {v2, v0, v8, v4}, Lge/b$a;->d(Landroid/media/Image;IZ)V

    :cond_10
    iget-object v0, v5, Lge/b$a;->e:Landroid/media/Image;

    const/4 v4, 0x1

    if-eqz v0, :cond_11

    invoke-virtual {v2, v0, v4, v3}, Lge/b$a;->d(Landroid/media/Image;IZ)V

    :cond_11
    invoke-virtual {v2}, Lge/b$a;->c()Z

    move-result v0

    if-eqz v0, :cond_12

    iput-object v2, v1, Lge/b;->i:Lge/b$a;

    invoke-virtual {v6, v1, v4}, Lye/a$a;->a(Lge/b;Z)V
    ...
    iget-object v0, v1, Lge/b;->n:Landroid/util/Size;
    ...
    invoke-static {v13, v12, v14, v0}, Landroidx/activity/result/a;->d(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
    ...
    new-instance v10, Lge/b$a;

    iget v15, v1, Lge/b;->b:I

    iget-boolean v0, v1, Lge/b;->l:Z

    iget-object v11, v1, Lge/b;->o:Lge/d;

    const/16 v18, 0x1

    iget-boolean v14, v1, Lge/b;->m:Z
    ...
    invoke-direct/range {v14 .. v19}, Lge/b$a;-><init>(IZLge/d;ZZ)V
    ...
    iget-object v0, v3, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v17, Lp9/c0;->k1:Lp9/b0;

    invoke-virtual/range {v17 .. v17}, Lp9/d0;->b()Ljava/lang/Object;
    ...
    iget-object v6, v3, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v3, v3, Lge/b$a;->d:Landroid/media/Image;
    ...
    :cond_1d
    invoke-static {v8, v7}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v10, v7}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v11, v7, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v11}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getTimeStamp()J

    move-result-wide v12

    iget-object v0, v1, Lge/b;->o:Lge/d;
    ...
    check-cast v14, Lge/b$a;

    iget-object v0, v14, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v18, Lp9/c0;->k1:Lp9/b0;

    invoke-virtual/range {v18 .. v18}, Lp9/d0;->b()Ljava/lang/Object;
    ...
    invoke-static {v0, v3}, Landroidx/activity/e;->e(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v3, v14, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v3, v14, Lge/b$a;->e:Landroid/media/Image;
    ...
    iget-object v3, v3, Lge/b$a;->e:Landroid/media/Image;
    ...
    :cond_20
    invoke-static {v8, v2}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_21
    invoke-static {v10, v2}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v0, v3, v2}, Lge/b$a;->d(Landroid/media/Image;IZ)V
    ...
    :goto_13
    iput-object v11, v8, Lge/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-boolean v3, v8, Lge/b$a;->a:Z

    iget-boolean v0, v8, Lge/b$a;->m:Z

    if-eqz v0, :cond_24

    invoke-virtual {v8}, Lge/b$a;->b()V
    ...
    iget-object v0, v7, Lge/b$a;->g:Landroid/media/Image;

    iget-boolean v2, v7, Lge/b$a;->l:Z
    ...
    invoke-virtual {v8, v0, v2, v2}, Lge/b$a;->d(Landroid/media/Image;IZ)V
    ...
    :cond_28
    iget-object v9, v3, Lge/b$a;->d:Landroid/media/Image;
    ...
    invoke-virtual {v10, v9}, Lje/t$c;->b(Landroid/media/Image;)V

    iget-object v9, v3, Lge/b$a;->e:Landroid/media/Image;
    ...
    :cond_29
    iget-object v3, v3, Lge/b$a;->g:Landroid/media/Image;

    if-eqz v3, :cond_2a

    invoke-virtual {v3}, Landroid/media/Image;->close()V

    invoke-virtual {v10, v3}, Lje/t$c;->b(Landroid/media/Image;)V
    ...
    iget-object v2, v7, Lge/b$a;->d:Landroid/media/Image;

    invoke-virtual {v2}, Landroid/media/Image;->close()V

    check-cast v0, Lje/t$c;

    invoke-virtual {v0, v2}, Lje/t$c;->b(Landroid/media/Image;)V

    iget-object v2, v7, Lge/b$a;->e:Landroid/media/Image;

    if-eqz v2, :cond_2d

    iget-object v3, v1, Lge/b;->o:Lge/d;
    ...
    invoke-virtual {v8, v2, v3, v0}, Lge/b$a;->d(Landroid/media/Image;IZ)V
    ...
    iput-boolean v0, v3, Lge/b$a;->i:Z
    ...
    iput-object v6, v1, Lge/b;->g:Ljava/util/List;

    iget-boolean v0, v1, Lge/b;->k:Z

    xor-int/lit8 v0, v0, 0x1

    move-object/from16 v2, v24

    invoke-virtual {v2, v1, v0}, Lye/a$a;->a(Lge/b;Z)V
    ...
    iput-object v8, v1, Lge/b;->i:Lge/b$a;
    ...
    invoke-static {v1, v12}, La/d;->b(Ljava/lang/String;I)Ljava/lang/String;
