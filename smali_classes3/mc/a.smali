...
.method public static a(Ljava/lang/String;)Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBean;
    ...
    invoke-static {p0}, Lyb/k;->d([B)Lyb/k;

    move-result-object p0

    invoke-virtual {p0}, Lyb/k;->b()Lcom/google/protobuf/ByteString;
    ...
    invoke-virtual {p0}, Lyb/k;->c()Lcom/google/protobuf/ByteString;
    ...
    sget-object v4, Lmc/b;->a:Ljava/nio/charset/CharsetDecoder;
    ...
    :cond_5
    :try_start_0
    sget-object p0, Lmc/b;->a:Ljava/nio/charset/CharsetDecoder;
    ...
    :try_start_1
    sget-object p0, Lmc/b;->b:Ljava/nio/charset/CharsetDecoder;
    ...
    new-instance p0, Lhd/a0$a;

    invoke-direct {p0}, Lhd/a0$a;-><init>()V

    new-instance v4, Lhd/a0;

    invoke-direct {v4, p0}, Lhd/a0;-><init>(Lhd/a0$a;)V

    const-class p0, Lcom/miui/camerainfra/cloudconfig/data/http/bean/BizCloudConfigBean;

    invoke-virtual {v4, p0}, Lhd/a0;->a(Ljava/lang/Class;)Lhd/o;
    ...
    invoke-direct {p0, v0}, Lhd/q;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3}, Lhd/q;-><init>(Ljava/lang/String;)V
