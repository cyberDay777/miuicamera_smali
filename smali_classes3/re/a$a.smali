...
# direct methods
.method public constructor <init>(Lse/b$d;Lse/b$d;ILjava/lang/Object;Lre/e;)V
    .locals 8
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Lre/a$a;->b:Lse/b$d;

    iput-object p2, p0, Lre/a$a;->c:Lse/b$d;

    iput p3, p0, Lre/a$a;->e:I

    iput-object p4, p0, Lre/a$a;->f:Ljava/lang/Object;

    iput-object p5, p0, Lre/a$a;->d:Lr7/w;
    ...
    new-instance v7, Lcom/android/camera/q3;

    const/4 p2, 0x5

    const-string p3, "LiveShot"

    invoke-direct {v7, p3, p2}, Lcom/android/camera/q3;-><init>(Ljava/lang/String;I)V
    ...
    iput-object p1, p0, Lre/a$a;->g:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public final a(Ljava/lang/Exception;)V
    ...
    invoke-static {v0, p1}, Landroidx/concurrent/futures/a;->d(Ljava/lang/String;Ljava/lang/Exception;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lre/a$a;->d:Lr7/w;

    if-eqz v0, :cond_0

    iget-object p0, p0, Lre/a$a;->f:Ljava/lang/Object;

    invoke-interface {v0, p0, p1}, Lr7/w;->b(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public final run()V
    ...
    iget-object v4, v1, Lue/a$b;->a:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v4}, Ljava/util/concurrent/atomic/AtomicBoolean;->get()Z

    move-result v4

    iget-object v5, v1, Lre/a$a;->g:Ljava/util/concurrent/ThreadPoolExecutor;

    iget-object v6, v1, Lre/a$a;->d:Lr7/w;

    const-string v7, "CircularMediaRecorder"

    const/4 v8, 0x0

    iget-object v9, v1, Lre/a$a;->f:Ljava/lang/Object;
    ...
    invoke-interface {v6, v9}, Lr7/w;->a(Ljava/lang/Object;)V
    ...
    iget-object v11, v1, Lre/a$a;->c:Lse/b$d;
    ...
    :try_start_2
    iget-object v13, v11, Lse/b$d;->a:Landroid/media/MediaFormat;
    ...
    :goto_0
    iget-object v14, v1, Lre/a$a;->b:Lse/b$d;

    if-eqz v14, :cond_3

    :try_start_3
    iget-object v15, v14, Lse/b$d;->a:Landroid/media/MediaFormat;
    ...
    invoke-direct {v4, v8}, Lve/b$a;-><init>(Ljava/lang/Long;)V

    new-instance v8, Lve/c;

    invoke-direct {v8, v10, v11, v13, v4}, Lve/c;-><init>(Landroid/media/MediaMuxer;Lse/b$d;ILve/b$a;)V
    ...
    new-instance v8, Lve/a;

    invoke-direct {v8, v10, v14, v15, v4}, Lve/a;-><init>(Landroid/media/MediaMuxer;Lse/b$d;ILve/b$a;)V
    ...
    :cond_9
    iget-wide v2, v11, Lse/b$d;->d:J

    :goto_5
    invoke-interface {v6, v9, v0, v2, v3}, Lr7/w;->c(Ljava/lang/Object;Ljava/lang/String;J)V
    :try_end_3
    ...
    :cond_a
    :goto_6
    invoke-static {v10}, Lre/a$a;->b(Landroid/media/MediaMuxer;)V
    ...
    :goto_7
    :try_start_4
    invoke-virtual {v1, v0}, Lre/a$a;->a(Ljava/lang/Exception;)V
    ...
    :goto_9
    invoke-static {v4}, Lre/a$a;->b(Landroid/media/MediaMuxer;)V
