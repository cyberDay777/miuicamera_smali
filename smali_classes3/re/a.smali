...
.field public final f:Lte/c$b;


# direct methods
.method public constructor <init>(Landroid/util/Size;Landroid/opengl/EGLContext;Lnk/a;Lnk/a;Ljava/util/concurrent/LinkedBlockingQueue;)V
    .locals 15
    .param p3    # Lnk/a;
    ...
    invoke-direct {v4}, Lte/c$b;-><init>()V

    iput-object v4, v0, Lre/a;->f:Lte/c$b;

    iput-object v1, v4, Lk2/e;->f:Lnk/a;

    iput-object v2, v4, Lk2/e;->g:Lnk/a;
    ...
    sget-object v6, Lre/g;->a:Landroid/media/MediaCodecList;
    ...
    sput-object v6, Lre/g;->a:Landroid/media/MediaCodecList;
    ...
    invoke-static {v6, v10}, La1/c0;->c(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    sget-object v5, Lnk/a;->b:Lnk/a$c;
    ...
    invoke-direct {v4, v3, v2, v5}, Lse/c;-><init>(Landroid/media/MediaFormat;Landroid/opengl/EGLContext;Ljava/util/concurrent/LinkedBlockingQueue;)V

    iput-object v4, v0, Lre/a;->b:Lse/c;

    iput-boolean v8, v0, Lre/a;->a:Z
    ...
    invoke-direct {v2, v3}, Lse/a;-><init>(Landroid/media/MediaFormat;)V

    iput-object v2, v0, Lre/a;->c:Lse/a;
    ...
    invoke-direct {v2, v3, v7}, Lcom/android/camera/q3;-><init>(Ljava/lang/String;I)V

    invoke-static {v2}, Ljava/util/concurrent/Executors;->newSingleThreadExecutor(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ExecutorService;

    move-result-object v2

    invoke-direct {v1, v2}, Lue/a;-><init>(Ljava/util/concurrent/ExecutorService;)V

    iput-object v1, v0, Lre/a;->d:Lue/a;
...
.method public final a()V
    ...
    iget-object v1, p0, Lre/a;->d:Lue/a;

    iget-object v1, v1, Lue/a;->a:Ljava/util/concurrent/ExecutorService;

    invoke-interface {v1}, Ljava/util/concurrent/ExecutorService;->shutdown()V

    iget-object v1, p0, Lre/a;->b:Lse/c;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lse/b;->g()V

    :cond_0
    iget-object p0, p0, Lre/a;->c:Lse/a;

    if-eqz p0, :cond_1

    invoke-virtual {p0}, Lse/b;->g()V
...
.method public final b(ILre/e;Ljava/lang/Object;I)V
    .locals 7
    .annotation build Lcom/android/camera/jacoco/JacocoForceIgnore;
    .end annotation

    new-instance v6, Lre/a$a;

    iget-object v0, p0, Lre/a;->c:Lse/a;
    ...
    :cond_0
    invoke-virtual {v0, p4}, Lse/b;->h(I)Lse/b$d;
    ...
    :goto_0
    iget-object v0, p0, Lre/a;->b:Lse/c;
    ...
    invoke-direct/range {v0 .. v5}, Lre/a$a;-><init>(Lse/b$d;Lse/b$d;ILjava/lang/Object;Lre/e;)V

    iget-object p0, p0, Lre/a;->d:Lue/a;

    iget-object p1, p0, Lue/a;->b:Ljava/util/ArrayList;
    ...
    invoke-direct {p2, p0, v6}, Lue/a$a;-><init>(Lue/a;Lre/a$a;)V

    iget-object p3, p0, Lue/a;->b:Ljava/util/ArrayList;

    invoke-virtual {p3, p2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object p0, p0, Lue/a;->a:Ljava/util/concurrent/ExecutorService;
...
.method public final c()V
    ...
    iget-object v2, p0, Lre/a;->b:Lse/c;

    if-eqz v2, :cond_0

    new-array v4, v0, [Ljava/lang/Object;

    iget-object v5, v2, Lse/b;->a:Ljava/lang/String;

    invoke-static {v5, v1, v4}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v4, v2, Lse/b;->j:Lse/b$b;

    invoke-virtual {v4, v0}, Landroid/os/Handler;->obtainMessage(I)Landroid/os/Message;

    move-result-object v4

    iget-object v2, v2, Lse/b;->i:Lue/c;

    invoke-virtual {v2, v4}, Lue/c;->a(Landroid/os/Message;)V
    ...
    iget-object v4, p0, Lse/b;->a:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lue/c;->a(Landroid/os/Message;)V
...
.method public final d(Z)V
    ...
    iget-object v0, p0, Lre/a;->d:Lue/a;

    iget-object v1, v0, Lue/a;->b:Ljava/util/ArrayList;
    ...
    iget-object v3, v3, Lue/a$a;->a:Lue/a$b;

    iget-object v3, v3, Lue/a$b;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v0, p1}, Lse/c;->i(Z)V
    ...
    invoke-virtual {p0, p1}, Lse/b;->i(Z)V
