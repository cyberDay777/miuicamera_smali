...
.method public constructor <init>(Ljf/e;)V
    ...
    iput-object p1, p0, Ljf/d;->c:Ljf/e;
    ...
    iput-wide v0, p0, Ljf/d;->a:J

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Ljf/d;->b:J
...
.method public final a(ILandroid/media/AudioTimestamp;Ljava/nio/ByteBuffer;I)V
    ...
    iget-object v0, v1, Ljf/d;->c:Ljf/e;

    iget-object v0, v0, Ljf/e;->a:Landroid/media/AudioRecord;
    ...
    iput-wide v8, v1, Ljf/d;->b:J

    :goto_0
    iget-object v0, v1, Ljf/d;->c:Ljf/e;

    iget-object v0, v0, Ljf/e;->m:Lif/b;

    iget-wide v8, v1, Ljf/d;->b:J

    iput-wide v8, v0, Lif/b;->d:J
    ...
    iget-object v8, v0, Ljf/e;->m:Lif/b;

    iget-wide v9, v8, Lif/b;->d:J
    ...
    :cond_2
    :try_start_0
    iget-object v0, v8, Lif/b;->c:Ljava/nio/ByteBuffer;

    invoke-virtual {v0}, Ljava/nio/ByteBuffer;->clear()Ljava/nio/Buffer;

    iget-object v0, v8, Lif/b;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v6, v8, Lif/b;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object v6, v8, Lif/b;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v6, v8, Lif/b;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v9, v8, Lif/b;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v8, Lif/b;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v11, v8, Lif/b;->c:Ljava/nio/ByteBuffer;
    ...
    :cond_5
    iget-wide v10, v8, Lif/b;->e:J

    const-wide/16 v12, 0x400

    add-long/2addr v10, v12

    iput-wide v10, v8, Lif/b;->e:J

    iget-wide v12, v8, Lif/b;->d:J

    const-wide/32 v14, 0xf4240

    mul-long/2addr v10, v14

    iget v0, v8, Lif/b;->a:I
    ...
    iget-object v0, v8, Lif/b;->g:Lif/a;
    ...
    iget-object v12, v0, Ljf/b;->a:Ljf/e;

    iget-boolean v12, v12, Ljf/e;->d:Z

    if-nez v12, :cond_6

    new-instance v12, Lkf/f;

    invoke-direct {v12, v10, v11, v7, v9}, Lkf/f;-><init>(JILjava/nio/ByteBuffer;)V

    iget-object v7, v0, Ljf/b;->a:Ljf/e;

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, v0, Ljf/b;->a:Ljf/e;
    ...
    :try_start_1
    iget-object v0, v0, Ljf/a;->a:Ljava/util/concurrent/ArrayBlockingQueue;
    ...
    :cond_9
    iget-object v3, v8, Lif/b;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object v3, v8, Lif/b;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v4, v8, Lif/b;->c:Ljava/nio/ByteBuffer;
    ...
    iget-wide v4, v1, Ljf/d;->a:J

    cmp-long v0, v2, v4

    if-lez v0, :cond_c

    iput-wide v2, v1, Ljf/d;->a:J
...
.method public final run()V
    ...
    iget-object v0, p0, Ljf/d;->c:Ljf/e;

    iget v0, v0, Ljf/e;->g:I

    invoke-static {v0}, Ljava/nio/ByteBuffer;->allocateDirect(I)Ljava/nio/ByteBuffer;

    move-result-object v0

    iget-object v1, p0, Ljf/d;->c:Ljf/e;

    invoke-static {v1}, Ljf/e;->b(Ljf/e;)V

    const-wide/16 v3, -0x1

    iput-wide v3, p0, Ljf/d;->b:J

    :goto_0
    iget-object v1, p0, Ljf/d;->c:Ljf/e;

    iget-boolean v1, v1, Ljf/e;->c:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, Ljf/d;->c:Ljf/e;

    iget-object v1, v1, Ljf/e;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v3, p0, Ljf/d;->c:Ljf/e;

    iget-object v4, v3, Ljf/e;->a:Landroid/media/AudioRecord;

    iget v3, v3, Ljf/e;->g:I

    invoke-virtual {v4, v0, v3}, Landroid/media/AudioRecord;->read(Ljava/nio/ByteBuffer;I)I

    move-result v3

    iget-object v4, p0, Ljf/d;->c:Ljf/e;

    iget-object v5, v4, Ljf/e;->a:Landroid/media/AudioRecord;

    iget-object v6, v4, Ljf/e;->k:Landroid/media/AudioTimestamp;

    iget v4, v4, Ljf/e;->n:I
    ...
    iget-object v5, p0, Ljf/d;->c:Ljf/e;

    iget-object v5, v5, Ljf/e;->k:Landroid/media/AudioTimestamp;

    invoke-virtual {p0, v4, v5, v0, v3}, Ljf/d;->a(ILandroid/media/AudioTimestamp;Ljava/nio/ByteBuffer;I)V
    ...
    invoke-static {v4, v5, v3}, Ljf/e;->a(Ljf/e;Ljava/lang/String;I)V
    ...
    :cond_1
    :try_start_1
    iget-object p0, p0, Ljf/d;->c:Ljf/e;
