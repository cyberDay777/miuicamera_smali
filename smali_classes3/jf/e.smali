...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Ljf/e;->i:Ljf/a;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Ljf/e;->j:Ljava/lang/Object;

    new-instance v1, Landroid/media/AudioTimestamp;

    invoke-direct {v1}, Landroid/media/AudioTimestamp;-><init>()V

    iput-object v1, p0, Ljf/e;->k:Landroid/media/AudioTimestamp;

    iput-boolean v0, p0, Ljf/e;->l:Z

    iput v0, p0, Ljf/e;->n:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Ljf/e;->o:J

    return-void
.end method

.method public static a(Ljf/e;Ljava/lang/String;I)V
    .locals 4
    ...
    invoke-static {p1, v0, p2}, Landroidx/constraintlayout/core/parser/a;->f(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput-wide p1, p0, Ljf/e;->o:J

    :cond_0
    return-void
.end method

.method public static b(Ljf/e;)V
    .locals 5
    ...
    iget-object v3, p0, Ljf/e;->a:Landroid/media/AudioRecord;
    ...
    iget-object v1, p0, Ljf/e;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Ljf/e;->a:Landroid/media/AudioRecord;
...
.method public final c()V
    ...
    iget-object v0, p0, Ljf/e;->b:Ljava/lang/Thread;

    if-nez v0, :cond_2

    iget-boolean v0, p0, Ljf/e;->l:Z
    ...
    invoke-direct {v0, p0}, Ljf/d;-><init>(Ljf/e;)V

    iput-object v0, p0, Ljf/e;->b:Ljava/lang/Thread;
    ...
    invoke-direct {v0, p0}, Ljf/c;-><init>(Ljf/e;)V
...
.method public final d(Landroid/media/AudioFormat;III)V
    ...
    iget v0, p0, Ljf/e;->n:I

    iput-object p1, p0, Ljf/e;->e:Landroid/media/AudioFormat;

    iput p2, p0, Ljf/e;->g:I

    iput p3, p0, Ljf/e;->f:I

    iput p4, p0, Ljf/e;->h:I
    ...
    invoke-direct {p3, p1}, Lif/b;-><init>(I)V

    iput-object p3, p0, Ljf/e;->m:Lif/b;

    new-instance p1, Ljf/b;

    invoke-direct {p1, p0}, Ljf/b;-><init>(Ljf/e;)V

    iput-object p1, p3, Lif/b;->g:Lif/a;
    ...
    invoke-static {p1, p2, p3}, Landroidx/appcompat/widget/b;->d(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-boolean p2, p0, Ljf/e;->l:Z
    ...
    iget-object p2, p0, Ljf/e;->e:Landroid/media/AudioFormat;
    ...
    iput-object p1, p0, Ljf/e;->a:Landroid/media/AudioRecord;
    :try_end_0
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {p0}, Ljf/e;->c()V
...
.method public final e()V
    ...
    iput-boolean v2, p0, Ljf/e;->c:Z

    iget-object v0, p0, Ljf/e;->j:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Ljf/e;->a:Landroid/media/AudioRecord;
    ...
    iput-object v1, p0, Ljf/e;->a:Landroid/media/AudioRecord;

    iget-object v3, p0, Ljf/e;->i:Ljf/a;

    invoke-virtual {v3}, Ljf/a;->a()V

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, p0, Ljf/e;->m:Lif/b;

    if-eqz v0, :cond_3

    iput-object v1, v0, Lif/b;->b:Ljava/nio/ByteBuffer;

    iput-object v1, v0, Lif/b;->c:Ljava/nio/ByteBuffer;

    iput-object v1, v0, Lif/b;->g:Lif/a;

    const-wide/16 v3, -0x1

    iput-wide v3, v0, Lif/b;->d:J

    const-wide/16 v3, 0x0

    iput-wide v3, v0, Lif/b;->e:J

    :cond_3
    iput-object v1, p0, Ljf/e;->m:Lif/b;

    iput-object v1, p0, Ljf/e;->b:Ljava/lang/Thread;

    iput-boolean v2, p0, Ljf/e;->l:Z
...
.method public final f()V
    ...
    :try_start_1
    iget-object v3, p0, Ljf/e;->m:Lif/b;

    iget-object v4, v3, Lif/b;->b:Ljava/nio/ByteBuffer;
    ...
    :cond_1
    iput-object v1, v3, Lif/b;->b:Ljava/nio/ByteBuffer;

    iget-object v4, v3, Lif/b;->c:Ljava/nio/ByteBuffer;
