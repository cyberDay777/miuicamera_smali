...
.field public Y:Lcom/xiaomi/milab/videosdk/XmsAudioClip;

.field public Z:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

.field public final a:Ljava/lang/String;

.field public final a0:Lhg/c$b;
...
.field public final c:Lcom/android/camera/ui/v0;
...
# direct methods
.method public constructor <init>(Lhg/c$c;)V
    .locals 8
    ...
    iput-object v0, p0, Lhg/c;->a:Ljava/lang/String;

    new-instance v1, Ljava/util/Stack;

    invoke-direct {v1}, Ljava/util/Stack;-><init>()V

    iput-object v1, p0, Lhg/c;->d:Ljava/util/Stack;

    new-instance v2, Lk2/e;

    invoke-direct {v2}, Lk2/e;-><init>()V

    iput-object v2, p0, Lhg/c;->e:Lk2/e;

    const/4 v2, 0x0

    iput v2, p0, Lhg/c;->t:I

    new-instance v3, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v3}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v3, p0, Lhg/c;->u:Ljava/util/concurrent/locks/ReentrantLock;

    const/4 v3, 0x1

    new-array v4, v3, [I

    iput-object v4, p0, Lhg/c;->x:[I

    const v4, 0xac44

    iput v4, p0, Lhg/c;->P:I

    const/4 v4, 0x2

    iput v4, p0, Lhg/c;->Q:I

    const v5, 0x17700

    iput v5, p0, Lhg/c;->U:I

    new-instance v5, Lhg/c$b;

    invoke-direct {v5, p0}, Lhg/c$b;-><init>(Lhg/c;)V

    iput-object v5, p0, Lhg/c;->a0:Lhg/c$b;

    const-string v5, "camera.debug.dump_milive"

    invoke-static {v5, v2}, Lsf/f;->c(Ljava/lang/String;Z)Z

    move-result v5

    iput-boolean v5, p0, Lhg/c;->y:Z

    iget-object v6, p1, Lhg/c$c;->a:Ljava/lang/ref/WeakReference;

    iput-object v6, p0, Lhg/c;->b:Ljava/lang/ref/WeakReference;

    iget v7, p1, Lhg/c$c;->b:I

    iput v7, p0, Lhg/c;->h:I

    iget-object v7, p1, Lhg/c$c;->c:Ljava/lang/String;

    iput-object v7, p0, Lhg/c;->i:Ljava/lang/String;

    iget-object v7, p1, Lhg/c$c;->d:Lcom/xiaomi/microfilm/milive/a$d;

    iput-object v7, p0, Lhg/c;->o:Lcom/xiaomi/microfilm/milive/a$d;

    iget-object v7, p1, Lhg/c$c;->f:Landroid/os/Handler;

    iput-object v7, p0, Lhg/c;->p:Landroid/os/Handler;

    iget-object p1, p1, Lhg/c$c;->e:Ljava/util/List;
    ...
    iput-object v0, p0, Lhg/c;->c:Lcom/android/camera/ui/v0;
...
.method public final c(II)V
    ...
    iget-object v3, p0, Lhg/c;->a:Ljava/lang/String;
    ...
    iput v0, p0, Lhg/c;->f:I

    invoke-static {p1, p2}, Ljava/lang/Math;->min(II)I

    move-result p1

    iput p1, p0, Lhg/c;->g:I

    :cond_2
    iput-boolean v1, p0, Lhg/c;->M:Z
...
.method public final d(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lhg/c;->a:Ljava/lang/String;

    invoke-static {v2, v0, v1}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iput-object p1, p0, Lhg/c;->j:Ljava/lang/String;
...
.method public final e(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lhg/c;->k:Ljava/lang/String;
...
.method public final f(I)V
    ...
    invoke-virtual {p0, v2}, Lhg/c;->a(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lhg/c;->a(I)Ljava/lang/String;
    ...
    iput p1, p0, Lhg/c;->t:I

    iget-object p1, p0, Lhg/c;->n:Lcom/xiaomi/microfilm/milive/a$c;

    if-eqz p1, :cond_0

    iget p0, p0, Lhg/c;->t:I
...
.method public final i(Lcom/xiaomi/microfilm/milive/a$d;)V
    ...
    invoke-direct/range {v1 .. v7}, Lhg/c$a;-><init>(Lhg/c;JJLcom/xiaomi/microfilm/milive/a$d;)V

    iput-object v0, p0, Lhg/c;->q:Lhg/c$a;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v0

    iput-wide v0, p0, Lhg/c;->r:J

    iget-object p1, p0, Lhg/c;->q:Lhg/c$a;
...
.method public final j()V
    ...
    iget-object v1, p0, Lhg/c;->c:Lcom/android/camera/ui/v0;
    ...
    iget-object v3, p0, Lhg/c;->V:Lm2/c;
    ...
    iget-object v0, p0, Lhg/c;->O:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;
    ...
    iget-object v2, p0, Lhg/c;->j:Ljava/lang/String;

    invoke-static {v2}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z

    move-result v2

    iget v3, p0, Lhg/c;->h:I

    if-nez v2, :cond_2

    iget-object v2, p0, Lhg/c;->O:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    iget-object v4, p0, Lhg/c;->j:Ljava/lang/String;
    ...
    iput-object v2, p0, Lhg/c;->Y:Lcom/xiaomi/milab/videosdk/XmsAudioClip;
    ...
    iget-object p0, p0, Lhg/c;->Y:Lcom/xiaomi/milab/videosdk/XmsAudioClip;
    ...
    :cond_2
    iget-object p0, p0, Lhg/c;->O:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;
...
.method public final onSurfaceTextureReleased()V
    ...
    iget-object v0, p0, Lhg/c;->V:Lm2/c;
    ...
    iput-object v1, p0, Lhg/c;->V:Lm2/c;

    :cond_0
    iget-object v0, p0, Lhg/c;->w:Lkotlinx/coroutines/scheduling/g;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lkotlinx/coroutines/scheduling/g;->c()V

    iput-object v1, p0, Lhg/c;->w:Lkotlinx/coroutines/scheduling/g;
...
.method public final onSurfaceTextureUpdated(Lcom/android/gallery3d/ui/g;Lk2/b;)V
    ...
    iget-object v6, v0, Lhg/c;->e:Lk2/e;
    ...
    iget-object v1, v0, Lhg/c;->e:Lk2/e;
    ...
    :goto_0
    iget-object v6, v0, Lhg/c;->b:Ljava/lang/ref/WeakReference;
    ...
    iget-object v7, v6, Lcom/android/camera/ActivityBase;->b0:Lcom/android/camera/ui/v0;

    if-eqz v7, :cond_19

    invoke-interface {v7}, Lcom/android/camera/ui/v0;->M0()Lcom/android/gallery3d/ui/f;
    ...
    :cond_3
    iget-object v7, v0, Lhg/c;->u:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v7}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    sget-object v7, Lzk/a$a;->a:Lzk/a;

    iget-object v8, v7, Lzk/a;->d:Lcom/xiaomi/milab/videosdk/XmsTimeline;

    if-nez v8, :cond_4

    iget-object v0, v0, Lhg/c;->u:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-virtual {v7, v8}, Lzk/a;->c(Lcom/xiaomi/milab/videosdk/XmsTimeline;)Z
    ...
    iget-object v7, v7, Lzk/a;->c:Ljava/util/HashMap;
    ...
    iget-object v9, v0, Lhg/c;->a0:Lhg/c$b;
    ...
    iput-object v7, v0, Lhg/c;->Z:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    invoke-virtual {v8}, Lcom/xiaomi/milab/videosdk/XmsTimeline;->appendAudioTrack()Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    move-result-object v7

    iput-object v7, v0, Lhg/c;->O:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    iget-object v9, v0, Lhg/c;->j:Ljava/lang/String;

    iget v11, v0, Lhg/c;->h:I
    ...
    iput-object v7, v0, Lhg/c;->Y:Lcom/xiaomi/milab/videosdk/XmsAudioClip;

    invoke-virtual {v8}, Lcom/xiaomi/milab/videosdk/XmsTimeline;->createRecordConsumer()V

    :cond_5
    iget-object v7, v0, Lhg/c;->V:Lm2/c;
    ...
    iget-boolean v7, v0, Lhg/c;->M:Z

    if-nez v7, :cond_8

    :cond_6
    iput-boolean v10, v0, Lhg/c;->M:Z
    ...
    iput-object v7, v0, Lhg/c;->V:Lm2/c;

    :cond_8
    iget v5, v0, Lhg/c;->t:I
    ...
    :goto_1
    invoke-virtual {v0, v10}, Lhg/c;->f(I)V
    ...
    iget-object v5, v7, Lcom/android/gallery3d/ui/a;->c:Lcom/android/camera/effect/w;

    invoke-virtual {v5}, Lcom/android/camera/effect/w;->d()V
    ...
    iget-object v3, v7, Lcom/android/gallery3d/ui/a;->c:Lcom/android/camera/effect/w;

    invoke-virtual {v3, v10, v14, v14, v11}, Lcom/android/camera/effect/w;->e(FFFF)V
    ...
    invoke-virtual {v5, v3, v4}, Lcom/android/camera/effect/w;->i(FF)V

    invoke-virtual {v5, v10, v14, v11, v14}, Lcom/android/camera/effect/w;->e(FFFF)V
    ...
    invoke-virtual {v5, v3, v14}, Lcom/android/camera/effect/w;->i(FF)V
    ...
    invoke-virtual {v5, v2, v14}, Lcom/android/camera/effect/w;->i(FF)V

    iget-object v2, v6, Lcom/android/camera/ActivityBase;->b0:Lcom/android/camera/ui/v0;

    move-object v3, v1

    check-cast v3, Lk2/e;

    invoke-interface {v2}, Lcom/android/camera/ui/v0;->h0()[F
    ...
    iget-object v2, v7, Lcom/android/gallery3d/ui/a;->c:Lcom/android/camera/effect/w;

    const/high16 v3, 0x42b40000    # 90.0f

    invoke-virtual {v2, v3, v14, v14, v11}, Lcom/android/camera/effect/w;->e(FFFF)V
    ...
    invoke-virtual {v3, v14, v2}, Lcom/android/camera/effect/w;->i(FF)V

    invoke-virtual {v3, v10, v11, v14, v14}, Lcom/android/camera/effect/w;->e(FFFF)V
    ...
    invoke-virtual {v3, v2, v14}, Lcom/android/camera/effect/w;->i(FF)V
    ...
    invoke-virtual {v5, v3, v2}, Lcom/android/camera/effect/w;->i(FF)V
    ...
    iget v1, v0, Lhg/c;->t:I

    if-ne v1, v15, :cond_15

    iget-object v1, v0, Lhg/c;->V:Lm2/c;

    invoke-virtual {v1}, Lm2/c;->a()I

    move-result v1

    iget-object v2, v0, Lhg/c;->V:Lm2/c;

    iget-object v2, v2, Lm2/c;->b:Lcom/android/gallery3d/ui/k;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {v6}, Lcom/android/camera/ActivityBase;->V9()Landroid/graphics/SurfaceTexture;
    ...
    iget-boolean v4, v0, Lhg/c;->y:Z

    if-eqz v4, :cond_16

    sget-boolean v4, Ltb/b;->e:Z
    ...
    :cond_11
    iget-object v4, v0, Lhg/c;->w:Lkotlinx/coroutines/scheduling/g;
    ...
    iput-object v4, v0, Lhg/c;->w:Lkotlinx/coroutines/scheduling/g;
    ...
    :goto_3
    iget-object v5, v0, Lhg/c;->x:[I

    iget-object v6, v0, Lhg/c;->a:Ljava/lang/String;
    ...
    :cond_13
    sget-object v4, Lg6/q;->e:Ljava/lang/String;

    invoke-static {v4}, Lg6/q;->n(Ljava/lang/String;)Z

    move-result v7

    if-nez v7, :cond_14

    invoke-static {v4}, Lg6/q;->o(Ljava/lang/String;)V
    ...
    iget-object v5, v0, Lhg/c;->w:Lkotlinx/coroutines/scheduling/g;

    invoke-virtual {v5, v1}, Lkotlinx/coroutines/scheduling/g;->b(I)V
    ...
    invoke-static {v4, v1, v2}, Landroidx/concurrent/futures/b;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v12, v13, v1}, Lbg/f;->b(IIILjava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lhg/c;->f(I)V
