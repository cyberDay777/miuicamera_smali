...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    :cond_0
    invoke-virtual {v1}, Lcom/android/camera/module/m;->isCreated()Z
    ...
    invoke-direct {p1, v5}, Lx9/h;-><init>(I)V
    ...
    :cond_4
    invoke-virtual {v1}, Lcom/android/camera/module/m;->onCameraOpenedFail()V
    ...
    :cond_8
    iget-object v0, p1, Lcom/android/camera/module/m;->mCameraManager:Lz5/k;
    ...
    new-instance v3, Lcom/xiaomi/milive/mode/d;

    invoke-direct {v3, p0, p1, v0, v1}, Lcom/xiaomi/milive/mode/d;-><init>(ZLcom/xiaomi/milive/mode/MiLiveMasterModule;ZZ)V
    ...
    invoke-virtual {v1}, Lcom/android/camera/module/m;->getWindow()Landroid/view/Window;

    move-result-object p1

    invoke-virtual {p1, v3}, Landroid/view/Window;->addFlags(I)V

    invoke-virtual {v1}, Lcom/android/camera/module/m;->getScreenDelay()I
    ...
    :cond_c
    invoke-virtual {v1}, Lcom/android/camera/module/m;->checkActivityOrientation()V
