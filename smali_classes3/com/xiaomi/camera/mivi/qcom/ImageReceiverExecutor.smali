...
.method private static dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Lje/q;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object p1, p1, Lje/q;->W:Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2}, Lfe/f;->c(Landroid/media/Image;Ljava/lang/String;Ljava/lang/String;)Z

    :cond_0
    return-void
.end method

.method private initReprocessProxy(Lje/q;Z)V
    .locals 2
...
.method private lambda$startReprocessLoop$1()V
    ...
    invoke-static {v7, v8, v9, v5}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;JZ)Lje/q;
    ...
    invoke-virtual {v5, v7, v8}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->readParallelTaskDataFromSmallJpeg(Landroid/content/Context;Ljava/lang/String;)Lje/q;
    ...
    :cond_6
    invoke-virtual {v3, v7}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->setParallelTaskData(Lje/q;)V
    ...
    sget-boolean v5, Lfe/f;->e:Z

    if-eqz v5, :cond_7

    const-string v5, "algo_done"

    invoke-static {v3, v7, v5}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Lje/q;Ljava/lang/String;)V
    ...
    :goto_4
    invoke-direct {p0, v7, v6}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->initReprocessProxy(Lje/q;Z)V
...
.method private loop()V
    ...
    invoke-virtual {v1}, L펕펙펛폘펛펟폘펒펓펀펟펕펓폘펵펙펛펛펙페;->f2()Z
