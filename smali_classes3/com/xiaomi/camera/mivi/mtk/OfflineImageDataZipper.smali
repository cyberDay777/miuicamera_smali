...
.method public static synthetic a(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lje/q;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lje/q;)V
...
.method private doJpeg(Lje/q;Landroid/media/Image;I)V
    .locals 9
    ...
    invoke-static {v1, v2, p3}, Landroidx/concurrent/futures/a;->f(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->generateReprocessData(Lje/q;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
...
.method private generateReprocessData(Lje/q;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 17
    ...
    iget-object v5, v1, Lje/q;->L:Landroid/media/Image;
...
.method private handTimeoutTask(J)V
    ...
    invoke-static {v1, p1, p2, v2}, Landroidx/concurrent/futures/c;->e(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;
...
.method private handleDataBeanIfReady(Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;Z)V
    ...
    invoke-virtual {p2, v0}, Ls6/g;->d(Ljava/lang/String;)J

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;->getTimestamp()J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)Lje/q;
    ...
    :cond_1
    iget-wide v0, p2, Lje/q;->b0:J

    iget-object v3, p2, Lje/q;->W:Ljava/lang/String;

    iget-wide v4, p2, Lje/q;->e:J
    ...
    invoke-virtual {p2, v1, v0}, Lje/q;->a(I[B)V
    ...
    invoke-static {v1, v3, v4}, Landroidx/concurrent/futures/a;->f(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput-object v0, p2, Lje/q;->L:Landroid/media/Image;
    ...
    iget-object v1, p2, Lje/q;->q:Lje/r;

    iget-boolean v1, v1, Lje/r;->a:Z
    ...
    invoke-direct {p0, v1, p2, v0}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->postCvWaterMark(Landroid/media/Image;Lje/q;I)V
    ...
    invoke-direct {p0, p2, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->doJpeg(Lje/q;Landroid/media/Image;I)V
...
.method private handleRawImageData([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, p2, p1}, Lje/q;->a(I[B)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->notifyFinish(Lje/q;Ljava/lang/String;)V
...
.method private static synthetic lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lje/q;)V
    .locals 0

    invoke-virtual {p2}, Lje/q;->c()I
...
.method private postCvWaterMark(Landroid/media/Image;Lje/q;I)V
    .locals 4
    ...
    invoke-static {p1, v2}, Lfe/f;->d(Landroid/media/Image;Z)[B

    move-result-object v2

    const-string v3, ""

    invoke-static {p3, v3}, Landroidx/activity/result/a;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, p1, v3}, Landroidx/activity/e;->d(JLjava/lang/StringBuilder;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, Landroidx/concurrent/futures/a;->f(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
...
.method public getParallelTaskData(J)Lje/q;
    .locals 3
...
.method public putParallelTaskData(JLje/q;)V
    .locals 5
