...
.method public final onPictureTaken([BLandroid/hardware/camera2/CaptureResult;)V
    ...
    iget-object v0, p2, Lcom/android/camera/module/m;->mModuleStateMgr:Lz5/f;
    ...
    :cond_0
    iget-object v0, p2, Lcom/android/camera/module/m;->mCameraManager:Lz5/k;
    ...
    iput-object p1, v4, Lr7/h$a;->n:Ljava/lang/String;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v2

    iput-wide v2, v4, Lr7/b$a;->k:J

    iget-object p0, p0, Lcom/xiaomi/microfilm/dualcam/mode/DualVideoRecordModule$b;->a:Landroid/location/Location;

    iput-object p0, v4, Lr7/b$a;->i:Landroid/location/Location;

    iget-object p0, p2, Lcom/android/camera/module/VideoBase;->mUserRecordSetting:Lm6/x;

    iget-object p0, p0, Lm6/x;->c:Lfe/c;

    iget p1, p0, Lfe/c;->a:I

    iput p1, v4, Lr7/b$a;->e:I

    iget p0, p0, Lfe/c;->b:I

    iput p0, v4, Lr7/b$a;->f:I

    iput v0, v4, Lr7/b$a;->g:I

    iput-boolean v1, v4, Lr7/h$a;->o:Z

    const/4 p0, -0x1

    iput p0, v4, Lr7/h$a;->s:I

    iget-object p0, v4, Lr7/h$a;->q:Ljava/lang/String;

    if-eqz p0, :cond_1

    iget-object p0, v4, Lr7/h$a;->m:Landroid/net/Uri;

    if-nez p0, :cond_1

    iget-object p0, p2, Lcom/android/camera/module/m;->mActivity:Lcom/android/camera/Camera;

    iget-object p0, p0, Lcom/android/camera/Camera;->U0:Lr7/i;

    iget-object p0, p0, Lr7/i;->c:Landroid/net/Uri;

    iput-object p0, v4, Lr7/h$a;->m:Landroid/net/Uri;
    ...
    invoke-direct {p1, v4}, Lr7/h;-><init>(Lr7/h$a;)V

    iget-object p2, v4, Lr7/b$a;->j:Lge/f;
