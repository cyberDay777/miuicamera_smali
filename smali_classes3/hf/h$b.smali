...
.method public final call()Ljava/lang/Object;
    ...
    iget-object v0, v0, Lhf/h;->g:Ljf/e;
    ...
    iput-boolean v2, v0, Ljf/e;->c:Z

    iget-object v4, v0, Ljf/e;->i:Ljf/a;

    invoke-virtual {v4}, Ljf/a;->a()V

    iget-object v4, v0, Ljf/e;->b:Ljava/lang/Thread;

    if-nez v4, :cond_0

    invoke-virtual {v0}, Ljf/e;->c()V

    :cond_0
    iget-object v0, v0, Ljf/e;->b:Ljava/lang/Thread;
    ...
    iget-boolean v3, v0, Lhf/h;->S:Z

    if-eqz v3, :cond_3

    iget v3, v0, Lhf/h;->o:I

    if-gez v3, :cond_3

    iget-object v3, v0, Lhf/h;->g:Ljf/e;

    iget-object v3, v3, Ljf/e;->a:Landroid/media/AudioRecord;

    invoke-virtual {v3}, Landroid/media/AudioRecord;->getSampleRate()I

    move-result v3

    iget-object v4, v0, Lhf/h;->g:Ljf/e;

    iget-object v4, v4, Ljf/e;->a:Landroid/media/AudioRecord;
    ...
    iget-object v5, v0, Lhf/h;->g:Ljf/e;

    iget-object v5, v5, Ljf/e;->a:Landroid/media/AudioRecord;
    ...
    invoke-virtual {v0, v3}, Lhf/h;->c(Landroid/media/MediaFormat;)V

    :cond_3
    iget-object p0, p0, Lhf/h$b;->a:Lhf/h;

    iget-object p0, p0, Lhf/h;->l:Lkf/a;

    if-eqz p0, :cond_4

    invoke-virtual {p0}, Lkf/a;->k()V
