...
.method public constructor <init>(Lqd/e;)V
    ...
    iput-object v0, p0, Lqd/i;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Lqd/i;->g:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lqd/i;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lqd/i;->i:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Lqd/i;->j:Ljava/util/concurrent/CopyOnWriteArraySet;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lqd/i;->k:J

    const/4 v0, 0x0

    iput-boolean v0, p0, Lqd/i;->l:Z

    iput-object p1, p0, Lqd/i;->c:Lqd/e;

    new-instance v1, Ltd/a;

    invoke-direct {v1, p1}, Ltd/a;-><init>(Lqd/e;)V

    iput-object v1, p0, Lqd/i;->d:Ltd/a;

    new-instance v2, Lqd/i$a;

    invoke-direct {v2, p0}, Lqd/i$a;-><init>(Lqd/i;)V

    new-instance v3, Ltd/c;

    invoke-direct {v3, p1, v1, v2}, Ltd/c;-><init>(Lqd/e;Ltd/a;Lqd/i$a;)V

    iput-object v3, p0, Lqd/i;->e:Ltd/c;
    ...
    iput-object p1, p0, Lqd/i;->a:Landroid/os/HandlerThread;
    ...
    new-instance v1, Lqd/i$b;

    invoke-direct {v1, p0}, Lqd/i$b;-><init>(Lqd/i;)V

    invoke-direct {v0, p1, v1}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    iput-object v0, p0, Lqd/i;->b:Landroid/os/Handler;

    invoke-virtual {p0}, Lqd/i;->c()V
...
.method public final a(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lqd/i;->c:Lqd/e;
    ...
    invoke-virtual {p1, v0}, Lce/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, p0}, Lce/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, v0, v1, p0}, Lce/a;->e(JLjava/lang/String;)V
    ...
    invoke-virtual {p1, v5, v6, v0}, Lce/a;->e(JLjava/lang/String;)V

    iget-wide v0, p0, Lqd/i;->k:J
    ...
    iput-wide v3, p0, Lqd/i;->k:J

    iget-boolean v3, p0, Lqd/i;->l:Z
    ...
    :goto_2
    invoke-virtual {p1, v3}, Lce/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, v0, v1, v3}, Lce/a;->e(JLjava/lang/String;)V

    :cond_7
    iput-boolean v2, p0, Lqd/i;->l:Z
...
.method public final b(Z)V
    ...
    :try_start_0
    iget-object v2, p0, Lqd/i;->c:Lqd/e;
    ...
    iget-object p0, p0, Lqd/i;->b:Landroid/os/Handler;
...
.method public final c()V
    ...
    iget-object v0, v0, Lqd/e;->l:Landroid/content/Context;
...
.method public final d(Lxd/f;)V
    .locals 8

    iget-object v0, p0, Lqd/i;->c:Lqd/e;

    iget-object v1, v0, Lqd/e;->b:Lzd/a;
    ...
    :cond_0
    iget-object v2, p1, Lxd/h;->a:Lxd/i;
    ...
    invoke-static {v2}, Lxf/a;->c(Ljava/lang/Object;)Lxf/a;

    move-result-object v4

    iget-object v5, p0, Lqd/i;->j:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    invoke-direct {v7, p0}, Lce/a;-><init>(Lcom/android/camera/data/data/f;)V
    ...
    iget-object p0, v0, Lqd/e;->l:Landroid/content/Context;
    ...
    invoke-virtual {v7, v6, v0}, Lce/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v0, p0}, Lce/a;->c(Ljava/lang/String;I)V
    ...
    invoke-virtual {v7, v0, p0}, Lce/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, p0, v0}, Lce/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v0}, Lbe/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v3, p1}, Lce/a;->e(JLjava/lang/String;)V
    ...
    :pswitch_4
    check-cast p1, Lwd/wb;

    const-wide/16 v0, 0x0

    if-eqz p1, :cond_d

    iget-object p1, p1, Lwd/wb;->a:Lxf/a;
    ...
    invoke-virtual {p0, p1}, Lce/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p0, v0, v1, p1}, Lce/a;->e(JLjava/lang/String;)V
