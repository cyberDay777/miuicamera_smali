...
.method public constructor <init>(Lqd/e;)V
    ...
    iput-object v0, p0, Lqd/b;->e:Ljava/util/HashSet;
...
.method public final E(Z)V
    ...
    invoke-static {p1, v0}, Lbe/a;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_1
    iput-boolean p1, v0, Lqd/b$a;->b:Z
    :try_end_1
    ...
    iget-object p1, p0, Lqd/b;->d:Lqd/b$a;
    ...
    :try_start_3
    iget-boolean v2, v0, Lqd/b$a;->a:Z
    ...
    :try_start_5
    iput-boolean v1, p1, Lqd/b$a;->b:Z
    :try_end_5
...
.method public final a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lqd/e;->a(Ljava/lang/Class;)Lpd/b;
    ...
    invoke-virtual {p0, p1}, Lpd/g;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method public final b()V
    ...
    invoke-static {p0, v0}, Lbe/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public final c(Lae/a;)V
    .locals 3
    ...
    iget-object p1, p1, Lae/a;->b:Ljava/lang/String;
    ...
    invoke-static {v0, p1}, Lbe/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, p0, Lqd/b;->a:Lqd/e;

    iget-object p1, p1, Lqd/e;->p:Lqd/i;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Lqd/i;->b(Z)V
    ...
    :try_start_0
    iget-boolean v0, p1, Lqd/b$a;->b:Z
    :try_end_0
    ...
    invoke-virtual {p1, v0}, Lqd/e;->a(Ljava/lang/Class;)Lpd/b;
    ...
    invoke-virtual {p1}, Lpd/d;->a()V

    :cond_2
    iget-object p1, p0, Lqd/b;->a:Lqd/e;

    iget-object p1, p1, Lqd/e;->i:Lqd/j;

    monitor-enter p1

    :try_start_1
    iget-object v0, p1, Lqd/j;->f:Ljava/util/LinkedList;
    ...
    iget-object p0, p0, Lqd/e;->i:Lqd/j;

    invoke-virtual {p0}, Lqd/j;->b()V
...
.method public final d(Lce/a;)V
    .locals 2

    iget-object p0, p0, Lqd/b;->a:Lqd/e;

    iget-object v0, p0, Lqd/e;->l:Landroid/content/Context;
    ...
    invoke-virtual {p1, v1, v0}, Lce/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lqd/e;->l:Landroid/content/Context;
    ...
    invoke-virtual {p1, v0, p0}, Lce/a;->c(Ljava/lang/String;I)V
    ...
    invoke-virtual {p1, v0, p0}, Lce/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    :goto_0
    return-void
.end method

.method public final e(Lxd/f;)V
    .locals 9
    ...
    invoke-virtual {v1, p1}, Lqd/i;->d(Lxd/f;)V

    iget-object v1, p0, Lqd/b;->e:Ljava/util/HashSet;
    ...
    iget-object v1, v1, Lqd/e;->c:Lqd/g;
    ...
    iget-object v2, v1, Lqd/g;->b:Lqd/e;

    iget-object v2, v2, Lqd/e;->d:Lqd/f;

    invoke-virtual {v2, p1}, Lqd/f;->a(Lxd/f;)Z
    ...
    :try_start_0
    invoke-virtual {v1, p1}, Lqd/g;->b(Lxd/f;)V
    ...
    iget-object v1, v1, Lqd/e;->h:Lqd/d;
    ...
    iget-object p0, p0, Lqd/e;->n:Lqd/h;
    ...
    iget-object v4, p0, Lqd/h;->e:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v4, v1}, Ljava/util/concurrent/ConcurrentHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lqd/h$a;
    ...
    :cond_b
    :goto_2
    iget-object v1, v5, Lqd/h$a;->a:Ljava/lang/String;
    ...
    :cond_c
    invoke-virtual {p0, v5}, Lqd/h;->a(Lqd/h$a;)V

    iget-object p1, p1, Lxd/h;->b:Ljava/lang/Object;

    check-cast p1, Lwd/gb;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput v6, v5, Lqd/h$a;->e:I

    iget p1, v5, Lqd/h$a;->f:I

    add-int/2addr p1, v2

    iput p1, v5, Lqd/h$a;->f:I
    ...
    iput-object v1, p0, Lqd/h;->h:Ljava/lang/String;

    :cond_10
    :goto_3
    invoke-virtual {p0, v5}, Lqd/h;->b(Lqd/h$a;)V
...
.method public final f([B)V
    ...
    iget-object v0, v0, Lqd/e;->p:Lqd/i;

    iget-object v1, v0, Lqd/i;->c:Lqd/e;
    ...
    invoke-virtual {v2, v3, v4}, Lzd/a;->b(Ljava/lang/String;Z)Z
    ...
    iget-object v1, v1, Lqd/e;->d:Lqd/f;

    iget-object v1, v1, Lqd/f;->b:Ljava/lang/String;
    ...
    :cond_1
    iget-object v0, v0, Lqd/i;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v0, v2}, Lce/a;->b(Ljava/lang/String;)J
    ...
    invoke-static {v3, v1}, Lbe/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v7

    invoke-virtual {v0, v7, v8, v2}, Lce/a;->e(JLjava/lang/String;)V

    :cond_2
    :goto_0
    iget-object v0, p0, Lqd/b;->a:Lqd/e;

    iget-object v0, v0, Lqd/e;->c:Lqd/g;

    iget-object v1, v0, Lqd/g;->b:Lqd/e;

    iget-object v1, v1, Lqd/e;->p:Lqd/i;

    iget-object v2, v1, Lqd/i;->c:Lqd/e;

    iget-object v3, v2, Lqd/e;->b:Lzd/a;

    const-string v7, "track.enable"

    invoke-virtual {v3, v7, v4}, Lzd/a;->b(Ljava/lang/String;Z)Z
    ...
    iget-object v2, v2, Lqd/f;->b:Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Lce/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {v1, v5, v6, v3}, Lce/a;->e(JLjava/lang/String;)V
    ...
    :try_start_0
    iget-object v1, v0, Lqd/g;->c:Lrd/a;

    if-eqz v1, :cond_6

    invoke-virtual {v1, p1, v4}, Lrd/a;->a([BZ)V
    ...
    iget-object p1, p0, Lqd/h;->h:Ljava/lang/String;
    ...
    :cond_7
    iget-object v0, p0, Lqd/h;->e:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ConcurrentHashMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lqd/h$a;
    ...
    :cond_8
    invoke-virtual {p0, p1}, Lqd/h;->a(Lqd/h$a;)V

    const/4 v0, 0x6

    iput v0, p1, Lqd/h$a;->e:I

    iget v0, p1, Lqd/h$a;->g:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p1, Lqd/h$a;->g:I

    invoke-virtual {p0, p1}, Lqd/h;->b(Lqd/h$a;)V
...
.method public final g(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lpd/g;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final k(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lpd/g;->b(Ljava/lang/String;)V
...
.method public final n(Lzd/b;)V
    ...
    invoke-virtual {p1, p0, v0}, Lzd/b;->o(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final o()V
    ...
    invoke-virtual {v0, v1, v2}, Lzd/a;->c(Ljava/lang/String;I)I
    ...
    iget-object v0, v0, Lqd/e;->n:Lqd/h;

    iget-object v1, v0, Lqd/h;->b:Lqd/e;

    iget-object v1, v1, Lqd/e;->b:Lzd/a;

    const-string v3, "connection.max_keep_alive_time"

    invoke-virtual {v1, v3, v2}, Lzd/a;->c(Ljava/lang/String;I)I
    ...
    :try_start_2
    iget-object v2, v0, Lqd/h;->g:Ljava/util/concurrent/ScheduledFuture;
    ...
    :cond_1
    iget-object v2, v0, Lqd/h;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    new-instance v3, Lqd/h$b;

    invoke-direct {v3, v0}, Lqd/h$b;-><init>(Lqd/h;)V
    ...
    iput-object v1, v0, Lqd/h;->g:Ljava/util/concurrent/ScheduledFuture;
...
.method public final r()V
    ...
    invoke-virtual {v0, v1}, Lqd/i;->b(Z)V
    ...
    :try_start_1
    iput-boolean v2, v0, Lqd/b$a;->b:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {v0, v3}, Lbe/a;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lqd/e;->a(Ljava/lang/Class;)Lpd/b;
    ...
    invoke-virtual {v0}, Lpd/d;->a()V

    :cond_3
    iget-object v0, p0, Lqd/b;->a:Lqd/e;

    iget-object v0, v0, Lqd/e;->i:Lqd/j;

    invoke-virtual {v0}, Lqd/j;->b()V

    iget-object p0, p0, Lqd/b;->a:Lqd/e;

    iget-object v0, p0, Lqd/e;->n:Lqd/h;

    monitor-enter v0

    :try_start_3
    iget-object p0, v0, Lqd/h;->g:Ljava/util/concurrent/ScheduledFuture;
    ...
    iput-object p0, v0, Lqd/h;->g:Ljava/util/concurrent/ScheduledFuture;
...
.method public final w(Lzd/b;)V
    .locals 2

    iget-object p1, p0, Lqd/b;->a:Lqd/e;

    iget-object p1, p1, Lqd/e;->l:Landroid/content/Context;

    const-string v0, "aivs_cloud_control"

    const-string v1, "link_mode"

    invoke-static {p1, v0, v1}, Lud/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lqd/b;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lqd/b;->k(Ljava/lang/String;)V
