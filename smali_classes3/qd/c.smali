...
.method public constructor <init>(Lqd/e;)V
    ...
    iput v0, p0, Lqd/c;->h:I

    new-instance v1, Ljava/security/SecureRandom;

    invoke-direct {v1}, Ljava/security/SecureRandom;-><init>()V

    iput-object v1, p0, Lqd/c;->j:Ljava/security/SecureRandom;

    iput-object p1, p0, Lqd/c;->a:Lqd/e;

    iget-object v1, p1, Lqd/e;->l:Landroid/content/Context;

    iput-object v1, p0, Lqd/c;->b:Landroid/content/Context;

    iget-object v1, p1, Lqd/e;->b:Lzd/a;

    const-string v2, "auth.client_id"

    invoke-virtual {v1, v2}, Lzd/a;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lqd/c;->d:Ljava/lang/String;
    ...
    iput-object v2, p0, Lqd/c;->f:Ljava/lang/String;

    iget-object v2, p1, Lqd/e;->o:Lwd/ea;
    ...
    iget-object p1, p1, Lqd/e;->o:Lwd/ea;
    ...
    :goto_0
    iput-object p1, p0, Lqd/c;->e:Ljava/lang/String;
    ...
    new-instance p1, Lqd/c$a;

    invoke-direct {p1, p0}, Lqd/c$a;-><init>(Lqd/c;)V

    iput-object p1, p0, Lqd/c;->c:Lqd/c$a;

    return-void
.end method

.method public static b(Lqd/c;J)V
    .locals 5
    ...
    iget-object v0, p0, Lqd/c;->c:Lqd/c$a;
    ...
    :cond_0
    iget-object v2, p0, Lqd/c;->i:Ljava/util/concurrent/ScheduledFuture;
    ...
    sget-object v3, Lyd/b;->a:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    :goto_0
    :try_start_0
    invoke-static {v0, p1, p2}, Lyd/b;->a(Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;

    move-result-object p1

    iput-object p1, p0, Lqd/c;->i:Ljava/util/concurrent/ScheduledFuture;
    :try_end_0
...
.method public static c(Lqd/c;I)J
    .locals 6

    const-string v0, "cloud_config_last_request_time"

    invoke-virtual {p0, v0}, Lqd/c;->a(Ljava/lang/String;)J
    ...
    invoke-static {p1, v1}, Lbe/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p0, p0, Lqd/c;->b:Landroid/content/Context;

    const-string p1, "aivs_cloud_control"

    invoke-static {p0, p1, v0}, Lud/b;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    return-wide v4
.end method

.method public static d(Lqd/c;)V
    .locals 6
    ...
    iget-object v2, p0, Lqd/c;->b:Landroid/content/Context;

    const-string v3, "aivs_cloud_control"

    const-string v4, "cloud_config_last_request_time"

    invoke-static {v2, v3, v4, v1}, Lud/b;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "parse error"

    const-string v2, "getCloudConfigFromNet body: "

    iget-object v3, p0, Lqd/c;->a:Lqd/e;
    ...
    invoke-virtual {v3, v5, v4}, Lzd/a;->c(Ljava/lang/String;I)I
    ...
    iget-object v5, p0, Lqd/c;->d:Ljava/lang/String;
    ...
    iget-object v5, p0, Lqd/c;->f:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v4, p0, Lqd/c;->g:Lokhttp3/OkHttpClient;
    ...
    invoke-static {v1, v4}, Loa/s;->b(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object v4, v2, Loa/s;->b:Leb/m;

    invoke-virtual {v4, v3}, Leb/m;->k(Ljava/lang/reflect/Type;)Loa/h;
    ...
    :try_start_1
    iget-object v4, v2, Loa/s;->a:Lga/c;

    invoke-virtual {v4, v1}, Lga/c;->k(Ljava/lang/String;)Lga/h;

    move-result-object v1

    invoke-virtual {v2, v1, v3}, Loa/s;->e(Lga/h;Loa/h;)Ljava/lang/Object;
    ...
    invoke-static {v1}, Loa/j;->e(Ljava/io/IOException;)Loa/j;
    ...
    iget-object p0, p0, Lqd/c;->c:Lqd/c$a;
...
.method public final a(Ljava/lang/String;)J
    ...
    invoke-static {p0, v0, p1}, Lud/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, p1, v3}, Landroidx/activity/result/a;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p1, p0}, Lbe/a;->c(Ljava/lang/String;Ljava/lang/String;)V
